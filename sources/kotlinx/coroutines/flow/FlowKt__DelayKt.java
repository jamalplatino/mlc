...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m7557debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m7510toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m7558sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m7510toDelayMillisLRDsOJo(j));
    }
}
