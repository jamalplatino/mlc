    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m6005constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m6005constructorimpl(Unit.INSTANCE);
        if (Result.m6012isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m7545successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m7543closedJP2dKIU(Result.m6008exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m7530boximpl(obj3);
    }
}
