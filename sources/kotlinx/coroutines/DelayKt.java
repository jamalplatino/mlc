...
public final class DelayKt {
    ...
    public static final Object m7509delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m7510toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7510toDelayMillisLRDsOJo(long j) {
        if (Duration.m7336compareToLRDsOJo(j, Duration.Companion.m7439getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7355getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
