...
final class ReportDrawnComposition implements Function0<Unit> {
    ...
    public ReportDrawnComposition(FullyDrawnReporter fullyDrawnReporter2, Function0<Boolean> function0) {
        this.fullyDrawnReporter = fullyDrawnReporter2;
        this.predicate = function0;
        SnapshotStateObserver snapshotStateObserver2 = new SnapshotStateObserver(ReportDrawnComposition$snapshotStateObserver$1.INSTANCE);
        snapshotStateObserver2.start();
        this.snapshotStateObserver = snapshotStateObserver2;
