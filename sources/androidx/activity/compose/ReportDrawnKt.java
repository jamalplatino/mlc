...
public final class ReportDrawnKt {
    ...
    public static final void ReportDrawnAfter(Function1<? super Continuation<? super Unit>, ? extends Object> function1, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(function1, fullyDrawnReporter, new ReportDrawnKt$ReportDrawnAfter$1(fullyDrawnReporter, function1, (Continuation<? super ReportDrawnKt$ReportDrawnAfter$1>) null), startRestartGroup, 584);
        ScopeUpdateScope endRestartGroup2 = startRestartGroup.endRestartGroup();
        if (endRestartGroup2 != null) {
