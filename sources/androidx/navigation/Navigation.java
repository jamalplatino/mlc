...
public final class Navigation {
    ...
    public static final void m5910createNavigateOnClickListener$lambda0(int i, Bundle bundle, View view) {
    ...
    public static final void m5911createNavigateOnClickListener$lambda1(NavDirections navDirections, View view) {
        Intrinsics.checkNotNullParameter(navDirections, "$directions");
        Intrinsics.checkNotNullExpressionValue(view, "view");
