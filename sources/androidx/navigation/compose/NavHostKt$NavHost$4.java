...
final class NavHostKt$NavHost$4 extends Lambda implements Function3<String, Composer, Integer, Unit> {
    ...
    public final void invoke(String str, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C145@5663L600,145@5640L623,161@6288L147:NavHost.kt#opm8kd");
        if ((i & 14) == 0) {
            i |= composer.changed((Object) str) ? 4 : 2;
        }
        if ((i & 91) != 18 || !composer.getSkipping()) {
            List r8 = NavHostKt.m5916NavHost$lambda5(this.$visibleEntries$delegate);
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual((Object) str, (Object) ((NavBackStackEntry) obj).getId())) {
                    break;
                }
            }
            ...
            if (navBackStackEntry != null) {
                NavBackStackEntryProviderKt.LocalOwnersProvider(navBackStackEntry, this.$saveableStateHolder, ComposableLambdaKt.composableLambda(composer, -631736544, true, new Function2<Composer, Integer, Unit>() {
                    ...
                    public final void invoke(Composer composer, int i) {
                        ComposerKt.sourceInformation(composer, "C162@6403L18:NavHost.kt#opm8kd");
