...
public final class DialogHostKt {
    public static final void DialogHost(DialogNavigator dialogNavigator, Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            SnapshotStateList<NavBackStackEntry> rememberVisibleList = rememberVisibleList(m5914DialogHost$lambda0(collectAsState), startRestartGroup, 8);
            PopulateVisibleList(rememberVisibleList, m5914DialogHost$lambda0(collectAsState), startRestartGroup, 64);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x002b, code lost:
        if (r0 == androidx.compose.runtime.Composer.Companion.getEmpty()) goto L_0x002d;
     */
    ...
    private static final List<NavBackStackEntry> m5914DialogHost$lambda0(State<? extends List<NavBackStackEntry>> state) {
