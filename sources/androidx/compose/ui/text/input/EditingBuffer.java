...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m5129getMinimpl(j);
        this.selectionEnd = TextRange.m5128getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int r0 = TextRange.m5129getMinimpl(j);
        int r5 = TextRange.m5128getMaximpl(j);
    ...
    public final TextRange m5273getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m5119boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m5274getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int i, int i2) {
        ...
        long r5 = EditingBufferKt.m5275updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m5129getMinimpl(r5));
        setSelectionEnd(TextRange.m5128getMaximpl(r5));
        if (hasComposition$ui_text_release()) {
            long r52 = EditingBufferKt.m5275updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m5125getCollapsedimpl(r52)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m5129getMinimpl(r52);
            this.compositionEnd = TextRange.m5128getMaximpl(r52);
        }
    }
