...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue textFieldValue, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int i = -1;
            int r02 = r0 != null ? TextRange.m5129getMinimpl(r0.m5135unboximpl()) : -1;
            TextRange r2 = textFieldValue.m5351getCompositionMzsxiRA();
            if (r2 != null) {
                i = TextRange.m5128getMaximpl(r2.m5135unboximpl());
            }
            inputMethodManager.updateSelection(TextRange.m5129getMinimpl(textFieldValue.m5352getSelectiond9O1mEE()), TextRange.m5128getMaximpl(textFieldValue.m5352getSelectiond9O1mEE()), r02, i);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m5125getCollapsedimpl(this.mTextFieldValue.m5352getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (i != 0) {
            switch (i) {
                case 2:
                    i2 = ImeAction.Companion.m5293getGoeUduSuo();
                    break;
                case 3:
                    i2 = ImeAction.Companion.m5297getSearcheUduSuo();
                    break;
                case 4:
                    i2 = ImeAction.Companion.m5298getSendeUduSuo();
                    break;
                case 5:
                    i2 = ImeAction.Companion.m5294getNexteUduSuo();
                    break;
                case 6:
                    i2 = ImeAction.Companion.m5292getDoneeUduSuo();
                    break;
                case 7:
                    i2 = ImeAction.Companion.m5296getPreviouseUduSuo();
                    break;
                default:
                    Log.w(RecordingInputConnection_androidKt.TAG, "IME sends unsupported Editor Action: " + i);
                    i2 = ImeAction.Companion.m5291getDefaulteUduSuo();
                    break;
            }
        } else {
            i2 = ImeAction.Companion.m5291getDefaulteUduSuo();
        }
        this.eventCallback.m5306onImeActionKlQnJC8(i2);
        return true;
    }

    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m5129getMinimpl(this.mTextFieldValue.m5352getSelectiond9O1mEE()), i);
    }
}
