...
public final class KeyboardCapitalization {
    ...
    public static final int Characters = m5308constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int None = m5308constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Sentences = m5308constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int Words = m5308constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m5307boximpl(int i) {
    ...
    public static boolean m5309equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).m5313unboximpl();
    }
    ...
    public final /* synthetic */ int m5313unboximpl() {
        return this.value;
    }
    ...
    public static String m5312toStringimpl(int i) {
        if (m5310equalsimpl0(i, None)) {
            return "None";
        }
        if (m5310equalsimpl0(i, Characters)) {
            return "Characters";
        }
        if (m5310equalsimpl0(i, Words)) {
            return "Words";
        }
        return m5310equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5314getCharactersIUNYP9k$annotations() {
        }

        /* renamed from: getNone-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m5315getNoneIUNYP9k$annotations() {
        }

        /* renamed from: getSentences-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m5316getSentencesIUNYP9k$annotations() {
        }

        /* renamed from: getWords-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m5317getWordsIUNYP9k$annotations() {
        }
        ...
        public final int m5319getNoneIUNYP9k() {
            return KeyboardCapitalization.None;
        }

        /* renamed from: getCharacters-IUNYP9k  reason: not valid java name */
        public final int m5318getCharactersIUNYP9k() {
            return KeyboardCapitalization.Characters;
        }

        /* renamed from: getWords-IUNYP9k  reason: not valid java name */
        public final int m5321getWordsIUNYP9k() {
            return KeyboardCapitalization.Words;
        }

        /* renamed from: getSentences-IUNYP9k  reason: not valid java name */
        public final int m5320getSentencesIUNYP9k() {
