...
public final class ImeOptions {
    ...
    public final int m5301getCapitalizationIUNYP9k() {
        return this.capitalization;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m5302getImeActioneUduSuo() {
        return this.imeAction;
    }

    /* renamed from: getKeyboardType-PjHm6EE  reason: not valid java name */
    public final int m5303getKeyboardTypePjHm6EE() {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.Companion.m5319getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.Companion.m5345getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.Companion.m5291getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ ImeOptions m5299copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m5300copyuxg59PA(z, i5, z3, i6, i3);
    }

    /* renamed from: copy-uxg59PA  reason: not valid java name */
    public final ImeOptions m5300copyuxg59PA(boolean z, int i, boolean z2, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m5310equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m5325equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m5279equalsimpl0(this.imeAction, imeOptions.imeAction);
    }

    public int hashCode() {
        return (((((((Boolean.hashCode(this.singleLine) * 31) + KeyboardCapitalization.m5311hashCodeimpl(this.capitalization)) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m5326hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5280hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + KeyboardCapitalization.m5312toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m5327toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m5281toStringimpl(this.imeAction) + ')';
    }
}
