...
final class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5409copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5411copy8_81llA(j);
    }

    /* renamed from: component1-0d7_KjU  reason: not valid java name */
    public final long m5410component10d7_KjU() {
        return this.value;
    }

    /* renamed from: copy-8_81llA  reason: not valid java name */
    public final ColorStyle m5411copy8_81llA(long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorStyle) && Color.m2822equalsimpl0(this.value, ((ColorStyle) obj).value);
    }
    ...
    public long m5412getColor0d7_KjU() {
        return this.value;
    }

    /* renamed from: getValue-0d7_KjU  reason: not valid java name */
    public final long m5413getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m2828hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + Color.m2829toStringimpl(this.value) + ')';
    }
    ...
    public float getAlpha() {
        return Color.m2823getAlphaimpl(m5412getColor0d7_KjU());
    }
}
