...
final class SaversKt$OffsetSaver$1 extends Lambda implements Function2<SaverScope, Offset, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m5075invokeUv8p0NA((SaverScope) obj, ((Offset) obj2).m2582unboximpl());
    }

    /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
    public final Object m5075invokeUv8p0NA(SaverScope saverScope, long j) {
        Intrinsics.checkNotNullParameter(saverScope, "$this$Saver");
        if (Offset.m2569equalsimpl0(j, Offset.Companion.m2587getUnspecifiedF1C5BW0())) {
            return (Serializable) false;
        }
        return CollectionsKt.arrayListOf((Float) SaversKt.save(Float.valueOf(Offset.m2572getXimpl(j))), (Float) SaversKt.save(Float.valueOf(Offset.m2573getYimpl(j))));
    }
}
