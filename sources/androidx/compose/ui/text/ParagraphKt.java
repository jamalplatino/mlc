...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String str, TextStyle textStyle, float f, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z) {
        ...
        return AndroidParagraph_androidKt.m5367ActualParagraphO3s9Psw(str2, textStyle2, list3, list4, i, z, ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, (Object) null), density2, resolver2);
    }

    /* renamed from: Paragraph-UdtVg6A$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m5032ParagraphUdtVg6A$default(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, List list2, int i, boolean z, int i2, Object obj) {
        List list3;
        int i3 = i2;
        List emptyList = (i3 & 32) != 0 ? CollectionsKt.emptyList() : list;
        if ((i3 & 64) != 0) {
        ...
        return m5031ParagraphUdtVg6A(str, textStyle, j, density, resolver, emptyList, list3, (i3 & 128) != 0 ? Integer.MAX_VALUE : i, (i3 & 256) != 0 ? false : z);
    }

    /* renamed from: Paragraph-UdtVg6A  reason: not valid java name */
    public static final Paragraph m5031ParagraphUdtVg6A(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z) {
        Intrinsics.checkNotNullParameter(str, "text");
        Intrinsics.checkNotNullParameter(textStyle, "style");
        Intrinsics.checkNotNullParameter(density, "density");
        FontFamily.Resolver resolver2 = resolver;
        ...
        List<AnnotatedString.Range<Placeholder>> list4 = list2;
        Intrinsics.checkNotNullParameter(list4, "placeholders");
        return AndroidParagraph_androidKt.m5367ActualParagraphO3s9Psw(str, textStyle, list3, list4, i, z, j, density, resolver2);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, float f) {
        ...
        return AndroidParagraph_androidKt.m5366ActualParagraphhBUhpc(paragraphIntrinsics, i, z, ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, (Object) null));
    }

    /* renamed from: Paragraph-_EkL_-Y$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m5034Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m5033Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }

    /* renamed from: Paragraph-_EkL_-Y  reason: not valid java name */
    public static final Paragraph m5033Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z) {
        Intrinsics.checkNotNullParameter(paragraphIntrinsics, "paragraphIntrinsics");
        return AndroidParagraph_androidKt.m5366ActualParagraphhBUhpc(paragraphIntrinsics, i, z, j);
    }
