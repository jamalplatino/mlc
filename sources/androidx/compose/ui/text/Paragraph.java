...
public interface Paragraph {
    ...
    int m5024getOffsetForPositionk4lQ0M(long j);
    ...
    long m5025getWordBoundaryjx7JFs(int i);

    boolean isLineEllipsized(int i);

    /* renamed from: paint-LG529CI  reason: not valid java name */
    void m5026paintLG529CI(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i);

    /* renamed from: paint-RPmYEkk  reason: not valid java name */
    void m5027paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration);

    /* renamed from: paint-hn5TExg  reason: not valid java name */
    void m5028painthn5TExg(Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i);
    ...
    static /* synthetic */ void m5021paintLG529CI$default(Paragraph paragraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if (obj == null) {
            ...
            paragraph.m5026paintLG529CI(canvas, r0, shadow2, textDecoration2, drawStyle2, (i2 & 32) != 0 ? DrawScope.Companion.m3430getDefaultBlendMode0nO6VwU() : i);
            return;
        }
    ...
    static /* synthetic */ void m5022paintRPmYEkk$default(Paragraph paragraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Color.Companion.m2857getUnspecified0d7_KjU();
            }
            paragraph.m5027paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
            return;
        }
    ...
    static /* synthetic */ void m5023painthn5TExg$default(Paragraph paragraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if (obj == null) {
            paragraph.m5028painthn5TExg(canvas, brush, (i2 & 4) != 0 ? Float.NaN : f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.Companion.m3430getDefaultBlendMode0nO6VwU() : i);
            return;
        }
