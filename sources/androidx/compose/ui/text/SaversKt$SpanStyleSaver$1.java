...
final class SaversKt$SpanStyleSaver$1 extends Lambda implements Function2<SaverScope, SpanStyle, Object> {
    ...
    public final Object invoke(SaverScope saverScope, SpanStyle spanStyle) {
        ...
        Intrinsics.checkNotNullParameter(saverScope2, "$this$Saver");
        Intrinsics.checkNotNullParameter(spanStyle, "it");
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m2811boximpl(spanStyle.m5091getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope2), SaversKt.save(TextUnit.m5797boximpl(spanStyle.m5092getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope2), SaversKt.save(spanStyle.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), saverScope2), SaversKt.save(spanStyle.m5093getFontStyle4Lr2A7w()), SaversKt.save(spanStyle.m5094getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(spanStyle.getFontFeatureSettings()), SaversKt.save(TextUnit.m5797boximpl(spanStyle.m5095getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope2), SaversKt.save(spanStyle.m5090getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), saverScope2), SaversKt.save(spanStyle.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), saverScope2), SaversKt.save(spanStyle.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), saverScope2), SaversKt.save(Color.m2811boximpl(spanStyle.m5089getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope2), SaversKt.save(spanStyle.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), saverScope2), SaversKt.save(spanStyle.getShadow(), SaversKt.getSaver(Shadow.Companion), saverScope2));
    }
}
