...
final class SaversKt$ShadowSaver$1 extends Lambda implements Function2<SaverScope, Shadow, Object> {
    ...
    public final Object invoke(SaverScope saverScope, Shadow shadow) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m2811boximpl(shadow.m3173getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(Offset.m2561boximpl(shadow.m3174getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), saverScope), SaversKt.save(Float.valueOf(shadow.getBlurRadius())));
    }
}
