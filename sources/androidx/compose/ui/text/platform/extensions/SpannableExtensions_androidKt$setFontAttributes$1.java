...
final class SpannableExtensions_androidKt$setFontAttributes$1 extends Lambda implements Function3<SpanStyle, Integer, Integer, Unit> {
    ...
    public final void invoke(SpanStyle spanStyle, int i, int i2) {
        ...
        FontStyle r5 = spanStyle.m5093getFontStyle4Lr2A7w();
        FontStyle r52 = FontStyle.m5217boximpl(r5 != null ? r5.m5223unboximpl() : FontStyle.Companion.m5225getNormal_LCdwA());
        FontSynthesis r7 = spanStyle.m5094getFontSynthesisZQGJjVo();
        spannable.setSpan(new TypefaceSpan(function4.invoke(fontFamily, fontWeight, r52, FontSynthesis.m5226boximpl(r7 != null ? r7.m5234unboximpl() : FontSynthesis.Companion.m5235getAllGVVA2EU()))), i, i2, 33);
    }
}
