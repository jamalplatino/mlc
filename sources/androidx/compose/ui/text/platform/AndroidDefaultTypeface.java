...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface m5356getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5170getAndroidTypefaceStyleFO1MlWM(fontWeight, i));
        ...
        return typefaceHelperMethodsApi28.create(typeface, fontWeight.getWeight(), FontStyle.m5220equalsimpl0(i, FontStyle.Companion.m5224getItalic_LCdwA()));
    }
}
