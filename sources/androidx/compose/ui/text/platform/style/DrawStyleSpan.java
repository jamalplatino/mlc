...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual((Object) drawStyle2, (Object) Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(m5391toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3510getJoinLxFBmk8()));
                textPaint.setStrokeCap(m5390toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3509getCapKaPHkGw()));
    ...
    private final Paint.Join m5391toAndroidJoinWw9F2mQ(int i) {
        if (StrokeJoin.m3210equalsimpl0(i, StrokeJoin.Companion.m3215getMiterLxFBmk8())) {
            return Paint.Join.MITER;
        }
        if (StrokeJoin.m3210equalsimpl0(i, StrokeJoin.Companion.m3216getRoundLxFBmk8())) {
            return Paint.Join.ROUND;
        }
        if (StrokeJoin.m3210equalsimpl0(i, StrokeJoin.Companion.m3214getBevelLxFBmk8())) {
    ...
    private final Paint.Cap m5390toAndroidCapBeK7IIE(int i) {
        if (StrokeCap.m3200equalsimpl0(i, StrokeCap.Companion.m3204getButtKaPHkGw())) {
            return Paint.Cap.BUTT;
        }
        if (StrokeCap.m3200equalsimpl0(i, StrokeCap.Companion.m3205getRoundKaPHkGw())) {
