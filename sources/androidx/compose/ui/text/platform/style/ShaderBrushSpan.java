...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public final long m5392getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m5393setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        if (this.size != Size.Companion.m2649getUnspecifiedNHjbRc()) {
            Pair<Size, ? extends Shader> pair = this.cachedShader;
            if (pair == null || !Size.m2637equalsimpl0(pair.getFirst().m2646unboximpl(), this.size)) {
                shader = this.shaderBrush.m3160createShaderuvyYCjk(this.size);
            } else {
                shader = (Shader) pair.getSecond();
            }
            textPaint.setShader(shader);
            this.cachedShader = TuplesKt.to(Size.m2629boximpl(this.size), shader);
        }
    }
}
