...
public final class ParagraphInfo {
    ...
    public final long m5030toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2609translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.m3103translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m5029toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m5131getStartimpl(j)), toGlobalIndex(TextRange.m5126getEndimpl(j)));
    }
}
