...
final class SaversKt$TextIndentSaver$1 extends Lambda implements Function2<SaverScope, TextIndent, Object> {
    ...
    public final Object invoke(SaverScope saverScope, TextIndent textIndent) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m5797boximpl(textIndent.m5530getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(TextUnit.m5797boximpl(textIndent.m5531getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope));
    }
}
