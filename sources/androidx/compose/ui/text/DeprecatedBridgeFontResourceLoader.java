...
final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        ...
        return FontFamily.Resolver.m5193resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.m5192getStyle_LCdwA(), 0, 8, (Object) null).getValue();
    }
