...
public final class TextLayoutResult {
    ...
    public final long m5104getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5785getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5786getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5103getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m5016getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m5105getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m5017getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m5101copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m5102copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m5102copyO0kMr_c(TextLayoutInput textLayoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.layoutInput, (Object) textLayoutResult.layoutInput) && Intrinsics.areEqual((Object) this.multiParagraph, (Object) textLayoutResult.multiParagraph) && IntSize.m5784equalsimpl0(this.size, textLayoutResult.size) && this.firstBaseline == textLayoutResult.firstBaseline && this.lastBaseline == textLayoutResult.lastBaseline && Intrinsics.areEqual((Object) this.placeholderRects, (Object) textLayoutResult.placeholderRects);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5787hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m5789toStringimpl(this.size) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
