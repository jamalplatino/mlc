...
public final class LayoutIntrinsics {
    ...
    public final float getMaxIntrinsicWidth() {
        ...
        if (valueOf == null) {
            ...
            valueOf = Float.valueOf((float) Math.ceil((double) Layout.getDesiredWidth(charSequence2, 0, charSequence2.length(), this.textPaint)));
        }
        if (LayoutIntrinsicsKt.shouldIncreaseMaxIntrinsic(valueOf.floatValue(), this.charSequence, this.textPaint)) {
