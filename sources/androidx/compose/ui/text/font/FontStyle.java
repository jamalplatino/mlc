...
public final class FontStyle {
    ...
    public static final int Italic = m5218constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Normal = m5218constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FontStyle m5217boximpl(int i) {
        return new FontStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m5218constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5219equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m5223unboximpl();
    }
    ...
    public static String m5222toStringimpl(int i) {
        if (m5220equalsimpl0(i, Normal)) {
            return "Normal";
        }
        return m5220equalsimpl0(i, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m5225getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA  reason: not valid java name */
        public final int m5224getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf(FontStyle.m5217boximpl(m5225getNormal_LCdwA()), FontStyle.m5217boximpl(m5224getItalic_LCdwA()));
        }
    }
}
