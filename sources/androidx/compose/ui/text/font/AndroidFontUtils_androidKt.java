...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5170getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m5220equalsimpl0(i, FontStyle.Companion.m5224getItalic_LCdwA()));
    }
}
