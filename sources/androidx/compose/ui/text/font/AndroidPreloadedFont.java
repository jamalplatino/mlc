...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int m5171getStyle_LCdwA() {
        return this.style;
    }
    ...
    private AndroidPreloadedFont(FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m5212getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, (DefaultConstructorMarker) null);
