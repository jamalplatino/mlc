...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m5262getLoadingStrategyPKNRLFQ$annotations() {
    }

    /* renamed from: getLoadingStrategy-PKNRLFQ  reason: not valid java name */
    public int m5265getLoadingStrategyPKNRLFQ() {
    ...
    public int m5266getStyle_LCdwA() {
        return this.style;
    }
    ...
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x000a:
            ...
            int r10 = r9.m5225getNormal_LCdwA()
        L_0x0015:
            r3 = r10
            r9 = r13 & 8
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m5240Settings6EWAqTQ(r2, r3, r10)
        L_0x0023:
            r4 = r11
            r9 = r13 & 16
            ...
            int r12 = r9.m5211getAsyncPKNRLFQ()
        L_0x002e:
            r5 = r12
            r6 = 0
            r0 = r7
    ...
    public static /* synthetic */ ResourceFont m5261copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.m5266getStyle_LCdwA();
        }
        return resourceFont.m5264copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m5264copyRetOiIg(int i, FontWeight fontWeight, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "weight");
        return m5260copyF3nL8kk$default(this, i, fontWeight, i2, m5265getLoadingStrategyPKNRLFQ(), (FontVariation.Settings) null, 16, (Object) null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m5260copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        if ((i4 & 8) != 0) {
            i3 = resourceFont.m5265getLoadingStrategyPKNRLFQ();
        }
        int i6 = i3;
        if ((i4 & 16) != 0) {
            settings = resourceFont.variationSettings;
        }
        return resourceFont.m5263copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m5263copyF3nL8kk(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings) {
        Intrinsics.checkNotNullParameter(fontWeight, "weight");
    ...
    public boolean equals(Object obj) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual((Object) getWeight(), (Object) resourceFont.getWeight()) && FontStyle.m5220equalsimpl0(m5266getStyle_LCdwA(), resourceFont.m5266getStyle_LCdwA()) && Intrinsics.areEqual((Object) this.variationSettings, (Object) resourceFont.variationSettings) && FontLoadingStrategy.m5207equalsimpl0(m5265getLoadingStrategyPKNRLFQ(), resourceFont.m5265getLoadingStrategyPKNRLFQ());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m5221hashCodeimpl(m5266getStyle_LCdwA())) * 31) + FontLoadingStrategy.m5208hashCodeimpl(m5265getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + FontStyle.m5222toStringimpl(m5266getStyle_LCdwA()) + ", loadingStrategy=" + FontLoadingStrategy.m5209toStringimpl(m5265getLoadingStrategyPKNRLFQ()) + ')';
    }
}
