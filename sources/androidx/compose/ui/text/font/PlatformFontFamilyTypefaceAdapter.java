...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            typeface = this.platformTypefaceResolver.m5245createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m5271getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typeface = this.platformTypefaceResolver.m5246createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m5271getFontStyle_LCdwA());
            ...
            typeface = ((AndroidTypeface) typeface2).m5374getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m5271getFontStyle_LCdwA(), typefaceRequest.m5272getFontSynthesisGVVA2EU());
        }
