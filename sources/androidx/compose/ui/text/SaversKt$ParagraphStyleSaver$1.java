...
final class SaversKt$ParagraphStyleSaver$1 extends Lambda implements Function2<SaverScope, ParagraphStyle, Object> {
    ...
    public final Object invoke(SaverScope saverScope, ParagraphStyle paragraphStyle) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(paragraphStyle.m5048getTextAlignbuA522U()), SaversKt.save(paragraphStyle.m5050getTextDirectionmmuk1to()), SaversKt.save(TextUnit.m5797boximpl(paragraphStyle.m5047getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(paragraphStyle.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), saverScope));
    }
}
