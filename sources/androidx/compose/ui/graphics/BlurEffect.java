...
public final class BlurEffect extends RenderEffect {
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m3147createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public /* synthetic */ BlurEffect(RenderEffect renderEffect2, float f, float f2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(renderEffect2, f, (i2 & 4) != 0 ? f : f2, (i2 & 8) != 0 ? TileMode.Companion.m3225getClamp3opZhB0() : i, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.radiusX == blurEffect.radiusX && this.radiusY == blurEffect.radiusY && TileMode.m3221equalsimpl0(this.edgeTreatment, blurEffect.edgeTreatment) && Intrinsics.areEqual((Object) this.renderEffect, (Object) blurEffect.renderEffect);
    }

    public int hashCode() {
        RenderEffect renderEffect2 = this.renderEffect;
        return ((((((renderEffect2 != null ? renderEffect2.hashCode() : 0) * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m3222hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + TileMode.m3223toStringimpl(this.edgeTreatment) + ')';
    }
}
