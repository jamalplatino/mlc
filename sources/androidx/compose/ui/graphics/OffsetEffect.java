...
public final class OffsetEffect extends RenderEffect {
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m3148createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.renderEffect, (Object) offsetEffect.renderEffect) && Offset.m2569equalsimpl0(this.offset, offsetEffect.offset);
    }

    public int hashCode() {
        RenderEffect renderEffect2 = this.renderEffect;
        return ((renderEffect2 != null ? renderEffect2.hashCode() : 0) * 31) + Offset.m2574hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + Offset.m2580toStringimpl(this.offset) + ')';
    }
}
