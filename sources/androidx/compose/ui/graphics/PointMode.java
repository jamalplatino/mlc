...
public final class PointMode {
    ...
    public static final int Lines = m3132constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Points = m3132constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Polygon = m3132constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointMode m3131boximpl(int i) {
    ...
    public static boolean m3133equalsimpl(int i, Object obj) {
        return (obj instanceof PointMode) && i == ((PointMode) obj).m3137unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3139getPointsr_lszbg() {
            return PointMode.Points;
        }

        /* renamed from: getLines-r_lszbg  reason: not valid java name */
        public final int m3138getLinesr_lszbg() {
            return PointMode.Lines;
        }

        /* renamed from: getPolygon-r_lszbg  reason: not valid java name */
        public final int m3140getPolygonr_lszbg() {
    ...
    public static String m3136toStringimpl(int i) {
        if (m3134equalsimpl0(i, Points)) {
            return "Points";
        }
        if (m3134equalsimpl0(i, Lines)) {
            return "Lines";
        }
        return m3134equalsimpl0(i, Polygon) ? "Polygon" : "Unknown";
    }
}
