...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m3518BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.Companion.m5754getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m2916getLowfv9h1I();
        }
        return m3517BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m3517BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        ...
        bitmapPainter.m3516setFilterQualityvDHp3xo$ui_graphics_release(i);
