...
public final class ColorPainter extends Painter {
    ...
    public final long m3520getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getIntrinsicSize-NH-jbRc  reason: not valid java name */
    public long m3521getIntrinsicSizeNHjbRc() {
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        DrawScope.m3405drawRectnJ9OG0$default(drawScope, this.color, 0, 0, this.alpha, (DrawStyle) null, this.colorFilter, 0, 86, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorPainter) && Color.m2822equalsimpl0(this.color, ((ColorPainter) obj).color);
    }

    public int hashCode() {
        return Color.m2828hashCodeimpl(this.color);
    }

    public String toString() {
        return "ColorPainter(color=" + Color.m2829toStringimpl(this.color) + ')';
    }
}
