...
public abstract class Painter {
    ...
    public abstract long m3524getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3522drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter2, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                f = 1.0f;
            }
            ...
            painter.m3523drawx_KDEd0(drawScope, j, f2, colorFilter2);
            return;
        }
    ...
    public final void m3523drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter2) {
        ...
        float r8 = Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc()) - Size.m2641getWidthimpl(j);
        float r0 = Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc()) - Size.m2638getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, r8, r0);
        if (f > 0.0f && Size.m2641getWidthimpl(j) > 0.0f && Size.m2638getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect r5 = RectKt.m2612Recttz77jQw(Offset.Companion.m2588getZeroF1C5BW0(), SizeKt.Size(Size.m2641getWidthimpl(j), Size.m2638getHeightimpl(j)));
