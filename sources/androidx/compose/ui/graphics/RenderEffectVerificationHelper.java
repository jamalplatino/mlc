...
final class RenderEffectVerificationHelper {
    ...
    public final RenderEffect m3147createBlurEffect8A3gB4(RenderEffect renderEffect, float f, float f2, int i) {
        if (renderEffect == null) {
            RenderEffect createBlurEffect = RenderEffect.createBlurEffect(f, f2, AndroidTileMode_androidKt.m2717toAndroidTileMode0vamqd0(i));
            Intrinsics.checkNotNullExpressionValue(createBlurEffect, "{\n            android.gr…)\n            )\n        }");
            return createBlurEffect;
        }
        RenderEffect createBlurEffect2 = RenderEffect.createBlurEffect(f, f2, renderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m2717toAndroidTileMode0vamqd0(i));
    ...
    public final RenderEffect m3148createOffsetEffectUv8p0NA(RenderEffect renderEffect, long j) {
        if (renderEffect == null) {
            RenderEffect createOffsetEffect = RenderEffect.createOffsetEffect(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j));
            Intrinsics.checkNotNullExpressionValue(createOffsetEffect, "{\n            android.gr…et.x, offset.y)\n        }");
            return createOffsetEffect;
        }
        RenderEffect createOffsetEffect2 = RenderEffect.createOffsetEffect(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j), renderEffect.asAndroidRenderEffect());
