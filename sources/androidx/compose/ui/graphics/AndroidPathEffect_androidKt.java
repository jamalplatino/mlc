...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m2708actualStampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(path, "shape");
        if (path instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) path).getInternalPath(), f, f2, m2709toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo  reason: not valid java name */
    public static final PathDashPathEffect.Style m2709toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        if (StampedPathEffectStyle.m3190equalsimpl0(i, StampedPathEffectStyle.Companion.m3194getMorphYpspkwk())) {
            return PathDashPathEffect.Style.MORPH;
        }
        if (StampedPathEffectStyle.m3190equalsimpl0(i, StampedPathEffectStyle.Companion.m3195getRotateYpspkwk())) {
            return PathDashPathEffect.Style.ROTATE;
        }
        if (StampedPathEffectStyle.m3190equalsimpl0(i, StampedPathEffectStyle.Companion.m3196getTranslateYpspkwk())) {
