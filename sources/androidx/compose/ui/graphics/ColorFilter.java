...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2862tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m2752getSrcIn0nO6VwU();
            }
            return companion.m2865tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m2865tintxETnrds(long j, int i) {
            return AndroidColorFilter_androidKt.m2679actualTintColorFilterxETnrds(j, i);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m2863colorMatrixjHGOpc(float[] fArr) {
            Intrinsics.checkNotNullParameter(fArr, "colorMatrix");
            return AndroidColorFilter_androidKt.m2677actualColorMatrixColorFilterjHGOpc(fArr);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m2864lightingOWjLjI(long j, long j2) {
            return AndroidColorFilter_androidKt.m2678actualLightingColorFilterOWjLjI(j, j2);
        }
    }
}
