...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m3106stampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
            Intrinsics.checkNotNullParameter(path, "shape");
            return AndroidPathEffect_androidKt.m2708actualStampedPathEffect7aD1DOk(path, f, f2, i);
        }
    }
}
