...
public final class SolidColor extends Brush {
    ...
    public final long m3186getValue0d7_KjU() {
        return this.value;
    }
    ...
    public void m3185applyToPq9zytI(long j, Paint paint, float f) {
        long j2;
        ...
        if (f == 1.0f) {
            ...
            long j3 = this.value;
            j2 = Color.m2820copywmQWz5c$default(j3, Color.m2823getAlphaimpl(j3) * f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        }
        paint.m3084setColor8_81llA(j2);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m2822equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + Color.m2829toStringimpl(this.value) + ')';
    }
}
