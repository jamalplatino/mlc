...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m3496rotateRad0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.m3485getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(drawTransform, "$this$rotateRad");
        drawTransform.m3487rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: rotateRad-0AR0LA0  reason: not valid java name */
    public static final void m3495rotateRad0AR0LA0(DrawTransform drawTransform, float f, long j) {
        Intrinsics.checkNotNullParameter(drawTransform, "$this$rotateRad");
        drawTransform.m3487rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: scale-0AR0LA0$default  reason: not valid java name */
    public static /* synthetic */ void m3498scale0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.m3485getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(drawTransform, "$this$scale");
        drawTransform.m3488scale0AR0LA0(f, f, j);
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public static final void m3497scale0AR0LA0(DrawTransform drawTransform, float f, long j) {
        Intrinsics.checkNotNullParameter(drawTransform, "$this$scale");
        drawTransform.m3488scale0AR0LA0(f, f, j);
    }
