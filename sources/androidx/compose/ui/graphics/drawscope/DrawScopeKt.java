...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3471rotateRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m3428getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(drawScope, "$this$rotate");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r0 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3487rotateUv8p0NA(f, j);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r0);
    }

    /* renamed from: rotateRad-Rg1IO4c$default  reason: not valid java name */
    public static /* synthetic */ void m3473rotateRadRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m3428getCenterF1C5BW0();
        }
        ...
        long r0 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3487rotateUv8p0NA(DegreesKt.degrees(f), j);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r0);
    }
    ...
    public static /* synthetic */ void m3475scaleFgt4K4Q$default(DrawScope drawScope, float f, float f2, long j, Function1 function1, int i, Object obj) {
        if ((i & 4) != 0) {
            j = drawScope.m3428getCenterF1C5BW0();
        }
        ...
        long r0 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3488scale0AR0LA0(f, f2, j);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r0);
    }
    ...
    public static /* synthetic */ void m3477scaleRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m3428getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(drawScope, "$this$scale");
        ...
        long r0 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3488scale0AR0LA0(f, f, j);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r0);
    }
    ...
    public static /* synthetic */ void m3469clipRectrOu3jXo$default(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1 function1, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.Companion.m2810getIntersectrtfAjoo();
        }
        Intrinsics.checkNotNullParameter(drawScope, "$this$clipRect");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r9 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3484clipRectN_I0leg(f5, f6, f7, f8, i);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r9);
    }

    /* renamed from: clipPath-KD09W0M$default  reason: not valid java name */
    public static /* synthetic */ void m3467clipPathKD09W0M$default(DrawScope drawScope, Path path, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.Companion.m2810getIntersectrtfAjoo();
        }
        ...
        long r0 = drawContext.m3372getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().m3483clipPathmtrdDE(path, i);
        function1.invoke(drawScope);
        drawContext.getCanvas().restore();
        drawContext.m3373setSizeuvyYCjk(r0);
    }
    ...
    public static final void m3470rotateRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$rotate");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m3372getSizeNHjbRc();
    ...
    public static final void m3472rotateRadRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m3372getSizeNHjbRc();
    ...
    public static final void m3474scaleFgt4K4Q(DrawScope drawScope, float f, float f2, long j, Function1<? super DrawScope, Unit> function1) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$scale");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m3372getSizeNHjbRc();
    ...
    public static final void m3476scaleRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$scale");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m3372getSizeNHjbRc();
    ...
    public static final void m3468clipRectrOu3jXo(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> function1) {
        ...
        drawContext.getCanvas().save();
        drawContext.getTransform().m3484clipRectN_I0leg(f, f2, f3, f4, i);
        function12.invoke(drawScope);
        drawContext.getCanvas().restore();
    ...
    public static final void m3466clipPathKD09W0M(DrawScope drawScope, Path path, int i, Function1<? super DrawScope, Unit> function1) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(function1, "block");
        DrawContext drawContext = drawScope.getDrawContext();
