...
public final class CanvasDrawScopeKt$asDrawTransform$1 implements DrawTransform {
    ...
    public long m3338getSizeNHjbRc() {
        return this.$this_asDrawTransform.m3372getSizeNHjbRc();
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    public long m3337getCenterF1C5BW0() {
        return SizeKt.m2651getCenteruvyYCjk(m3338getSizeNHjbRc());
    }
    ...
    public void inset(float f, float f2, float f3, float f4) {
        ...
        long Size = SizeKt.Size(Size.m2641getWidthimpl(m3338getSizeNHjbRc()) - (f3 + f), Size.m2638getHeightimpl(m3338getSizeNHjbRc()) - (f4 + f2));
        if (Size.m2641getWidthimpl(Size) < 0.0f || Size.m2638getHeightimpl(Size) < 0.0f) {
            throw new IllegalArgumentException("Width and height must be greater than or equal to zero".toString());
        }
        drawContext.m3373setSizeuvyYCjk(Size);
        canvas.translate(f, f2);
    }

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    public void m3336clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.$this_asDrawTransform.getCanvas().m2787clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void m3335clipPathmtrdDE(Path path, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        this.$this_asDrawTransform.getCanvas().m2786clipPathmtrdDE(path, i);
    }
    ...
    public void m3339rotateUv8p0NA(float f, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
        canvas.translate(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j));
        canvas.rotate(f);
        canvas.translate(-Offset.m2572getXimpl(j), -Offset.m2573getYimpl(j));
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public void m3340scale0AR0LA0(float f, float f2, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
        canvas.translate(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j));
        canvas.scale(f, f2);
        canvas.translate(-Offset.m2572getXimpl(j), -Offset.m2573getYimpl(j));
    ...
    public void m3341transform58bKbWc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        this.$this_asDrawTransform.getCanvas().m2789concat58bKbWc(fArr);
    }
}
