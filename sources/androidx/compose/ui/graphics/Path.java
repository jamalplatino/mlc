...
public interface Path {
    ...
    void m3099addPathUv8p0NA(Path path, long j);
    ...
    boolean m3101opN5in7k0(Path path, Path path2, int i);
    ...
    void m3102setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    void m3103translatek4lQ0M(long j);
    ...
    static /* synthetic */ void m3098addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m2588getZeroF1C5BW0();
            }
            path.m3099addPathUv8p0NA(path2, j);
            return;
        }
    ...
    public static final class Companion {
        ...
        public final Path m3104combinexh6zSI8(int i, Path path, Path path2) {
            Intrinsics.checkNotNullParameter(path, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.m3101opN5in7k0(path, path2, i)) {
                return Path;
            }
