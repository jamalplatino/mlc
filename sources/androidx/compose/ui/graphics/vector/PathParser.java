...
public final class PathParser {
    ...
    public final PathParser parsePathString(String str) {
        ...
        if (i2 - i == 1 && i < str.length()) {
            addNode(str.charAt(i), new float[0]);
        }
        return this;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:25:0x0047 A[LOOP:0: B:1:0x0008->B:25:0x0047, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x004a A[EDGE_INSN: B:28:0x004a->B:26:0x004a ?: BREAK  , SYNTHETIC] */
