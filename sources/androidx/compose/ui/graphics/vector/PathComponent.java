...
public final class PathComponent extends VNode {
    ...
    public final int m3534getPathFillTypeRgk1Os() {
    ...
    public final int m3535getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m3536getStrokeLineJoinLxFBmk8() {
    ...
    public final void m3537setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.m3102setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m3538setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m3539setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (this.trimPathStart == 0.0f && this.trimPathEnd == 1.0f) {
            Path.m3098addPathUv8p0NA$default(this.renderPath, this.path, 0, 2, (Object) null);
            return;
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m3400drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, (DrawStyle) null, (ColorFilter) null, 0, 56, (Object) null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m3400drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke2, (ColorFilter) null, 0, 48, (Object) null);
        }
    }
