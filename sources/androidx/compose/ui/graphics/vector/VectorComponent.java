...
public final class VectorComponent extends VNode {
    ...
    private long previousDrawSize = Size.Companion.m2649getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2637equalsimpl0(this.previousDrawSize, drawScope.m3429getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3525drawCachedImageCJJARo(IntSizeKt.IntSize((int) ((float) Math.ceil((double) Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc()))), (int) ((float) Math.ceil((double) Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc())))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.m3429getSizeNHjbRc();
        }
