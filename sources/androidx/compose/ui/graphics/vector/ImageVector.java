...
public final class ImageVector {
    ...
    public final float m3526getDefaultHeightD9Ej5fM() {
        return this.defaultHeight;
    }

    /* renamed from: getDefaultWidth-D9Ej5fM  reason: not valid java name */
    public final float m3527getDefaultWidthD9Ej5fM() {
    ...
    public final int m3528getTintBlendMode0nO6VwU() {
        return this.tintBlendMode;
    }

    /* renamed from: getTintColor-0d7_KjU  reason: not valid java name */
    public final long m3529getTintColor0d7_KjU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(java.lang.String r14, float r15, float r16, float r17, float r18, long r19, int r21, boolean r22, int r23, kotlin.jvm.internal.DefaultConstructorMarker r24) {
            ...
            L_0x0019:
                ...
                int r1 = r1.m2752getSrcIn0nO6VwU()
                r10 = r1
                goto L_0x0027
            L_0x0025:
                r10 = r21
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2857getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2752getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public static /* synthetic */ Builder m3530addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            int i5;
            int i6 = i4;
            ...
            return builder.m3531addPathoIyEayM(list, defaultFillType, str2, brush4, f9, brush3, f10, f12, defaultStrokeLineCap, i5, f13, f14, f8, f11);
        }

        /* renamed from: addPath-oIyEayM  reason: not valid java name */
        public final Builder m3531addPathoIyEayM(List<? extends PathNode> list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7) {
            List<? extends PathNode> list2 = list;
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.name, (Object) imageVector.name) && Dp.m5631equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m5631equalsimpl0(this.defaultHeight, imageVector.defaultHeight) && this.viewportWidth == imageVector.viewportWidth && this.viewportHeight == imageVector.viewportHeight && Intrinsics.areEqual((Object) this.root, (Object) imageVector.root) && Color.m2822equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m2723equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
    }

    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m5632hashCodeimpl(this.defaultWidth)) * 31) + Dp.m5632hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2828hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2724hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
