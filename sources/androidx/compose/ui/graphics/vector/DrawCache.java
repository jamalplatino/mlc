...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m5791getZeroYbymL2g();
    ...
    public final void m3525drawCachedImageCJJARo(long j, Density density, LayoutDirection layoutDirection2, Function1<? super DrawScope, Unit> function1) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5786getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m5785getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m3043ImageBitmapx__hDU$default(IntSize.m5786getWidthimpl(j), IntSize.m5785getHeightimpl(j), 0, false, (ColorSpace) null, 28, (Object) null);
        ...
        drawParams3.m3332setSizeuvyYCjk(r13);
    ...
    public final void drawInto(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        ImageBitmap imageBitmap = this.mCachedImage;
        if (imageBitmap != null) {
            DrawScope.m3394drawImageAZ2fEMs$default(drawScope, imageBitmap, 0, this.size, 0, 0, f, (DrawStyle) null, colorFilter, 0, 0, 858, (Object) null);
            return;
        }
    ...
    private final void clear(DrawScope drawScope) {
        DrawScope.m3405drawRectnJ9OG0$default(drawScope, Color.Companion.m2847getBlack0d7_KjU(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m2727getClear0nO6VwU(), 62, (Object) null);
    }
}
