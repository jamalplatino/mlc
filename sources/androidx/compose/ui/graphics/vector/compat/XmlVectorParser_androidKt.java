...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3553getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m3204getButtKaPHkGw();
        }
        return m3552getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3552getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
    ...
    static /* synthetic */ int m3555getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m3215getMiterLxFBmk8();
        }
        return m3554getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3554getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        ...
        if (namedFloat <= 0.0f) {
            ...
            if (i2 == -1) {
                i = BlendMode.Companion.m2752getSrcIn0nO6VwU();
            } else if (i2 == 3) {
                i = BlendMode.Companion.m2754getSrcOver0nO6VwU();
            } else if (i2 == 5) {
                i = BlendMode.Companion.m2752getSrcIn0nO6VwU();
            } else if (i2 != 9) {
                switch (i2) {
                    case 14:
                        i = BlendMode.Companion.m2743getModulate0nO6VwU();
                        break;
                    case 15:
                        i = BlendMode.Companion.m2748getScreen0nO6VwU();
                        break;
                    case 16:
                        i = BlendMode.Companion.m2746getPlus0nO6VwU();
                        break;
                    default:
                        i = BlendMode.Companion.m2752getSrcIn0nO6VwU();
                        break;
                ...
                i = BlendMode.Companion.m2751getSrcAtop0nO6VwU();
            }
            int i3 = i;
            float r9 = Dp.m5626constructorimpl(dimension / resources.getDisplayMetrics().density);
            float r10 = Dp.m5626constructorimpl(dimension2 / resources.getDisplayMetrics().density);
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        if (TypedArrayUtils.hasAttribute(androidVectorParser.getXmlParser(), "pathData")) {
            ...
            int r15 = m3552getStrokeLineCapCSYIeUk(androidVectorParser2.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m3204getButtKaPHkGw());
            int r16 = m3554getStrokeLineJoinkLtJ_vA(androidVectorParser2.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m3214getBevelLxFBmk8());
            ...
            builder.m3531addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m3115getNonZeroRgk1Os() : companion.m3114getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, r15, r16, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
            return;
        }
