...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m3533pathR_LF3I$default(ImageVector.Builder builder, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1 function1, int i4, Object obj) {
        int i5;
        ...
        return ImageVector.Builder.m3530addPathoIyEayM$default(builder, pathBuilder.getNodes(), i5, str2, brush3, f5, brush4, f6, f7, defaultStrokeLineCap, defaultStrokeLineJoin, f8, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }
    ...
    public static final ImageVector.Builder m3532pathR_LF3I(ImageVector.Builder builder, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1<? super PathBuilder, Unit> function1) {
        ...
        PathBuilder pathBuilder = new PathBuilder();
        function12.invoke(pathBuilder);
        return ImageVector.Builder.m3530addPathoIyEayM$default(builder, pathBuilder.getNodes(), i4, str, brush, f, brush2, f2, f3, i, i2, f4, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
    }
}
