...
public interface Canvas {
    ...
    void m2786clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m2787clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc  reason: not valid java name */
    void m2789concat58bKbWc(float[] fArr);
    ...
    void m2790drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I  reason: not valid java name */
    void m2791drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    void m2792drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    void m2793drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void m2794drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY  reason: not valid java name */
    void m2795drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void m2796drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2799clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m2788clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m2784clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                i = ClipOp.Companion.m2810getIntersectrtfAjoo();
            }
            canvas.m2788clipRectmtrdDE(rect, i);
            return;
        }
    ...
    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    void m2788clipRectmtrdDE(Rect rect, int i) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        m2787clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m2783clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 16) != 0) {
                i = ClipOp.Companion.m2810getIntersectrtfAjoo();
            }
            canvas.m2787clipRectN_I0leg(f, f2, f3, f4, i);
            return;
        }
    ...
    static /* synthetic */ void m2782clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                i = ClipOp.Companion.m2810getIntersectrtfAjoo();
            }
            canvas.m2786clipPathmtrdDE(path, i);
            return;
        }
    ...
    static /* synthetic */ void m2785drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj == null) {
            long r4 = (i & 2) != 0 ? IntOffset.Companion.m5754getZeronOccac() : j;
            long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
            canvas.m2792drawImageRectHPBpro0(imageBitmap, r4, IntSize, (i & 8) != 0 ? IntOffset.Companion.m5754getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
            return;
        }
