...
public final class StrokeJoin {
    ...
    public static final int Bevel = m3208constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Miter = m3208constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Round = m3208constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m3207boximpl(int i) {
    ...
    public static boolean m3209equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeJoin) && i == ((StrokeJoin) obj).m3213unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3215getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8  reason: not valid java name */
        public final int m3216getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8  reason: not valid java name */
        public final int m3214getBevelLxFBmk8() {
    ...
    public static String m3212toStringimpl(int i) {
        if (m3210equalsimpl0(i, Miter)) {
            return "Miter";
        }
        if (m3210equalsimpl0(i, Round)) {
            return "Round";
        }
        return m3210equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
