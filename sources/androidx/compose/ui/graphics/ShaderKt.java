...
public final class ShaderKt {
    ...
    public static /* synthetic */ Shader m3164LinearGradientShaderVjE6UOU$default(long j, long j2, List list, List list2, int i, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            list2 = null;
        }
        List list3 = list2;
        ...
        return m3163LinearGradientShaderVjE6UOU(j, j2, list, list3, i);
    }

    /* renamed from: LinearGradientShader-VjE6UOU  reason: not valid java name */
    public static final Shader m3163LinearGradientShaderVjE6UOU(long j, long j2, List<Color> list, List<Float> list2, int i) {
        Intrinsics.checkNotNullParameter(list, "colors");
        return AndroidShader_androidKt.m2713ActualLinearGradientShaderVjE6UOU(j, j2, list, list2, i);
    }

    /* renamed from: RadialGradientShader-8uybcMk$default  reason: not valid java name */
    public static /* synthetic */ Shader m3166RadialGradientShader8uybcMk$default(long j, float f, List list, List list2, int i, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            list2 = null;
        }
        List list3 = list2;
        ...
        return m3165RadialGradientShader8uybcMk(j, f, list, list3, i);
    }

    /* renamed from: RadialGradientShader-8uybcMk  reason: not valid java name */
    public static final Shader m3165RadialGradientShader8uybcMk(long j, float f, List<Color> list, List<Float> list2, int i) {
        Intrinsics.checkNotNullParameter(list, "colors");
        return AndroidShader_androidKt.m2714ActualRadialGradientShader8uybcMk(j, f, list, list2, i);
    }

    /* renamed from: SweepGradientShader-9KIMszo$default  reason: not valid java name */
    public static /* synthetic */ Shader m3168SweepGradientShader9KIMszo$default(long j, List list, List list2, int i, Object obj) {
        if ((i & 4) != 0) {
            list2 = null;
        }
        return m3167SweepGradientShader9KIMszo(j, list, list2);
    }

    /* renamed from: SweepGradientShader-9KIMszo  reason: not valid java name */
    public static final Shader m3167SweepGradientShader9KIMszo(long j, List<Color> list, List<Float> list2) {
        Intrinsics.checkNotNullParameter(list, "colors");
        return AndroidShader_androidKt.m2715ActualSweepGradientShader9KIMszo(j, list, list2);
    }

    /* renamed from: ImageShader-F49vj9s$default  reason: not valid java name */
    public static /* synthetic */ Shader m3162ImageShaderF49vj9s$default(ImageBitmap imageBitmap, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = TileMode.Companion.m3225getClamp3opZhB0();
        }
        if ((i3 & 4) != 0) {
            i2 = TileMode.Companion.m3225getClamp3opZhB0();
        }
        return m3161ImageShaderF49vj9s(imageBitmap, i, i2);
    }

    /* renamed from: ImageShader-F49vj9s  reason: not valid java name */
    public static final Shader m3161ImageShaderF49vj9s(ImageBitmap imageBitmap, int i, int i2) {
        Intrinsics.checkNotNullParameter(imageBitmap, "image");
        return AndroidShader_androidKt.m2712ActualImageShaderF49vj9s(imageBitmap, i, i2);
    }
}
