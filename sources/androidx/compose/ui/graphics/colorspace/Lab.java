...
public final class Lab extends ColorSpace {
    ...
    public Lab(String str, int i) {
        super(str, ColorModel.Companion.m3265getLabxdoWZVw(), i, (DefaultConstructorMarker) null);
    ...
    public long toXy$ui_graphics_release(float f, float f2, float f3) {
        ...
        return (((long) Float.floatToIntBits((coerceIn2 > D ? (coerceIn2 * coerceIn2) * coerceIn2 : (coerceIn2 - C) * 0.12841855f) * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[0])) << 32) | (((long) Float.floatToIntBits((coerceIn > D ? coerceIn * coerceIn * coerceIn : (coerceIn - C) * 0.12841855f) * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1])) & 4294967295L);
    }
    ...
    public long m3279xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, ColorSpace colorSpace) {
    ...
    public float[] fromXyz(float[] fArr) {
        ...
        float f = fArr2[0] / Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[0];
        float f2 = fArr2[1] / Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1];
        float f3 = fArr2[2] / Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[2];
        ...
        fArr2[0] = RangesKt.coerceIn((116.0f * pow2) - 16.0f, 0.0f, 100.0f);
        fArr2[1] = RangesKt.coerceIn((pow - pow2) * 500.0f, -128.0f, 128.0f);
        fArr2[2] = RangesKt.coerceIn((pow2 - pow3) * 200.0f, -128.0f, 128.0f);
        return fArr2;
    }
