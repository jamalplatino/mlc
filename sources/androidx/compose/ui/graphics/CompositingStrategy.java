...
public final class CompositingStrategy {
    ...
    public static final int Auto = m2899constructorimpl(0);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int ModulateAlpha = m2899constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Offscreen = m2899constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m2898boximpl(int i) {
    ...
    public static boolean m2900equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).m2904unboximpl();
    }
    ...
    public final /* synthetic */ int m2904unboximpl() {
        return this.value;
    }
