...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader m3217createShaderuvyYCjk(long j) {
        long j2;
        if (OffsetKt.m2593isUnspecifiedk4lQ0M(this.center)) {
            j2 = SizeKt.m2651getCenteruvyYCjk(j);
        } else {
            j2 = OffsetKt.Offset(Offset.m2572getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2641getWidthimpl(j) : Offset.m2572getXimpl(this.center), Offset.m2573getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2638getHeightimpl(j) : Offset.m2573getYimpl(this.center));
        }
        return ShaderKt.m3167SweepGradientShader9KIMszo(j2, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Offset.m2569equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual((Object) this.colors, (Object) sweepGradient.colors) && Intrinsics.areEqual((Object) this.stops, (Object) sweepGradient.stops);
    }

    public int hashCode() {
        int r0 = ((Offset.m2574hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return r0 + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m2591isSpecifiedk4lQ0M(this.center) ? "center=" + Offset.m2580toStringimpl(this.center) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
