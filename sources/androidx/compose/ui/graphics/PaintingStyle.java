...
public final class PaintingStyle {
    ...
    public static final int Fill = m3090constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Stroke = m3090constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m3089boximpl(int i) {
    ...
    public static boolean m3091equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m3095unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m3096getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m3097getStrokeTiuSbCo() {
    ...
    public static String m3094toStringimpl(int i) {
        if (m3092equalsimpl0(i, Fill)) {
            return "Fill";
        }
        return m3092equalsimpl0(i, Stroke) ? "Stroke" : "Unknown";
    }
}
