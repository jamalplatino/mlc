...
public final class StampedPathEffectStyle {
    ...
    public static final int Morph = m3188constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Rotate = m3188constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Translate = m3188constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m3187boximpl(int i) {
    ...
    public static boolean m3189equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m3193unboximpl();
    }
    ...
    public static String m3192toStringimpl(int i) {
        if (m3190equalsimpl0(i, Translate)) {
            return "Translate";
        }
        if (m3190equalsimpl0(i, Rotate)) {
            return "Rotate";
        }
        return m3190equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}
