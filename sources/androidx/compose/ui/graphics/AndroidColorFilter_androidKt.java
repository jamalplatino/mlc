...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2679actualTintColorFilterxETnrds(long j, int i) {
        ColorFilter colorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            colorFilter = BlendModeColorFilterHelper.INSTANCE.m2756BlendModeColorFilterxETnrds(j, i);
        } else {
            colorFilter = new PorterDuffColorFilter(ColorKt.m2875toArgb8_81llA(j), AndroidBlendMode_androidKt.m2665toPorterDuffModes9anfk8(i));
        }
        return new ColorFilter(colorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m2677actualColorMatrixColorFilterjHGOpc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(fArr));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m2678actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2875toArgb8_81llA(j), ColorKt.m2875toArgb8_81llA(j2)));
    }
}
