...
public final class Shadow {
    ...
    public static /* synthetic */ void m3170getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m3171getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m2588getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.color, shadow.color) && Offset.m2569equalsimpl0(this.offset, shadow.offset) && this.blurRadius == shadow.blurRadius;
    }

    public int hashCode() {
        return (((Color.m2828hashCodeimpl(this.color) * 31) + Offset.m2574hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + Color.m2829toStringimpl(this.color) + ", offset=" + Offset.m2580toStringimpl(this.offset) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default  reason: not valid java name */
    public static /* synthetic */ Shadow m3169copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m3172copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m3172copyqcb84PM(long j, long j2, float f) {
