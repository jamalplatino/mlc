...
public abstract class ShaderBrush extends Brush {
    private long createdSize = Size.Companion.m2649getUnspecifiedNHjbRc();
    private Shader internalShader;

    /* renamed from: createShader-uvyYCjk  reason: not valid java name */
    public abstract Shader m3160createShaderuvyYCjk(long j);
    ...
    public final void m3159applyToPq9zytI(long j, Paint paint, float f) {
        Intrinsics.checkNotNullParameter(paint, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2637equalsimpl0(this.createdSize, j)) {
            shader = m3160createShaderuvyYCjk(j);
            this.internalShader = shader;
            this.createdSize = j;
        }
        if (!Color.m2822equalsimpl0(paint.m3078getColor0d7_KjU(), Color.Companion.m2847getBlack0d7_KjU())) {
            paint.m3084setColor8_81llA(Color.Companion.m2847getBlack0d7_KjU());
        }
