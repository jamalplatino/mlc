...
public final class HapticFeedbackType {
    ...
    public static final /* synthetic */ HapticFeedbackType m3557boximpl(int i) {
        return new HapticFeedbackType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3558constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3559equalsimpl(int i, Object obj) {
        return (obj instanceof HapticFeedbackType) && i == ((HapticFeedbackType) obj).m3563unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m3559equalsimpl(this.value, obj);
    }
    ...
    public String toString() {
        return m3562toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3562toStringimpl(int i) {
        Companion companion = Companion;
        if (m3560equalsimpl0(i, companion.m3564getLongPress5zf0vsI())) {
            return "LongPress";
        }
        return m3560equalsimpl0(i, companion.m3565getTextHandleMove5zf0vsI()) ? "TextHandleMove" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m3564getLongPress5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m3567getLongPress5zf0vsI();
        }

        /* renamed from: getTextHandleMove-5zf0vsI  reason: not valid java name */
        public final int m3565getTextHandleMove5zf0vsI() {
            return PlatformHapticFeedbackType.INSTANCE.m3568getTextHandleMove5zf0vsI();
        }

        public final List<HapticFeedbackType> values() {
            return CollectionsKt.listOf(HapticFeedbackType.m3557boximpl(m3564getLongPress5zf0vsI()), HapticFeedbackType.m3557boximpl(m3565getTextHandleMove5zf0vsI()));
        }
    }
}
