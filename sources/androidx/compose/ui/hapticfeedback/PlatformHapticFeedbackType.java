...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m3558constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m3558constructorimpl(9);

    /* renamed from: getLongPress-5zf0vsI  reason: not valid java name */
    public final int m3567getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI  reason: not valid java name */
    public final int m3568getTextHandleMove5zf0vsI() {
