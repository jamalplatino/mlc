...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m5558boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m5559constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5562equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m5576unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5563equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl  reason: not valid java name */
    private static final int m5564getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public static int m5573hashCodeimpl(long j) {
    ...
    public final /* synthetic */ long m5576unboximpl() {
        return this.value;
    }
    ...
    public static final int m5572getMinWidthimpl(long j) {
        return ((int) (j >> MinFocusHeight)) & WidthMask[m5564getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl  reason: not valid java name */
    public static final int m5570getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m5564getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m5571getMinHeightimpl(long j) {
        int r0 = m5564getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[r0])) & HeightMask[r0];
    }

    /* renamed from: getMaxHeight-impl  reason: not valid java name */
    public static final int m5569getMaxHeightimpl(long j) {
        int r0 = m5564getFocusIndeximpl(j);
    ...
    public static final boolean m5566getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m5564getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m5565getHasBoundedHeightimpl(long j) {
        int r0 = m5564getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[r0] + 31))) & HeightMask[r0]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl  reason: not valid java name */
    public static final boolean m5568getHasFixedWidthimpl(long j) {
        return m5570getMaxWidthimpl(j) == m5572getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl  reason: not valid java name */
    public static final boolean m5567getHasFixedHeightimpl(long j) {
        return m5569getMaxHeightimpl(j) == m5571getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl  reason: not valid java name */
    public static final boolean m5574isZeroimpl(long j) {
        return m5570getMaxWidthimpl(j) == 0 || m5569getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default  reason: not valid java name */
    public static /* synthetic */ long m5561copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m5572getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m5570getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m5571getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m5569getMaxHeightimpl(j);
        }
        return m5560copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m5560copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        if (i3 < 0 || i < 0) {
            ...
            return Companion.m5577createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
        } else {
    ...
    public static String m5575toStringimpl(long j) {
        String str;
        int r0 = m5570getMaxWidthimpl(j);
        ...
        int r3 = m5569getMaxHeightimpl(j);
        if (r3 != Integer.MAX_VALUE) {
            str2 = String.valueOf(r3);
        }
        return "Constraints(minWidth = " + m5572getMinWidthimpl(j) + ", maxWidth = " + str + ", minHeight = " + m5571getMinHeightimpl(j) + ", maxHeight = " + str2 + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5578fixedJhjzzOo(int i, int i2) {
            if (i >= 0 && i2 >= 0) {
                return m5577createConstraintsZbe2FdA$ui_unit_release(i, i, i2, i2);
            }
            throw new IllegalArgumentException(("width(" + i + ") and height(" + i2 + ") must be >= 0").toString());
        }

        /* renamed from: fixedWidth-OenEA2s  reason: not valid java name */
        public final long m5580fixedWidthOenEA2s(int i) {
            if (i >= 0) {
                return m5577createConstraintsZbe2FdA$ui_unit_release(i, i, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + i + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s  reason: not valid java name */
        public final long m5579fixedHeightOenEA2s(int i) {
            if (i >= 0) {
                return m5577createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, i, i);
            }
            throw new IllegalArgumentException(("height(" + i + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release  reason: not valid java name */
        public final long m5577createConstraintsZbe2FdA$ui_unit_release(int i, int i2, int i3, int i4) {
            long j;
            ...
            if (bitsNeedForSize + bitsNeedForSize2 <= 31) {
                ...
                return Constraints.m5559constructorimpl((((long) i8) << 33) | j | (((long) i) << Constraints.MinFocusHeight) | (((long) i3) << i9) | (((long) i7) << (i9 + 31)));
            }
