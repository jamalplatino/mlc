...
public final class IntRect {
    ...
    public static /* synthetic */ void m5762getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5770getSizeYbymL2g() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: translate--gyyYBs  reason: not valid java name */
    public final IntRect m5774translategyyYBs(long j) {
        return new IntRect(this.left + IntOffset.m5744getXimpl(j), this.top + IntOffset.m5745getYimpl(j), this.right + IntOffset.m5744getXimpl(j), this.bottom + IntOffset.m5745getYimpl(j));
    }
