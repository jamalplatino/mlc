...
final class BlurKt$blur$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        ...
        float r0 = graphicsLayerScope.m5607toPx0680j_4(this.$radiusX);
        float r1 = graphicsLayerScope.m5607toPx0680j_4(this.$radiusY);
        graphicsLayerScope.setRenderEffect((r0 <= 0.0f || r1 <= 0.0f) ? null : RenderEffectKt.m3145BlurEffect3YTHUZs(r0, r1, this.$tileMode));
