...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m5624boximpl(this.$elevation$inlined));
        ...
        inspectorInfo.getProperties().set("ambientColor", Color.m2811boximpl(this.$ambientColor$inlined));
        inspectorInfo.getProperties().set("spotColor", Color.m2811boximpl(this.$spotColor$inlined));
    }
}
