...
final class MeasuringIntrinsics {
    ...
    public final int minWidth$ui_release(LayoutModifier layoutModifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        return layoutModifier.m4504measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i, 7, (Object) null)).getWidth();
    }
    ...
    public final int minHeight$ui_release(LayoutModifier layoutModifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return layoutModifier.m4504measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i, 0, 0, 13, (Object) null)).getHeight();
    }
    ...
    public final int maxWidth$ui_release(LayoutModifier layoutModifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return layoutModifier.m4504measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i, 7, (Object) null)).getWidth();
    }
    ...
    public final int maxHeight$ui_release(LayoutModifier layoutModifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return layoutModifier.m4504measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i, 0, 0, 13, (Object) null)).getHeight();
    }
    ...
    private static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable m4546measureBRTryo0(long j) {
            int i;
            int i2;
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    i2 = this.measurable.maxIntrinsicWidth(Constraints.m5569getMaxHeightimpl(j));
                } else {
                    i2 = this.measurable.minIntrinsicWidth(Constraints.m5569getMaxHeightimpl(j));
                }
                return new EmptyPlaceable(i2, Constraints.m5569getMaxHeightimpl(j));
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                i = this.measurable.maxIntrinsicHeight(Constraints.m5570getMaxWidthimpl(j));
            } else {
                i = this.measurable.minIntrinsicHeight(Constraints.m5570getMaxWidthimpl(j));
            }
            return new EmptyPlaceable(Constraints.m5570getMaxWidthimpl(j), i);
        }
    ...
    private static final class EmptyPlaceable extends Placeable {
        ...
        public void m4547placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        }
