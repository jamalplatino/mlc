...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m4548measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i) {
        ...
        return m4548measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope2, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getWidth();
    }
    ...
    int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i) {
        ...
        return m4548measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope2, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getHeight();
    }
