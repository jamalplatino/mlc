...
public final class LayoutNodeSubcompositionsState$createMeasurePolicy$1 extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult m4506measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        return new LayoutNodeSubcompositionsState$createMeasurePolicy$1$measure$1(this.$block.invoke(this.this$0.scope, Constraints.m5558boximpl(j)), this.this$0, this.this$0.currentIndex);
    }
}
