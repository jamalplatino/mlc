...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable m4478measureBRTryo0(long j) {
        int i;
        int i2;
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(i2, Constraints.m5569getMaxHeightimpl(j));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5570getMaxWidthimpl(j), i);
    }
