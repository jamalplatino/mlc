...
public interface LayoutCoordinates {
    ...
    long m4497localPositionOfR5De75A(LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    long m4498localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    long m4499localToWindowMKHz9U(long j);

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    long m4501windowToLocalMKHz9U(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4502transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, float[] fArr) {
            Intrinsics.checkNotNullParameter(layoutCoordinates2, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(fArr, "matrix");
            LayoutCoordinates.super.m4500transformFromEL8BTi8(layoutCoordinates2, fArr);
        }
    }

    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    void m4500transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, float[] fArr) {
