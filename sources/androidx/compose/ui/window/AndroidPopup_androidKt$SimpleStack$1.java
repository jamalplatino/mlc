...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult m5873measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        int i;
        int i2;
        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                return MeasureScope.layout$default(measureScope, i2, i, (Map) null, new AndroidPopup_androidKt$SimpleStack$1$measure$3(list2), 4, (Object) null);
            }
