...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        this.inputMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3569boximpl(i), (SnapshotMutationPolicy) null, 2, (Object) null);
    }

    /* renamed from: getInputMode-aOaMEAU  reason: not valid java name */
    public int m3580getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m3575unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m3582setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m3569boximpl(i));
    }

    /* renamed from: requestInputMode-iuPiT84  reason: not valid java name */
    public boolean m3581requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m3569boximpl(i)).booleanValue();
    }
}
