...
public final class KeyInputInputModifierNodeImpl extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean m4188onKeyEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (function1 != null) {
            return function1.invoke(KeyEvent.m4164boximpl(keyEvent)).booleanValue();
        }
        return false;
    }

    /* renamed from: onPreKeyEvent-ZmokQxo  reason: not valid java name */
    public boolean m4189onPreKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, NotificationCompat.CATEGORY_EVENT);
