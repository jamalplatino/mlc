...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2569equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m2588getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2569equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m2588getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long r0 = Offset.m2576minusMKHz9U(pointerInputChange.m4324getPositionF1C5BW0(), pointerInputChange.m4325getPreviousPositionF1C5BW0());
        return (z || !pointerInputChange.isConsumed()) ? r0 : Offset.Companion.m2588getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (!Offset.m2569equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m2588getZeroF1C5BW0())) {
            pointerInputChange.consume();
        }
    }
    ...
    public static final boolean m4271isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "$this$isOutOfBounds");
        long r0 = pointerInputChange.m4324getPositionF1C5BW0();
        float r3 = Offset.m2572getXimpl(r0);
        float r02 = Offset.m2573getYimpl(r0);
        return r3 < 0.0f || r3 > ((float) IntSize.m5786getWidthimpl(j)) || r02 < 0.0f || r02 > ((float) IntSize.m5785getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs  reason: not valid java name */
    public static final boolean m4272isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "$this$isOutOfBounds");
        if (!PointerType.m4396equalsimpl0(pointerInputChange.m4327getTypeT8wyACA(), PointerType.Companion.m4403getTouchT8wyACA())) {
            return m4271isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long r0 = pointerInputChange.m4324getPositionF1C5BW0();
        float r4 = Offset.m2572getXimpl(r0);
        float r02 = Offset.m2573getYimpl(r0);
        return r4 < (-Size.m2641getWidthimpl(j2)) || r4 > ((float) IntSize.m5786getWidthimpl(j)) + Size.m2641getWidthimpl(j2) || r02 < (-Size.m2638getHeightimpl(j2)) || r02 > ((float) IntSize.m5785getHeightimpl(j)) + Size.m2638getHeightimpl(j2);
    }
}
