...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m4386boximpl(int i) {
        return new PointerKeyboardModifiers(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4387constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4388equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).m4392unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4389equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m4388equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4390hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4391toStringimpl(this.packedValue);
    }
