...
public final class RectKt {
    ...
    public static final Rect m2612Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j), Offset.m2572getXimpl(j) + Size.m2641getWidthimpl(j2), Offset.m2573getYimpl(j) + Size.m2638getHeightimpl(j2));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m2610Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j), Offset.m2572getXimpl(j2), Offset.m2573getYimpl(j2));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m2611Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m2572getXimpl(j) - f, Offset.m2573getYimpl(j) - f, Offset.m2572getXimpl(j) + f, Offset.m2573getYimpl(j) + f);
    }
