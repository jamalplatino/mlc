...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m2905getAutoNrFUSI();
    private int left;
    ...
    public int m4926getCompositingStrategyNrFUSI() {
    ...
    public void m4927setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m2901equalsimpl0(i, CompositingStrategy.Companion.m2907getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2901equalsimpl0(i, CompositingStrategy.Companion.m2906getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2901equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m2907getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> function1) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m2782clipPathmtrdDE$default(androidCanvas, path, 0, 2, (Object) null);
        }
