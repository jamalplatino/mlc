...
public final class ShapeContainingUtilKt {
    ...
    private static final boolean isInRoundedRect(Outline.Rounded rounded, float f, float f2, Path path, Path path2) {
        ...
        float r4 = CornerRadius.m2547getXimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs()) + roundRect.getLeft();
        float r5 = CornerRadius.m2548getYimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs()) + roundRect.getTop();
        float right = roundRect.getRight() - CornerRadius.m2547getXimpl(roundRect.m2623getTopRightCornerRadiuskKHJgLs());
        float r7 = CornerRadius.m2548getYimpl(roundRect.m2623getTopRightCornerRadiuskKHJgLs()) + roundRect.getTop();
        float right2 = roundRect.getRight() - CornerRadius.m2547getXimpl(roundRect.m2621getBottomRightCornerRadiuskKHJgLs());
        float bottom = roundRect.getBottom() - CornerRadius.m2548getYimpl(roundRect.m2621getBottomRightCornerRadiuskKHJgLs());
        float bottom2 = roundRect.getBottom() - CornerRadius.m2548getYimpl(roundRect.m2620getBottomLeftCornerRadiuskKHJgLs());
        float r11 = CornerRadius.m2547getXimpl(roundRect.m2620getBottomLeftCornerRadiuskKHJgLs()) + roundRect.getLeft();
        if (f3 < r4 && f4 < r5) {
            return m4937isWithinEllipseVE1yxkc(f, f2, roundRect.m2622getTopLeftCornerRadiuskKHJgLs(), r4, r5);
        } else if (f3 < r11 && f4 > bottom2) {
            return m4937isWithinEllipseVE1yxkc(f, f2, roundRect.m2620getBottomLeftCornerRadiuskKHJgLs(), r11, bottom2);
        } else if (f3 > right && f4 < r7) {
            return m4937isWithinEllipseVE1yxkc(f, f2, roundRect.m2623getTopRightCornerRadiuskKHJgLs(), right, r7);
        } else if (f3 <= right2 || f4 <= bottom) {
            return true;
        } else {
            return m4937isWithinEllipseVE1yxkc(f, f2, roundRect.m2621getBottomRightCornerRadiuskKHJgLs(), right2, bottom);
        }
    }

    private static final boolean cornersFit(RoundRect roundRect) {
        return CornerRadius.m2547getXimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs()) + CornerRadius.m2547getXimpl(roundRect.m2623getTopRightCornerRadiuskKHJgLs()) <= roundRect.getWidth() && CornerRadius.m2547getXimpl(roundRect.m2620getBottomLeftCornerRadiuskKHJgLs()) + CornerRadius.m2547getXimpl(roundRect.m2621getBottomRightCornerRadiuskKHJgLs()) <= roundRect.getWidth() && CornerRadius.m2548getYimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs()) + CornerRadius.m2548getYimpl(roundRect.m2620getBottomLeftCornerRadiuskKHJgLs()) <= roundRect.getHeight() && CornerRadius.m2548getYimpl(roundRect.m2623getTopRightCornerRadiuskKHJgLs()) + CornerRadius.m2548getYimpl(roundRect.m2621getBottomRightCornerRadiuskKHJgLs()) <= roundRect.getHeight();
    }

    /* renamed from: isWithinEllipse-VE1yxkc  reason: not valid java name */
    private static final boolean m4937isWithinEllipseVE1yxkc(float f, float f2, long j, float f3, float f4) {
        float f5 = f - f3;
        float f6 = f2 - f4;
        float r4 = CornerRadius.m2547getXimpl(j);
        float r2 = CornerRadius.m2548getYimpl(j);
    ...
    private static final boolean isInPath(Path path, float f, float f2, Path path2, Path path3) {
        ...
        path3.m3101opN5in7k0(path, path2, PathOperation.Companion.m3126getIntersectb3I0S0c());
