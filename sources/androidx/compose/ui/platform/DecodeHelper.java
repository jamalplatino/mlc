...
public final class DecodeHelper {
    ...
    public final androidx.compose.ui.text.SpanStyle decodeSpanStyle() {
        ...
        L_0x0024:
            ...
            long r1 = r22.m4878decodeColor0d7_KjU()
            r4 = r21
            r4.m4908setColor8_81llA(r1)
            goto L_0x0024
        L_0x0045:
            r4 = r21
            r5 = 2
            ...
            long r1 = r22.m4881decodeTextUnitXSAIIZE()
            r4.m4909setFontSizeR2X_6o(r1)
        L_0x0058:
            r21 = r4
            goto L_0x0024
        L_0x005b:
        ...
        L_0x006d:
            ...
            int r1 = r22.m4879decodeFontStyle_LCdwA()
            androidx.compose.ui.text.font.FontStyle r1 = androidx.compose.ui.text.font.FontStyle.m5217boximpl(r1)
            r4.m4910setFontStylemLjRB2g(r1)
            goto L_0x0058
        L_0x0081:
            if (r1 != r6) goto L_0x0095
            int r1 = r22.dataAvailable()
            if (r1 < r2) goto L_0x0114
            int r1 = r22.m4880decodeFontSynthesisGVVA2EU()
            androidx.compose.ui.text.font.FontSynthesis r1 = androidx.compose.ui.text.font.FontSynthesis.m5226boximpl(r1)
            r4.m4911setFontSynthesistDdu0R4(r1)
            goto L_0x0058
        L_0x0095:
            r2 = 6
        ...
        L_0x00a0:
            ...
            if (r1 < r6) goto L_0x0114
            long r1 = r22.m4881decodeTextUnitXSAIIZE()
            r4.m4912setLetterSpacingR2X_6o(r1)
            goto L_0x0058
        L_0x00b1:
            if (r1 != r3) goto L_0x00c5
            int r1 = r22.dataAvailable()
            if (r1 < r7) goto L_0x0114
            float r1 = r22.m4876decodeBaselineShifty9eOQZs()
            androidx.compose.ui.text.style.BaselineShift r1 = androidx.compose.ui.text.style.BaselineShift.m5394boximpl(r1)
            r4.m4907setBaselineShift_isdbwI(r1)
            goto L_0x0058
        L_0x00c5:
            r2 = 9
        ...
        L_0x00d7:
            ...
            if (r1 < r3) goto L_0x0114
            long r1 = r22.m4878decodeColor0d7_KjU()
            r4.m4906setBackground8_81llA(r1)
            goto L_0x0058
        L_0x00ea:
            r2 = 11
    ...
    public final long m4878decodeColor0d7_KjU() {
        return Color.m2817constructorimpl(m4877decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m4881decodeTextUnitXSAIIZE() {
        long j;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            j = TextUnitType.Companion.m5840getSpUIouoOA();
        } else if (decodeByte == 2) {
            j = TextUnitType.Companion.m5839getEmUIouoOA();
        } else {
            j = TextUnitType.Companion.m5841getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5835equalsimpl0(j, TextUnitType.Companion.m5841getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m5818getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5819TextUnitanM5pPY(decodeFloat(), j);
    }
    ...
    public final int m4879decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.Companion.m5225getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.Companion.m5224getItalic_LCdwA();
        }
        return FontStyle.Companion.m5225getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m4880decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.Companion.m5236getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.Companion.m5235getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.Companion.m5237getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.Companion.m5238getWeightGVVA2EU();
        }
        return FontSynthesis.Companion.m5236getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m4876decodeBaselineShifty9eOQZs() {
        return BaselineShift.m5395constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4878decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), (DefaultConstructorMarker) null);
    }
    ...
    private final long m4877decodeULongsVKNKU() {
        return ULong.m6179constructorimpl(this.parcel.readLong());
    }
