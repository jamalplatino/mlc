...
public final class OutlineResolver {
    ...
    public OutlineResolver(Density density2) {
        ...
        this.size = Size.Companion.m2650getZeroNHjbRc();
        this.shape = RectangleShapeKt.getRectangleShape();
        this.rectTopLeft = Offset.Companion.m2588getZeroF1C5BW0();
        this.rectSize = Size.Companion.m2650getZeroNHjbRc();
    ...
    public final boolean m4924isInOutlinek4lQ0M(long j) {
        androidx.compose.ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.calculatedOutline) != null) {
            return ShapeContainingUtilKt.isInOutline(outline, Offset.m2572getXimpl(j), Offset.m2573getYimpl(j), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:8:0x002e, code lost:
        if (m4923isSameBounds4L21HEs(r1, r7.rectTopLeft, r7.rectSize, r6) == false) goto L_0x0030;
     */
    ...
    public final void clipToOutline(androidx.compose.ui.graphics.Canvas r21) {
        /*
            ...
            androidx.compose.ui.graphics.Canvas.m2782clipPathmtrdDE$default(r8, r0, r9, r11, r10)
            goto L_0x00a8
        L_0x0017:
            ...
            long r4 = r7.rectSize
            r0 = r20
            boolean r0 = r0.m4923isSameBounds4L21HEs(r1, r2, r4, r6)
            if (r0 != 0) goto L_0x0073
        L_0x0030:
            long r0 = r7.rectTopLeft
            float r14 = androidx.compose.ui.geometry.Offset.m2572getXimpl(r0)
            long r0 = r7.rectTopLeft
            float r15 = androidx.compose.ui.geometry.Offset.m2573getYimpl(r0)
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m2572getXimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m2641getWidthimpl(r1)
            float r16 = r0 + r1
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m2573getYimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m2638getHeightimpl(r1)
            float r17 = r0 + r1
            float r0 = r7.roundedCornerRadius
            long r18 = androidx.compose.ui.geometry.CornerRadiusKt.CornerRadius$default(r0, r12, r11, r10)
            androidx.compose.ui.geometry.RoundRect r0 = androidx.compose.ui.geometry.RoundRectKt.m2626RoundRectgG7oq9Y(r14, r15, r16, r17, r18)
        ...
        L_0x006c:
            ...
            r7.tmpPath = r13
        L_0x0073:
            androidx.compose.ui.graphics.Canvas.m2782clipPathmtrdDE$default(r8, r13, r9, r11, r10)
            goto L_0x00a8
        L_0x0077:
            long r0 = r7.rectTopLeft
            float r9 = androidx.compose.ui.geometry.Offset.m2572getXimpl(r0)
            long r0 = r7.rectTopLeft
            float r10 = androidx.compose.ui.geometry.Offset.m2573getYimpl(r0)
            long r0 = r7.rectTopLeft
            float r0 = androidx.compose.ui.geometry.Offset.m2572getXimpl(r0)
            long r1 = r7.rectSize
            float r1 = androidx.compose.ui.geometry.Size.m2641getWidthimpl(r1)
            ...
            r15 = 0
            r8 = r21
            androidx.compose.ui.graphics.Canvas.m2783clipRectN_I0leg$default(r8, r9, r10, r11, r12, r13, r14, r15)
        L_0x00a8:
            return
        */
    ...
    public final void m4925updateuvyYCjk(long j) {
        if (!Size.m2637equalsimpl0(this.size, j)) {
            this.size = j;
            this.cacheIsDirty = true;
        }
    }
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            if (!this.outlineNeeded || Size.m2641getWidthimpl(j) <= 0.0f || Size.m2638getHeightimpl(this.size) <= 0.0f) {
                this.cachedOutline.setEmpty();
                return;
            }
            this.isSupportedOutline = true;
            androidx.compose.ui.graphics.Outline r0 = this.shape.m3175createOutlinePq9zytI(this.size, this.layoutDirection, this.density);
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float r0 = CornerRadius.m2547getXimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs());
    ...
    private final boolean m4923isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        if (roundRect != null && RoundRectKt.isSimple(roundRect) && roundRect.getLeft() == Offset.m2572getXimpl(j) && roundRect.getTop() == Offset.m2573getYimpl(j) && roundRect.getRight() == Offset.m2572getXimpl(j) + Size.m2641getWidthimpl(j2) && roundRect.getBottom() == Offset.m2573getYimpl(j) + Size.m2638getHeightimpl(j2) && CornerRadius.m2547getXimpl(roundRect.m2622getTopLeftCornerRadiuskKHJgLs()) == f) {
            return true;
        }
        return false;
    }
