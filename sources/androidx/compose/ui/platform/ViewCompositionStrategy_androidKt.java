...
public final class ViewCompositionStrategy_androidKt {
    ...
    public static final Function0<Unit> installForLifecycle(AbstractComposeView abstractComposeView, Lifecycle lifecycle) {
        if (lifecycle.getCurrentState().compareTo(Lifecycle.State.DESTROYED) > 0) {
            LifecycleEventObserver viewCompositionStrategy_androidKt$installForLifecycle$observer$1 = new ViewCompositionStrategy_androidKt$installForLifecycle$observer$1(abstractComposeView);
