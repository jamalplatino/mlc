...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    private long mTransformOrigin = TransformOrigin.Companion.m3243getCenterSzJe1aQ();
    ...
    public void m4947updateLayerPropertiesdDxrwY(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, LayoutDirection layoutDirection, Density density) {
        ...
        setRotationX(f7);
        setRotationY(f8);
        setPivotX(TransformOrigin.m3238getPivotFractionXimpl(this.mTransformOrigin) * ((float) getWidth()));
        setPivotY(TransformOrigin.m3239getPivotFractionYimpl(this.mTransformOrigin) * ((float) getHeight()));
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            View view = this;
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(view, ColorKt.m2875toArgb8_81llA(j2));
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(view, ColorKt.m2875toArgb8_81llA(j3));
        }
        if (Build.VERSION.SDK_INT >= 31) {
            ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
        }
        if (CompositingStrategy.m2901equalsimpl0(i2, CompositingStrategy.Companion.m2907getOffscreenNrFUSI())) {
            setLayerType(2, (Paint) null);
        } else if (CompositingStrategy.m2901equalsimpl0(i2, CompositingStrategy.Companion.m2906getModulateAlphaNrFUSI())) {
    ...
    public boolean m4942isInLayerk4lQ0M(long j) {
    ...
    public void m4945resizeozmzZPI(long j) {
        int r0 = IntSize.m5786getWidthimpl(j);
        int r5 = IntSize.m5785getHeightimpl(j);
        if (r0 != getWidth() || r5 != getHeight()) {
            float f = (float) r0;
            setPivotX(TransformOrigin.m3238getPivotFractionXimpl(this.mTransformOrigin) * f);
            float f2 = (float) r5;
            setPivotY(TransformOrigin.m3239getPivotFractionYimpl(this.mTransformOrigin) * f2);
    ...
    public void m4944movegyyYBs(long j) {
        int r0 = IntOffset.m5744getXimpl(j);
        if (r0 != getLeft()) {
    ...
    public long m4943mapOffset8S9VItk(long j, boolean z) {
        if (!z) {
            return androidx.compose.ui.graphics.Matrix.m3054mapMKHz9U(this.matrixCache.m4898calculateMatrixGrdbGEg(this), j);
        }
        float[] r3 = this.matrixCache.m4897calculateInverseMatrixbWbORWo(this);
        return r3 != null ? androidx.compose.ui.graphics.Matrix.m3054mapMKHz9U(r3, j) : Offset.Companion.m2586getInfiniteF1C5BW0();
    }
    ...
    public void mapBounds(MutableRect mutableRect, boolean z) {
        ...
        if (z) {
            ...
            androidx.compose.ui.graphics.Matrix.m3056mapimpl(this.matrixCache.m4898calculateMatrixGrdbGEg(this), mutableRect);
        }
    }
    ...
    public void reuseLayer(Function1<? super Canvas, Unit> function1, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3243getCenterSzJe1aQ();
        this.drawBlock = function1;
        this.invalidateParentLayer = function0;
    }

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    public void m4946transform58bKbWc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        androidx.compose.ui.graphics.Matrix.m3065timesAssign58bKbWc(fArr, this.matrixCache.m4898calculateMatrixGrdbGEg(this));
    }

    /* renamed from: inverseTransform-58bKbWc  reason: not valid java name */
    public void m4941inverseTransform58bKbWc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        float[] r0 = this.matrixCache.m4897calculateInverseMatrixbWbORWo(this);
        if (r0 != null) {
