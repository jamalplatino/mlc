...
public final class DeviceRenderNodeData {
    ...
    public final int m4885component25NrFUSI() {
    ...
    public final DeviceRenderNodeData m4886copyfuCbV5c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2, int i9) {
    ...
    public final int m4887getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode2 + (renderEffect2 == null ? 0 : renderEffect2.hashCode())) * 31) + CompositingStrategy.m2902hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final void m4888setCompositingStrategyaDBOjCE(int i) {
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append(CompositingStrategy.m2903toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
