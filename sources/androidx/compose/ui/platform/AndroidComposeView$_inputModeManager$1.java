...
final class AndroidComposeView$_inputModeManager$1 extends Lambda implements Function1<InputMode, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m4861invokeiuPiT84(((InputMode) obj).m3575unboximpl());
    }

    /* renamed from: invoke-iuPiT84  reason: not valid java name */
    public final Boolean m4861invokeiuPiT84(int i) {
        boolean z;
        if (InputMode.m3572equalsimpl0(i, InputMode.Companion.m3577getTouchaOaMEAU())) {
            z = this.this$0.isInTouchMode();
        } else {
            z = InputMode.m3572equalsimpl0(i, InputMode.Companion.m3576getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
        }
