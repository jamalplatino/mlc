...
public interface ViewConfiguration {
    ...
    public static final class DefaultImpls {
        ...
        public static long m4940getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration viewConfiguration) {
            return ViewConfiguration.super.m4939getMinimumTouchTargetSizeMYxV2XQ();
        }
    }

    /* renamed from: getMinimumTouchTargetSize-MYxV2XQ  reason: not valid java name */
    long m4939getMinimumTouchTargetSizeMYxV2XQ() {
        float f = (float) 48;
        return DpKt.m5648DpSizeYgX7TsA(Dp.m5626constructorimpl(f), Dp.m5626constructorimpl(f));
    }
}
