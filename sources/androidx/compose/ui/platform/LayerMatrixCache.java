...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4898calculateMatrixGrdbGEg(T t) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m3048constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
        ...
        if (matrix2 == null || !Intrinsics.areEqual((Object) matrix, (Object) matrix2)) {
            AndroidMatrixConversions_androidKt.m2684setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m4897calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m4895invertToJiSxe2E(m4898calculateMatrixGrdbGEg(t), fArr);
