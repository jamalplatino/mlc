...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int roundToInt = MathKt.roundToInt(Offset.m2572getXimpl(positionInRoot));
        int roundToInt2 = MathKt.roundToInt(Offset.m2573getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.Companion.m4223getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m4224getFlingWNlRxjI();
    }
}
