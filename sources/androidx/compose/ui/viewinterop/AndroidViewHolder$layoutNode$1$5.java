...
public final class AndroidViewHolder$layoutNode$1$5 implements MeasurePolicy {
    ...
    public MeasureResult m5863measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(list, "measurables");
        if (this.$this_run.getChildCount() == 0) {
            return MeasureScope.layout$default(measureScope, Constraints.m5572getMinWidthimpl(j), Constraints.m5571getMinHeightimpl(j), (Map) null, AndroidViewHolder$layoutNode$1$5$measure$1.INSTANCE, 4, (Object) null);
        }
        if (Constraints.m5572getMinWidthimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m5572getMinWidthimpl(j));
        }
        if (Constraints.m5571getMinHeightimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m5571getMinHeightimpl(j));
        }
        ...
        int r10 = Constraints.m5569getMaxHeightimpl(j);
