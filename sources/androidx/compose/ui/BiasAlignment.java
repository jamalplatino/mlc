...
public final class BiasAlignment implements Alignment {
    ...
    public long m2464alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float r0 = ((float) (IntSize.m5786getWidthimpl(j2) - IntSize.m5786getWidthimpl(j))) / 2.0f;
        float r3 = ((float) (IntSize.m5785getHeightimpl(j2) - IntSize.m5785getHeightimpl(j))) / 2.0f;
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(r0 * ((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : ((float) -1) * this.horizontalBias) + f)), MathKt.roundToInt(r3 * (f + this.verticalBias)));
    }
