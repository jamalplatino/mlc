...
public final class HitTestResult<T> implements List<T>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long r0 = m4639findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m4634getDistanceimpl(r0) < 0.0f && DistanceAndInLayer.m4636isInLayerimpl(r0);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        if (DistanceAndInLayer.m4630compareToS_HNhKs(m4639findBestHitDistanceptXAw2c(), HitTestResultKt.DistanceAndInLayer(f, z)) > 0) {
            return true;
        }
        return false;
    }
    ...
    private final long m4639findBestHitDistanceptXAw2c() {
        long access$DistanceAndInLayer = HitTestResultKt.DistanceAndInLayer(Float.POSITIVE_INFINITY, false);
        int i = this.hitDepth + 1;
        int lastIndex = CollectionsKt.getLastIndex(this);
        if (i <= lastIndex) {
            while (true) {
                long r4 = DistanceAndInLayer.m4631constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m4630compareToS_HNhKs(r4, access$DistanceAndInLayer) < 0) {
                    access$DistanceAndInLayer = r4;
                }
                if (DistanceAndInLayer.m4634getDistanceimpl(access$DistanceAndInLayer) >= 0.0f || !DistanceAndInLayer.m4636isInLayerimpl(access$DistanceAndInLayer)) {
                    if (i == lastIndex) {
                        break;
                    }
                    i++;
    ...
    public final void speculativeHit(T t, float f, boolean z, Function0<Unit> function0) {
        ...
        long r2 = m4639findBestHitDistanceptXAw2c();
        int i = this.hitDepth;
        this.hitDepth = CollectionsKt.getLastIndex(list);
        hitInMinimumTouchTarget(t, f, z, function0);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(list) && DistanceAndInLayer.m4630compareToS_HNhKs(r2, m4639findBestHitDistanceptXAw2c()) > 0) {
