...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode2) {
        ...
        this.layoutModifierNode = layoutModifierNode2;
        this.lookAheadTransientMeasureNode = ((layoutModifierNode2.getNode().getKindSet$ui_release() & NodeKind.m4780constructorimpl(512)) == 0 || !(layoutModifierNode2 instanceof IntermediateLayoutModifierNode)) ? null : (IntermediateLayoutModifierNode) layoutModifierNode2;
    }
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable m4651measureBRTryo0(long j) {
            ...
            lookaheadDelegate.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().m4647measure3p2s80s(this, lookaheadDelegate$ui_release, j));
    ...
    private final class LookaheadDelegateForIntermediateLayoutModifier extends LookaheadDelegate {
        ...
        /* renamed from: measure-BRTryo0  reason: not valid java name */
        public Placeable m4650measureBRTryo0(long j) {
            ...
            LookaheadDelegate lookaheadDelegate$ui_release = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate$ui_release();
            Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
            lookaheadDelegate$ui_release.m4520measureBRTryo0(j);
            intermediateLayoutModifierNode.m4645setTargetSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate$ui_release.getMeasureResult$ui_release().getWidth(), lookaheadDelegate$ui_release.getMeasureResult$ui_release().getHeight()));
    ...
    /* renamed from: measure-BRTryo0  reason: not valid java name */
    public Placeable m4648measureBRTryo0(long j) {
        NodeCoordinator nodeCoordinator = this;
        nodeCoordinator.m4559setMeasurementConstraintsBRTryo0(j);
        setMeasureResult$ui_release(this.layoutModifierNode.m4647measure3p2s80s(this, getWrappedNonNull(), j));
        Placeable placeable = this;
        OwnedLayer layer = nodeCoordinator.getLayer();
        if (layer != null) {
            layer.m4827resizeozmzZPI(nodeCoordinator.m4555getMeasuredSizeYbymL2g());
        }
        onMeasured();
        return placeable;
    }
    ...
    public void m4649placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        super.m4764placeAtf8xVGno(j, f, function1);
        if (!isShallowPlacing$ui_release()) {
            onPlaced();
            Placeable.PlacementScope.Companion companion = Placeable.PlacementScope.Companion;
            int r6 = IntSize.m5786getWidthimpl(m4555getMeasuredSizeYbymL2g());
    ...
    public void onLayoutModifierNodeChanged() {
        ...
        if ((node.getKindSet$ui_release() & NodeKind.m4780constructorimpl(512)) == 0 || !(layoutModifierNode2 instanceof IntermediateLayoutModifierNode)) {
    ...
    static {
        ...
        Paint.m3084setColor8_81llA(Color.Companion.m2848getBlue0d7_KjU());
