...
public abstract class AlignmentLines {
    ...
    public abstract long m4599calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = m4599calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            i2 = MathKt.roundToInt(Offset.m2573getYimpl(Offset));
        } else {
            i2 = MathKt.roundToInt(Offset.m2572getXimpl(Offset));
        }
