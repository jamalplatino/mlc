...
final class LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        float f = this.$zIndex;
        if (function1 == null) {
            companion.m4564place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f);
        } else {
            companion.m4569placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f, function1);
        }
    }
}
