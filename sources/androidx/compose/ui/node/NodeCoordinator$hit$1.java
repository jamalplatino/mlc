...
final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m4741hit1hIXUjU((DelegatableNode) NodeCoordinatorKt.m4778nextUncheckedUntilhw7D004(this.$this_hit, this.$hitTestSource.m4776entityTypeOLwlOKw(), NodeKind.m4780constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}
