...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long m2463alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5786getWidthimpl(j2) - IntSize.m5786getWidthimpl(j), IntSize.m5785getHeightimpl(j2) - IntSize.m5785getHeightimpl(j));
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((((float) IntSize.m5786getWidthimpl(IntSize)) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((((float) IntSize.m5785getHeightimpl(IntSize)) / 2.0f) * (f + this.verticalBias)));
    }
