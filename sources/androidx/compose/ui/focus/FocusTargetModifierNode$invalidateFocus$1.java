...
final class FocusTargetModifierNode$invalidateFocus$1 extends Lambda implements Function0<Unit> {
    ...
    FocusTargetModifierNode$invalidateFocus$1(Ref.ObjectRef<FocusProperties> objectRef, FocusTargetModifierNode focusTargetModifierNode) {
        super(0);
