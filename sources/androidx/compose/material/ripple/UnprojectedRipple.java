...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1112setColorDxMtmZc(long j, float f) {
        long r3 = m1111calculateRippleColor5vOe2sY(j, f);
        Color color = this.rippleColor;
        if (color == null || !Color.m2822equalsimpl0(color.m2831unboximpl(), r3)) {
            this.rippleColor = Color.m2811boximpl(r3);
            setColor(ColorStateList.valueOf(ColorKt.m2875toArgb8_81llA(r3)));
        }
    }
    ...
    private final long m1111calculateRippleColor5vOe2sY(long j, float f) {
        if (Build.VERSION.SDK_INT < 28) {
            f *= (float) 2;
        }
        return Color.m2820copywmQWz5c$default(j, RangesKt.coerceAtMost(f, 1.0f), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
