...
public final class RippleHostView extends View {
    ...
    public final void m1103addRippleKOepWvA(PressInteraction.Press press, boolean z, long j, int i, long j2, float f, Function0<Unit> function0) {
        boolean z2 = z;
        ...
        if (z2) {
            unprojectedRipple.setHotspot(Offset.m2572getXimpl(press.m383getPressPositionF1C5BW0()), Offset.m2573getYimpl(press.m383getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1104updateRipplePropertiesbiQXAtU(long j, int i, long j2, float f) {
        ...
        if (unprojectedRipple != null) {
            ...
            unprojectedRipple.m1112setColorDxMtmZc(j2, f);
            Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m2641getWidthimpl(j)), MathKt.roundToInt(Size.m2638getHeightimpl(j)));
            setLeft(rect.left);
            setTop(rect.top);
            setRight(rect.right);
