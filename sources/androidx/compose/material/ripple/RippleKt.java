...
public final class RippleKt {
    ...
    public static final Indication m1106rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(j), composer, (i >> 6) & 14);
        Boolean valueOf = Boolean.valueOf(z);
        Dp r7 = Dp.m5624boximpl(f);
    ...
    public static final AnimationSpec<Float> incomingStateLayerAnimationSpecFor(Interaction interaction) {
        ...
        return interaction instanceof DragInteraction.Start ? new TweenSpec<>(45, 0, EasingKt.getLinearEasing(), 2, (DefaultConstructorMarker) null) : DefaultTweenSpec;
    }
    ...
    public static final AnimationSpec<Float> outgoingStateLayerAnimationSpecFor(Interaction interaction) {
        ...
        return interaction instanceof DragInteraction.Start ? new TweenSpec<>(150, 0, EasingKt.getLinearEasing(), 2, (DefaultConstructorMarker) null) : DefaultTweenSpec;
    }
}
