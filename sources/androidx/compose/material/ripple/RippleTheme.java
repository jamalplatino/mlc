...
public interface RippleTheme {
    ...
    long m1107defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1109defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m2873luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m2858getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1108defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (!z) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m2873luminance8_81llA(j)) > 0.5d) {
