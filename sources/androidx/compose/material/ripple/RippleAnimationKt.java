...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5626constructorimpl((float) 10);
    ...
    public static final float m1101getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2641getWidthimpl(j), Size.m2638getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1100getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        Intrinsics.checkNotNullParameter(density, "$this$getRippleEndRadius");
        float r3 = Offset.m2570getDistanceimpl(OffsetKt.Offset(Size.m2641getWidthimpl(j), Size.m2638getHeightimpl(j))) / 2.0f;
        return z ? r3 + density.m5607toPx0680j_4(BoundedRippleExtraRadius) : r3;
    }
}
