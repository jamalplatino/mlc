...
public final class RippleAnimation {
    ...
    public final void m1099draw4WTKRHQ(DrawScope drawScope, long j) {
        float f;
        Float f2;
        DrawScope drawScope2 = drawScope;
        Intrinsics.checkNotNullParameter(drawScope2, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1101getRippleStartRadiusuvyYCjk(drawScope.m3429getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                f2 = Float.valueOf(RippleAnimationKt.m1100getRippleEndRadiuscSwnlzA(drawScope2, this.bounded, drawScope.m3429getSizeNHjbRc()));
            } else {
                f2 = Float.valueOf(drawScope2.m5607toPx0680j_4(this.radius));
            }
            this.targetRadius = f2;
        }
        if (this.origin == null) {
            this.origin = Offset.m2561boximpl(drawScope.m3428getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m2561boximpl(OffsetKt.Offset(Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc()) / 2.0f, Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc()) / 2.0f));
        }
        ...
        float r3 = Offset.m2572getXimpl(offset.m2582unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(r3, Offset.m2572getXimpl(offset2.m2582unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float r5 = Offset.m2573getYimpl(offset3.m2582unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(r5, Offset.m2573getYimpl(offset4.m2582unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long r2 = Color.m2820copywmQWz5c$default(j, Color.m2823getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (this.bounded) {
            float r11 = Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc());
            float r12 = Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc());
            int r13 = ClipOp.Companion.m2810getIntersectrtfAjoo();
            DrawContext drawContext = drawScope.getDrawContext();
            long r7 = drawContext.m3372getSizeNHjbRc();
            drawContext.getCanvas().save();
            drawContext.getTransform().m3484clipRectN_I0leg(0.0f, 0.0f, r11, r12, r13);
            DrawScope.m3392drawCircleVaOC9Bg$default(drawScope, r2, lerp, Offset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, MenuKt.InTransitionDuration, (Object) null);
            drawContext.getCanvas().restore();
            drawContext.m3373setSizeuvyYCjk(r7);
            return;
        }
        DrawScope.m3392drawCircleVaOC9Bg$default(drawScope, r2, lerp, Offset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, MenuKt.InTransitionDuration, (Object) null);
    }
