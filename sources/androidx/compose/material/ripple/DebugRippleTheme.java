...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long m1096defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long r0 = RippleTheme.Companion.m1109defaultRippleColor5vOe2sY(Color.Companion.m2847getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha r5 = RippleTheme.Companion.m1108defaultRippleAlphaDxMtmZc(Color.Companion.m2847getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
