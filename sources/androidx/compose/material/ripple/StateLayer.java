...
final class StateLayer {
    ...
    public final void m1110drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float f2;
        DrawScope drawScope2 = drawScope;
        Intrinsics.checkNotNullParameter(drawScope2, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m1100getRippleEndRadiuscSwnlzA(drawScope2, this.bounded, drawScope.m3429getSizeNHjbRc());
        } else {
            f2 = drawScope.m5607toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long r2 = Color.m2820copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, (Object) null);
            if (this.bounded) {
                float r9 = Size.m2641getWidthimpl(drawScope.m3429getSizeNHjbRc());
                float r10 = Size.m2638getHeightimpl(drawScope.m3429getSizeNHjbRc());
                int r11 = ClipOp.Companion.m2810getIntersectrtfAjoo();
                DrawContext drawContext = drawScope.getDrawContext();
                long r14 = drawContext.m3372getSizeNHjbRc();
                drawContext.getCanvas().save();
                drawContext.getTransform().m3484clipRectN_I0leg(0.0f, 0.0f, r9, r10, r11);
                DrawScope.m3392drawCircleVaOC9Bg$default(drawScope, r2, f3, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
                drawContext.getCanvas().restore();
                drawContext.m3373setSizeuvyYCjk(r14);
                return;
            }
            DrawScope.m3392drawCircleVaOC9Bg$default(drawScope, r2, f3, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
        }
