...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulb", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lightbulb", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLightbulb", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LightbulbKt {
    ...
    public static final ImageVector getLightbulb(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Lightbulb", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(12.0f, 4.0f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveTo(8.97f, 4.0f, 6.5f, 6.47f, 6.5f, 9.5f);
        pathBuilder2.curveToRelative(0.0f, 2.47f, 1.49f, 3.89f, 2.35f, 4.5f);
        pathBuilder.horizontalLineToRelative(6.3f);
        pathBuilder2.curveToRelative(0.86f, -0.61f, 2.35f, -2.03f, 2.35f, -4.5f);
        pathBuilder2.curveTo(17.5f, 6.47f, 15.03f, 4.0f, 12.0f, 4.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(10.0f, 21.1f, 10.9f, 22.0f, 12.0f, 22.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(8.0f, 17.0f);
        ...
        pathBuilder7.curveTo(7.86f, 2.0f, 4.5f, 5.36f, 4.5f, 9.5f);
        pathBuilder7.curveToRelative(0.0f, 3.82f, 2.66f, 5.86f, 3.77f, 6.5f);
        pathBuilder6.horizontalLineToRelative(7.46f);
        pathBuilder7.curveToRelative(1.11f, -0.64f, 3.77f, -2.68f, 3.77f, -6.5f);
        pathBuilder7.curveTo(19.5f, 5.36f, 16.14f, 2.0f, 12.0f, 2.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(15.15f, 14.0f);
        pathBuilder6.horizontalLineToRelative(-6.3f);
        pathBuilder7.curveTo(7.99f, 13.39f, 6.5f, 11.97f, 6.5f, 9.5f);
        pathBuilder7.curveTo(6.5f, 6.47f, 8.97f, 4.0f, 12.0f, 4.0f);
        pathBuilder6.reflectiveCurveToRelative(5.5f, 2.47f, 5.5f, 5.5f);
        pathBuilder7.curveTo(17.5f, 11.97f, 16.01f, 13.39f, 15.15f, 14.0f);
        pathBuilder6.close();
