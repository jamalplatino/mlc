...
public final class FormatListBulletedKt {
    ...
    public static final ImageVector getFormatListBulleted(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.FormatListBulleted", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.close();
        pathBuilder4.moveTo(4.0f, 19.5f);
        pathBuilder4.curveToRelative(0.82f, 0.0f, 1.5f, -0.68f, 1.5f, -1.5f);
        pathBuilder4.reflectiveCurveToRelative(-0.67f, -1.5f, -1.5f, -1.5f);
        pathBuilder4.reflectiveCurveToRelative(-1.5f, 0.68f, -1.5f, 1.5f);
        pathBuilder4.reflectiveCurveToRelative(0.68f, 1.5f, 1.5f, 1.5f);
        pathBuilder4.close();
