...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dataExploration", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DataExploration", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDataExploration", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class DataExplorationKt {
    ...
    public static final ImageVector getDataExploration(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.DataExploration", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(-2.89f, 0.0f, -5.43f, -1.54f, -6.83f, -3.84f);
        pathBuilder3.lineToRelative(2.95f, -2.95f);
        pathBuilder3.lineTo(11.41f, 16.0f);
        pathBuilder3.lineTo(16.0f, 11.42f);
        ...
        pathBuilder3.lineTo(8.0f, 10.5f);
        pathBuilder3.lineToRelative(-3.69f, 3.7f);
        pathBuilder4.curveTo(4.11f, 13.5f, 4.0f, 12.76f, 4.0f, 12.0f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(19.5f, 20.5f);
        ...
        pathBuilder3.reflectiveCurveTo(20.05f, 20.5f, 19.5f, 20.5f);
        pathBuilder3.close();
