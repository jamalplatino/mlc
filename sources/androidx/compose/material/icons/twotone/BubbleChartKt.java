...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bubbleChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BubbleChart", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBubbleChart", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BubbleChartKt {
    ...
    public static final ImageVector getBubbleChart(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.BubbleChart", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.arcToRelative(2.0f, 2.0f, 0.0f, true, true, -4.0f, 0.0f);
        ImageVector.Builder.m3530addPathoIyEayM$default(builder2, pathBuilder4.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 0.3f, 1.0f, r56, r57, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        int r73 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r74 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder6 = new PathBuilder();
        pathBuilder6.moveTo(7.0f, 18.0f);
        pathBuilder6.curveToRelative(2.21f, 0.0f, 4.0f, -1.79f, 4.0f, -4.0f);
        pathBuilder6.reflectiveCurveToRelative(-1.79f, -4.0f, -4.0f, -4.0f);
        ...
        pathBuilder6.reflectiveCurveToRelative(0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(18.01f, 18.0f);
        ...
        pathBuilder6.reflectiveCurveToRelative(3.0f, -1.35f, 3.0f, -3.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(14.01f, 18.0f);
        ...
        pathBuilder6.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(16.5f, 14.0f);
        pathBuilder7.curveToRelative(3.03f, 0.0f, 5.5f, -2.47f, 5.5f, -5.5f);
        pathBuilder6.reflectiveCurveTo(19.53f, 3.0f, 16.5f, 3.0f);
        pathBuilder6.reflectiveCurveTo(11.0f, 5.47f, 11.0f, 8.5f);
        pathBuilder6.reflectiveCurveToRelative(2.47f, 5.5f, 5.5f, 5.5f);
        pathBuilder6.close();
        pathBuilder6.moveTo(16.5f, 5.0f);
        pathBuilder7.curveTo(18.43f, 5.0f, 20.0f, 6.57f, 20.0f, 8.5f);
        pathBuilder6.reflectiveCurveTo(18.43f, 12.0f, 16.5f, 12.0f);
        pathBuilder6.reflectiveCurveTo(13.0f, 10.43f, 13.0f, 8.5f);
        pathBuilder6.reflectiveCurveTo(14.57f, 5.0f, 16.5f, 5.0f);
        pathBuilder6.close();
