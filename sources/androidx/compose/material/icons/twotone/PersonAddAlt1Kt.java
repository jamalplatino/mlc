...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personAddAlt1", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonAddAlt1", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPersonAddAlt1", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonAddAlt1Kt {
    ...
    public static final ImageVector getPersonAddAlt1(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.PersonAddAlt1", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(-2.7f, 0.0f, -5.8f, 1.29f, -6.0f, 2.0f);
        pathBuilder3.horizontalLineToRelative(12.0f);
        pathBuilder4.curveTo(14.78f, 17.28f, 11.69f, 16.0f, 9.0f, 16.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.verticalLineToRelative(-2.0f);
        pathBuilder6.curveTo(17.0f, 15.34f, 11.67f, 14.0f, 9.0f, 14.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(3.0f, 18.0f);
        PathBuilder pathBuilder7 = pathBuilder5;
        pathBuilder7.curveToRelative(0.2f, -0.71f, 3.3f, -2.0f, 6.0f, -2.0f);
        pathBuilder7.curveToRelative(2.69f, 0.0f, 5.78f, 1.28f, 6.0f, 2.0f);
        ...
        pathBuilder8.moveTo(20.0f, 10.0f);
        ...
        pathBuilder9.reflectiveCurveTo(5.0f, 5.79f, 5.0f, 8.0f);
        pathBuilder9.curveTo(5.0f, 10.21f, 6.79f, 12.0f, 9.0f, 12.0f);
        pathBuilder9.close();
        pathBuilder9.moveTo(9.0f, 6.0f);
        ...
        pathBuilder9.reflectiveCurveTo(7.0f, 9.1f, 7.0f, 8.0f);
        pathBuilder9.curveTo(7.0f, 6.9f, 7.9f, 6.0f, 9.0f, 6.0f);
        pathBuilder9.close();
