...
public final class AssignmentIndKt {
    ...
    public static final ImageVector getAssignmentInd(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.AssignmentInd", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(20.66f, 3.88f);
        ...
        pathBuilder4.curveToRelative(0.0f, -0.41f, -0.13f, -0.8f, -0.34f, -1.12f);
        pathBuilder3.close();
        pathBuilder3.moveTo(12.0f, 2.75f);
        pathBuilder4.curveToRelative(0.22f, 0.0f, 0.41f, 0.1f, 0.55f, 0.25f);
        pathBuilder4.curveToRelative(0.12f, 0.13f, 0.2f, 0.31f, 0.2f, 0.5f);
