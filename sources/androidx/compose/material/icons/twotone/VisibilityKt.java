...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_visibility", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Visibility", "Landroidx/compose/material/icons/Icons$TwoTone;", "getVisibility", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class VisibilityKt {
    ...
    public static final ImageVector getVisibility(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Visibility", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(4.83f, 14.87f, 8.21f, 17.0f, 12.0f, 17.0f);
        ...
        pathBuilder5.curveTo(7.0f, 4.0f, 2.73f, 7.11f, 1.0f, 11.5f);
        pathBuilder5.curveTo(2.73f, 15.89f, 7.0f, 19.0f, 12.0f, 19.0f);
        ...
        pathBuilder5.curveTo(4.83f, 8.13f, 8.21f, 6.0f, 12.0f, 6.0f);
        pathBuilder4.reflectiveCurveToRelative(7.17f, 2.13f, 8.82f, 5.5f);
        pathBuilder5.curveTo(19.17f, 14.87f, 15.79f, 17.0f, 12.0f, 17.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 7.0f);
        pathBuilder5.curveToRelative(-2.48f, 0.0f, -4.5f, 2.02f, -4.5f, 4.5f);
        pathBuilder4.reflectiveCurveTo(9.52f, 16.0f, 12.0f, 16.0f);
        pathBuilder4.reflectiveCurveToRelative(4.5f, -2.02f, 4.5f, -4.5f);
        pathBuilder4.reflectiveCurveTo(14.48f, 7.0f, 12.0f, 7.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 14.0f);
        pathBuilder5.curveToRelative(-1.38f, 0.0f, -2.5f, -1.12f, -2.5f, -2.5f);
        pathBuilder4.reflectiveCurveTo(10.62f, 9.0f, 12.0f, 9.0f);
        pathBuilder4.reflectiveCurveToRelative(2.5f, 1.12f, 2.5f, 2.5f);
        pathBuilder4.reflectiveCurveTo(13.38f, 14.0f, 12.0f, 14.0f);
        pathBuilder4.close();
