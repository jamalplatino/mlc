...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_vaccines", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Vaccines", "Landroidx/compose/material/icons/Icons$TwoTone;", "getVaccines", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class VaccinesKt {
    ...
    public static final ImageVector getVaccines(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Vaccines", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(6.5f, 12.34f, 6.84f, 12.0f, 7.25f, 12.0f);
        pathBuilder.horizontalLineTo(9.0f);
        pathBuilder.verticalLineToRelative(-1.5f);
        pathBuilder.horizontalLineTo(7.25f);
        pathBuilder2.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilder2.curveTo(6.5f, 9.34f, 6.84f, 9.0f, 7.25f, 9.0f);
        pathBuilder.horizontalLineTo(9.0f);
        ...
        pathBuilder3.moveTo(11.0f, 5.5f);
        ...
        pathBuilder3.lineToRelative(2.0f, 1.5f);
        pathBuilder3.verticalLineTo(17.0f);
        pathBuilder3.horizontalLineToRelative(1.0f);
        pathBuilder4.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder3.verticalLineTo(7.5f);
        pathBuilder4.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder4.curveTo(12.0f, 5.95f, 11.55f, 5.5f, 11.0f, 5.5f);
        pathBuilder3.close();
        pathBuilder3.moveTo(9.0f, 9.0f);
        pathBuilder3.horizontalLineTo(7.25f);
        pathBuilder4.curveTo(6.84f, 9.0f, 6.5f, 9.34f, 6.5f, 9.75f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(19.5f, 10.5f);
        ...
        pathBuilder4.curveToRelative(0.0f, 0.5f, -1.5f, 1.16f, -1.5f, 3.0f);
        pathBuilder3.verticalLineTo(20.0f);
        pathBuilder4.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder3.horizontalLineToRelative(4.0f);
        pathBuilder4.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder3.verticalLineToRelative(-6.5f);
        pathBuilder4.curveTo(21.0f, 11.66f, 19.5f, 11.0f, 19.5f, 10.5f);
        pathBuilder3.close();
        pathBuilder3.moveTo(16.5f, 10.5f);
        pathBuilder3.verticalLineTo(10.0f);
        pathBuilder3.horizontalLineToRelative(1.0f);
        pathBuilder3.verticalLineToRelative(0.5f);
        pathBuilder4.curveToRelative(0.0f, 1.6f, 1.5f, 2.0f, 1.5f, 3.0f);
        pathBuilder3.verticalLineTo(14.0f);
        pathBuilder3.horizontalLineToRelative(-4.0f);
        pathBuilder4.curveToRelative(0.0f, -0.21f, 0.0f, -0.39f, 0.0f, -0.5f);
        pathBuilder4.curveTo(15.0f, 12.5f, 16.5f, 12.1f, 16.5f, 10.5f);
        pathBuilder3.close();
        pathBuilder3.moveTo(19.0f, 15.5f);
        pathBuilder3.verticalLineTo(17.0f);
        pathBuilder3.horizontalLineToRelative(-4.0f);
        pathBuilder4.curveToRelative(0.0f, -0.51f, 0.0f, -1.02f, 0.0f, -1.5f);
        pathBuilder3.horizontalLineTo(19.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(15.0f, 20.0f);
        pathBuilder4.curveToRelative(0.0f, 0.0f, 0.0f, -0.63f, 0.0f, -1.5f);
        pathBuilder3.horizontalLineToRelative(4.0f);
        pathBuilder3.verticalLineTo(20.0f);
