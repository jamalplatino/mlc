...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_more", "Landroidx/compose/ui/graphics/vector/ImageVector;", "More", "Landroidx/compose/material/icons/Icons$TwoTone;", "getMore", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MoreKt {
    ...
    public static final ImageVector getMore(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.More", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.01f, 0.0f, 0.01f, 0.0f, 0.0f, 0.0f);
        pathBuilder.close();
        ...
        pathBuilder3.lineTo(7.0f, 3.0f);
        pathBuilder3.curveToRelative(-0.69f, 0.0f, -1.23f, 0.35f, -1.59f, 0.88f);
        pathBuilder3.lineTo(0.0f, 12.0f);
        pathBuilder3.lineToRelative(5.41f, 8.11f);
        pathBuilder3.curveToRelative(0.36f, 0.53f, 0.97f, 0.89f, 1.66f, 0.89f);
        pathBuilder3.lineTo(22.0f, 21.0f);
        pathBuilder3.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder3.lineTo(24.0f, 5.0f);
        pathBuilder3.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(22.0f, 19.0f);
        pathBuilder3.lineTo(7.07f, 19.0f);
        pathBuilder3.lineTo(2.4f, 12.0f);
        pathBuilder3.lineToRelative(4.66f, -7.0f);
        ...
        pathBuilder6.moveTo(14.0f, 12.0f);
        ...
        pathBuilder8.moveTo(19.0f, 12.0f);
