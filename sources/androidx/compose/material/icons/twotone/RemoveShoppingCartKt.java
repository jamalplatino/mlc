...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_removeShoppingCart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "RemoveShoppingCart", "Landroidx/compose/material/icons/Icons$TwoTone;", "getRemoveShoppingCart", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class RemoveShoppingCartKt {
    ...
    public static final ImageVector getRemoveShoppingCart(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.RemoveShoppingCart", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(18.31f, 6.0f);
        pathBuilder4.horizontalLineTo(9.12f);
        pathBuilder4.lineToRelative(4.99f, 5.0f);
        pathBuilder4.horizontalLineToRelative(1.44f);
        pathBuilder4.close();
        ...
        pathBuilder5.horizontalLineTo(7.12f);
        pathBuilder5.lineToRelative(2.0f, 2.0f);
        pathBuilder5.horizontalLineToRelative(9.19f);
        pathBuilder5.lineToRelative(-2.76f, 5.0f);
        pathBuilder5.horizontalLineToRelative(-1.44f);
        pathBuilder5.lineToRelative(1.94f, 1.94f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(0.54f, -0.14f, 0.99f, -0.49f, 1.25f, -0.97f);
        pathBuilder5.lineToRelative(3.58f, -6.49f);
        pathBuilder6.curveTo(21.25f, 4.82f, 20.76f, 4.0f, 20.0f, 4.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(7.0f, 18.0f);
        pathBuilder6.curveToRelative(-1.1f, 0.0f, -1.99f, 0.9f, -1.99f, 2.0f);
        pathBuilder5.reflectiveCurveTo(5.9f, 22.0f, 7.0f, 22.0f);
