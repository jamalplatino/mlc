...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_screenSearchDesktop", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ScreenSearchDesktop", "Landroidx/compose/material/icons/Icons$TwoTone;", "getScreenSearchDesktop", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ScreenSearchDesktopKt {
    ...
    public static final ImageVector getScreenSearchDesktop(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.ScreenSearchDesktop", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(2.9f, 3.0f, 2.0f, 3.9f, 2.0f, 5.0f);
        pathBuilder3.verticalLineToRelative(11.0f);
        pathBuilder3.curveTo(2.0f, 17.1f, 2.9f, 18.0f, 4.0f, 18.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(4.0f, 5.0f);
        pathBuilder3.horizontalLineToRelative(16.0f);
        pathBuilder3.verticalLineToRelative(11.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        ...
        pathBuilder5.moveTo(1.0f, 19.0f);
        pathBuilder5.horizontalLineToRelative(22.0f);
        ...
        pathBuilder6.moveTo(13.97f, 7.53f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveToRelative(-1.37f, -1.37f, -3.58f, -1.37f, -4.95f, 0.0f);
        pathBuilder6.reflectiveCurveToRelative(-1.37f, 3.58f, 0.0f, 4.95f);
        pathBuilder7.curveToRelative(1.18f, 1.18f, 3.0f, 1.34f, 4.36f, 0.47f);
        pathBuilder6.lineToRelative(2.09f, 2.09f);
        pathBuilder6.lineToRelative(1.06f, -1.06f);
        pathBuilder6.lineToRelative(-2.09f, -2.09f);
        pathBuilder7.curveTo(15.31f, 10.53f, 15.16f, 8.71f, 13.97f, 7.53f);
        pathBuilder6.close();
        pathBuilder6.moveTo(12.91f, 11.41f);
        ...
        pathBuilder6.reflectiveCurveToRelative(2.05f, -0.78f, 2.83f, 0.0f);
        pathBuilder7.curveTo(13.69f, 9.37f, 13.69f, 10.63f, 12.91f, 11.41f);
        pathBuilder6.close();
