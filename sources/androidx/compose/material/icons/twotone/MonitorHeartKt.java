...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_monitorHeart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "MonitorHeart", "Landroidx/compose/material/icons/Icons$TwoTone;", "getMonitorHeart", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MonitorHeartKt {
    ...
    public static final ImageVector getMonitorHeart(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.MonitorHeart", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder7.moveTo(14.89f, 7.55f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(-0.34f, -0.68f, -1.45f, -0.68f, -1.79f, 0.0f);
        pathBuilder7.lineTo(10.0f, 13.76f);
        pathBuilder7.lineToRelative(-1.11f, -2.21f);
        pathBuilder8.curveTo(8.72f, 11.21f, 8.38f, 11.0f, 8.0f, 11.0f);
        pathBuilder7.horizontalLineTo(2.0f);
        pathBuilder7.verticalLineToRelative(2.0f);
        pathBuilder7.horizontalLineToRelative(5.38f);
        pathBuilder7.lineToRelative(1.72f, 3.45f);
        pathBuilder8.curveTo(9.28f, 16.79f, 9.62f, 17.0f, 10.0f, 17.0f);
        pathBuilder7.reflectiveCurveToRelative(0.72f, -0.21f, 0.89f, -0.55f);
        pathBuilder7.lineTo(14.0f, 10.24f);
        pathBuilder7.lineToRelative(1.11f, 2.21f);
        pathBuilder8.curveTo(15.28f, 12.79f, 15.62f, 13.0f, 16.0f, 13.0f);
        pathBuilder7.horizontalLineToRelative(6.0f);
        pathBuilder7.verticalLineToRelative(-2.0f);
        pathBuilder7.horizontalLineToRelative(-5.38f);
        pathBuilder7.lineTo(14.89f, 7.55f);
        pathBuilder7.close();
