...
public final class ElectricRickshawKt {
    ...
    public static final ImageVector getElectricRickshaw(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.ElectricRickshaw", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(3.58f, 11.84f, 4.7f, 11.0f, 6.0f, 11.0f);
        ...
        pathBuilder4.moveTo(21.0f, 11.18f);
        pathBuilder4.verticalLineTo(9.72f);
        pathBuilder4.curveToRelative(0.0f, -0.47f, -0.16f, -0.92f, -0.46f, -1.28f);
        pathBuilder4.lineTo(16.6f, 3.72f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveTo(16.22f, 3.26f, 15.66f, 3.0f, 15.06f, 3.0f);
        ...
        pathBuilder4.horizontalLineToRelative(0.18f);
        pathBuilder4.curveTo(3.6f, 16.16f, 4.7f, 17.0f, 6.0f, 17.0f);
        pathBuilder4.reflectiveCurveToRelative(2.4f, -0.84f, 2.82f, -2.0f);
        pathBuilder4.horizontalLineToRelative(8.37f);
        ...
        pathBuilder6.curveTo(23.0f, 12.7f, 22.16f, 11.6f, 21.0f, 11.18f);
        pathBuilder4.close();
        pathBuilder4.moveTo(6.0f, 15.0f);
        ...
        pathBuilder4.reflectiveCurveTo(6.55f, 15.0f, 6.0f, 15.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(7.0f, 11.17f);
        PathBuilder pathBuilder7 = pathBuilder4;
        pathBuilder7.curveTo(6.69f, 11.06f, 6.35f, 11.0f, 6.0f, 11.0f);
        pathBuilder7.curveToRelative(-1.3f, 0.0f, -2.42f, 0.84f, -2.83f, 2.0f);
        pathBuilder4.horizontalLineTo(3.0f);
        pathBuilder4.verticalLineToRelative(-3.0f);
        pathBuilder4.horizontalLineToRelative(4.0f);
        pathBuilder4.verticalLineTo(11.17f);
        pathBuilder4.close();
        pathBuilder4.moveTo(7.0f, 8.0f);
        pathBuilder4.horizontalLineTo(3.0f);
        pathBuilder4.verticalLineTo(5.0f);
        pathBuilder4.horizontalLineToRelative(4.0f);
        pathBuilder4.verticalLineTo(8.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(14.0f, 13.0f);
        ...
        pathBuilder4.close();
        pathBuilder4.moveTo(16.0f, 6.12f);
        pathBuilder4.lineTo(18.4f, 9.0f);
        pathBuilder4.horizontalLineTo(16.0f);
        pathBuilder4.verticalLineTo(6.12f);
        pathBuilder4.close();
        pathBuilder4.moveTo(17.17f, 13.0f);
        pathBuilder4.horizontalLineTo(16.0f);
        pathBuilder4.verticalLineToRelative(-2.0f);
        pathBuilder4.horizontalLineToRelative(3.0f);
        pathBuilder4.verticalLineToRelative(0.17f);
        PathBuilder pathBuilder8 = pathBuilder4;
        pathBuilder8.curveTo(18.15f, 11.47f, 17.47f, 12.15f, 17.17f, 13.0f);
        pathBuilder4.close();
