...
public final class PermIdentityKt {
    ...
    public static final ImageVector getPermIdentity(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.PermIdentity", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(-2.7f, 0.0f, -5.8f, 1.29f, -6.0f, 2.01f);
        ...
        pathBuilder5.curveToRelative(0.2f, -0.72f, 3.3f, -2.01f, 6.0f, -2.01f);
