...
public final class DirectionsTransitFilledKt {
    ...
    public static final ImageVector getDirectionsTransitFilled(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.DirectionsTransitFilled", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(6.0f, 15.5f);
        pathBuilder3.curveTo(6.0f, 16.33f, 6.67f, 17.0f, 7.5f, 17.0f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(15.5f, 13.0f);
        pathBuilder4.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilder3.reflectiveCurveTo(16.33f, 16.0f, 15.5f, 16.0f);
        pathBuilder3.reflectiveCurveTo(14.0f, 15.33f, 14.0f, 14.5f);
        pathBuilder3.reflectiveCurveTo(14.67f, 13.0f, 15.5f, 13.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.curveTo(8.0f, 2.0f, 4.0f, 2.5f, 4.0f, 6.0f);
        pathBuilder5.verticalLineToRelative(9.5f);
        pathBuilder6.curveTo(4.0f, 17.43f, 5.57f, 19.0f, 7.5f, 19.0f);
        ...
        pathBuilder6.curveTo(20.0f, 2.5f, 16.42f, 2.0f, 12.0f, 2.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(12.0f, 4.0f);
        pathBuilder6.curveToRelative(3.71f, 0.0f, 5.13f, 0.46f, 5.67f, 1.0f);
        pathBuilder5.horizontalLineTo(13.0f);
        pathBuilder5.horizontalLineToRelative(-2.0f);
        pathBuilder5.horizontalLineTo(6.43f);
        pathBuilder6.curveTo(7.03f, 4.48f, 8.48f, 4.0f, 12.0f, 4.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.curveTo(6.67f, 17.0f, 6.0f, 16.33f, 6.0f, 15.5f);
