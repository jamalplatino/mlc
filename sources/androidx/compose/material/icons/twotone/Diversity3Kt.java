...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_diversity3", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Diversity3", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDiversity3", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Diversity3Kt {
    ...
    public static final ImageVector getDiversity3(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.Diversity3", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder9.horizontalLineToRelative(7.0f);
        pathBuilder9.verticalLineToRelative(-2.26f);
        pathBuilder9.curveToRelative(1.15f, 0.8f, 2.54f, 1.26f, 4.0f, 1.26f);
        pathBuilder9.reflectiveCurveToRelative(2.85f, -0.46f, 4.0f, -1.26f);
        pathBuilder9.verticalLineTo(20.0f);
        pathBuilder9.horizontalLineToRelative(7.0f);
        pathBuilder9.verticalLineToRelative(-4.0f);
        pathBuilder9.curveTo(23.0f, 14.9f, 22.1f, 14.0f, 21.0f, 14.0f);
        pathBuilder9.close();
