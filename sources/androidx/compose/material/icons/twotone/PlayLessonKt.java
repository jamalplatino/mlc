...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_playLesson", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PlayLesson", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPlayLesson", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PlayLessonKt {
    ...
    public static final ImageVector getPlayLesson(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.PlayLesson", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.lineToRelative(2.5f, -1.5f);
        pathBuilder3.lineTo(12.0f, 11.0f);
        pathBuilder3.verticalLineTo(4.0f);
        pathBuilder3.horizontalLineToRelative(5.0f);
        pathBuilder3.verticalLineToRelative(7.08f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveToRelative(0.33f, -0.05f, 0.66f, -0.08f, 1.0f, -0.08f);
        pathBuilder3.reflectiveCurveToRelative(0.67f, 0.03f, 1.0f, 0.08f);
        pathBuilder3.verticalLineTo(4.0f);
        pathBuilder4.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilder3.horizontalLineTo(5.0f);
        pathBuilder4.curveTo(3.9f, 2.0f, 3.0f, 2.9f, 3.0f, 4.0f);
        pathBuilder3.verticalLineToRelative(16.0f);
        pathBuilder4.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder3.horizontalLineToRelative(7.26f);
        ...
        pathBuilder5.reflectiveCurveTo(20.76f, 13.0f, 18.0f, 13.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(16.75f, 20.5f);
        pathBuilder5.verticalLineToRelative(-5.0f);
        pathBuilder5.lineToRelative(4.0f, 2.5f);
        pathBuilder5.lineTo(16.75f, 20.5f);
        pathBuilder5.close();
