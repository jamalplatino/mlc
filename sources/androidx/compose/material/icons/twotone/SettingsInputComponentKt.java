...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_settingsInputComponent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SettingsInputComponent", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSettingsInputComponent", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SettingsInputComponentKt {
    ...
    public static final ImageVector getSettingsInputComponent(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.SettingsInputComponent", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(-4.18f);
        pathBuilder3.curveToRelative(1.16f, -0.42f, 2.0f, -1.52f, 2.0f, -2.82f);
        pathBuilder3.lineTo(15.0f, 6.0f);
        pathBuilder3.horizontalLineToRelative(-2.0f);
        pathBuilder3.lineTo(13.0f, 2.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.lineTo(21.0f, 2.0f);
        ...
        pathBuilder3.lineTo(19.0f, 23.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(-4.18f);
        pathBuilder6.curveToRelative(1.16f, -0.42f, 2.0f, -1.52f, 2.0f, -2.82f);
        pathBuilder3.lineTo(23.0f, 6.0f);
        pathBuilder3.horizontalLineToRelative(-2.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(21.0f, 12.0f);
        pathBuilder3.horizontalLineToRelative(-2.0f);
