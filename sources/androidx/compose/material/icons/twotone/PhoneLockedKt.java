...
public final class PhoneLockedKt {
    ...
    public static final ImageVector getPhoneLocked(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.PhoneLocked", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveToRelative(-0.5f, -0.1f, -0.83f, 0.2f, -0.9f, 0.27f);
        ...
        pathBuilder5.curveToRelative(0.23f, -0.24f, 0.33f, -0.57f, 0.27f, -0.9f);
        pathBuilder4.lineTo(9.13f, 3.8f);
        pathBuilder5.curveTo(9.04f, 3.34f, 8.63f, 3.0f, 8.15f, 3.0f);
        pathBuilder4.horizontalLineTo(4.0f);
        pathBuilder5.curveTo(3.44f, 3.0f, 2.97f, 3.47f, 3.0f, 4.03f);
        pathBuilder5.curveTo(3.17f, 6.92f, 4.05f, 9.63f, 5.43f, 12.0f);
        pathBuilder5.curveToRelative(1.58f, 2.73f, 3.85f, 4.99f, 6.57f, 6.57f);
        pathBuilder5.curveToRelative(2.37f, 1.37f, 5.08f, 2.26f, 7.97f, 2.43f);
        pathBuilder5.curveToRelative(0.55f, 0.03f, 1.03f, -0.43f, 1.03f, -1.0f);
        pathBuilder4.verticalLineToRelative(-4.15f);
        pathBuilder5.curveTo(21.0f, 15.37f, 20.66f, 14.96f, 20.2f, 14.87f);
        pathBuilder4.close();
        ...
        pathBuilder5.curveTo(5.63f, 7.7f, 5.27f, 6.37f, 5.1f, 5.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(19.0f, 18.9f);
        pathBuilder5.curveToRelative(-1.37f, -0.18f, -2.7f, -0.53f, -4.0f, -1.07f);
