...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_smokingRooms", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SmokingRooms", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSmokingRooms", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SmokingRoomsKt {
    ...
    public static final ImageVector getSmokingRooms(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.SmokingRooms", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.verticalLineToRelative(-3.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(20.5f, 16.0f);
        pathBuilder3.lineTo(22.0f, 16.0f);
        pathBuilder3.verticalLineToRelative(3.0f);
        ...
        pathBuilder3.verticalLineToRelative(-3.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(18.85f, 7.73f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveToRelative(0.62f, -0.61f, 1.0f, -1.45f, 1.0f, -2.38f);
        pathBuilder4.curveTo(19.85f, 3.5f, 18.35f, 2.0f, 16.5f, 2.0f);
        pathBuilder3.verticalLineToRelative(1.5f);
        pathBuilder4.curveToRelative(1.02f, 0.0f, 1.85f, 0.83f, 1.85f, 1.85f);
        pathBuilder3.reflectiveCurveTo(17.52f, 7.2f, 16.5f, 7.2f);
        pathBuilder3.verticalLineToRelative(1.5f);
        pathBuilder4.curveToRelative(2.24f, 0.0f, 4.0f, 1.83f, 4.0f, 4.07f);
        pathBuilder3.lineTo(20.5f, 15.0f);
        pathBuilder3.lineTo(22.0f, 15.0f);
        pathBuilder3.verticalLineToRelative(-2.24f);
        pathBuilder4.curveToRelative(0.0f, -2.22f, -1.28f, -4.14f, -3.15f, -5.03f);
        pathBuilder3.close();
        pathBuilder3.moveTo(16.03f, 10.2f);
        pathBuilder3.lineTo(14.5f, 10.2f);
        pathBuilder4.curveToRelative(-1.02f, 0.0f, -1.85f, -0.98f, -1.85f, -2.0f);
        pathBuilder3.reflectiveCurveToRelative(0.83f, -1.75f, 1.85f, -1.75f);
        pathBuilder3.verticalLineToRelative(-1.5f);
        pathBuilder4.curveToRelative(-1.85f, 0.0f, -3.35f, 1.5f, -3.35f, 3.35f);
        pathBuilder3.reflectiveCurveToRelative(1.5f, 3.35f, 3.35f, 3.35f);
        pathBuilder3.horizontalLineToRelative(1.53f);
        pathBuilder4.curveToRelative(1.05f, 0.0f, 1.97f, 0.74f, 1.97f, 2.05f);
        pathBuilder3.lineTo(18.0f, 15.0f);
        pathBuilder3.horizontalLineToRelative(1.5f);
        pathBuilder3.verticalLineToRelative(-1.64f);
        pathBuilder4.curveToRelative(0.0f, -1.81f, -1.6f, -3.16f, -3.47f, -3.16f);
        pathBuilder3.close();
