...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_public", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Public", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPublic", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PublicKt {
    ...
    public static final ImageVector getPublic(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Public", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.89f, 0.0f, 1.64f, 0.59f, 1.9f, 1.4f);
        pathBuilder3.curveTo(19.19f, 15.98f, 20.0f, 14.08f, 20.0f, 12.0f);
        pathBuilder3.curveToRelative(0.0f, -3.35f, -2.08f, -6.23f, -5.01f, -7.41f);
        pathBuilder.close();
        pathBuilder.moveTo(8.99f, 16.0f);
        pathBuilder.verticalLineToRelative(-1.0f);
        pathBuilder.lineToRelative(-4.78f, -4.78f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveTo(4.08f, 10.79f, 4.0f, 11.39f, 4.0f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, 4.07f, 3.06f, 7.43f, 6.99f, 7.93f);
        ...
        pathBuilder5.close();
        pathBuilder5.moveTo(10.99f, 19.93f);
        pathBuilder6.curveTo(7.06f, 19.43f, 4.0f, 16.07f, 4.0f, 12.0f);
        pathBuilder6.curveToRelative(0.0f, -0.61f, 0.08f, -1.21f, 0.21f, -1.78f);
        pathBuilder5.lineTo(8.99f, 15.0f);
        pathBuilder5.verticalLineToRelative(1.0f);
        pathBuilder6.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder5.verticalLineToRelative(1.93f);
        pathBuilder5.close();
        pathBuilder5.moveTo(17.89f, 17.4f);
        pathBuilder6.curveToRelative(-0.26f, -0.81f, -1.0f, -1.4f, -1.9f, -1.4f);
        ...
        pathBuilder5.lineTo(10.99f, 7.0f);
        pathBuilder5.horizontalLineToRelative(2.0f);
        pathBuilder6.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder5.verticalLineToRelative(-0.41f);
        pathBuilder6.curveTo(17.92f, 5.77f, 20.0f, 8.65f, 20.0f, 12.0f);
        pathBuilder6.curveToRelative(0.0f, 2.08f, -0.81f, 3.98f, -2.11f, 5.4f);
        pathBuilder5.close();
