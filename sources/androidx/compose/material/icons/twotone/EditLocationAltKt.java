...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_editLocationAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EditLocationAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getEditLocationAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class EditLocationAltKt {
    ...
    public static final ImageVector getEditLocationAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.EditLocationAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(13.95f, 13.0f);
        pathBuilder4.horizontalLineTo(9.0f);
        pathBuilder4.verticalLineTo(8.05f);
        pathBuilder4.lineToRelative(3.97f, -3.97f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveTo(12.65f, 4.03f, 12.32f, 4.0f, 12.0f, 4.0f);
        pathBuilder5.curveToRelative(-2.91f, 0.0f, -6.0f, 2.17f, -6.0f, 6.2f);
        pathBuilder5.curveToRelative(0.0f, 1.71f, 1.08f, 4.64f, 6.0f, 9.14f);
        pathBuilder5.curveToRelative(4.92f, -4.49f, 6.0f, -7.43f, 6.0f, -9.14f);
        pathBuilder5.curveToRelative(0.0f, -0.4f, -0.04f, -0.78f, -0.1f, -1.15f);
        pathBuilder4.lineTo(13.95f, 13.0f);
        pathBuilder4.close();
