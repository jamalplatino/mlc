...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_keyboardVoice", "Landroidx/compose/ui/graphics/vector/ImageVector;", "KeyboardVoice", "Landroidx/compose/material/icons/Icons$TwoTone;", "getKeyboardVoice", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class KeyboardVoiceKt {
    ...
    public static final ImageVector getKeyboardVoice(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.KeyboardVoice", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.reflectiveCurveTo(9.0f, 4.34f, 9.0f, 6.0f);
        pathBuilder3.verticalLineToRelative(6.0f);
        pathBuilder4.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(10.8f, 5.9f);
        pathBuilder4.curveToRelative(0.0f, -0.66f, 0.54f, -1.2f, 1.2f, -1.2f);
        pathBuilder3.reflectiveCurveToRelative(1.2f, 0.54f, 1.2f, 1.2f);
        pathBuilder3.lineToRelative(-0.01f, 6.2f);
        pathBuilder4.curveToRelative(0.0f, 0.66f, -0.53f, 1.2f, -1.19f, 1.2f);
        pathBuilder3.reflectiveCurveToRelative(-1.2f, -0.54f, -1.2f, -1.2f);
        pathBuilder3.lineTo(10.8f, 5.9f);
        pathBuilder3.close();
        pathBuilder3.moveTo(17.3f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, 3.0f, -2.54f, 5.1f, -5.3f, 5.1f);
        pathBuilder3.reflectiveCurveTo(6.7f, 15.0f, 6.7f, 12.0f);
        pathBuilder3.lineTo(5.0f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, 3.41f, 2.72f, 6.23f, 6.0f, 6.72f);
        pathBuilder3.lineTo(11.0f, 22.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(-3.28f);
        pathBuilder4.curveToRelative(3.28f, -0.48f, 6.0f, -3.3f, 6.0f, -6.72f);
