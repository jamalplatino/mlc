...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_contentPasteGo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ContentPasteGo", "Landroidx/compose/material/icons/Icons$TwoTone;", "getContentPasteGo", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ContentPasteGoKt {
    ...
    public static final ImageVector getContentPasteGo(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.ContentPasteGo", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(18.01f, 13.0f);
        pathBuilder5.lineToRelative(-1.42f, 1.41f);
        pathBuilder5.lineToRelative(1.58f, 1.58f);
        pathBuilder5.lineToRelative(-6.17f, 0.0f);
        pathBuilder5.lineToRelative(0.0f, 2.0f);
        pathBuilder5.lineToRelative(6.17f, 0.0f);
        pathBuilder5.lineToRelative(-1.58f, 1.59f);
        pathBuilder5.lineToRelative(1.42f, 1.41f);
        pathBuilder5.lineToRelative(3.99f, -4.0f);
        pathBuilder5.close();
