...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_privateConnectivity", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PrivateConnectivity", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPrivateConnectivity", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PrivateConnectivityKt {
    ...
    public static final ImageVector getPrivateConnectivity(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.PrivateConnectivity", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.reflectiveCurveTo(9.24f, 7.0f, 12.0f, 7.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(5.07f, 13.0f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveToRelative(0.49f, 3.39f, 3.4f, 6.0f, 6.93f, 6.0f);
        pathBuilder5.curveToRelative(3.53f, 0.0f, 6.44f, -2.61f, 6.93f, -6.0f);
        pathBuilder4.lineTo(22.0f, 13.0f);
        pathBuilder4.verticalLineToRelative(-2.0f);
        pathBuilder4.lineToRelative(-3.07f, 0.0f);
        pathBuilder5.curveToRelative(-0.49f, -3.39f, -3.4f, -6.0f, -6.93f, -6.0f);
        pathBuilder4.lineToRelative(0.0f, 0.0f);
        pathBuilder5.curveToRelative(-3.53f, 0.0f, -6.44f, 2.61f, -6.93f, 6.0f);
        pathBuilder5.curveToRelative(0.0f, 0.0f, -3.07f, 0.0f, -3.07f, 0.0f);
        pathBuilder4.verticalLineToRelative(2.0f);
        pathBuilder4.lineTo(5.07f, 13.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(14.0f, 10.5f);
        pathBuilder4.verticalLineTo(9.61f);
        pathBuilder5.curveToRelative(0.0f, -1.0f, -0.68f, -1.92f, -1.66f, -2.08f);
        pathBuilder5.curveTo(11.08f, 7.32f, 10.0f, 8.29f, 10.0f, 9.5f);
        ...
        pathBuilder4.verticalLineToRelative(-3.0f);
        pathBuilder4.curveTo(15.0f, 10.95f, 14.55f, 10.5f, 14.0f, 10.5f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 13.75f);
        ...
        pathBuilder7.curveTo(12.75f, 13.41f, 12.41f, 13.75f, 12.0f, 13.75f);
        pathBuilder4.close();
        pathBuilder4.moveTo(13.0f, 10.5f);
