...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_emojiEmotions", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EmojiEmotions", "Landroidx/compose/material/icons/Icons$TwoTone;", "getEmojiEmotions", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class EmojiEmotionsKt {
    ...
    public static final ImageVector getEmojiEmotions(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.EmojiEmotions", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(16.22f, 16.34f, 14.28f, 18.0f, 12.0f, 18.0f);
        pathBuilder.close();
        ...
        pathBuilder8.curveTo(6.47f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        pathBuilder8.curveToRelative(0.0f, 5.52f, 4.47f, 10.0f, 9.99f, 10.0f);
        pathBuilder8.curveTo(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        pathBuilder8.curveTo(22.0f, 6.48f, 17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilder7.close();
        ...
        pathBuilder8.curveTo(20.0f, 16.42f, 16.42f, 20.0f, 12.0f, 20.0f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(12.0f, 18.0f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveToRelative(2.28f, 0.0f, 4.22f, -1.66f, 5.0f, -4.0f);
        pathBuilder9.horizontalLineTo(7.0f);
        pathBuilder10.curveTo(7.78f, 16.34f, 9.72f, 18.0f, 12.0f, 18.0f);
        pathBuilder9.close();
