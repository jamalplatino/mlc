...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wifiCalling", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WifiCalling", "Landroidx/compose/material/icons/Icons$TwoTone;", "getWifiCalling", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class WifiCallingKt {
    ...
    public static final ImageVector getWifiCalling(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.WifiCalling", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.09f, 1.32f, 0.35f, 2.59f, 0.75f, 3.8f);
        pathBuilder2.lineToRelative(1.2f, -1.2f);
        pathBuilder3.curveTo(6.75f, 6.76f, 6.6f, 5.89f, 6.54f, 5.0f);
        pathBuilder2.close();
        ...
        pathBuilder4.moveTo(20.0f, 15.51f);
        ...
        pathBuilder4.lineToRelative(-2.2f, 2.2f);
        pathBuilder5.curveToRelative(-2.83f, -1.45f, -5.15f, -3.76f, -6.59f, -6.59f);
        pathBuilder4.lineToRelative(2.2f, -2.2f);
        pathBuilder5.curveTo(9.1f, 8.31f, 9.18f, 7.92f, 9.07f, 7.57f);
        pathBuilder5.curveTo(8.7f, 6.45f, 8.5f, 5.25f, 8.5f, 4.0f);
        ...
        pathBuilder6.curveTo(3.45f, 3.0f, 3.0f, 3.45f, 3.0f, 4.0f);
        pathBuilder6.curveToRelative(0.0f, 9.39f, 7.61f, 17.0f, 17.0f, 17.0f);
        pathBuilder6.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder4.verticalLineToRelative(-3.49f);
        pathBuilder4.curveTo(21.0f, 15.96f, 20.55f, 15.51f, 20.0f, 15.51f);
        pathBuilder4.close();
        pathBuilder4.moveTo(5.03f, 5.0f);
        pathBuilder4.horizontalLineToRelative(1.5f);
        PathBuilder pathBuilder7 = pathBuilder4;
        pathBuilder7.curveTo(6.6f, 5.89f, 6.75f, 6.76f, 6.99f, 7.59f);
        pathBuilder4.lineToRelative(-1.2f, 1.2f);
        pathBuilder7.curveTo(5.38f, 7.59f, 5.12f, 6.32f, 5.03f, 5.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(19.0f, 18.97f);
        pathBuilder7.curveToRelative(-1.32f, -0.09f, -2.59f, -0.35f, -3.8f, -0.75f);
        pathBuilder4.lineToRelative(1.19f, -1.19f);
        pathBuilder4.curveToRelative(0.85f, 0.24f, 1.72f, 0.39f, 2.6f, 0.45f);
        pathBuilder4.verticalLineTo(18.97f);
        pathBuilder4.close();
        ...
        pathBuilder8.moveTo(22.0f, 4.95f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveTo(21.79f, 4.78f, 19.67f, 3.0f, 16.5f, 3.0f);
        pathBuilder9.curveToRelative(-3.18f, 0.0f, -5.29f, 1.78f, -5.5f, 1.95f);
        pathBuilder8.lineTo(16.5f, 12.0f);
        pathBuilder8.lineTo(22.0f, 4.95f);
        pathBuilder8.close();
