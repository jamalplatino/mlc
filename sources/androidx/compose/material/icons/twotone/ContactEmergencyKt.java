...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_contactEmergency", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ContactEmergency", "Landroidx/compose/material/icons/Icons$TwoTone;", "getContactEmergency", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ContactEmergencyKt {
    ...
    public static final ImageVector getContactEmergency(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.ContactEmergency", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.54f, 0.0f, 1.0f, 0.46f, 1.0f, 1.0f);
        ...
        pathBuilder5.curveTo(0.9f, 3.0f, 0.0f, 3.9f, 0.0f, 5.0f);
        ...
        pathBuilder5.curveToRelative(1.1f, 0.0f, 1.99f, -0.9f, 1.99f, -2.0f);
        pathBuilder4.lineTo(24.0f, 5.0f);
        pathBuilder5.curveTo(24.0f, 3.9f, 23.1f, 3.0f, 22.0f, 3.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(4.54f, 19.0f);
        pathBuilder5.curveToRelative(1.1f, -1.22f, 2.69f, -2.0f, 4.46f, -2.0f);
        pathBuilder4.reflectiveCurveToRelative(3.36f, 0.78f, 4.46f, 2.0f);
        pathBuilder4.horizontalLineTo(4.54f);
        pathBuilder4.close();
        pathBuilder4.moveTo(22.0f, 19.0f);
        pathBuilder4.horizontalLineToRelative(-6.08f);
        pathBuilder5.curveToRelative(-1.38f, -2.39f, -3.96f, -4.0f, -6.92f, -4.0f);
        pathBuilder4.reflectiveCurveToRelative(-5.54f, 1.61f, -6.92f, 4.0f);
        pathBuilder4.horizontalLineTo(2.0f);
        ...
        pathBuilder6.moveTo(15.78f, 11.15f);
        pathBuilder6.lineToRelative(1.47f, -0.85f);
        pathBuilder6.lineToRelative(0.0f, 1.7f);
