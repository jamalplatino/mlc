...
public final class PermPhoneMsgKt {
    ...
    public static final ImageVector getPermPhoneMsg(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.PermPhoneMsg", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.09f, 1.32f, 0.35f, 2.59f, 0.75f, 3.79f);
        ...
        pathBuilder4.curveToRelative(-2.83f, -1.44f, -5.15f, -3.75f, -6.59f, -6.58f);
        pathBuilder3.lineToRelative(2.2f, -2.21f);
        pathBuilder4.curveToRelative(0.28f, -0.27f, 0.36f, -0.66f, 0.25f, -1.01f);
        ...
        pathBuilder4.curveToRelative(0.07f, 0.88f, 0.22f, 1.75f, 0.46f, 2.59f);
