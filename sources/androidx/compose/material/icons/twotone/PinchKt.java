...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_pinch", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Pinch", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPinch", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PinchKt {
    ...
    public static final ImageVector getPinch(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Pinch", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(17.96f, 12.04f, 17.81f, 12.0f, 17.65f, 12.0f);
        pathBuilder2.horizontalLineTo(17.0f);
        pathBuilder2.verticalLineTo(7.5f);
        pathBuilder3.curveTo(17.0f, 6.12f, 15.88f, 5.0f, 14.5f, 5.0f);
        ...
        pathBuilder3.curveTo(12.49f, 22.79f, 13.0f, 23.0f, 13.53f, 23.0f);
        ...
        pathBuilder3.curveTo(23.12f, 15.03f, 22.68f, 14.17f, 21.89f, 13.77f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineTo(7.5f);
        pathBuilder3.curveTo(14.0f, 7.22f, 14.22f, 7.0f, 14.5f, 7.0f);
