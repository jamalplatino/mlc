...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_directionsBus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DirectionsBus", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDirectionsBus", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class DirectionsBusKt {
    ...
    public static final ImageVector getDirectionsBus(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.DirectionsBus", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.13f, -0.11f, 0.34f, -0.36f, 0.34f, -0.73f);
        ...
        pathBuilder3.curveToRelative(-3.69f, 0.0f, -5.11f, 0.46f, -5.66f, 0.99f);
        pathBuilder.horizontalLineToRelative(11.31f);
        pathBuilder3.curveTo(17.11f, 4.46f, 15.69f, 4.0f, 12.0f, 4.0f);
        pathBuilder.close();
        ...
        pathBuilder4.reflectiveCurveToRelative(-8.0f, 0.5f, -8.0f, 4.0f);
        ...
        pathBuilder5.curveToRelative(3.69f, 0.0f, 5.11f, 0.46f, 5.66f, 0.99f);
        pathBuilder4.horizontalLineTo(6.34f);
        pathBuilder5.curveTo(6.89f, 4.46f, 8.31f, 4.0f, 12.0f, 4.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(6.0f, 6.99f);
        pathBuilder4.horizontalLineToRelative(12.0f);
        pathBuilder4.verticalLineTo(10.0f);
        pathBuilder4.horizontalLineTo(6.0f);
        pathBuilder4.verticalLineTo(6.99f);
        pathBuilder4.close();
        pathBuilder4.moveTo(8.0f, 17.0f);
        pathBuilder4.horizontalLineTo(6.63f);
        pathBuilder4.lineToRelative(-0.29f, -0.27f);
        pathBuilder5.curveTo(6.21f, 16.62f, 6.0f, 16.37f, 6.0f, 16.0f);
        ...
        pathBuilder6.moveTo(8.5f, 14.5f);
        ...
        pathBuilder8.moveTo(15.5f, 14.5f);
