...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_terminal", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Terminal", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTerminal", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TerminalKt {
    ...
    public static final ImageVector getTerminal(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Terminal", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(2.89f, 4.0f, 2.0f, 4.9f, 2.0f, 6.0f);
        ...
        pathBuilder4.curveTo(22.0f, 4.9f, 21.11f, 4.0f, 20.0f, 4.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(7.5f, 17.0f);
        pathBuilder5.lineToRelative(4.0f, -4.0f);
        pathBuilder5.lineToRelative(-4.0f, -4.0f);
        pathBuilder5.lineToRelative(-1.41f, 1.41f);
        pathBuilder5.lineToRelative(2.58f, 2.59f);
        pathBuilder5.lineToRelative(-2.58f, 2.59f);
        pathBuilder5.close();
