...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_reportOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ReportOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getReportOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ReportOffKt {
    ...
    public static final ImageVector getReportOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.ReportOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.verticalLineToRelative(0.33f);
        pathBuilder5.lineToRelative(2.0f, 2.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(2.41f, 1.58f);
        pathBuilder5.lineTo(1.0f, 2.99f);
        pathBuilder5.lineToRelative(3.64f, 3.64f);
        pathBuilder5.lineTo(3.0f, 8.27f);
        pathBuilder5.verticalLineToRelative(7.46f);
        pathBuilder5.lineTo(8.27f, 21.0f);
        pathBuilder5.horizontalLineToRelative(7.46f);
        pathBuilder5.lineToRelative(1.64f, -1.64f);
        pathBuilder5.lineTo(21.01f, 23.0f);
        pathBuilder5.lineToRelative(1.41f, -1.41f);
        pathBuilder5.lineTo(2.41f, 1.58f);
        pathBuilder5.close();
        pathBuilder5.moveTo(14.9f, 19.0f);
        pathBuilder5.horizontalLineTo(9.1f);
        pathBuilder5.lineTo(5.0f, 14.9f);
        pathBuilder5.verticalLineTo(9.1f);
        pathBuilder5.lineToRelative(1.05f, -1.05f);
        pathBuilder5.lineToRelative(9.9f, 9.9f);
        pathBuilder5.lineTo(14.9f, 19.0f);
        pathBuilder5.close();
