...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sportsMma", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsMma", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSportsMma", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SportsMmaKt {
    ...
    public static final ImageVector getSportsMma(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.SportsMma", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(18.0f, 7.0f);
        ...
        pathBuilder5.curveTo(5.9f, 3.0f, 5.0f, 3.9f, 5.0f, 5.0f);
        pathBuilder4.verticalLineToRelative(5.8f);
        pathBuilder5.curveToRelative(0.0f, 0.13f, 0.01f, 0.26f, 0.04f, 0.39f);
        pathBuilder4.lineToRelative(0.8f, 4.0f);
        PathBuilder pathBuilder6 = pathBuilder4;
        pathBuilder6.curveToRelative(0.09f, 0.47f, 0.5f, 0.8f, 0.98f, 0.8f);
        pathBuilder4.horizontalLineTo(17.0f);
        pathBuilder6.curveToRelative(0.55f, 0.0f, 1.09f, -0.44f, 1.2f, -0.98f);
        pathBuilder4.lineToRelative(0.77f, -3.83f);
        ...
        pathBuilder7.curveTo(19.0f, 7.45f, 18.55f, 7.0f, 18.0f, 7.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(17.0f, 10.6f);
        pathBuilder7.curveToRelative(0.0f, 0.13f, -0.64f, 3.4f, -0.64f, 3.4f);
        pathBuilder4.horizontalLineTo(7.64f);
        pathBuilder7.curveToRelative(0.0f, 0.0f, -0.64f, -3.26f, -0.64f, -3.4f);
        pathBuilder4.verticalLineTo(5.0f);
        ...
        pathBuilder4.verticalLineTo(10.6f);
        pathBuilder4.close();
