...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomParent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomParent", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBedroomParent", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BedroomParentKt {
    ...
    public static final ImageVector getBedroomParent(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.BedroomParent", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.moveTo(6.5f, 15.5f);
        pathBuilder6.horizontalLineToRelative(11.0f);
        pathBuilder6.verticalLineTo(17.0f);
        pathBuilder6.horizontalLineTo(19.0f);
        pathBuilder6.verticalLineToRelative(-3.83f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveToRelative(0.0f, -0.66f, -0.25f, -1.26f, -0.65f, -1.72f);
        ...
        pathBuilder7.curveToRelative(-0.37f, 0.0f, -0.72f, 0.12f, -1.0f, 0.32f);
        pathBuilder7.curveTo(11.72f, 7.12f, 11.37f, 7.0f, 11.0f, 7.0f);
        pathBuilder6.horizontalLineTo(7.65f);
        pathBuilder6.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilder6.verticalLineToRelative(2.45f);
        pathBuilder6.curveTo(5.25f, 11.91f, 5.0f, 12.51f, 5.0f, 13.17f);
        pathBuilder6.verticalLineTo(17.0f);
        pathBuilder6.horizontalLineToRelative(1.5f);
        pathBuilder6.verticalLineTo(15.5f);
        pathBuilder6.close();
        pathBuilder6.moveTo(12.75f, 8.5f);
        pathBuilder6.horizontalLineToRelative(4.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.horizontalLineToRelative(-4.0f);
        pathBuilder6.verticalLineTo(8.5f);
        pathBuilder6.close();
        pathBuilder6.moveTo(7.25f, 8.5f);
        pathBuilder6.horizontalLineToRelative(4.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.horizontalLineToRelative(-4.0f);
        pathBuilder6.verticalLineTo(8.5f);
        pathBuilder6.close();
        pathBuilder6.moveTo(6.5f, 13.0f);
