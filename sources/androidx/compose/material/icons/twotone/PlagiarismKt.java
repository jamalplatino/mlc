...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_plagiarism", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Plagiarism", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPlagiarism", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PlagiarismKt {
    ...
    public static final ImageVector getPlagiarism(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Plagiarism", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(10.39f, 9.66f, 12.61f, 9.66f, 13.97f, 11.03f);
        pathBuilder.close();
        ...
        pathBuilder3.moveTo(11.5f, 13.5f);
        ...
        pathBuilder7.moveTo(9.03f, 11.03f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(-1.37f, 1.37f, -1.37f, 3.58f, 0.0f, 4.95f);
        pathBuilder8.curveToRelative(1.12f, 1.12f, 2.8f, 1.31f, 4.13f, 0.59f);
        pathBuilder7.lineToRelative(1.88f, 1.88f);
        pathBuilder7.lineToRelative(1.41f, -1.41f);
        pathBuilder7.lineToRelative(-1.88f, -1.88f);
        pathBuilder8.curveToRelative(0.71f, -1.33f, 0.53f, -3.01f, -0.59f, -4.13f);
        pathBuilder8.curveTo(12.61f, 9.66f, 10.39f, 9.66f, 9.03f, 11.03f);
        pathBuilder7.close();
        pathBuilder7.moveTo(12.56f, 14.56f);
        pathBuilder8.curveToRelative(-0.59f, 0.59f, -1.54f, 0.59f, -2.12f, 0.0f);
        pathBuilder8.curveToRelative(-0.59f, -0.59f, -0.59f, -1.54f, 0.0f, -2.12f);
        pathBuilder8.curveToRelative(0.59f, -0.59f, 1.54f, -0.59f, 2.12f, 0.0f);
        pathBuilder8.curveTo(13.15f, 13.03f, 13.15f, 13.97f, 12.56f, 14.56f);
        pathBuilder7.close();
