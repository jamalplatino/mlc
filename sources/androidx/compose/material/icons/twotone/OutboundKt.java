...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_outbound", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Outbound", "Landroidx/compose/material/icons/Icons$TwoTone;", "getOutbound", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class OutboundKt {
    ...
    public static final ImageVector getOutbound(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Outbound", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.reflectiveCurveTo(7.59f, 4.0f, 12.0f, 4.0f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(13.88f, 11.54f);
        pathBuilder3.lineToRelative(-4.96f, 4.96f);
        pathBuilder3.lineToRelative(-1.41f, -1.41f);
        pathBuilder3.lineToRelative(4.96f, -4.96f);
        pathBuilder3.lineTo(10.34f, 8.0f);
        pathBuilder3.lineToRelative(5.65f, 0.01f);
        pathBuilder3.lineTo(16.0f, 13.66f);
        pathBuilder3.lineTo(13.88f, 11.54f);
        pathBuilder3.close();
