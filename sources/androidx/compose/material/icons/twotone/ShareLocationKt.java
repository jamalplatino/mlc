...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_shareLocation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ShareLocation", "Landroidx/compose/material/icons/Icons$TwoTone;", "getShareLocation", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ShareLocationKt {
    ...
    public static final ImageVector getShareLocation(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("TwoTone.ShareLocation", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(15.81f, 19.17f, 14.48f, 19.75f, 13.02f, 19.93f);
        pathBuilder.close();
        ...
        pathBuilder4.curveToRelative(0.0f, -4.05f, 3.03f, -7.41f, 6.95f, -7.93f);
        pathBuilder3.verticalLineTo(2.05f);
        pathBuilder4.curveTo(5.95f, 2.58f, 2.03f, 6.84f, 2.03f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, 5.16f, 3.92f, 9.42f, 8.95f, 9.95f);
        pathBuilder3.verticalLineToRelative(-2.02f);
        pathBuilder4.curveTo(7.06f, 19.41f, 4.03f, 16.05f, 4.03f, 12.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(19.95f, 11.0f);
        pathBuilder5.horizontalLineToRelative(2.02f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(-0.2f, -2.01f, -1.0f, -3.84f, -2.21f, -5.32f);
        pathBuilder5.lineToRelative(-1.43f, 1.43f);
        pathBuilder6.curveTo(19.19f, 8.21f, 19.77f, 9.54f, 19.95f, 11.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(18.34f, 4.26f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(-1.48f, -1.21f, -3.32f, -2.01f, -5.32f, -2.21f);
        pathBuilder7.verticalLineToRelative(2.02f);
        pathBuilder8.curveToRelative(1.46f, 0.18f, 2.79f, 0.76f, 3.9f, 1.62f);
        pathBuilder7.lineTo(18.34f, 4.26f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(18.33f, 16.9f);
        pathBuilder9.lineToRelative(1.43f, 1.42f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveToRelative(1.21f, -1.48f, 2.01f, -3.31f, 2.21f, -5.32f);
        pathBuilder9.horizontalLineToRelative(-2.02f);
        pathBuilder10.curveTo(19.77f, 14.46f, 19.19f, 15.79f, 18.33f, 16.9f);
        pathBuilder9.close();
        ...
        pathBuilder12.curveToRelative(0.0f, 1.66f, 1.33f, 3.63f, 4.0f, 5.9f);
        pathBuilder12.curveTo(14.67f, 14.73f, 16.0f, 12.76f, 16.0f, 11.1f);
        pathBuilder11.close();
