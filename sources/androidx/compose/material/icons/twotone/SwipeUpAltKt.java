...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_swipeUpAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SwipeUpAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSwipeUpAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SwipeUpAltKt {
    ...
    public static final ImageVector getSwipeUpAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.SwipeUpAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(13.0f, 5.83f);
        pathBuilder3.lineToRelative(1.59f, 1.59f);
        pathBuilder3.lineTo(16.0f, 6.0f);
        pathBuilder3.lineToRelative(-4.0f, -4.0f);
        pathBuilder3.lineTo(8.0f, 6.0f);
        pathBuilder3.lineToRelative(1.41f, 1.41f);
        pathBuilder3.lineTo(11.0f, 5.83f);
        pathBuilder3.verticalLineToRelative(4.27f);
        ...
        pathBuilder3.verticalLineTo(5.83f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(13.66f, 18.0f, 12.0f, 18.0f);
        pathBuilder3.close();
