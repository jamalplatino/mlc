...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_rsvp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Rsvp", "Landroidx/compose/material/icons/Icons$TwoTone;", "getRsvp", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class RsvpKt {
    ...
    public static final ImageVector getRsvp(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("TwoTone.Rsvp", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(5.35f, 9.0f, 6.0f, 9.65f, 6.0f, 10.5f);
        pathBuilder.verticalLineToRelative(1.0f);
        pathBuilder2.curveTo(6.0f, 12.1f, 5.6f, 12.65f, 5.1f, 12.9f);
        pathBuilder.close();
        ...
        pathBuilder.verticalLineToRelative(1.0f);
        pathBuilder3.curveTo(23.0f, 12.33f, 22.33f, 13.0f, 21.5f, 13.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(7.34f, 12.75f, 7.0f, 12.41f, 7.0f, 12.0f);
        pathBuilder.verticalLineToRelative(-2.0f);
