...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_vapeFree", "Landroidx/compose/ui/graphics/vector/ImageVector;", "VapeFree", "Landroidx/compose/material/icons/Icons$TwoTone;", "getVapeFree", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class VapeFreeKt {
    ...
    public static final ImageVector getVapeFree(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.VapeFree", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(16.17f, 19.0f);
        ...
        pathBuilder3.lineToRelative(-1.41f, 1.41f);
        pathBuilder3.lineTo(16.17f, 19.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(18.83f, 16.0f);
        pathBuilder3.horizontalLineTo(22.0f);
        pathBuilder3.verticalLineToRelative(3.0f);
        pathBuilder3.horizontalLineToRelative(-0.17f);
        pathBuilder3.lineTo(18.83f, 16.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(11.15f, 8.32f);
        pathBuilder5.curveToRelative(0.0f, -0.01f, 0.0f, -0.01f, 0.0f, -0.02f);
        pathBuilder5.curveToRelative(0.0f, -1.85f, 1.5f, -3.35f, 3.35f, -3.35f);
        ...
        pathBuilder6.curveToRelative(1.87f, 0.0f, 3.47f, 1.35f, 3.47f, 3.16f);
        pathBuilder3.verticalLineTo(15.0f);
        ...
        pathBuilder6.curveToRelative(-0.01f, 0.0f, -0.01f, 0.0f, -0.02f, 0.0f);
        pathBuilder3.lineTo(11.15f, 8.32f);
        pathBuilder3.close();
