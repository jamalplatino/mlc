...
public final class InstallMobileKt {
    ...
    public static final ImageVector getInstallMobile(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.InstallMobile", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.lineToRelative(-0.41f, 0.41f);
        pathBuilder5.lineToRelative(-1.0f, 1.0f);
        pathBuilder5.lineToRelative(1.0f, 1.0f);
