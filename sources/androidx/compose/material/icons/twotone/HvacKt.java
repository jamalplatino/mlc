...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_hvac", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Hvac", "Landroidx/compose/material/icons/Icons$TwoTone;", "getHvac", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class HvacKt {
    ...
    public static final ImageVector getHvac(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Hvac", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.reflectiveCurveTo(8.69f, 18.0f, 12.0f, 18.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 16.0f);
        pathBuilder5.curveToRelative(-1.01f, 0.0f, -1.91f, -0.39f, -2.62f, -1.0f);
        pathBuilder4.horizontalLineToRelative(5.24f);
        pathBuilder5.curveTo(13.91f, 15.61f, 13.01f, 16.0f, 12.0f, 16.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 8.0f);
        pathBuilder5.curveToRelative(1.01f, 0.0f, 1.91f, 0.39f, 2.62f, 1.0f);
        pathBuilder4.horizontalLineTo(9.38f);
        pathBuilder5.curveTo(10.09f, 8.39f, 10.99f, 8.0f, 12.0f, 8.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(8.56f, 10.0f);
        pathBuilder4.horizontalLineToRelative(6.89f);
        pathBuilder5.curveToRelative(0.26f, 0.45f, 0.44f, 0.96f, 0.51f, 1.5f);
        pathBuilder4.horizontalLineToRelative(-7.9f);
        pathBuilder5.curveTo(8.12f, 10.96f, 8.29f, 10.45f, 8.56f, 10.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(15.95f, 12.5f);
        pathBuilder5.curveToRelative(-0.07f, 0.54f, -0.24f, 1.05f, -0.51f, 1.5f);
        pathBuilder4.horizontalLineTo(8.56f);
        pathBuilder5.curveToRelative(-0.26f, -0.45f, -0.44f, -0.96f, -0.51f, -1.5f);
        pathBuilder4.horizontalLineTo(15.95f);
        pathBuilder4.close();
