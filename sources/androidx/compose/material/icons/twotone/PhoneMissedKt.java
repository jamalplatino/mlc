...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_phoneMissed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PhoneMissed", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPhoneMissed", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PhoneMissedKt {
    ...
    public static final ImageVector getPhoneMissed(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.PhoneMissed", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(18.6f, 17.22f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(0.66f, 0.37f, 1.28f, 0.79f, 1.88f, 1.27f);
        ...
        pathBuilder3.moveTo(23.71f, 16.67f);
        pathBuilder3.curveTo(20.66f, 13.78f, 16.54f, 12.0f, 12.0f, 12.0f);
        pathBuilder3.reflectiveCurveTo(3.34f, 13.78f, 0.29f, 16.67f);
        ...
        pathBuilder3.reflectiveCurveToRelative(3.15f, 0.25f, 4.6f, 0.72f);
        pathBuilder3.verticalLineToRelative(3.1f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveToRelative(0.0f, 0.39f, 0.23f, 0.74f, 0.56f, 0.9f);
        pathBuilder5.curveToRelative(0.98f, 0.49f, 1.87f, 1.12f, 2.67f, 1.85f);
        pathBuilder5.curveToRelative(0.18f, 0.18f, 0.43f, 0.28f, 0.7f, 0.28f);
        pathBuilder5.curveToRelative(0.28f, 0.0f, 0.53f, -0.11f, 0.71f, -0.29f);
        pathBuilder3.lineToRelative(2.48f, -2.48f);
        PathBuilder pathBuilder6 = pathBuilder3;
        pathBuilder6.curveToRelative(0.18f, -0.18f, 0.29f, -0.43f, 0.29f, -0.71f);
        pathBuilder6.curveToRelative(0.0f, -0.28f, -0.12f, -0.52f, -0.3f, -0.7f);
        pathBuilder3.close();
        pathBuilder3.moveTo(5.4f, 17.23f);
        PathBuilder pathBuilder7 = pathBuilder3;
        pathBuilder7.curveToRelative(-0.66f, 0.37f, -1.29f, 0.8f, -1.87f, 1.27f);
        pathBuilder3.lineToRelative(-1.07f, -1.07f);
        pathBuilder7.curveToRelative(0.91f, -0.75f, 1.9f, -1.39f, 2.95f, -1.9f);
        pathBuilder3.verticalLineToRelative(1.7f);
        pathBuilder3.close();
        pathBuilder3.moveTo(20.48f, 18.49f);
        pathBuilder3.curveToRelative(-0.6f, -0.48f, -1.22f, -0.9f, -1.88f, -1.27f);
        pathBuilder3.verticalLineToRelative(-1.7f);
        pathBuilder3.curveToRelative(1.05f, 0.51f, 2.03f, 1.15f, 2.95f, 1.9f);
        pathBuilder3.lineToRelative(-1.07f, 1.07f);
        pathBuilder3.close();
        pathBuilder3.moveTo(7.0f, 6.43f);
        pathBuilder3.lineToRelative(4.94f, 4.94f);
        pathBuilder3.lineToRelative(7.07f, -7.07f);
        pathBuilder3.lineToRelative(-1.41f, -1.42f);
        pathBuilder3.lineToRelative(-5.66f, 5.66f);
        pathBuilder3.lineTo(8.4f, 5.0f);
        pathBuilder3.lineTo(11.0f, 5.0f);
