...
public final class TempleBuddhistKt {
    ...
    public static final ImageVector getTempleBuddhist(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.TempleBuddhist", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(21.0f, 9.02f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(0.0f, 1.09f, -0.89f, 1.98f, -1.98f, 1.98f);
        pathBuilder5.horizontalLineTo(18.0f);
        pathBuilder5.verticalLineTo(8.86f);
        pathBuilder6.curveToRelative(1.72f, -0.44f, 3.0f, -1.99f, 3.0f, -3.84f);
        pathBuilder5.verticalLineTo(5.0f);
        pathBuilder5.lineToRelative(-2.0f, 0.02f);
        pathBuilder6.curveTo(19.0f, 6.11f, 18.11f, 7.0f, 17.02f, 7.0f);
        pathBuilder5.horizontalLineTo(16.5f);
        pathBuilder5.lineTo(12.0f, 1.0f);
        pathBuilder5.lineTo(7.5f, 7.0f);
        pathBuilder5.horizontalLineTo(6.98f);
        pathBuilder6.curveTo(5.89f, 7.0f, 5.0f, 6.11f, 5.0f, 5.02f);
        pathBuilder5.horizontalLineTo(3.0f);
        pathBuilder6.curveToRelative(0.0f, 1.86f, 1.28f, 3.4f, 3.0f, 3.84f);
        pathBuilder5.verticalLineTo(11.0f);
        pathBuilder5.horizontalLineTo(4.98f);
        pathBuilder6.curveTo(3.89f, 11.0f, 3.0f, 10.11f, 3.0f, 9.02f);
        ...
        pathBuilder5.verticalLineToRelative(4.0f);
        pathBuilder5.horizontalLineToRelative(7.0f);
        pathBuilder5.verticalLineToRelative(-9.14f);
        pathBuilder6.curveToRelative(1.72f, -0.44f, 3.0f, -1.99f, 3.0f, -3.84f);
        pathBuilder5.verticalLineTo(9.0f);
        pathBuilder5.lineTo(21.0f, 9.02f);
        pathBuilder5.close();
        pathBuilder5.moveTo(12.0f, 4.33f);
        pathBuilder5.lineTo(14.0f, 7.0f);
        pathBuilder5.horizontalLineToRelative(-4.0f);
        pathBuilder5.lineTo(12.0f, 4.33f);
        pathBuilder5.close();
        pathBuilder5.moveTo(8.0f, 9.0f);
