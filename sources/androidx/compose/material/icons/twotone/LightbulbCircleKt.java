...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulbCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LightbulbCircle", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLightbulbCircle", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LightbulbCircleKt {
    ...
    public static final ImageVector getLightbulbCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.LightbulbCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(7.8f, 13.09f, 7.0f, 11.64f, 7.0f, 10.0f);
        ...
        pathBuilder6.curveTo(10.5f, 18.33f, 11.17f, 19.0f, 12.0f, 19.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(9.0f, 15.0f);
        ...
        pathBuilder8.moveTo(12.0f, 5.0f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveToRelative(-2.76f, 0.0f, -5.0f, 2.24f, -5.0f, 5.0f);
        pathBuilder9.curveToRelative(0.0f, 1.64f, 0.8f, 3.09f, 2.03f, 4.0f);
        pathBuilder8.horizontalLineToRelative(5.95f);
        pathBuilder9.curveTo(16.2f, 13.09f, 17.0f, 11.64f, 17.0f, 10.0f);
        pathBuilder9.curveTo(17.0f, 7.24f, 14.76f, 5.0f, 12.0f, 5.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(14.43f, 12.5f);
        pathBuilder8.horizontalLineTo(9.57f);
        PathBuilder pathBuilder10 = pathBuilder8;
        pathBuilder10.curveTo(8.89f, 11.84f, 8.5f, 10.95f, 8.5f, 10.0f);
        pathBuilder10.curveToRelative(0.0f, -1.93f, 1.57f, -3.5f, 3.5f, -3.5f);
        pathBuilder8.reflectiveCurveToRelative(3.5f, 1.57f, 3.5f, 3.5f);
        pathBuilder8.curveTo(15.5f, 10.95f, 15.11f, 11.84f, 14.43f, 12.5f);
        pathBuilder8.close();
