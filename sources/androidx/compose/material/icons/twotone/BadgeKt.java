...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_badge", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Badge", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBadge", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BadgeKt {
    ...
    public static final ImageVector getBadge(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Badge", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveTo(15.0f, 10.1f, 14.1f, 11.0f, 13.0f, 11.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.curveTo(7.5f, 12.67f, 8.17f, 12.0f, 9.0f, 12.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 18.0f);
        pathBuilder4.horizontalLineTo(6.0f);
        pathBuilder4.verticalLineToRelative(-0.43f);
        pathBuilder5.curveToRelative(0.0f, -0.6f, 0.36f, -1.15f, 0.92f, -1.39f);
        pathBuilder5.curveTo(7.56f, 15.9f, 8.26f, 15.75f, 9.0f, 15.75f);
        pathBuilder4.reflectiveCurveToRelative(1.44f, 0.15f, 2.08f, 0.43f);
        pathBuilder5.curveToRelative(0.55f, 0.24f, 0.92f, 0.78f, 0.92f, 1.39f);
        pathBuilder4.verticalLineTo(18.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(18.0f, 16.5f);
