...
public final class WorkHistoryKt {
    ...
    public static final ImageVector getWorkHistory(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.WorkHistory", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(11.03f, 18.67f, 11.0f, 18.34f, 11.0f, 18.0f);
        ...
        pathBuilder3.verticalLineToRelative(3.29f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveToRelative(0.72f, 0.22f, 1.4f, 0.54f, 2.0f, 0.97f);
        pathBuilder3.verticalLineTo(8.0f);
        ...
        pathBuilder4.curveToRelative(0.0f, -1.11f, -0.89f, -2.0f, -2.0f, -2.0f);
        pathBuilder3.horizontalLineToRelative(-4.0f);
        pathBuilder4.curveTo(8.89f, 2.0f, 8.0f, 2.89f, 8.0f, 4.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder4.curveTo(2.89f, 6.0f, 2.01f, 6.89f, 2.01f, 8.0f);
        pathBuilder3.lineTo(2.0f, 19.0f);
        pathBuilder4.curveToRelative(0.0f, 1.11f, 0.89f, 2.0f, 2.0f, 2.0f);
        pathBuilder3.horizontalLineToRelative(7.68f);
        pathBuilder3.curveToRelative(-0.3f, -0.62f, -0.5f, -1.29f, -0.6f, -2.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.close();
        pathBuilder5.moveTo(19.65f, 20.35f);
        pathBuilder5.lineToRelative(-2.15f, -2.15f);
        pathBuilder5.verticalLineTo(15.0f);
        pathBuilder5.horizontalLineToRelative(1.0f);
        pathBuilder5.verticalLineToRelative(2.79f);
        pathBuilder5.lineToRelative(1.85f, 1.85f);
        pathBuilder5.lineTo(19.65f, 20.35f);
        pathBuilder5.close();
