...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_electricBike", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElectricBike", "Landroidx/compose/material/icons/Icons$TwoTone;", "getElectricBike", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ElectricBikeKt {
    ...
    public static final ImageVector getElectricBike(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.ElectricBike", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(9.46f, 8.77f, 7.59f, 7.12f, 5.25f, 7.01f);
        pathBuilder2.curveTo(2.45f, 6.87f, 0.0f, 9.2f, 0.0f, 12.0f);
        ...
        pathBuilder2.curveTo(24.0f, 9.2f, 21.8f, 7.0f, 19.0f, 7.0f);
        pathBuilder.close();
        pathBuilder.moveTo(7.82f, 13.0f);
        pathBuilder2.curveToRelative(-0.4f, 1.17f, -1.49f, 2.0f, -2.82f, 2.0f);
        pathBuilder2.curveToRelative(-1.68f, 0.0f, -3.0f, -1.32f, -3.0f, -3.0f);
        pathBuilder.reflectiveCurveToRelative(1.32f, -3.0f, 3.0f, -3.0f);
        pathBuilder2.curveToRelative(1.33f, 0.0f, 2.42f, 0.83f, 2.82f, 2.0f);
        ...
        pathBuilder3.curveTo(14.56f, 9.58f, 14.24f, 10.25f, 14.1f, 11.0f);
        pathBuilder.close();
        pathBuilder.moveTo(19.0f, 15.0f);
        pathBuilder3.curveToRelative(-1.68f, 0.0f, -3.0f, -1.32f, -3.0f, -3.0f);
        pathBuilder3.curveToRelative(0.0f, -0.93f, 0.41f, -1.73f, 1.05f, -2.28f);
        ...
        pathBuilder4.curveTo(18.94f, 9.01f, 18.97f, 9.0f, 19.0f, 9.0f);
