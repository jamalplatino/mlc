...
public final class EditNotificationsKt {
    ...
    public static final ImageVector getEditNotifications(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.EditNotifications", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(17.58f, 6.25f);
        pathBuilder3.lineToRelative(1.77f, 1.77f);
        pathBuilder3.lineTo(14.37f, 13.0f);
        pathBuilder3.horizontalLineTo(12.6f);
        pathBuilder3.verticalLineToRelative(-1.77f);
        pathBuilder3.lineTo(17.58f, 6.25f);
        pathBuilder3.close();
        pathBuilder3.moveTo(20.85f, 5.81f);
        ...
        pathBuilder3.lineToRelative(1.77f, 1.77f);
        pathBuilder3.lineToRelative(0.85f, -0.85f);
        pathBuilder4.curveTo(21.05f, 6.32f, 21.05f, 6.0f, 20.85f, 5.81f);
        pathBuilder3.close();
        pathBuilder3.moveTo(18.0f, 12.2f);
        ...
        pathBuilder3.curveToRelative(0.0f, -2.79f, 1.91f, -5.14f, 4.5f, -5.8f);
        pathBuilder3.verticalLineTo(3.5f);
        pathBuilder3.curveTo(10.5f, 2.67f, 11.17f, 2.0f, 12.0f, 2.0f);
        pathBuilder3.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilder3.verticalLineToRelative(0.7f);
        pathBuilder3.curveToRelative(0.82f, 0.21f, 1.57f, 0.59f, 2.21f, 1.09f);
        pathBuilder3.lineToRelative(-1.43f, 1.43f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(13.64f, 6.26f, 12.85f, 6.0f, 12.0f, 6.0f);
        pathBuilder5.curveToRelative(-2.21f, 0.0f, -4.0f, 1.79f, -4.0f, 4.0f);
        pathBuilder3.verticalLineToRelative(7.0f);
        pathBuilder3.horizontalLineToRelative(8.0f);
        pathBuilder3.verticalLineToRelative(-2.8f);
        pathBuilder3.lineTo(18.0f, 12.2f);
        pathBuilder3.close();
        pathBuilder3.moveTo(10.0f, 20.0f);
        pathBuilder3.horizontalLineToRelative(4.0f);
        pathBuilder5.curveToRelative(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        pathBuilder3.reflectiveCurveTo(10.0f, 21.1f, 10.0f, 20.0f);
        pathBuilder3.close();
