...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_airplaneTicket", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AirplaneTicket", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAirplaneTicket", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AirplaneTicketKt {
    ...
    public static final ImageVector getAirplaneTicket(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.AirplaneTicket", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, 1.47f, -0.81f, 2.77f, -2.0f, 3.46f);
        ...
        pathBuilder3.curveToRelative(0.51f, -0.14f, 1.04f, 0.17f, 1.18f, 0.68f);
        pathBuilder3.curveToRelative(0.13f, 0.51f, -0.17f, 1.04f, -0.69f, 1.19f);
        ...
        pathBuilder4.moveTo(20.19f, 4.0f);
        pathBuilder4.horizontalLineTo(4.0f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveTo(2.9f, 4.0f, 2.01f, 4.9f, 2.01f, 6.0f);
        pathBuilder4.verticalLineToRelative(4.0f);
        pathBuilder5.curveTo(3.11f, 10.0f, 4.0f, 10.9f, 4.0f, 12.0f);
        pathBuilder4.reflectiveCurveToRelative(-0.89f, 2.0f, -2.0f, 2.0f);
        pathBuilder4.verticalLineToRelative(4.0f);
        ...
        pathBuilder6.curveTo(22.0f, 4.9f, 21.19f, 4.0f, 20.19f, 4.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(20.0f, 18.0f);
        pathBuilder4.horizontalLineTo(4.0f);
        pathBuilder4.verticalLineToRelative(-2.54f);
        PathBuilder pathBuilder7 = pathBuilder4;
        pathBuilder7.curveToRelative(1.19f, -0.69f, 2.0f, -1.99f, 2.0f, -3.46f);
        pathBuilder7.curveToRelative(0.0f, -1.48f, -0.8f, -2.77f, -1.99f, -3.46f);
        ...
        pathBuilder8.moveTo(17.73f, 13.3f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveToRelative(0.52f, -0.15f, 0.82f, -0.68f, 0.69f, -1.19f);
        pathBuilder9.curveToRelative(-0.14f, -0.51f, -0.67f, -0.82f, -1.18f, -0.68f);
        pathBuilder8.lineToRelative(-2.44f, 0.65f);
        pathBuilder8.lineToRelative(-4.01f, -3.74f);
        pathBuilder8.lineToRelative(-1.4f, 0.38f);
        pathBuilder8.lineToRelative(2.4f, 4.16f);
        pathBuilder8.lineTo(9.4f, 13.52f);
        pathBuilder8.lineToRelative(-1.26f, -0.99f);
        pathBuilder8.lineToRelative(-0.93f, 0.25f);
        pathBuilder8.lineToRelative(1.66f, 2.88f);
        pathBuilder8.lineTo(17.73f, 13.3f);
        pathBuilder8.close();
