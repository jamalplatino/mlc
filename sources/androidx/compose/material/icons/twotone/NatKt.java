...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_nat", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Nat", "Landroidx/compose/material/icons/Icons$TwoTone;", "getNat", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class NatKt {
    ...
    public static final ImageVector getNat(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Nat", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(6.82f, 13.0f);
        pathBuilder3.horizontalLineTo(11.0f);
        pathBuilder3.verticalLineToRelative(-2.0f);
        pathBuilder3.horizontalLineTo(6.82f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveTo(6.4f, 9.84f, 5.3f, 9.0f, 4.0f, 9.0f);
        ...
        pathBuilder5.curveTo(5.3f, 15.0f, 6.4f, 14.16f, 6.82f, 13.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.moveTo(23.0f, 12.0f);
        pathBuilder6.lineToRelative(-4.0f, -3.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.horizontalLineToRelative(-4.05f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveTo(14.45f, 5.95f, 10.19f, 2.0f, 5.0f, 2.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder7.curveToRelative(4.42f, 0.0f, 8.0f, 3.58f, 8.0f, 8.0f);
        pathBuilder6.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.curveToRelative(5.19f, 0.0f, 9.45f, -3.95f, 9.95f, -9.0f);
        pathBuilder6.horizontalLineTo(19.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.lineTo(23.0f, 12.0f);
        pathBuilder6.close();
