...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_surfing", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Surfing", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSurfing", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SurfingKt {
    ...
    public static final ImageVector getSurfing(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("TwoTone.Surfing", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(21.0f, 23.0f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(-1.03f, 0.0f, -2.06f, -0.25f, -3.0f, -0.75f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder2.curveToRelative(-1.89f, 1.0f, -4.11f, 1.0f, -6.0f, 0.0f);
        pathBuilder2.curveToRelative(-1.89f, 1.0f, -4.11f, 1.0f, -6.0f, 0.0f);
        pathBuilder2.curveTo(5.05f, 22.75f, 4.03f, 23.0f, 3.0f, 23.0f);
        ...
        pathBuilder3.curveToRelative(0.53f, 0.38f, 1.03f, 0.78f, 1.49f, 1.17f);
        pathBuilder3.curveTo(16.81f, 18.59f, 15.94f, 19.0f, 15.0f, 19.0f);
        pathBuilder3.curveToRelative(-1.2f, 0.0f, -2.27f, -0.66f, -3.0f, -1.5f);
        pathBuilder3.curveToRelative(-0.73f, 0.84f, -1.8f, 1.5f, -3.0f, 1.5f);
        pathBuilder3.curveToRelative(-0.33f, 0.0f, -0.65f, -0.05f, -0.96f, -0.14f);
        pathBuilder3.curveTo(5.19f, 16.9f, 3.0f, 14.72f, 3.0f, 13.28f);
        pathBuilder3.curveTo(3.0f, 12.25f, 4.01f, 12.0f, 4.85f, 12.0f);
        pathBuilder3.curveToRelative(0.98f, 0.0f, 2.28f, 0.31f, 3.7f, 0.83f);
        ...
        pathBuilder4.curveTo(17.01f, 8.98f, 18.64f, 10.0f, 20.5f, 10.0f);
        pathBuilder.verticalLineToRelative(2.0f);
        pathBuilder4.curveTo(17.91f, 12.0f, 15.64f, 10.58f, 14.43f, 8.48f);
        pathBuilder.close();
