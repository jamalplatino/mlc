...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_print", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Print", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPrint", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PrintKt {
    ...
    public static final ImageVector getPrint(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Print", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.lineTo(6.0f, 3.0f);
        pathBuilder4.verticalLineToRelative(5.0f);
        pathBuilder4.lineTo(5.0f, 8.0f);
        ...
        pathBuilder4.lineTo(8.0f, 8.0f);
        pathBuilder4.lineTo(8.0f, 5.0f);
        pathBuilder4.close();
        ...
        pathBuilder4.verticalLineToRelative(2.0f);
        pathBuilder4.lineTo(4.0f, 15.0f);
        pathBuilder4.verticalLineToRelative(-4.0f);
        ...
        pathBuilder6.moveTo(6.0f, 13.0f);
        ...
        pathBuilder6.verticalLineToRelative(-2.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(18.0f, 10.5f);
        pathBuilder7.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder6.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder6.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilder6.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilder6.close();
        ImageVector build = ImageVector.Builder.m3530addPathoIyEayM$default(builder, pathBuilder6.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 0.3f, 1.0f, r73, r74, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _print = build;
