...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_webhook", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Webhook", "Landroidx/compose/material/icons/Icons$TwoTone;", "getWebhook", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class WebhookKt {
    ...
    public static final ImageVector getWebhook(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("TwoTone.Webhook", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.27f, -0.31f, 0.67f, -0.5f, 1.12f, -0.5f);
        pathBuilder2.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilder2.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilder2.curveToRelative(-0.44f, 0.0f, -0.84f, -0.19f, -1.12f, -0.5f);
        ...
        pathBuilder4.curveTo(4.84f, 13.58f, 4.0f, 14.7f, 4.0f, 16.0f);
        ...
        pathBuilder5.curveToRelative(0.0f, 1.43f, 0.6f, 2.71f, 1.55f, 3.62f);
        pathBuilder.lineToRelative(-2.35f, 3.9f);
        PathBuilder pathBuilder6 = pathBuilder;
        pathBuilder6.curveTo(6.02f, 14.66f, 5.5f, 15.27f, 5.5f, 16.0f);
        ...
        pathBuilder7.curveTo(10.49f, 9.61f, 9.5f, 8.42f, 9.5f, 7.0f);
        pathBuilder7.curveTo(9.5f, 5.35f, 10.85f, 4.0f, 12.5f, 4.0f);
        pathBuilder.close();
        pathBuilder.moveTo(17.0f, 13.0f);
        pathBuilder7.curveToRelative(-0.64f, 0.0f, -1.23f, 0.2f, -1.72f, 0.54f);
        pathBuilder.lineToRelative(-3.05f, -5.07f);
        PathBuilder pathBuilder8 = pathBuilder;
        pathBuilder8.curveTo(11.53f, 8.35f, 11.0f, 7.74f, 11.0f, 7.0f);
