...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_blender", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Blender", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBlender", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BlenderKt {
    ...
    public static final ImageVector getBlender(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Blender", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.verticalLineToRelative(-1.0f);
        pathBuilder2.curveTo(16.0f, 17.35f, 14.65f, 16.0f, 13.0f, 16.0f);
        pathBuilder.close();
        ...
        pathBuilder3.moveTo(16.13f, 15.13f);
        ...
        pathBuilder3.horizontalLineToRelative(2.23f);
        pathBuilder3.lineToRelative(0.64f, 4.13f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(6.74f, 16.05f, 6.0f, 17.43f, 6.0f, 19.0f);
        pathBuilder3.verticalLineToRelative(1.0f);
        ...
        pathBuilder3.verticalLineToRelative(-1.0f);
        pathBuilder5.curveTo(18.0f, 17.43f, 17.26f, 16.05f, 16.13f, 15.13f);
        pathBuilder3.close();
        pathBuilder3.moveTo(5.0f, 9.0f);
        pathBuilder3.verticalLineTo(5.0f);
        pathBuilder3.horizontalLineToRelative(1.31f);
        pathBuilder3.lineToRelative(0.62f, 4.0f);
        pathBuilder3.horizontalLineTo(5.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(15.67f, 5.0f);
        pathBuilder3.lineToRelative(-1.38f, 9.0f);
        pathBuilder3.horizontalLineTo(9.72f);
        pathBuilder3.lineTo(8.33f, 5.0f);
        pathBuilder3.horizontalLineTo(15.67f);
        pathBuilder3.close();
        ...
        pathBuilder7.moveTo(12.0f, 18.0f);
