...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stroller", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stroller", "Landroidx/compose/material/icons/Icons$TwoTone;", "getStroller", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class StrollerKt {
    ...
    public static final ImageVector getStroller(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Stroller", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.29f, 0.0f, 0.58f, 0.02f, 0.86f, 0.05f);
        pathBuilder3.lineTo(9.49f, 6.66f);
        pathBuilder3.lineToRelative(-1.4f, -1.4f);
        pathBuilder4.curveTo(8.71f, 5.09f, 9.35f, 5.0f, 10.0f, 5.0f);
        pathBuilder3.moveTo(15.0f, 8.66f);
        pathBuilder3.verticalLineTo(15.0f);
        pathBuilder3.horizontalLineTo(9.6f);
        pathBuilder3.lineTo(15.0f, 8.66f);
        pathBuilder3.moveTo(18.65f, 3.0f);
        pathBuilder4.curveToRelative(-1.66f, 0.0f, -2.54f, 1.27f, -3.18f, 2.03f);
        pathBuilder3.lineToRelative(-8.8f, 10.32f);
        pathBuilder4.curveTo(6.12f, 16.0f, 6.58f, 17.0f, 7.43f, 17.0f);
        ...
        pathBuilder3.lineTo(18.65f, 3.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(10.0f, 3.0f);
        pathBuilder4.curveTo(8.03f, 3.0f, 6.21f, 3.64f, 4.72f, 4.72f);
        pathBuilder3.lineToRelative(4.89f, 4.89f);
        pathBuilder3.lineToRelative(4.7f, -5.51f);
        pathBuilder4.curveTo(13.03f, 3.4f, 11.56f, 3.0f, 10.0f, 3.0f);
        pathBuilder3.lineTo(10.0f, 3.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(17.1f, 18.0f, 16.0f, 18.0f);
        pathBuilder3.lineTo(16.0f, 18.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(6.0f, 18.0f);
        pathBuilder4.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilder3.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder3.reflectiveCurveToRelative(2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder3.reflectiveCurveTo(7.1f, 18.0f, 6.0f, 18.0f);
