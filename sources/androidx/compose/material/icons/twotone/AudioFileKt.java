...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_audioFile", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AudioFile", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAudioFile", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AudioFileKt {
    ...
    public static final ImageVector getAudioFile(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.AudioFile", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, -1.24f, 1.01f, -2.25f, 2.25f, -2.25f);
        pathBuilder2.curveToRelative(0.46f, 0.0f, 0.89f, 0.14f, 1.25f, 0.38f);
        ...
        pathBuilder4.curveTo(4.9f, 2.0f, 4.0f, 2.9f, 4.0f, 4.0f);
        ...
        pathBuilder5.moveTo(12.0f, 14.88f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(-0.36f, -0.24f, -0.79f, -0.38f, -1.25f, -0.38f);
        pathBuilder6.curveToRelative(-1.24f, 0.0f, -2.25f, 1.01f, -2.25f, 2.25f);
        pathBuilder6.curveToRelative(0.0f, 1.24f, 1.01f, 2.25f, 2.25f, 2.25f);
        pathBuilder5.reflectiveCurveTo(13.0f, 17.99f, 13.0f, 16.75f);
        ...
        pathBuilder5.verticalLineTo(14.88f);
        pathBuilder5.close();
