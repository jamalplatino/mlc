...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_traffic", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Traffic", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTraffic", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TrafficKt {
    ...
    public static final ImageVector getTraffic(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Traffic", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.lineTo(17.0f, 4.0f);
        ...
        pathBuilder3.lineTo(7.0f, 10.0f);
        ...
        pathBuilder3.verticalLineToRelative(-1.14f);
        pathBuilder4.curveToRelative(1.72f, -0.45f, 3.0f, -2.0f, 3.0f, -3.86f);
        pathBuilder3.horizontalLineToRelative(-3.0f);
        pathBuilder3.verticalLineToRelative(-1.14f);
        pathBuilder4.curveToRelative(1.72f, -0.45f, 3.0f, -2.0f, 3.0f, -3.86f);
        pathBuilder3.horizontalLineToRelative(-3.0f);
        pathBuilder3.lineTo(17.0f, 8.86f);
        pathBuilder4.curveToRelative(1.72f, -0.45f, 3.0f, -2.0f, 3.0f, -3.86f);
        pathBuilder3.close();
        pathBuilder3.moveTo(15.0f, 19.0f);
        pathBuilder3.lineTo(9.0f, 19.0f);
        pathBuilder3.lineTo(9.0f, 5.0f);
        ...
        pathBuilder3.reflectiveCurveTo(12.83f, 15.0f, 12.0f, 15.0f);
        ...
        pathBuilder4.curveToRelative(0.83f, 0.0f, 1.5f, -0.67f, 1.5f, -1.5f);
        pathBuilder3.reflectiveCurveTo(12.83f, 6.0f, 12.0f, 6.0f);
        pathBuilder3.reflectiveCurveToRelative(-1.5f, 0.67f, -1.5f, 1.5f);
        pathBuilder3.reflectiveCurveTo(11.17f, 9.0f, 12.0f, 9.0f);
        pathBuilder3.close();
