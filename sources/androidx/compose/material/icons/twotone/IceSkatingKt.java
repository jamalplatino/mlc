...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_iceSkating", "Landroidx/compose/ui/graphics/vector/ImageVector;", "IceSkating", "Landroidx/compose/material/icons/Icons$TwoTone;", "getIceSkating", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class IceSkatingKt {
    ...
    public static final ImageVector getIceSkating(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.IceSkating", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(21.0f, 17.0f);
        ...
        pathBuilder4.curveToRelative(0.0f, -1.79f, -1.19f, -3.34f, -2.91f, -3.82f);
        pathBuilder3.lineToRelative(-2.62f, -0.74f);
        pathBuilder4.curveTo(12.62f, 9.19f, 12.0f, 8.39f, 12.0f, 7.5f);
        ...
        pathBuilder4.curveTo(8.22f, 6.0f, 8.0f, 6.22f, 8.0f, 6.5f);
        pathBuilder4.curveTo(8.0f, 6.78f, 8.22f, 7.0f, 8.5f, 7.0f);
        pathBuilder3.horizontalLineTo(10.0f);
        pathBuilder3.lineToRelative(0.1f, 1.0f);
        pathBuilder3.horizontalLineTo(8.5f);
        pathBuilder4.curveTo(8.22f, 8.0f, 8.0f, 8.22f, 8.0f, 8.5f);
        pathBuilder4.curveTo(8.0f, 8.78f, 8.22f, 9.0f, 8.5f, 9.0f);
        pathBuilder3.horizontalLineToRelative(1.81f);
        pathBuilder4.curveToRelative(0.45f, 1.12f, 1.4f, 2.01f, 2.6f, 2.36f);
        pathBuilder3.lineToRelative(2.62f, 0.73f);
        pathBuilder4.curveTo(16.4f, 12.33f, 17.0f, 13.1f, 17.0f, 14.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineTo(5.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(14.0f, 20.0f);
