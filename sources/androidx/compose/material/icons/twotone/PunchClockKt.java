...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_punchClock", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PunchClock", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPunchClock", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PunchClockKt {
    ...
    public static final ImageVector getPunchClock(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.PunchClock", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveTo(3.9f, 6.0f, 3.0f, 6.9f, 3.0f, 8.0f);
        ...
        pathBuilder5.curveTo(21.0f, 6.9f, 20.1f, 6.0f, 19.0f, 6.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(8.0f, 3.0f);
        ...
        pathBuilder4.close();
        pathBuilder4.moveTo(19.0f, 20.0f);
        pathBuilder4.horizontalLineTo(5.0f);
        pathBuilder4.verticalLineTo(8.0f);
        pathBuilder4.horizontalLineToRelative(14.0f);
        ...
        pathBuilder6.moveTo(12.0f, 19.0f);
        ...
        pathBuilder7.curveToRelative(-2.76f, 0.0f, -5.0f, 2.24f, -5.0f, 5.0f);
        pathBuilder6.reflectiveCurveTo(9.24f, 19.0f, 12.0f, 19.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(12.0f, 10.5f);
        pathBuilder7.curveToRelative(1.93f, 0.0f, 3.5f, 1.57f, 3.5f, 3.5f);
        pathBuilder6.reflectiveCurveToRelative(-1.57f, 3.5f, -3.5f, 3.5f);
        pathBuilder6.reflectiveCurveTo(8.5f, 15.93f, 8.5f, 14.0f);
        pathBuilder6.reflectiveCurveTo(10.07f, 10.5f, 12.0f, 10.5f);
        pathBuilder6.close();
        ...
        pathBuilder8.moveTo(13.85f, 15.14f);
        pathBuilder8.lineToRelative(-1.35f, -1.35f);
        pathBuilder8.lineToRelative(0.0f, -2.29f);
        pathBuilder8.lineToRelative(-1.0f, 0.0f);
        pathBuilder8.lineToRelative(0.0f, 2.71f);
        pathBuilder8.lineToRelative(1.64f, 1.64f);
        pathBuilder8.close();
