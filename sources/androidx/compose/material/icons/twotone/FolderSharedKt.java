...
public final class FolderSharedKt {
    ...
    public static final ImageVector getFolderShared(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.FolderShared", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder2.verticalLineToRelative(-1.0f);
        pathBuilder3.curveToRelative(0.0f, -1.33f, -2.67f, -2.0f, -4.0f, -2.0f);
