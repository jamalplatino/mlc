...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_heatPump", "Landroidx/compose/ui/graphics/vector/ImageVector;", "HeatPump", "Landroidx/compose/material/icons/Icons$TwoTone;", "getHeatPump", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class HeatPumpKt {
    ...
    public static final ImageVector getHeatPump(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.HeatPump", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.close();
        pathBuilder4.moveTo(11.25f, 15.92f);
        pathBuilder5.curveToRelative(-0.55f, -0.1f, -1.05f, -0.32f, -1.5f, -0.62f);
        pathBuilder4.lineToRelative(1.5f, -1.5f);
        pathBuilder4.verticalLineTo(15.92f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.75f, 15.92f);
        pathBuilder4.verticalLineToRelative(-2.11f);
        pathBuilder4.lineToRelative(1.5f, 1.5f);
        pathBuilder5.curveTo(13.8f, 15.61f, 13.3f, 15.82f, 12.75f, 15.92f);
        pathBuilder4.close();
        pathBuilder4.moveTo(15.31f, 14.25f);
        pathBuilder4.lineToRelative(-1.5f, -1.5f);
        pathBuilder4.horizontalLineToRelative(2.11f);
        pathBuilder5.curveTo(15.82f, 13.3f, 15.61f, 13.8f, 15.31f, 14.25f);
        pathBuilder4.close();
        pathBuilder4.moveTo(15.92f, 11.25f);
        pathBuilder4.horizontalLineToRelative(-2.11f);
        pathBuilder4.lineToRelative(1.5f, -1.5f);
        pathBuilder5.curveTo(15.61f, 10.2f, 15.82f, 10.7f, 15.92f, 11.25f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.75f, 8.08f);
        pathBuilder5.curveToRelative(0.55f, 0.1f, 1.05f, 0.32f, 1.5f, 0.62f);
        pathBuilder4.lineToRelative(-1.5f, 1.5f);
        pathBuilder4.verticalLineTo(8.08f);
        pathBuilder4.close();
        ...
        pathBuilder5.curveTo(11.0f, 11.45f, 11.45f, 11.0f, 12.0f, 11.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(11.25f, 8.08f);
        pathBuilder4.verticalLineToRelative(2.11f);
        pathBuilder4.lineToRelative(-1.5f, -1.5f);
        pathBuilder5.curveTo(10.2f, 8.39f, 10.7f, 8.18f, 11.25f, 8.08f);
        pathBuilder4.close();
        pathBuilder4.moveTo(8.69f, 9.75f);
        pathBuilder4.lineToRelative(1.5f, 1.5f);
        pathBuilder4.horizontalLineTo(8.08f);
        pathBuilder5.curveTo(8.18f, 10.7f, 8.39f, 10.2f, 8.69f, 9.75f);
        pathBuilder4.close();
        pathBuilder4.moveTo(10.19f, 12.75f);
        pathBuilder4.lineToRelative(-1.5f, 1.5f);
        pathBuilder5.curveToRelative(-0.3f, -0.44f, -0.51f, -0.95f, -0.62f, -1.5f);
        pathBuilder4.horizontalLineTo(10.19f);
        pathBuilder4.close();
