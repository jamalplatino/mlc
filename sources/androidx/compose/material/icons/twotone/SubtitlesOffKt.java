...
public final class SubtitlesOffKt {
    ...
    public static final ImageVector getSubtitlesOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.SubtitlesOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.moveTo(1.04f, 3.87f);
        pathBuilder6.lineToRelative(1.2f, 1.2f);
        pathBuilder6.curveTo(2.09f, 5.35f, 2.0f, 5.66f, 2.0f, 6.0f);
        pathBuilder6.verticalLineToRelative(12.0f);
        pathBuilder6.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder6.horizontalLineToRelative(13.17f);
        pathBuilder6.lineToRelative(2.96f, 2.96f);
        pathBuilder6.lineToRelative(1.41f, -1.41f);
        pathBuilder6.lineTo(2.45f, 2.45f);
        pathBuilder6.lineTo(1.04f, 3.87f);
        pathBuilder6.close();
        pathBuilder6.moveTo(4.0f, 6.83f);
        pathBuilder6.lineTo(7.17f, 10.0f);
        pathBuilder6.horizontalLineTo(6.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.horizontalLineToRelative(2.0f);
        pathBuilder6.verticalLineToRelative(-1.17f);
        pathBuilder6.lineTo(11.17f, 14.0f);
        pathBuilder6.horizontalLineTo(6.0f);
        pathBuilder6.verticalLineToRelative(2.0f);
        pathBuilder6.horizontalLineToRelative(7.17f);
        pathBuilder6.lineToRelative(2.0f, 2.0f);
        pathBuilder6.horizontalLineTo(4.0f);
        pathBuilder6.verticalLineTo(6.83f);
        pathBuilder6.close();
