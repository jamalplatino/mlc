...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.DownloadForOffline", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.curveTo(6.49f, 2.0f, 2.0f, 6.49f, 2.0f, 12.0f);
        pathBuilder5.reflectiveCurveToRelative(4.49f, 10.0f, 10.0f, 10.0f);
        pathBuilder5.reflectiveCurveToRelative(10.0f, -4.49f, 10.0f, -10.0f);
        pathBuilder5.reflectiveCurveTo(17.51f, 2.0f, 12.0f, 2.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.curveTo(20.0f, 16.41f, 16.41f, 20.0f, 12.0f, 20.0f);
        pathBuilder5.close();
