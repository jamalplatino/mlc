...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lunchDining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LunchDining", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLunchDining", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LunchDiningKt {
    ...
    public static final ImageVector getLunchDining(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.LunchDining", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.horizontalLineToRelative(-16.0f);
        pathBuilder.close();
        ImageVector.Builder.m3530addPathoIyEayM$default(builder5, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 1.0f, 1.0f, r22, r23, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        pathBuilder3.curveToRelative(-0.13f, -0.37f, -0.35f, -0.7f, -0.66f, -1.01f);
        pathBuilder3.curveTo(17.93f, 5.73f, 15.31f, 5.0f, 12.0f, 5.0f);
        pathBuilder2.close();
        ImageVector.Builder.m3530addPathoIyEayM$default(builder4, pathBuilder2.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 1.0f, 1.0f, r39, r40, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        pathBuilder7.curveToRelative(1.19f, 0.0f, 1.42f, 1.0f, 3.33f, 1.0f);
        pathBuilder7.curveToRelative(1.95f, 0.0f, 2.09f, -1.0f, 3.33f, -1.0f);
        pathBuilder7.curveToRelative(1.19f, 0.0f, 1.4f, 0.98f, 3.32f, 1.0f);
        pathBuilder6.lineToRelative(-0.01f, -1.98f);
        pathBuilder7.curveTo(20.38f, 12.19f, 20.37f, 11.5f, 18.66f, 11.5f);
        pathBuilder6.close();
        ...
        pathBuilder8.moveTo(22.0f, 9.0f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveToRelative(0.02f, -4.0f, -4.28f, -6.0f, -10.0f, -6.0f);
        pathBuilder9.curveTo(6.29f, 3.0f, 2.0f, 5.0f, 2.0f, 9.0f);
        pathBuilder8.verticalLineToRelative(1.0f);
        pathBuilder8.horizontalLineToRelative(20.0f);
        pathBuilder8.lineTo(22.0f, 9.0f);
        pathBuilder8.lineTo(22.0f, 9.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(4.18f, 8.0f);
        pathBuilder9.curveTo(5.01f, 5.81f, 8.61f, 5.0f, 12.0f, 5.0f);
        pathBuilder9.curveToRelative(3.31f, 0.0f, 5.93f, 0.73f, 7.19f, 1.99f);
        pathBuilder9.curveTo(19.49f, 7.3f, 19.71f, 7.63f, 19.84f, 8.0f);
        pathBuilder8.horizontalLineTo(4.18f);
        pathBuilder8.close();
