...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_mouse", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Mouse", "Landroidx/compose/material/icons/Icons$TwoTone;", "getMouse", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MouseKt {
    ...
    public static final ImageVector getMouse(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Mouse", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(8.19f, 3.63f, 6.04f, 6.06f, 6.0f, 9.0f);
        pathBuilder.horizontalLineToRelative(5.0f);
        ...
        pathBuilder4.curveToRelative(-0.04f, -4.39f, -3.6f, -7.93f, -8.0f, -7.93f);
        pathBuilder3.reflectiveCurveTo(4.04f, 4.61f, 4.0f, 9.0f);
        ...
        pathBuilder3.lineTo(20.0f, 9.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(13.0f, 3.16f);
        pathBuilder4.curveToRelative(2.81f, 0.47f, 4.96f, 2.9f, 5.0f, 5.84f);
        pathBuilder3.horizontalLineToRelative(-5.0f);
        pathBuilder3.lineTo(13.0f, 3.16f);
        pathBuilder3.close();
        pathBuilder3.moveTo(11.0f, 3.16f);
        pathBuilder3.lineTo(11.0f, 9.0f);
        pathBuilder3.lineTo(6.0f, 9.0f);
        pathBuilder4.curveToRelative(0.04f, -2.94f, 2.19f, -5.37f, 5.0f, -5.84f);
        pathBuilder3.close();
