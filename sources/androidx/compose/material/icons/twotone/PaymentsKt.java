...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_payments", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Payments", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPayments", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PaymentsKt {
    ...
    public static final ImageVector getPayments(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Payments", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(1.9f, 4.0f, 1.0f, 4.9f, 1.0f, 6.0f);
        pathBuilder2.verticalLineToRelative(8.0f);
        pathBuilder3.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder2.horizontalLineToRelative(14.0f);
        pathBuilder3.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder2.verticalLineTo(6.0f);
        pathBuilder3.curveTo(19.0f, 4.9f, 18.1f, 4.0f, 17.0f, 4.0f);
        ...
        pathBuilder4.moveTo(10.0f, 7.0f);
        ...
        pathBuilder4.reflectiveCurveTo(11.66f, 7.0f, 10.0f, 7.0f);
        pathBuilder4.lineTo(10.0f, 7.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.moveTo(23.0f, 7.0f);
        ...
        pathBuilder6.curveToRelative(0.0f, -1.0f, 0.0f, -0.9f, 0.0f, -2.0f);
        pathBuilder5.horizontalLineToRelative(17.0f);
        pathBuilder5.verticalLineTo(7.0f);
        pathBuilder6.curveTo(22.1f, 7.0f, 22.0f, 7.0f, 23.0f, 7.0f);
        pathBuilder5.close();
