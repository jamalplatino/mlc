...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_liquor", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Liquor", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLiquor", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LiquorKt {
    ...
    public static final ImageVector getLiquor(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.Liquor", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.verticalLineToRelative(1.0f);
        pathBuilder3.curveTo(5.0f, 14.55f, 5.45f, 15.0f, 6.0f, 15.0f);
        pathBuilder2.close();
        ...
        pathBuilder5.moveTo(3.0f, 14.0f);
        ...
        pathBuilder5.verticalLineToRelative(-3.18f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(8.16f, 16.4f, 9.0f, 15.3f, 9.0f, 14.0f);
        ...
        pathBuilder5.close();
        pathBuilder5.moveTo(5.0f, 13.0f);
        pathBuilder5.horizontalLineToRelative(2.0f);
        ...
        pathBuilder7.moveTo(20.64f, 8.54f);
        pathBuilder7.lineToRelative(-0.96f, -0.32f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveTo(19.27f, 8.08f, 19.0f, 7.7f, 19.0f, 7.27f);
        ...
        pathBuilder7.verticalLineToRelative(4.28f);
        pathBuilder8.curveToRelative(0.0f, 0.43f, -0.27f, 0.81f, -0.68f, 0.95f);
        pathBuilder7.lineToRelative(-0.96f, 0.32f);
        pathBuilder8.curveTo(11.55f, 8.83f, 11.0f, 9.59f, 11.0f, 10.45f);
        ...
        pathBuilder7.verticalLineToRelative(-9.56f);
        pathBuilder8.curveTo(22.0f, 9.58f, 21.45f, 8.82f, 20.64f, 8.54f);
        pathBuilder7.close();
        pathBuilder7.moveTo(16.0f, 4.0f);
        pathBuilder7.horizontalLineToRelative(1.0f);
        pathBuilder7.verticalLineToRelative(1.0f);
        pathBuilder7.horizontalLineToRelative(-1.0f);
        pathBuilder7.verticalLineTo(4.0f);
        pathBuilder7.close();
        pathBuilder7.moveTo(20.0f, 20.0f);
        pathBuilder7.horizontalLineToRelative(-7.0f);
        ...
        pathBuilder7.close();
        pathBuilder7.moveTo(20.0f, 12.0f);
        pathBuilder7.horizontalLineToRelative(-7.0f);
        pathBuilder7.verticalLineToRelative(-1.56f);
        pathBuilder7.lineToRelative(0.95f, -0.32f);
        pathBuilder8.curveTo(15.18f, 9.72f, 16.0f, 8.57f, 16.0f, 7.28f);
        pathBuilder7.verticalLineTo(7.0f);
        pathBuilder7.horizontalLineToRelative(1.0f);
        pathBuilder7.verticalLineToRelative(0.28f);
        pathBuilder8.curveToRelative(0.0f, 1.29f, 0.82f, 2.44f, 2.05f, 2.85f);
        pathBuilder7.lineTo(20.0f, 10.44f);
