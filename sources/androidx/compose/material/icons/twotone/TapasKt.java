...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_tapas", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Tapas", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTapas", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TapasKt {
    ...
    public static final ImageVector getTapas(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Tapas", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.verticalLineToRelative(-2.0f);
        pathBuilder3.horizontalLineToRelative(-2.0f);
        pathBuilder3.verticalLineToRelative(-7.14f);
        pathBuilder4.curveTo(20.72f, 13.41f, 22.0f, 11.86f, 22.0f, 10.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(16.0f, 11.1f, 16.0f, 10.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.curveTo(12.5f, 4.12f, 11.38f, 3.0f, 10.0f, 3.0f);
        pathBuilder3.horizontalLineTo(8.0f);
        pathBuilder3.verticalLineTo(1.0f);
        pathBuilder3.horizontalLineTo(6.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder4.curveTo(2.62f, 3.0f, 1.5f, 4.12f, 1.5f, 5.5f);
        pathBuilder4.curveTo(1.5f, 6.88f, 2.62f, 8.0f, 4.0f, 8.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(1.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder4.curveToRelative(-1.38f, 0.0f, -2.5f, 1.12f, -2.5f, 2.5f);
        pathBuilder4.curveTo(1.5f, 12.88f, 2.62f, 14.0f, 4.0f, 14.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(9.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineToRelative(-9.0f);
        ...
        pathBuilder4.curveTo(3.72f, 6.0f, 3.5f, 5.78f, 3.5f, 5.5f);
        pathBuilder3.reflectiveCurveTo(3.72f, 5.0f, 4.0f, 5.0f);
        pathBuilder3.horizontalLineToRelative(6.0f);
        pathBuilder4.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilder3.reflectiveCurveTo(10.28f, 6.0f, 10.0f, 6.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(10.0f, 12.0f);
        pathBuilder3.horizontalLineTo(4.0f);
        pathBuilder4.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        pathBuilder3.reflectiveCurveTo(3.72f, 11.0f, 4.0f, 11.0f);
        pathBuilder3.horizontalLineToRelative(6.0f);
        pathBuilder4.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilder3.reflectiveCurveTo(10.28f, 12.0f, 10.0f, 12.0f);
        pathBuilder3.close();
