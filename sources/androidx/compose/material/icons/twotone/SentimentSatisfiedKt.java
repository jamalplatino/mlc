...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentSatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentSatisfied", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSentimentSatisfied", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SentimentSatisfiedKt {
    ...
    public static final ImageVector getSentimentSatisfied(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.SentimentSatisfied", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder8.moveTo(12.0f, 16.0f);
        pathBuilder8.curveToRelative(-1.48f, 0.0f, -2.75f, -0.81f, -3.45f, -2.0f);
        pathBuilder8.lineTo(6.88f, 14.0f);
        pathBuilder8.curveToRelative(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        pathBuilder8.reflectiveCurveToRelative(4.32f, -1.45f, 5.12f, -3.5f);
        pathBuilder8.horizontalLineToRelative(-1.67f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveToRelative(-0.7f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(11.99f, 2.0f);
        pathBuilder9.curveTo(6.47f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        pathBuilder8.reflectiveCurveToRelative(4.47f, 10.0f, 9.99f, 10.0f);
        pathBuilder8.curveTo(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        pathBuilder8.reflectiveCurveTo(17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(12.0f, 20.0f);
        pathBuilder8.curveToRelative(-4.42f, 0.0f, -8.0f, -3.58f, -8.0f, -8.0f);
        pathBuilder8.reflectiveCurveToRelative(3.58f, -8.0f, 8.0f, -8.0f);
        pathBuilder8.reflectiveCurveToRelative(8.0f, 3.58f, 8.0f, 8.0f);
        pathBuilder8.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilder8.close();
