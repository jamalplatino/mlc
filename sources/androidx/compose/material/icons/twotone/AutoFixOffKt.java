...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_autoFixOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AutoFixOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAutoFixOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AutoFixOffKt {
    ...
    public static final ImageVector getAutoFixOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.AutoFixOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(2.81f, 2.81f);
        pathBuilder5.lineTo(1.39f, 4.22f);
        pathBuilder5.lineToRelative(7.07f, 7.07f);
        pathBuilder5.lineToRelative(-6.17f, 6.17f);
        ...
        pathBuilder5.lineTo(2.81f, 2.81f);
        pathBuilder5.close();
        pathBuilder5.moveTo(5.83f, 19.59f);
        pathBuilder5.lineToRelative(-1.41f, -1.41f);
        pathBuilder5.lineToRelative(5.46f, -5.46f);
        pathBuilder5.lineToRelative(1.41f, 1.41f);
