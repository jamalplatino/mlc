...
public final class MobileScreenShareKt {
    ...
    public static final ImageVector getMobileScreenShare(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.MobileScreenShare", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-2.22f, 0.0f, -3.69f, 0.68f, -4.8f, 2.18f);
        pathBuilder2.curveToRelative(0.45f, -2.14f, 1.69f, -4.27f, 4.8f, -4.7f);
        pathBuilder.close();
        ...
        pathBuilder4.curveToRelative(-1.1f, 0.0f, -1.99f, 0.85f, -1.99f, 1.95f);
        pathBuilder3.verticalLineToRelative(18.0f);
        pathBuilder4.curveTo(5.01f, 22.05f, 5.9f, 23.0f, 7.0f, 23.0f);
        pathBuilder3.horizontalLineToRelative(10.0f);
        pathBuilder4.curveToRelative(1.1f, 0.0f, 2.0f, -0.95f, 2.0f, -2.05f);
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(12.8f, 13.24f);
        pathBuilder3.verticalLineToRelative(1.75f);
        pathBuilder3.lineTo(16.0f, 12.0f);
        pathBuilder3.lineToRelative(-3.2f, -2.98f);
        pathBuilder3.verticalLineToRelative(1.7f);
        pathBuilder4.curveToRelative(-3.11f, 0.43f, -4.35f, 2.56f, -4.8f, 4.7f);
        pathBuilder4.curveToRelative(1.11f, -1.5f, 2.58f, -2.18f, 4.8f, -2.18f);
        pathBuilder3.close();
