...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sportsGolf", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsGolf", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSportsGolf", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SportsGolfKt {
    ...
    public static final ImageVector getSportsGolf(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("TwoTone.SportsGolf", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(13.0f, 7.45f, 13.45f, 7.0f, 14.0f, 7.0f);
        pathBuilder.close();
        pathBuilder.moveTo(12.0f, 5.0f);
        pathBuilder2.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder2.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilder2.curveTo(11.0f, 5.45f, 11.45f, 5.0f, 12.0f, 5.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(5.0f, 12.87f, 8.13f, 16.0f, 12.0f, 16.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(9.24f, 4.0f, 12.0f, 4.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(10.0f, 8.0f);
        ...
        pathBuilder7.moveTo(14.0f, 8.0f);
        ...
        pathBuilder9.moveTo(12.0f, 6.0f);
        ...
        pathBuilder11.moveTo(7.0f, 19.0f);
