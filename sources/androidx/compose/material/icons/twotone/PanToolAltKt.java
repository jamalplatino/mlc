...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_panToolAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PanToolAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPanToolAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PanToolAltKt {
    ...
    public static final ImageVector getPanToolAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.PanToolAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(14.96f, 10.04f, 14.81f, 10.0f, 14.65f, 10.0f);
        pathBuilder2.horizontalLineTo(14.0f);
        pathBuilder2.verticalLineTo(5.5f);
        pathBuilder3.curveTo(14.0f, 4.12f, 12.88f, 3.0f, 11.5f, 3.0f);
        ...
        pathBuilder4.curveTo(9.49f, 20.79f, 10.0f, 21.0f, 10.53f, 21.0f);
        ...
        pathBuilder5.curveTo(20.12f, 13.03f, 19.68f, 12.17f, 18.89f, 11.77f);
        pathBuilder2.close();
        ...
        pathBuilder2.verticalLineTo(5.5f);
        pathBuilder5.curveTo(11.0f, 5.22f, 11.22f, 5.0f, 11.5f, 5.0f);
