...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("TwoTone.DirectionsBike", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.4f, 0.4f, -0.6f, 0.9f, -0.6f, 1.4f);
        pathBuilder2.curveToRelative(0.0f, 0.6f, 0.2f, 1.1f, 0.6f, 1.4f);
        pathBuilder.close();
