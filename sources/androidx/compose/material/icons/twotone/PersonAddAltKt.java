...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personAddAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonAddAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPersonAddAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonAddAltKt {
    ...
    public static final ImageVector getPersonAddAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.PersonAddAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(14.48f, 16.34f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveTo(13.29f, 15.73f, 11.37f, 15.0f, 9.0f, 15.0f);
        pathBuilder4.curveToRelative(-2.37f, 0.0f, -4.29f, 0.73f, -5.48f, 1.34f);
        pathBuilder4.curveTo(3.2f, 16.5f, 3.0f, 16.84f, 3.0f, 17.22f);
        pathBuilder3.verticalLineTo(18.0f);
        pathBuilder3.horizontalLineToRelative(12.0f);
        pathBuilder3.verticalLineToRelative(-0.78f);
        pathBuilder4.curveTo(15.0f, 16.84f, 14.8f, 16.5f, 14.48f, 16.34f);
        pathBuilder3.close();
        ...
        pathBuilder9.moveTo(15.39f, 14.56f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveTo(13.71f, 13.7f, 11.53f, 13.0f, 9.0f, 13.0f);
        pathBuilder10.curveToRelative(-2.53f, 0.0f, -4.71f, 0.7f, -6.39f, 1.56f);
        pathBuilder10.curveTo(1.61f, 15.07f, 1.0f, 16.1f, 1.0f, 17.22f);
        pathBuilder9.verticalLineTo(20.0f);
        pathBuilder9.horizontalLineToRelative(16.0f);
        pathBuilder9.verticalLineToRelative(-2.78f);
        pathBuilder10.curveTo(17.0f, 16.1f, 16.39f, 15.07f, 15.39f, 14.56f);
        pathBuilder9.close();
        pathBuilder9.moveTo(15.0f, 18.0f);
        ...
        pathBuilder10.curveTo(4.71f, 15.73f, 6.63f, 15.0f, 9.0f, 15.0f);
        pathBuilder10.curveToRelative(2.37f, 0.0f, 4.29f, 0.73f, 5.48f, 1.34f);
        pathBuilder10.curveTo(14.8f, 16.5f, 15.0f, 16.84f, 15.0f, 17.22f);
