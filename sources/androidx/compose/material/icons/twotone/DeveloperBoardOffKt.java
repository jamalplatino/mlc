...
public final class DeveloperBoardOffKt {
    ...
    public static final ImageVector getDeveloperBoardOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.DeveloperBoardOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.06f, 0.0f, 0.11f, 0.0f, 0.16f, -0.01f);
        ...
        pathBuilder3.curveTo(2.0f, 4.89f, 2.0f, 4.94f, 2.0f, 5.0f);
