...
public final class NotificationsPausedKt {
    ...
    public static final ImageVector getNotificationsPaused(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.NotificationsPaused", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(9.5f, 9.8f);
        pathBuilder3.horizontalLineToRelative(2.8f);
        pathBuilder3.lineToRelative(-2.8f, 3.4f);
        pathBuilder3.lineTo(9.5f, 15.0f);
        pathBuilder3.horizontalLineToRelative(5.0f);
        pathBuilder3.verticalLineToRelative(-1.8f);
        pathBuilder3.horizontalLineToRelative(-2.8f);
        pathBuilder3.lineToRelative(2.8f, -3.4f);
        pathBuilder3.lineTo(14.5f, 8.0f);
        pathBuilder3.horizontalLineToRelative(-5.0f);
        pathBuilder3.close();
