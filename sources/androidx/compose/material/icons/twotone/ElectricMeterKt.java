...
public final class ElectricMeterKt {
    ...
    public static final ImageVector getElectricMeter(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.ElectricMeter", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.0f, 3.92f, 2.51f, 7.24f, 6.0f, 8.48f);
        ...
        pathBuilder4.curveToRelative(3.49f, -1.24f, 6.0f, -4.56f, 6.0f, -8.48f);
        pathBuilder4.curveTo(21.0f, 6.03f, 16.97f, 2.0f, 12.0f, 2.0f);
        pathBuilder2.close();
        ...
        pathBuilder6.moveTo(12.75f, 10.0f);
        pathBuilder6.lineToRelative(-3.0f, 3.0f);
        pathBuilder6.lineToRelative(1.25f, 1.25f);
        pathBuilder6.lineToRelative(-1.25f, 1.25f);
