...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_agriculture", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Agriculture", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAgriculture", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AgricultureKt {
    ...
    public static final ImageVector getAgriculture(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Agriculture", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveToRelative(0.46f, 1.06f, 1.28f, 1.91f, 2.31f, 2.43f);
        pathBuilder3.lineToRelative(0.4f, -0.89f);
        pathBuilder3.lineToRelative(0.46f, 0.21f);
        pathBuilder3.lineToRelative(-0.4f, 0.9f);
        pathBuilder5.curveTo(4.74f, 19.87f, 5.36f, 20.0f, 6.0f, 20.0f);
        pathBuilder5.curveToRelative(0.53f, 0.0f, 1.04f, -0.11f, 1.52f, -0.26f);
        pathBuilder3.lineToRelative(-0.34f, -0.91f);
        pathBuilder3.lineToRelative(0.47f, -0.18f);
        ...
        pathBuilder3.lineToRelative(0.21f, -0.46f);
        pathBuilder3.lineToRelative(0.9f, 0.4f);
        pathBuilder5.curveToRelative(0.1f, -0.26f, 0.18f, -0.54f, 0.24f, -0.82f);
        pathBuilder3.horizontalLineToRelative(5.16f);
        pathBuilder5.curveTo(16.03f, 16.16f, 16.0f, 16.33f, 16.0f, 16.5f);
        ...
        pathBuilder6.curveTo(23.0f, 15.55f, 22.62f, 14.69f, 22.0f, 14.06f);
        pathBuilder3.close();
        ...
        pathBuilder7.curveToRelative(-0.04f, -0.18f, -0.08f, -0.35f, -0.13f, -0.52f);
        pathBuilder3.lineToRelative(-0.91f, 0.34f);
        pathBuilder3.lineToRelative(-0.18f, -0.47f);
        pathBuilder3.lineTo(10.58f, 13.0f);
        pathBuilder7.curveToRelative(0.0f, 0.0f, 0.42f, 0.0f, 0.42f, 0.0f);
        ...
        pathBuilder7.curveTo(19.84f, 13.03f, 19.67f, 13.0f, 19.5f, 13.0f);
        pathBuilder7.curveToRelative(-0.95f, 0.0f, -1.81f, 0.38f, -2.44f, 1.0f);
        ...
        pathBuilder8.moveTo(20.0f, 13.05f);
        ...
        pathBuilder9.curveToRelative(0.14f, 0.32f, 0.25f, 0.65f, 0.32f, 1.0f);
        pathBuilder8.horizontalLineToRelative(6.16f);
        PathBuilder pathBuilder10 = pathBuilder8;
        pathBuilder10.curveToRelative(0.63f, -0.62f, 1.49f, -1.0f, 2.44f, -1.0f);
        pathBuilder10.curveTo(19.67f, 13.0f, 19.84f, 13.03f, 20.0f, 13.05f);
        pathBuilder8.close();
        ImageVector build = ImageVector.Builder.m3530addPathoIyEayM$default(builder, pathBuilder8.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 0.3f, (Brush) null, 0.3f, 1.0f, r56, r57, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _agriculture = build;
