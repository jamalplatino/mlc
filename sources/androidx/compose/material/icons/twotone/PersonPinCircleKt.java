...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personPinCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonPinCircle", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPersonPinCircle", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonPinCircleKt {
    ...
    public static final ImageVector getPersonPinCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.PersonPinCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(1.33f, 0.0f, 4.0f, 0.67f, 4.0f, 2.0f);
        pathBuilder3.verticalLineToRelative(0.16f);
        pathBuilder4.curveTo(15.03f, 14.28f, 13.6f, 15.0f, 12.0f, 15.0f);
        pathBuilder3.reflectiveCurveToRelative(-3.03f, -0.72f, -4.0f, -1.84f);
        pathBuilder3.verticalLineTo(13.0f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(8.0f, 11.67f, 10.67f, 11.0f, 12.0f, 11.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(13.1f, 10.0f, 12.0f, 10.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.curveToRelative(4.2f, 0.0f, 8.0f, 3.22f, 8.0f, 8.2f);
        ...
        pathBuilder6.curveTo(4.0f, 5.22f, 7.8f, 2.0f, 12.0f, 2.0f);
        pathBuilder3.close();
