...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_switchAccount", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SwitchAccount", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSwitchAccount", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SwitchAccountKt {
    ...
    public static final ImageVector getSwitchAccount(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.SwitchAccount", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(11.0f, 9.66f, 12.34f, 11.0f, 14.0f, 11.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.reflectiveCurveTo(13.45f, 7.0f, 14.0f, 7.0f);
        pathBuilder3.close();
        ...
        pathBuilder3.close();
        pathBuilder3.moveTo(10.69f, 16.0f);
        pathBuilder4.curveToRelative(0.95f, -0.63f, 2.09f, -1.0f, 3.31f, -1.0f);
        pathBuilder3.reflectiveCurveToRelative(2.36f, 0.37f, 3.31f, 1.0f);
        pathBuilder3.horizontalLineTo(10.69f);
        pathBuilder3.close();
        pathBuilder3.moveTo(20.0f, 15.73f);
        pathBuilder4.curveTo(18.53f, 14.06f, 16.4f, 13.0f, 14.0f, 13.0f);
        pathBuilder3.reflectiveCurveToRelative(-4.53f, 1.06f, -6.0f, 2.73f);
        pathBuilder3.verticalLineTo(4.0f);
        pathBuilder3.horizontalLineToRelative(12.0f);
        pathBuilder3.verticalLineTo(15.73f);
        pathBuilder3.close();
