...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_train", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Train", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTrain", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Train", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.6f, -0.52f, -2.05f, -1.0f, -5.56f, -1.0f);
        pathBuilder.close();
        ...
        pathBuilder9.curveToRelative(-4.0f, 0.0f, -8.0f, 0.5f, -8.0f, 4.0f);
        pathBuilder8.verticalLineToRelative(9.5f);
        pathBuilder9.curveTo(4.0f, 17.43f, 5.57f, 19.0f, 7.5f, 19.0f);
        pathBuilder8.lineTo(6.0f, 20.5f);
        ...
        pathBuilder8.horizontalLineToRelative(2.0f);
        pathBuilder8.verticalLineToRelative(-0.5f);
        pathBuilder8.lineTo(16.5f, 19.0f);
        pathBuilder9.curveToRelative(1.93f, 0.0f, 3.5f, -1.57f, 3.5f, -3.5f);
        pathBuilder8.lineTo(20.0f, 6.0f);
        pathBuilder9.curveToRelative(0.0f, -3.5f, -4.0f, -4.0f, -8.0f, -4.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(12.0f, 4.0f);
        pathBuilder9.curveToRelative(3.51f, 0.0f, 4.96f, 0.48f, 5.57f, 1.0f);
        pathBuilder8.lineTo(6.43f, 5.0f);
        pathBuilder9.curveToRelative(0.61f, -0.52f, 2.06f, -1.0f, 5.57f, -1.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(6.0f, 7.0f);
        pathBuilder8.horizontalLineToRelative(5.0f);
        pathBuilder8.verticalLineToRelative(3.0f);
        pathBuilder8.lineTo(6.0f, 10.0f);
        pathBuilder8.lineTo(6.0f, 7.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(18.0f, 15.5f);
        pathBuilder9.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilder8.horizontalLineToRelative(-9.0f);
        pathBuilder9.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilder8.lineTo(6.0f, 12.0f);
        pathBuilder8.horizontalLineToRelative(12.0f);
        pathBuilder8.verticalLineToRelative(3.5f);
        pathBuilder8.close();
        pathBuilder8.moveTo(18.0f, 10.0f);
        pathBuilder8.horizontalLineToRelative(-5.0f);
        pathBuilder8.lineTo(13.0f, 7.0f);
        pathBuilder8.horizontalLineToRelative(5.0f);
        pathBuilder8.verticalLineToRelative(3.0f);
        pathBuilder8.close();
