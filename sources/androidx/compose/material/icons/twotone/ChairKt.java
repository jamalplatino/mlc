...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_chair", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Chair", "Landroidx/compose/material/icons/Icons$TwoTone;", "getChair", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ChairKt {
    ...
    public static final ImageVector getChair(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Chair", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(6.45f, 5.0f, 6.0f, 5.45f, 6.0f, 6.0f);
        pathBuilder.verticalLineToRelative(2.78f);
        pathBuilder2.curveTo(6.61f, 9.33f, 7.0f, 10.12f, 7.0f, 11.0f);
        ...
        pathBuilder4.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder3.verticalLineToRelative(-5.0f);
        pathBuilder4.curveTo(21.0f, 10.45f, 20.55f, 10.0f, 20.0f, 10.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(20.0f, 8.0f);
        ...
        pathBuilder6.curveTo(5.35f, 3.0f, 4.0f, 4.35f, 4.0f, 6.0f);
        ...
        pathBuilder5.verticalLineToRelative(-5.0f);
        pathBuilder7.curveTo(23.0f, 9.35f, 21.65f, 8.0f, 20.0f, 8.0f);
        pathBuilder5.close();
        ...
        pathBuilder8.curveToRelative(-0.61f, 0.55f, -1.0f, 1.34f, -1.0f, 2.22f);
        pathBuilder5.verticalLineToRelative(2.0f);
        pathBuilder5.horizontalLineTo(7.0f);
        pathBuilder5.verticalLineToRelative(-2.0f);
        ...
        pathBuilder5.verticalLineTo(6.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(21.0f, 16.0f);
