...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personRemove", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonRemove", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPersonRemove", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonRemoveKt {
    ...
    public static final ImageVector getPersonRemove(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("TwoTone.PersonRemove", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(4.2f, 17.29f, 7.3f, 16.0f, 10.0f, 16.0f);
        pathBuilder.close();
        ...
        pathBuilder5.moveTo(14.0f, 8.0f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(0.0f, -2.21f, -1.79f, -4.0f, -4.0f, -4.0f);
        pathBuilder6.curveTo(7.79f, 4.0f, 6.0f, 5.79f, 6.0f, 8.0f);
        pathBuilder6.curveToRelative(0.0f, 2.21f, 1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilder6.curveTo(12.21f, 12.0f, 14.0f, 10.21f, 14.0f, 8.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.curveTo(11.1f, 6.0f, 12.0f, 6.9f, 12.0f, 8.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(2.0f, 18.0f);
        pathBuilder7.verticalLineToRelative(2.0f);
        pathBuilder7.horizontalLineToRelative(16.0f);
        pathBuilder7.verticalLineToRelative(-2.0f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(0.0f, -2.66f, -5.33f, -4.0f, -8.0f, -4.0f);
        pathBuilder8.curveTo(7.33f, 14.0f, 2.0f, 15.34f, 2.0f, 18.0f);
        pathBuilder7.close();
        pathBuilder7.moveTo(4.0f, 18.0f);
        pathBuilder8.curveToRelative(0.2f, -0.71f, 3.3f, -2.0f, 6.0f, -2.0f);
        pathBuilder8.curveToRelative(2.69f, 0.0f, 5.77f, 1.28f, 6.0f, 2.0f);
        ...
        pathBuilder9.moveTo(17.0f, 10.0f);
