...
public final class SimCardDownloadKt {
    ...
    public static final ImageVector getSimCardDownload(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Outlined.SimCardDownload", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.lineTo(11.0f, 13.17f);
        pathBuilder3.verticalLineTo(9.02f);
        pathBuilder3.lineTo(13.0f, 9.0f);
        pathBuilder3.verticalLineToRelative(4.17f);
        pathBuilder3.lineToRelative(1.59f, -1.59f);
        pathBuilder3.lineTo(16.0f, 13.0f);
        pathBuilder3.close();
