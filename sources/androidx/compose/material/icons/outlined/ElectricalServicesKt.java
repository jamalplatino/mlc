...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_electricalServices", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElectricalServices", "Landroidx/compose/material/icons/Icons$Outlined;", "getElectricalServices", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ElectricalServicesKt {
    ...
    public static final ImageVector getElectricalServices(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.ElectricalServices", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.horizontalLineToRelative(-3.0f);
        pathBuilder5.curveTo(12.9f, 12.0f, 12.0f, 12.9f, 12.0f, 14.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(5.0f, 13.0f);
        ...
        pathBuilder6.reflectiveCurveTo(10.43f, 4.0f, 8.5f, 4.0f);
        pathBuilder6.horizontalLineTo(5.0f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveTo(4.45f, 4.0f, 4.0f, 4.45f, 4.0f, 5.0f);
        pathBuilder7.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder6.horizontalLineToRelative(3.5f);
        pathBuilder7.curveTo(9.33f, 6.0f, 10.0f, 6.67f, 10.0f, 7.5f);
        pathBuilder6.reflectiveCurveTo(9.33f, 9.0f, 8.5f, 9.0f);
        ...
        pathBuilder6.horizontalLineTo(7.0f);
        pathBuilder8.curveTo(5.9f, 15.0f, 5.0f, 14.1f, 5.0f, 13.0f);
        pathBuilder6.close();
