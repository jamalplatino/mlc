...
public final class AssignmentIndKt {
    ...
    public static final ImageVector getAssignmentInd(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.AssignmentInd", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.22f, 0.0f, 0.41f, 0.1f, 0.55f, 0.25f);
        pathBuilder3.curveToRelative(0.12f, 0.13f, 0.2f, 0.31f, 0.2f, 0.5f);
        ...
        pathBuilder4.curveToRelative(0.0f, -0.19f, 0.08f, -0.37f, 0.2f, -0.5f);
        pathBuilder4.curveToRelative(0.14f, -0.15f, 0.33f, -0.25f, 0.55f, -0.25f);
        pathBuilder.close();
