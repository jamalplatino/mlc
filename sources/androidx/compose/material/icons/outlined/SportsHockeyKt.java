...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sportsHockey", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SportsHockey", "Landroidx/compose/material/icons/Icons$Outlined;", "getSportsHockey", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SportsHockeyKt {
    ...
    public static final ImageVector getSportsHockey(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.SportsHockey", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(21.53f, 16.11f, 21.28f, 16.0f, 21.0f, 16.0f);
        pathBuilder3.horizontalLineToRelative(-1.0f);
        pathBuilder3.verticalLineToRelative(4.0f);
        pathBuilder3.lineToRelative(2.0f, 0.0f);
        pathBuilder3.verticalLineToRelative(-3.0f);
        pathBuilder4.curveTo(22.0f, 16.72f, 21.89f, 16.47f, 21.71f, 16.29f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(13.6f, 12.84f);
        pathBuilder5.lineTo(17.65f, 4.0f);
        pathBuilder5.horizontalLineTo(14.3f);
        pathBuilder5.lineToRelative(-1.76f, 3.97f);
        pathBuilder5.lineToRelative(-0.49f, 1.1f);
        pathBuilder5.lineTo(12.0f, 9.21f);
        pathBuilder5.lineTo(9.7f, 4.0f);
        pathBuilder5.horizontalLineTo(6.35f);
        pathBuilder5.lineToRelative(4.05f, 8.84f);
        pathBuilder5.lineToRelative(1.52f, 3.32f);
        pathBuilder5.lineTo(12.0f, 16.34f);
        pathBuilder5.lineToRelative(1.42f, 3.1f);
        pathBuilder5.curveToRelative(0.17f, 0.34f, 0.51f, 0.55f, 0.89f, 0.55f);
        pathBuilder5.lineTo(19.0f, 20.0f);
        pathBuilder5.verticalLineToRelative(-4.0f);
        pathBuilder5.horizontalLineToRelative(-4.0f);
        pathBuilder5.lineTo(13.6f, 12.84f);
        pathBuilder5.close();
