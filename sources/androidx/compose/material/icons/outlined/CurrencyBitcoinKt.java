...
public final class CurrencyBitcoinKt {
    ...
    public static final ImageVector getCurrencyBitcoin(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.CurrencyBitcoin", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(19.0f, 13.55f, 18.22f, 12.27f, 17.06f, 11.57f);
        pathBuilder.close();
