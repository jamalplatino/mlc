...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_kayaking", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Kayaking", "Landroidx/compose/material/icons/Icons$Outlined;", "getKayaking", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class KayakingKt {
    ...
    public static final ImageVector getKayaking(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.Kayaking", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.0f, 0.0f, -1.52f, 0.71f, -3.93f, 1.37f);
        pathBuilder3.curveToRelative(-0.82f, -0.23f, -1.53f, -0.75f, -2.07f, -1.37f);
        pathBuilder3.curveToRelative(-0.73f, 0.84f, -1.8f, 1.5f, -3.0f, 1.5f);
        pathBuilder.reflectiveCurveToRelative(-2.27f, -0.66f, -3.0f, -1.5f);
        pathBuilder3.curveToRelative(-0.73f, 0.84f, -1.8f, 1.5f, -3.0f, 1.5f);
        pathBuilder.reflectiveCurveToRelative(-2.27f, -0.66f, -3.0f, -1.5f);
        pathBuilder3.curveToRelative(-0.54f, 0.61f, -1.25f, 1.13f, -2.07f, 1.37f);
        pathBuilder3.curveTo(1.52f, 18.21f, 0.0f, 17.5f, 0.0f, 17.5f);
        pathBuilder.reflectiveCurveToRelative(2.93f, -1.36f, 7.13f, -2.08f);
        pathBuilder.lineToRelative(1.35f, -4.17f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveToRelative(0.31f, -0.95f, 1.32f, -1.47f, 2.27f, -1.16f);
        pathBuilder4.curveToRelative(0.09f, 0.03f, 0.19f, 0.07f, 0.27f, 0.11f);
        ...
        pathBuilder5.curveTo(11.36f, 15.01f, 11.68f, 15.0f, 12.0f, 15.0f);
        pathBuilder5.curveToRelative(0.71f, 0.0f, 1.4f, 0.03f, 2.07f, 0.08f);
