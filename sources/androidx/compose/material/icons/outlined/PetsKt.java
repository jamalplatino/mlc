...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_pets", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Pets", "Landroidx/compose/material/icons/Icons$Outlined;", "getPets", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PetsKt {
    ...
    public static final ImageVector getPets(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Outlined.Pets", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(15.0f, 5.5f);
        ...
        pathBuilder7.moveTo(19.5f, 9.5f);
        ...
        pathBuilder9.moveTo(17.34f, 14.86f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveToRelative(-0.87f, -1.02f, -1.6f, -1.89f, -2.48f, -2.91f);
        pathBuilder10.curveToRelative(-0.46f, -0.54f, -1.05f, -1.08f, -1.75f, -1.32f);
        pathBuilder10.curveToRelative(-0.11f, -0.04f, -0.22f, -0.07f, -0.33f, -0.09f);
        pathBuilder10.curveToRelative(-0.25f, -0.04f, -0.52f, -0.04f, -0.78f, -0.04f);
        pathBuilder9.reflectiveCurveToRelative(-0.53f, 0.0f, -0.79f, 0.05f);
        PathBuilder pathBuilder11 = pathBuilder9;
        pathBuilder11.curveToRelative(-0.11f, 0.02f, -0.22f, 0.05f, -0.33f, 0.09f);
        pathBuilder11.curveToRelative(-0.7f, 0.24f, -1.28f, 0.78f, -1.75f, 1.32f);
        pathBuilder11.curveToRelative(-0.87f, 1.02f, -1.6f, 1.89f, -2.48f, 2.91f);
        pathBuilder11.curveToRelative(-1.31f, 1.31f, -2.92f, 2.76f, -2.62f, 4.79f);
        pathBuilder11.curveToRelative(0.29f, 1.02f, 1.02f, 2.03f, 2.33f, 2.32f);
        pathBuilder11.curveToRelative(0.73f, 0.15f, 3.06f, -0.44f, 5.54f, -0.44f);
        pathBuilder9.horizontalLineToRelative(0.18f);
        PathBuilder pathBuilder12 = pathBuilder9;
        pathBuilder12.curveToRelative(2.48f, 0.0f, 4.81f, 0.58f, 5.54f, 0.44f);
        pathBuilder12.curveToRelative(1.31f, -0.29f, 2.04f, -1.31f, 2.33f, -2.32f);
        pathBuilder12.curveToRelative(0.31f, -2.04f, -1.3f, -3.49f, -2.61f, -4.8f);
        pathBuilder9.close();
