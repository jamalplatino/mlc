...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_kebabDining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "KebabDining", "Landroidx/compose/material/icons/Icons$Outlined;", "getKebabDining", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class KebabDiningKt {
    ...
    public static final ImageVector getKebabDining(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.KebabDining", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveTo(9.88f, 7.0f, 11.0f, 5.88f, 11.0f, 4.5f);
        pathBuilder5.curveTo(11.0f, 3.12f, 9.88f, 2.0f, 8.5f, 2.0f);
        ...
        pathBuilder6.curveTo(4.12f, 2.0f, 3.0f, 3.12f, 3.0f, 4.5f);
        pathBuilder6.curveTo(3.0f, 5.88f, 4.12f, 7.0f, 5.5f, 7.0f);
        pathBuilder.horizontalLineToRelative(0.75f);
        pathBuilder.verticalLineToRelative(1.0f);
        ...
        pathBuilder7.curveTo(4.12f, 14.0f, 3.0f, 15.12f, 3.0f, 16.5f);
        pathBuilder7.curveTo(3.0f, 17.88f, 4.12f, 19.0f, 5.5f, 19.0f);
        pathBuilder.horizontalLineToRelative(0.75f);
        pathBuilder.verticalLineToRelative(4.0f);
        pathBuilder.horizontalLineToRelative(1.5f);
        pathBuilder.verticalLineToRelative(-4.0f);
