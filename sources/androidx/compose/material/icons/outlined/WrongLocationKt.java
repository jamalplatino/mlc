...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wrongLocation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WrongLocation", "Landroidx/compose/material/icons/Icons$Outlined;", "getWrongLocation", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class WrongLocationKt {
    ...
    public static final ImageVector getWrongLocation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.WrongLocation", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(6.0f, 7.57f, 8.65f, 5.0f, 12.0f, 5.0f);
        pathBuilder2.curveToRelative(0.34f, 0.0f, 0.68f, 0.03f, 1.0f, 0.08f);
        pathBuilder.verticalLineTo(3.06f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveTo(12.67f, 3.02f, 12.34f, 3.0f, 12.0f, 3.0f);
        ...
        pathBuilder3.curveToRelative(0.0f, -0.07f, 0.0f, -0.13f, 0.0f, -0.2f);
        ...
        pathBuilder6.moveTo(22.54f, 2.88f);
        pathBuilder6.lineToRelative(-1.42f, -1.42f);
        pathBuilder6.lineToRelative(-2.12f, 2.13f);
        pathBuilder6.lineToRelative(-2.12f, -2.13f);
        pathBuilder6.lineToRelative(-1.42f, 1.42f);
        pathBuilder6.lineToRelative(2.13f, 2.12f);
        pathBuilder6.lineToRelative(-2.13f, 2.12f);
        pathBuilder6.lineToRelative(1.42f, 1.42f);
        pathBuilder6.lineToRelative(2.12f, -2.13f);
        pathBuilder6.lineToRelative(2.12f, 2.13f);
