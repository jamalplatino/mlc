...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bugReport", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BugReport", "Landroidx/compose/material/icons/Icons$Outlined;", "getBugReport", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BugReportKt {
    ...
    public static final ImageVector getBugReport(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.BugReport", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(-0.72f, 1.24f, -2.04f, 2.0f, -3.46f, 2.0f);
        pathBuilder.reflectiveCurveToRelative(-2.74f, -0.77f, -3.46f, -2.0f);
        pathBuilder.lineToRelative(-0.37f, -0.64f);
        pathBuilder.lineToRelative(-0.1f, -0.65f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveTo(8.03f, 15.48f, 8.0f, 15.23f, 8.0f, 15.0f);
        pathBuilder.verticalLineToRelative(-4.0f);
        pathBuilder4.curveToRelative(0.0f, -0.23f, 0.03f, -0.48f, 0.07f, -0.7f);
        pathBuilder.lineToRelative(0.1f, -0.65f);
        pathBuilder.lineToRelative(0.37f, -0.65f);
        ...
        pathBuilder5.curveToRelative(0.31f, -0.08f, 0.63f, -0.12f, 0.94f, -0.12f);
        pathBuilder5.curveToRelative(0.32f, 0.0f, 0.63f, 0.04f, 0.95f, 0.12f);
