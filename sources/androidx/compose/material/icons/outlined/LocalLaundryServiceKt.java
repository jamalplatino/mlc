...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localLaundryService", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalLaundryService", "Landroidx/compose/material/icons/Icons$Outlined;", "getLocalLaundryService", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LocalLaundryServiceKt {
    ...
    public static final ImageVector getLocalLaundryService(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.LocalLaundryService", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(11.0f, 6.0f);
        ...
        pathBuilder7.moveTo(12.0f, 19.0f);
        ...
        pathBuilder7.reflectiveCurveToRelative(2.24f, 5.0f, 5.0f, 5.0f);
        pathBuilder7.close();
        pathBuilder7.moveTo(14.36f, 11.64f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(1.3f, 1.3f, 1.3f, 3.42f, 0.0f, 4.72f);
        pathBuilder8.curveToRelative(-1.3f, 1.3f, -3.42f, 1.3f, -4.72f, 0.0f);
        pathBuilder7.lineToRelative(4.72f, -4.72f);
        pathBuilder7.close();
