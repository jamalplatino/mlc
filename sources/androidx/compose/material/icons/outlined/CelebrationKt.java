...
public final class CelebrationKt {
    ...
    public static final ImageVector getCelebration(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Outlined.Celebration", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(10.06f, 6.88f);
        ...
        pathBuilder4.lineToRelative(0.59f, 0.59f);
        pathBuilder5.curveTo(10.54f, 5.6f, 10.54f, 6.4f, 10.06f, 6.88f);
        pathBuilder4.close();
