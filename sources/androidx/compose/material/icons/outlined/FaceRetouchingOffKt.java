...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_faceRetouchingOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FaceRetouchingOff", "Landroidx/compose/material/icons/Icons$Outlined;", "getFaceRetouchingOff", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class FaceRetouchingOffKt {
    ...
    public static final ImageVector getFaceRetouchingOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.FaceRetouchingOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(17.5f, 10.0f);
        ...
        pathBuilder4.curveToRelative(0.0f, 1.22f, -0.28f, 2.37f, -0.77f, 3.4f);
        pathBuilder3.lineToRelative(1.49f, 1.49f);
        pathBuilder4.curveTo(21.53f, 15.44f, 22.0f, 13.78f, 22.0f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, -5.52f, -4.48f, -10.0f, -10.0f, -10.0f);
        pathBuilder4.curveToRelative(-1.78f, 0.0f, -3.44f, 0.47f, -4.89f, 1.28f);
        pathBuilder3.lineToRelative(5.33f, 5.33f);
        pathBuilder4.curveTo(13.93f, 9.49f, 15.65f, 10.0f, 17.5f, 10.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(10.66f, 4.12f);
        ...
        pathBuilder4.curveTo(14.6f, 8.0f, 12.06f, 6.44f, 10.66f, 4.12f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(1.89f, 3.72f);
        pathBuilder5.lineToRelative(2.19f, 2.19f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(2.78f, 7.6f, 2.0f, 9.71f, 2.0f, 12.0f);
        pathBuilder6.curveToRelative(0.0f, 5.52f, 4.48f, 10.0f, 10.0f, 10.0f);
        pathBuilder6.curveToRelative(2.29f, 0.0f, 4.4f, -0.78f, 6.09f, -2.08f);
        pathBuilder5.lineToRelative(2.19f, 2.19f);
        pathBuilder5.lineToRelative(1.41f, -1.41f);
        pathBuilder5.lineTo(3.31f, 2.31f);
        pathBuilder5.lineTo(1.89f, 3.72f);
        pathBuilder5.close();
        pathBuilder5.moveTo(16.66f, 18.49f);
        PathBuilder pathBuilder7 = pathBuilder5;
        pathBuilder7.curveTo(15.35f, 19.44f, 13.74f, 20.0f, 12.0f, 20.0f);
        ...
        pathBuilder7.curveToRelative(1.39f, -0.52f, 2.63f, -1.35f, 3.64f, -2.39f);
        pathBuilder5.lineTo(16.66f, 18.49f);
        pathBuilder5.close();
        pathBuilder5.moveTo(6.23f, 8.06f);
        pathBuilder7.curveTo(5.7f, 8.61f, 5.09f, 9.09f, 4.42f, 9.47f);
        pathBuilder7.curveTo(4.68f, 8.7f, 5.05f, 7.99f, 5.51f, 7.34f);
        pathBuilder5.lineTo(6.23f, 8.06f);
        pathBuilder5.close();
