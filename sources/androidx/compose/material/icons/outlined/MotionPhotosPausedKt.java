...
public final class MotionPhotosPausedKt {
    ...
    public static final ImageVector getMotionPhotosPaused(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.MotionPhotosPaused", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(4.17f, 10.14f, 4.0f, 11.05f, 4.0f, 12.0f);
        ...
        pathBuilder3.curveTo(9.69f, 2.22f, 10.82f, 2.0f, 12.0f, 2.0f);
        pathBuilder3.curveTo(17.52f, 2.0f, 22.0f, 6.48f, 22.0f, 12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(5.5f, 4.0f);
        pathBuilder3.curveTo(4.67f, 4.0f, 4.0f, 4.67f, 4.0f, 5.5f);
