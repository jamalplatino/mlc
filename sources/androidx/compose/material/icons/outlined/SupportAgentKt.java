...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_supportAgent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SupportAgent", "Landroidx/compose/material/icons/Icons$Outlined;", "getSupportAgent", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SupportAgentKt {
    ...
    public static final ImageVector getSupportAgent(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.SupportAgent", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(21.0f, 12.22f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveTo(21.0f, 6.73f, 16.74f, 3.0f, 12.0f, 3.0f);
        pathBuilder2.curveToRelative(-4.69f, 0.0f, -9.0f, 3.65f, -9.0f, 9.28f);
        pathBuilder2.curveTo(2.4f, 12.62f, 2.0f, 13.26f, 2.0f, 14.0f);
        ...
        pathBuilder3.curveToRelative(0.59f, -0.31f, 1.0f, -0.92f, 1.0f, -1.64f);
        pathBuilder.verticalLineToRelative(-2.3f);
        pathBuilder3.curveTo(22.0f, 13.14f, 21.59f, 12.53f, 21.0f, 12.22f);
        pathBuilder.close();
        ...
        pathBuilder8.moveTo(18.0f, 11.03f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveTo(17.52f, 8.18f, 15.04f, 6.0f, 12.05f, 6.0f);
        pathBuilder9.curveToRelative(-3.03f, 0.0f, -6.29f, 2.51f, -6.03f, 6.45f);
        pathBuilder9.curveToRelative(2.47f, -1.01f, 4.33f, -3.21f, 4.86f, -5.89f);
        pathBuilder9.curveTo(12.19f, 9.19f, 14.88f, 11.0f, 18.0f, 11.03f);
        pathBuilder8.close();
