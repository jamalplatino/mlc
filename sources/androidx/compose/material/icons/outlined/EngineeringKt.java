...
public final class EngineeringKt {
    ...
    public static final ImageVector getEngineering(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.Engineering", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(4.74f, 9.0f);
        ...
        pathBuilder3.horizontalLineToRelative(0.26f);
        pathBuilder3.curveToRelative(0.27f, 0.0f, 0.49f, -0.22f, 0.49f, -0.49f);
        pathBuilder3.verticalLineTo(8.49f);
        ...
        pathBuilder3.reflectiveCurveTo(10.0f, 5.78f, 10.0f, 5.5f);
        pathBuilder3.verticalLineTo(4.14f);
        pathBuilder4.curveTo(9.68f, 4.06f, 9.35f, 4.0f, 9.0f, 4.0f);
        pathBuilder3.reflectiveCurveTo(8.32f, 4.06f, 8.0f, 4.14f);
        pathBuilder3.verticalLineTo(5.5f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(8.0f, 5.78f, 7.78f, 6.0f, 7.5f, 6.0f);
        pathBuilder3.reflectiveCurveTo(7.0f, 5.78f, 7.0f, 5.5f);
        pathBuilder3.verticalLineTo(4.55f);
        pathBuilder5.curveTo(5.81f, 5.25f, 5.0f, 6.52f, 5.0f, 8.0f);
        pathBuilder3.horizontalLineTo(4.74f);
        pathBuilder5.curveTo(4.47f, 8.0f, 4.25f, 8.22f, 4.25f, 8.49f);
        pathBuilder3.verticalLineToRelative(0.03f);
        pathBuilder5.curveTo(4.25f, 8.78f, 4.47f, 9.0f, 4.74f, 9.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.moveTo(21.98f, 6.23f);
        pathBuilder6.lineToRelative(0.93f, -0.83f);
        pathBuilder6.lineToRelative(-0.75f, -1.3f);
        pathBuilder6.lineToRelative(-1.19f, 0.39f);
        pathBuilder6.curveToRelative(-0.14f, -0.11f, -0.3f, -0.2f, -0.47f, -0.27f);
        pathBuilder6.lineTo(20.25f, 3.0f);
        pathBuilder6.horizontalLineToRelative(-1.5f);
        pathBuilder6.lineTo(18.5f, 4.22f);
        pathBuilder6.curveToRelative(-0.17f, 0.07f, -0.33f, 0.16f, -0.48f, 0.27f);
        pathBuilder6.lineTo(16.84f, 4.1f);
        pathBuilder6.lineToRelative(-0.75f, 1.3f);
        pathBuilder6.lineToRelative(0.93f, 0.83f);
        pathBuilder6.curveTo(17.0f, 6.4f, 17.0f, 6.58f, 17.02f, 6.75f);
        pathBuilder6.lineTo(16.09f, 7.6f);
        pathBuilder6.lineToRelative(0.75f, 1.3f);
        pathBuilder6.lineToRelative(1.2f, -0.38f);
        pathBuilder6.curveToRelative(0.13f, 0.1f, 0.28f, 0.18f, 0.43f, 0.25f);
        pathBuilder6.lineTo(18.75f, 10.0f);
        pathBuilder6.horizontalLineToRelative(1.5f);
        pathBuilder6.lineToRelative(0.27f, -1.22f);
        pathBuilder6.curveToRelative(0.16f, -0.07f, 0.3f, -0.15f, 0.44f, -0.25f);
        pathBuilder6.lineToRelative(1.19f, 0.38f);
        pathBuilder6.lineToRelative(0.75f, -1.3f);
        pathBuilder6.lineToRelative(-0.93f, -0.85f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveTo(22.0f, 6.57f, 21.99f, 6.4f, 21.98f, 6.23f);
        pathBuilder6.close();
        pathBuilder6.moveTo(19.5f, 7.75f);
        pathBuilder7.curveToRelative(-0.69f, 0.0f, -1.25f, -0.56f, -1.25f, -1.25f);
        pathBuilder6.reflectiveCurveToRelative(0.56f, -1.25f, 1.25f, -1.25f);
        pathBuilder6.reflectiveCurveToRelative(1.25f, 0.56f, 1.25f, 1.25f);
        pathBuilder6.reflectiveCurveTo(20.19f, 7.75f, 19.5f, 7.75f);
        pathBuilder6.close();
        ...
        pathBuilder9.curveToRelative(0.1f, 0.07f, 0.2f, 0.13f, 0.31f, 0.18f);
