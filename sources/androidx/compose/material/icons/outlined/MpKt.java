...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Mp", "Landroidx/compose/material/icons/Icons$Outlined;", "getMp", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
/* compiled from: Mp.kt */
public final class MpKt {
    ...
    public static final ImageVector getMp(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.Mp", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(18.0f, 9.45f, 17.55f, 9.0f, 17.0f, 9.0f);
        pathBuilder.close();
        ...
        pathBuilder3.horizontalLineToRelative(1.5f);
        pathBuilder3.verticalLineToRelative(-5.0f);
        pathBuilder3.curveTo(12.5f, 9.45f, 12.05f, 9.0f, 11.5f, 9.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.lineTo(5.0f, 5.0f);
        pathBuilder4.horizontalLineToRelative(14.0f);
        pathBuilder4.lineToRelative(0.0f, 14.0f);
        pathBuilder4.lineTo(5.0f, 19.0f);
        pathBuilder4.close();
