...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_emojiObjects", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EmojiObjects", "Landroidx/compose/material/icons/Icons$Outlined;", "getEmojiObjects", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class EmojiObjectsKt {
    ...
    public static final ImageVector getEmojiObjects(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.EmojiObjects", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(12.0f, 3.0f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(-0.46f, 0.0f, -0.93f, 0.04f, -1.4f, 0.14f);
        pathBuilder2.curveTo(7.84f, 3.67f, 5.64f, 5.9f, 5.12f, 8.66f);
        ...
        pathBuilder4.curveToRelative(-0.08f, -0.09f, -0.15f, -0.19f, -0.24f, -0.27f);
        pathBuilder4.curveToRelative(-1.32f, -1.18f, -1.91f, -2.94f, -1.59f, -4.7f);
        pathBuilder4.curveToRelative(0.36f, -1.94f, 1.96f, -3.55f, 3.89f, -3.93f);
        pathBuilder4.curveTo(11.32f, 5.03f, 11.66f, 5.0f, 12.0f, 5.0f);
        pathBuilder4.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        pathBuilder4.curveTo(17.0f, 11.43f, 16.39f, 12.79f, 15.31f, 13.74f);
        pathBuilder.close();
        ...
        pathBuilder5.moveTo(11.5f, 11.0f);
        ...
        pathBuilder6.moveTo(9.672f, 9.581f);
        ...
        pathBuilder7.moveTo(12.208f, 11.712f);
