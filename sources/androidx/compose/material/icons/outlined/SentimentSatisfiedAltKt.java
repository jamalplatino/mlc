...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentSatisfiedAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentSatisfiedAlt", "Landroidx/compose/material/icons/Icons$Outlined;", "getSentimentSatisfiedAlt", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SentimentSatisfiedAltKt {
    ...
    public static final ImageVector getSentimentSatisfiedAlt(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.SentimentSatisfiedAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveToRelative(-1.48f, 0.0f, -2.75f, -0.81f, -3.45f, -2.0f);
        pathBuilder5.lineTo(6.88f, 14.0f);
        pathBuilder5.curveToRelative(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        pathBuilder5.reflectiveCurveToRelative(4.32f, -1.45f, 5.12f, -3.5f);
