...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulbCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LightbulbCircle", "Landroidx/compose/material/icons/Icons$Outlined;", "getLightbulbCircle", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LightbulbCircleKt {
    ...
    public static final ImageVector getLightbulbCircle(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.LightbulbCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.curveToRelative(0.0f, 1.64f, 0.8f, 3.09f, 2.03f, 4.0f);
        pathBuilder5.horizontalLineToRelative(5.95f);
        pathBuilder6.curveTo(16.2f, 13.09f, 17.0f, 11.64f, 17.0f, 10.0f);
        pathBuilder6.curveTo(17.0f, 7.24f, 14.76f, 5.0f, 12.0f, 5.0f);
        pathBuilder5.close();
        pathBuilder5.moveTo(14.43f, 12.5f);
        pathBuilder5.horizontalLineTo(9.57f);
        PathBuilder pathBuilder7 = pathBuilder5;
        pathBuilder7.curveTo(8.89f, 11.84f, 8.5f, 10.95f, 8.5f, 10.0f);
