...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_face4", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Face4", "Landroidx/compose/material/icons/Icons$Outlined;", "getFace4", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Face4Kt {
    ...
    public static final ImageVector getFace4(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.Face4", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(12.0f, 2.0f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(-0.96f, 0.0f, -1.88f, 0.14f, -2.75f, 0.39f);
        pathBuilder2.curveTo(8.37f, 0.96f, 6.8f, 0.0f, 5.0f, 0.0f);
        pathBuilder2.curveTo(2.24f, 0.0f, 0.0f, 2.24f, 0.0f, 5.0f);
        pathBuilder2.curveToRelative(0.0f, 1.8f, 0.96f, 3.37f, 2.39f, 4.25f);
        pathBuilder2.curveTo(2.14f, 10.12f, 2.0f, 11.04f, 2.0f, 12.0f);
        ...
        pathBuilder3.curveToRelative(2.9f, 0.0f, 5.44f, 1.56f, 6.84f, 3.88f);
        pathBuilder3.curveTo(18.41f, 7.95f, 17.96f, 8.0f, 17.5f, 8.0f);
        pathBuilder3.curveToRelative(-2.9f, 0.0f, -5.44f, -1.56f, -6.84f, -3.88f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder3.curveTo(11.09f, 4.05f, 11.54f, 4.0f, 12.0f, 4.0f);
        pathBuilder.close();
        ...
        pathBuilder5.curveToRelative(0.95f, 0.0f, 1.8f, 0.46f, 2.35f, 1.15f);
        pathBuilder5.curveTo(5.56f, 4.09f, 4.09f, 5.56f, 3.15f, 7.35f);
        pathBuilder5.curveTo(2.46f, 6.8f, 2.0f, 5.95f, 2.0f, 5.0f);
        pathBuilder.close();
        ...
        pathBuilder5.curveTo(19.88f, 10.47f, 20.0f, 11.22f, 20.0f, 12.0f);
