...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_appShortcut", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AppShortcut", "Landroidx/compose/material/icons/Icons$Outlined;", "getAppShortcut", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AppShortcutKt {
    ...
    public static final ImageVector getAppShortcut(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.AppShortcut", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.lineToRelative(0.62f, 1.38f);
        pathBuilder3.lineToRelative(0.62f, -1.38f);
        pathBuilder3.lineToRelative(1.38f, -0.62f);
        pathBuilder3.lineToRelative(-1.38f, -0.62f);
        pathBuilder3.lineToRelative(-0.62f, -1.38f);
        pathBuilder3.lineToRelative(-0.62f, 1.38f);
        pathBuilder3.lineToRelative(-1.38f, 0.62f);
        ...
        pathBuilder4.lineToRelative(-1.25f, 2.75f);
        pathBuilder4.lineToRelative(-2.75f, 1.25f);
        pathBuilder4.lineToRelative(2.75f, 1.25f);
        pathBuilder4.lineToRelative(1.25f, 2.75f);
        pathBuilder4.lineToRelative(1.25f, -2.75f);
        pathBuilder4.lineToRelative(2.75f, -1.25f);
        ...
        pathBuilder5.moveTo(21.0f, 13.0f);
        pathBuilder5.lineToRelative(-0.62f, 1.38f);
        pathBuilder5.lineToRelative(-1.38f, 0.62f);
        pathBuilder5.lineToRelative(1.38f, 0.62f);
        pathBuilder5.lineToRelative(0.62f, 1.38f);
        pathBuilder5.lineToRelative(0.62f, -1.38f);
        pathBuilder5.lineToRelative(1.38f, -0.62f);
