...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_curtains", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Curtains", "Landroidx/compose/material/icons/Icons$Outlined;", "getCurtains", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class CurtainsKt {
    ...
    public static final ImageVector getCurtains(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.Curtains", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(12.31f, 8.06f, 13.77f, 10.65f, 15.81f, 12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(9.94f, 5.0f);
        pathBuilder3.curveTo(9.64f, 7.93f, 8.05f, 10.27f, 6.0f, 10.86f);
        pathBuilder.verticalLineTo(5.0f);
        pathBuilder.horizontalLineTo(9.94f);
        pathBuilder.close();
        pathBuilder.moveTo(6.0f, 13.14f);
        pathBuilder3.curveToRelative(2.05f, 0.58f, 3.64f, 2.93f, 3.94f, 5.86f);
        pathBuilder.horizontalLineTo(6.0f);
        pathBuilder.verticalLineTo(13.14f);
        pathBuilder.close();
        pathBuilder.moveTo(14.06f, 19.0f);
        pathBuilder3.curveToRelative(0.3f, -2.93f, 1.89f, -5.27f, 3.94f, -5.86f);
