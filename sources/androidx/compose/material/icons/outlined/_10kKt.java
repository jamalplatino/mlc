...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__10k", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_10k", "Landroidx/compose/material/icons/Icons$Outlined;", "get_10k", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class _10kKt {
    ...
    public static final ImageVector get_10k(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined._10k", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(15.5f, 11.25f);
        ...
        pathBuilder4.moveTo(9.5f, 15.0f);
        ...
        pathBuilder4.horizontalLineTo(9.5f);
        pathBuilder5.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder4.verticalLineToRelative(4.0f);
        pathBuilder5.curveTo(8.5f, 14.55f, 8.95f, 15.0f, 9.5f, 15.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(10.0f, 10.5f);
        pathBuilder4.horizontalLineToRelative(1.5f);
        pathBuilder4.verticalLineToRelative(3.0f);
        pathBuilder4.horizontalLineTo(10.0f);
        pathBuilder4.verticalLineTo(10.5f);
        pathBuilder4.close();
