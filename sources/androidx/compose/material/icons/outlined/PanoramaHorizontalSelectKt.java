...
public final class PanoramaHorizontalSelectKt {
    ...
    public static final ImageVector getPanoramaHorizontalSelect(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Outlined.PanoramaHorizontalSelect", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.0f, -0.68f, -0.66f, -1.17f, -1.31f, -0.95f);
        pathBuilder4.curveTo(18.66f, 4.73f, 15.86f, 5.5f, 12.0f, 5.5f);
        pathBuilder.close();
