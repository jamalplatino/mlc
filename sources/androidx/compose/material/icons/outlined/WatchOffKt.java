...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_watchOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WatchOff", "Landroidx/compose/material/icons/Icons$Outlined;", "getWatchOff", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class WatchOffKt {
    ...
    public static final ImageVector getWatchOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Outlined.WatchOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.lineToRelative(4.46f, 4.46f);
        ...
        pathBuilder3.lineToRelative(0.96f, -3.21f);
        pathBuilder3.lineToRelative(3.82f, 3.82f);
        pathBuilder3.lineToRelative(1.41f, -1.41f);
        pathBuilder3.lineTo(2.81f, 2.81f);
        pathBuilder3.close();
        pathBuilder3.moveTo(13.51f, 20.0f);
        pathBuilder3.horizontalLineToRelative(-3.02f);
        pathBuilder3.lineToRelative(-0.38f, -1.27f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveToRelative(0.55f, 0.15f, 1.97f, 0.51f, 3.78f, 0.0f);
        pathBuilder3.lineTo(13.51f, 20.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(12.0f, 17.0f);
        pathBuilder5.curveToRelative(-2.76f, 0.0f, -5.0f, -2.24f, -5.0f, -5.0f);
        pathBuilder5.curveToRelative(0.0f, -0.64f, 0.13f, -1.25f, 0.35f, -1.82f);
        pathBuilder3.lineToRelative(6.47f, 6.47f);
        pathBuilder5.curveTo(13.25f, 16.87f, 12.64f, 17.0f, 12.0f, 17.0f);
        pathBuilder3.close();
