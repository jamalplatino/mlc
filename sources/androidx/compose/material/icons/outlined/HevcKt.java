...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_hevc", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Hevc", "Landroidx/compose/material/icons/Icons$Outlined;", "getHevc", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class HevcKt {
    ...
    public static final ImageVector getHevc(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.Hevc", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(14.25f, 13.5f);
        pathBuilder5.lineToRelative(-0.75f, -4.5f);
        pathBuilder5.lineToRelative(-1.5f, 0.0f);
        pathBuilder5.lineToRelative(1.0f, 6.0f);
        pathBuilder5.lineToRelative(2.5f, 0.0f);
        pathBuilder5.lineToRelative(1.0f, -6.0f);
        pathBuilder5.lineToRelative(-1.5f, 0.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(8.0f, 9.0f);
        pathBuilder6.lineToRelative(0.0f, 6.0f);
        pathBuilder6.lineToRelative(3.5f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, -1.5f);
        pathBuilder6.lineToRelative(-2.0f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, -1.0f);
        pathBuilder6.lineToRelative(2.0f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, -1.5f);
        pathBuilder6.lineToRelative(-2.0f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, -0.5f);
        pathBuilder6.lineToRelative(2.0f, 0.0f);
        pathBuilder6.lineToRelative(0.0f, -1.5f);
        pathBuilder6.close();
