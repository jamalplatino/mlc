...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_offlineShare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "OfflineShare", "Landroidx/compose/material/icons/Icons$Outlined;", "getOfflineShare", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class OfflineShareKt {
    ...
    public static final ImageVector getOfflineShare(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.OfflineShare", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(8.9f, 1.0f, 8.0f, 1.9f, 8.0f, 3.0f);
        pathBuilder2.verticalLineToRelative(14.0f);
        pathBuilder3.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder2.horizontalLineToRelative(8.0f);
        pathBuilder3.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilder2.verticalLineTo(3.0f);
        pathBuilder3.curveTo(20.0f, 1.9f, 19.1f, 1.0f, 18.0f, 1.0f);
        pathBuilder2.close();
        ...
        pathBuilder4.moveTo(12.5f, 10.25f);
        pathBuilder4.horizontalLineToRelative(1.63f);
        pathBuilder4.lineToRelative(-0.69f, 0.69f);
        pathBuilder4.lineTo(14.5f, 12.0f);
        pathBuilder4.lineTo(17.0f, 9.5f);
        pathBuilder4.lineTo(14.5f, 7.0f);
        ...
        pathBuilder4.verticalLineTo(10.25f);
        pathBuilder4.close();
