...
public final class SignalWifiStatusbarConnectedNoInternet4Kt {
    ...
    public static final ImageVector getSignalWifiStatusbarConnectedNoInternet4(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.SignalWifiStatusbarConnectedNoInternet4", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(19.97f, 5.51f, 16.16f, 4.0f, 12.0f, 4.0f);
        pathBuilder.close();
