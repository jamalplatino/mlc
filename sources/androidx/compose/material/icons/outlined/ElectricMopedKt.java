...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_electricMoped", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElectricMoped", "Landroidx/compose/material/icons/Icons$Outlined;", "getElectricMoped", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ElectricMopedKt {
    ...
    public static final ImageVector getElectricMoped(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.ElectricMoped", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.horizontalLineToRelative(2.0f);
        pathBuilder3.curveTo(8.0f, 14.55f, 7.55f, 15.0f, 7.0f, 15.0f);
        pathBuilder.close();
        ...
        pathBuilder5.reflectiveCurveTo(20.66f, 11.0f, 19.0f, 11.0f);
        pathBuilder5.close();
        ...
        pathBuilder5.reflectiveCurveTo(19.55f, 15.0f, 19.0f, 15.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.lineToRelative(6.0f, 3.0f);
        pathBuilder7.lineToRelative(-4.0f, 0.0f);
        pathBuilder7.lineToRelative(0.0f, 2.0f);
        pathBuilder7.close();
