...
public final class SentimentSatisfiedKt {
    ...
    public static final ImageVector getSentimentSatisfied(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.SentimentSatisfied", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.curveToRelative(-0.7f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        pathBuilder5.close();
