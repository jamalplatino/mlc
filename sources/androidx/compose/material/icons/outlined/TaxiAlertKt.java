...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_taxiAlert", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TaxiAlert", "Landroidx/compose/material/icons/Icons$Outlined;", "getTaxiAlert", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TaxiAlertKt {
    ...
    public static final ImageVector getTaxiAlert(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Outlined.TaxiAlert", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.horizontalLineTo(4.81f);
        pathBuilder5.lineToRelative(1.04f, -3.0f);
        pathBuilder5.horizontalLineToRelative(5.44f);
        pathBuilder5.curveTo(11.1f, 7.37f, 11.0f, 6.7f, 11.0f, 6.0f);
        pathBuilder5.reflectiveCurveToRelative(0.1f, -1.37f, 0.29f, -2.0f);
        pathBuilder5.horizontalLineTo(8.0f);
        pathBuilder5.verticalLineToRelative(2.0f);
        pathBuilder5.horizontalLineTo(5.5f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(4.84f, 6.0f, 4.29f, 6.42f, 4.08f, 7.01f);
        pathBuilder5.lineTo(2.0f, 13.0f);
        ...
        pathBuilder5.verticalLineToRelative(-8.0f);
        pathBuilder5.lineToRelative(-0.09f, -0.27f);
        pathBuilder5.curveTo(19.3f, 12.9f, 18.66f, 13.0f, 18.0f, 13.0f);
        pathBuilder5.close();
        ...
        pathBuilder8.moveTo(18.0f, 1.0f);
        ...
        pathBuilder8.reflectiveCurveTo(20.76f, 1.0f, 18.0f, 1.0f);
        pathBuilder8.close();
        pathBuilder8.moveTo(18.5f, 9.0f);
