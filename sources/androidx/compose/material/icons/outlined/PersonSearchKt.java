...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personSearch", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonSearch", "Landroidx/compose/material/icons/Icons$Outlined;", "getPersonSearch", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonSearchKt {
    ...
    public static final ImageVector getPersonSearch(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Outlined.PersonSearch", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(6.0f, 10.21f, 7.79f, 12.0f, 10.0f, 12.0f);
        pathBuilder.close();
        pathBuilder.moveTo(10.0f, 6.0f);
        pathBuilder2.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilder2.curveToRelative(0.0f, 1.1f, -0.9f, 2.0f, -2.0f, 2.0f);
        pathBuilder.reflectiveCurveTo(8.0f, 9.1f, 8.0f, 8.0f);
        pathBuilder2.curveTo(8.0f, 6.9f, 8.9f, 6.0f, 10.0f, 6.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveToRelative(0.22f, -0.72f, 3.31f, -2.0f, 6.0f, -2.0f);
        pathBuilder4.curveToRelative(0.0f, -0.7f, 0.13f, -1.37f, 0.35f, -1.99f);
        pathBuilder4.curveTo(7.62f, 13.91f, 2.0f, 15.27f, 2.0f, 18.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineToRelative(9.54f);
        pathBuilder3.curveToRelative(-0.52f, -0.58f, -0.93f, -1.25f, -1.19f, -2.0f);
        ...
        pathBuilder6.curveTo(19.79f, 17.43f, 20.0f, 16.74f, 20.0f, 16.0f);
        ...
        pathBuilder7.curveToRelative(0.74f, 0.0f, 1.43f, -0.22f, 2.02f, -0.57f);
        pathBuilder7.curveToRelative(0.93f, 0.93f, 1.62f, 1.62f, 2.57f, 2.57f);
        pathBuilder5.lineTo(22.0f, 20.59f);
        PathBuilder pathBuilder8 = pathBuilder5;
        pathBuilder8.curveTo(20.5f, 19.09f, 21.21f, 19.79f, 19.43f, 18.02f);
        pathBuilder5.close();
        ...
        pathBuilder8.curveTo(18.0f, 17.1f, 17.1f, 18.0f, 16.0f, 18.0f);
        pathBuilder5.close();
