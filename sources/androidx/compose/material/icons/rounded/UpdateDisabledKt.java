...
public final class UpdateDisabledKt {
    ...
    public static final ImageVector getUpdateDisabled(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.UpdateDisabled", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(3.57f, 8.56f, 3.05f, 10.09f, 3.0f, 11.74f);
        pathBuilder3.curveTo(2.86f, 16.83f, 6.94f, 21.0f, 12.0f, 21.0f);
        pathBuilder3.curveToRelative(1.76f, 0.0f, 3.39f, -0.52f, 4.78f, -1.39f);
        ...
        pathBuilder5.curveToRelative(-2.78f, -0.49f, -5.04f, -2.71f, -5.58f, -5.47f);
        pathBuilder5.curveToRelative(-0.34f, -1.72f, -0.03f, -3.36f, 0.72f, -4.73f);
        ...
        pathBuilder6.curveToRelative(0.27f, -0.5f, 0.49f, -1.03f, 0.63f, -1.59f);
        pathBuilder6.curveTo(18.89f, 13.3f, 19.29f, 13.0f, 19.73f, 13.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder6.curveTo(20.38f, 13.0f, 20.88f, 13.61f, 20.72f, 14.23f);
        pathBuilder.close();
        pathBuilder.moveTo(7.24f, 4.41f);
        pathBuilder6.curveToRelative(1.46f, -0.93f, 3.18f, -1.45f, 5.0f, -1.41f);
        pathBuilder6.curveToRelative(2.65f, 0.07f, 5.0f, 1.28f, 6.6f, 3.16f);
        ...
        pathBuilder7.curveTo(16.12f, 6.02f, 14.18f, 5.0f, 12.0f, 5.0f);
        pathBuilder7.curveToRelative(-1.2f, 0.0f, -2.33f, 0.31f, -3.32f, 0.85f);
