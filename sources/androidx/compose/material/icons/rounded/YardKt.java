...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_yard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Yard", "Landroidx/compose/material/icons/Icons$Rounded;", "getYard", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class YardKt {
    ...
    public static final ImageVector getYard(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.Yard", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(-2.83f, 0.0f, -5.21f, -1.97f, -5.84f, -4.61f);
        pathBuilder4.curveToRelative(-0.18f, -0.74f, 0.49f, -1.4f, 1.23f, -1.23f);
        pathBuilder4.curveTo(10.03f, 13.79f, 12.0f, 16.17f, 12.0f, 19.0f);
        pathBuilder4.curveToRelative(0.0f, -2.83f, 1.97f, -5.21f, 4.61f, -5.84f);
        pathBuilder4.curveToRelative(0.74f, -0.18f, 1.4f, 0.49f, 1.23f, 1.23f);
        pathBuilder4.curveTo(17.21f, 17.03f, 14.83f, 19.0f, 12.0f, 19.0f);
        pathBuilder.close();
