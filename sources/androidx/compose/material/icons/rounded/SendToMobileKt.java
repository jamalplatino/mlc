...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sendToMobile", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SendToMobile", "Landroidx/compose/material/icons/Icons$Rounded;", "getSendToMobile", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SendToMobileKt {
    ...
    public static final ImageVector getSendToMobile(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.SendToMobile", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder4.curveTo(17.45f, 17.0f, 17.0f, 17.45f, 17.0f, 18.0f);
        ...
        pathBuilder5.moveTo(21.65f, 11.65f);
        pathBuilder5.lineToRelative(-2.79f, -2.79f);
        pathBuilder5.curveTo(18.54f, 8.54f, 18.0f, 8.76f, 18.0f, 9.21f);
        ...
        pathBuilder5.horizontalLineToRelative(4.0f);
        pathBuilder5.verticalLineToRelative(1.79f);
        pathBuilder6.curveToRelative(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.35f);
        pathBuilder5.lineToRelative(2.79f, -2.79f);
        pathBuilder6.curveTo(21.84f, 12.16f, 21.84f, 11.84f, 21.65f, 11.65f);
        pathBuilder5.close();
