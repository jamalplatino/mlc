...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_outbox", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Outbox", "Landroidx/compose/material/icons/Icons$Rounded;", "getOutbox", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class OutboxKt {
    ...
    public static final ImageVector getOutbox(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.Outbox", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.lineToRelative(-2.79f, 2.79f);
        pathBuilder2.curveTo(8.54f, 10.46f, 8.76f, 11.0f, 9.21f, 11.0f);
        pathBuilder.close();
        ...
        pathBuilder5.curveToRelative(-0.63f, 0.0f, -1.22f, 0.3f, -1.6f, 0.8f);
        pathBuilder5.curveTo(13.84f, 15.53f, 12.98f, 16.0f, 12.0f, 16.0f);
        pathBuilder3.reflectiveCurveToRelative(-1.84f, -0.47f, -2.38f, -1.2f);
        pathBuilder3.curveTo(9.24f, 14.3f, 8.65f, 14.0f, 8.02f, 14.0f);
        pathBuilder3.horizontalLineTo(5.0f);
        pathBuilder3.verticalLineTo(5.0f);
        pathBuilder3.horizontalLineToRelative(14.0f);
