...
public final class SignalWifiStatusbarConnectedNoInternet4Kt {
    ...
    public static final ImageVector getSignalWifiStatusbarConnectedNoInternet4(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SignalWifiStatusbarConnectedNoInternet4", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(0.32f, 9.3f, 0.35f, 8.63f, 0.79f, 8.24f);
        pathBuilder2.curveTo(3.78f, 5.6f, 7.7f, 4.0f, 12.0f, 4.0f);
        pathBuilder2.curveTo(16.16f, 4.0f, 19.97f, 5.51f, 22.92f, 8.0f);
        pathBuilder.close();
