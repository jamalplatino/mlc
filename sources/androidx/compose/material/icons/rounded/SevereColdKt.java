...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_severeCold", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SevereCold", "Landroidx/compose/material/icons/Icons$Rounded;", "getSevereCold", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SevereColdKt {
    ...
    public static final ImageVector getSevereCold(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.SevereCold", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(21.0f, 2.45f, 20.55f, 2.0f, 20.0f, 2.0f);
        pathBuilder.close();
        ...
        pathBuilder5.moveTo(12.0f, 10.41f);
        pathBuilder5.lineToRelative(3.29f, -3.29f);
        ...
        pathBuilder5.lineTo(12.0f, 7.59f);
        ...
        pathBuilder5.lineTo(8.12f, 5.71f);
        ...
        pathBuilder5.lineTo(10.0f, 10.41f);
        pathBuilder5.verticalLineTo(12.0f);
        pathBuilder5.horizontalLineTo(8.41f);
        pathBuilder5.lineTo(5.12f, 8.71f);
        ...
        pathBuilder5.lineTo(5.59f, 12.0f);
        ...
        pathBuilder5.horizontalLineToRelative(2.59f);
        pathBuilder5.lineToRelative(-1.88f, 1.88f);
        ...
        pathBuilder5.lineTo(8.41f, 14.0f);
        pathBuilder5.horizontalLineTo(10.0f);
        pathBuilder5.verticalLineToRelative(1.59f);
        pathBuilder5.lineToRelative(-3.29f, 3.29f);
        pathBuilder10.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder5.lineToRelative(0.0f, 0.0f);
        pathBuilder10.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilder5.lineTo(10.0f, 18.41f);
        ...
        pathBuilder5.lineTo(12.0f, 15.59f);
        pathBuilder5.verticalLineTo(14.0f);
        pathBuilder5.horizontalLineToRelative(1.59f);
        pathBuilder5.lineToRelative(3.29f, 3.29f);
        ...
        pathBuilder5.lineTo(16.41f, 14.0f);
        pathBuilder5.horizontalLineTo(19.0f);
        PathBuilder pathBuilder14 = pathBuilder5;
        ...
        pathBuilder5.verticalLineTo(10.41f);
        pathBuilder5.close();
