...
public final class PauseCircleKt {
    ...
    public static final ImageVector getPauseCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.PauseCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(11.0f, 15.55f, 10.55f, 16.0f, 10.0f, 16.0f);
        pathBuilder.close();
        ...
        pathBuilder3.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder.verticalLineToRelative(6.0f);
        pathBuilder3.curveTo(15.0f, 15.55f, 14.55f, 16.0f, 14.0f, 16.0f);
        pathBuilder.close();
