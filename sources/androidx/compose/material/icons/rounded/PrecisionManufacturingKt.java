...
public final class PrecisionManufacturingKt {
    ...
    public static final ImageVector getPrecisionManufacturing(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.PrecisionManufacturing", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(8.34f, 4.66f, 6.96f, 3.75f, 5.4f, 4.06f);
        pathBuilder4.curveTo(4.23f, 4.29f, 3.27f, 5.25f, 3.05f, 6.42f);
        pathBuilder4.curveTo(2.8f, 7.76f, 3.45f, 8.96f, 4.48f, 9.58f);
        pathBuilder.lineTo(7.08f, 18.0f);
        pathBuilder.horizontalLineTo(5.5f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveTo(4.67f, 18.0f, 4.0f, 18.67f, 4.0f, 19.5f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder5.curveTo(4.0f, 20.33f, 4.67f, 21.0f, 5.5f, 21.0f);
        ...
        pathBuilder7.curveToRelative(0.32f, 0.0f, 0.6f, -0.16f, 0.78f, -0.4f);
        ...
        pathBuilder8.curveToRelative(0.38f, -0.18f, 0.54f, -0.62f, 0.36f, -1.0f);
        pathBuilder8.curveTo(20.75f, 8.34f, 20.31f, 8.17f, 19.93f, 8.35f);
        pathBuilder.close();
        pathBuilder.moveTo(6.0f, 8.0f);
        PathBuilder pathBuilder9 = pathBuilder;
        pathBuilder9.curveTo(5.45f, 8.0f, 5.0f, 7.55f, 5.0f, 7.0f);
