...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_densityMedium", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DensityMedium", "Landroidx/compose/material/icons/Icons$Rounded;", "getDensityMedium", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class DensityMediumKt {
    ...
    public static final ImageVector getDensityMedium(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.DensityMedium", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(3.0f, 4.55f, 3.45f, 5.0f, 4.0f, 5.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder4.curveTo(21.0f, 19.45f, 20.55f, 19.0f, 20.0f, 19.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder6.curveTo(21.0f, 11.45f, 20.55f, 11.0f, 20.0f, 11.0f);
        pathBuilder5.close();
