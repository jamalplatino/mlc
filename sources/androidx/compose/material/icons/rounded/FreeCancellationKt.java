...
public final class FreeCancellationKt {
    ...
    public static final ImageVector getFreeCancellation(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.FreeCancellation", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.verticalLineToRelative(1.0f);
        pathBuilder.horizontalLineTo(5.0f);
        pathBuilder4.curveTo(3.89f, 4.0f, 3.01f, 4.9f, 3.01f, 6.0f);
        ...
        pathBuilder.lineToRelative(0.0f, 0.0f);
        pathBuilder5.curveTo(11.31f, 20.11f, 11.06f, 20.0f, 10.79f, 20.0f);
        pathBuilder.close();
