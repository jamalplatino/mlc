...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_subway", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Subway", "Landroidx/compose/material/icons/Icons$Rounded;", "getSubway", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SubwayKt {
    ...
    public static final ImageVector getSubway(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.Subway", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveTo(16.0f, 2.09f, 13.86f, 2.0f, 12.0f, 2.0f);
        pathBuilder5.reflectiveCurveToRelative(-4.0f, 0.09f, -5.8f, 0.8f);
        pathBuilder5.curveTo(3.53f, 3.84f, 2.0f, 6.05f, 2.0f, 8.86f);
        ...
        pathBuilder5.curveToRelative(0.0f, 1.54f, -1.16f, 2.79f, -2.65f, 2.96f);
        pathBuilder5.lineToRelative(1.15f, 1.16f);
        pathBuilder5.lineTo(16.5f, 20.0f);
        pathBuilder5.horizontalLineToRelative(-1.67f);
        pathBuilder5.lineToRelative(-1.5f, -1.5f);
        pathBuilder5.horizontalLineToRelative(-2.66f);
        pathBuilder5.lineTo(9.17f, 20.0f);
        pathBuilder5.lineTo(7.5f, 20.0f);
        pathBuilder5.verticalLineToRelative(-0.38f);
        pathBuilder5.lineToRelative(1.15f, -1.16f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(7.16f, 18.29f, 6.0f, 17.04f, 6.0f, 15.5f);
        pathBuilder5.lineTo(6.0f, 9.0f);
        pathBuilder6.curveToRelative(0.0f, -2.63f, 3.0f, -3.0f, 6.0f, -3.0f);
        pathBuilder5.reflectiveCurveToRelative(6.0f, 0.37f, 6.0f, 3.0f);
