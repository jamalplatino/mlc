...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_joinRight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "JoinRight", "Landroidx/compose/material/icons/Icons$Rounded;", "getJoinRight", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class JoinRightKt {
    ...
    public static final ImageVector getJoinRight(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.JoinRight", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(9.0f, 13.15f, 9.35f, 15.44f, 11.32f, 17.2f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(14.25f, 18.81f, 15.1f, 19.0f, 16.0f, 19.0f);
        ...
        pathBuilder4.curveTo(16.27f, 7.84f, 16.5f, 11.03f, 16.5f, 12.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(8.0f, 19.0f);
        ...
        pathBuilder6.curveTo(8.71f, 16.95f, 8.36f, 17.0f, 8.0f, 17.0f);
        ...
        pathBuilder7.curveTo(9.75f, 5.19f, 8.9f, 5.0f, 8.0f, 5.0f);
        pathBuilder7.curveToRelative(-3.86f, 0.0f, -7.0f, 3.14f, -7.0f, 7.0f);
        pathBuilder5.reflectiveCurveTo(4.14f, 19.0f, 8.0f, 19.0f);
        pathBuilder5.close();
