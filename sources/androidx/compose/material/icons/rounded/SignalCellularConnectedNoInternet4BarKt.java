...
public final class SignalCellularConnectedNoInternet4BarKt {
    ...
    public static final ImageVector getSignalCellularConnectedNoInternet4Bar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SignalCellularConnectedNoInternet4Bar", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(20.0f, 17.55f, 20.45f, 18.0f, 21.0f, 18.0f);
        pathBuilder.close();
        ...
        pathBuilder3.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder3.curveTo(20.0f, 21.55f, 20.45f, 22.0f, 21.0f, 22.0f);
        pathBuilder.close();
