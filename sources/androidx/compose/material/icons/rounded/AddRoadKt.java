...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_addRoad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AddRoad", "Landroidx/compose/material/icons/Icons$Rounded;", "getAddRoad", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AddRoadKt {
    ...
    public static final ImageVector getAddRoad(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("Rounded.AddRoad", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(20.0f, 4.45f, 19.55f, 4.0f, 19.0f, 4.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.lineTo(5.0f, 20.0f);
        ...
        pathBuilder6.curveTo(4.45f, 4.0f, 4.0f, 4.45f, 4.0f, 5.0f);
        pathBuilder5.verticalLineToRelative(14.0f);
        pathBuilder6.curveTo(4.0f, 19.55f, 4.45f, 20.0f, 5.0f, 20.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(12.0f, 8.0f);
        pathBuilder7.lineTo(12.0f, 8.0f);
        ...
        pathBuilder8.curveTo(11.0f, 7.55f, 11.45f, 8.0f, 12.0f, 8.0f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(12.0f, 14.0f);
        pathBuilder9.lineTo(12.0f, 14.0f);
        ...
        pathBuilder10.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder9.verticalLineToRelative(2.0f);
        pathBuilder10.curveTo(11.0f, 13.55f, 11.45f, 14.0f, 12.0f, 14.0f);
        pathBuilder9.close();
        ...
        pathBuilder11.lineTo(12.0f, 20.0f);
        ...
        pathBuilder12.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder11.verticalLineToRelative(2.0f);
        pathBuilder12.curveTo(11.0f, 19.55f, 11.45f, 20.0f, 12.0f, 20.0f);
        pathBuilder11.close();
