...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_timer3Select", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Timer3Select", "Landroidx/compose/material/icons/Icons$Rounded;", "getTimer3Select", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Timer3SelectKt {
    ...
    public static final ImageVector getTimer3Select(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Timer3Select", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(4.0f, 7.33f, 4.67f, 8.0f, 5.5f, 8.0f);
        pathBuilder.horizontalLineTo(10.0f);
        pathBuilder.verticalLineToRelative(2.5f);
        pathBuilder.horizontalLineTo(5.5f);
        pathBuilder3.curveTo(4.67f, 10.5f, 4.0f, 11.17f, 4.0f, 12.0f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder3.curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f);
        pathBuilder.horizontalLineTo(10.0f);
        pathBuilder.verticalLineTo(16.0f);
        pathBuilder.horizontalLineTo(5.5f);
        pathBuilder3.curveTo(4.67f, 16.0f, 4.0f, 16.67f, 4.0f, 17.5f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder3.curveTo(4.0f, 18.33f, 4.67f, 19.0f, 5.5f, 19.0f);
        pathBuilder.horizontalLineTo(10.0f);
        ...
        pathBuilder4.curveToRelative(1.16f, 0.0f, 2.1f, -0.94f, 2.1f, -2.1f);
        pathBuilder.verticalLineTo(8.0f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(0.0f, -1.66f, -1.34f, -3.0f, -3.0f, -3.0f);
        pathBuilder.horizontalLineTo(5.5f);
        pathBuilder5.curveTo(4.67f, 5.0f, 4.0f, 5.67f, 4.0f, 6.5f);
        pathBuilder.close();
