...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_timerOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TimerOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getTimerOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TimerOffKt {
    ...
    public static final ImageVector getTimerOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.TimerOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.horizontalLineToRelative(-4.0f);
        pathBuilder2.curveTo(9.45f, 1.0f, 9.0f, 1.45f, 9.0f, 2.0f);
        pathBuilder2.curveTo(9.0f, 2.55f, 9.45f, 3.0f, 10.0f, 3.0f);
        pathBuilder.close();
        ...
        pathBuilder3.lineToRelative(6.98f, 6.98f);
        ...
        pathBuilder3.lineToRelative(0.75f, -0.75f);
        pathBuilder4.curveToRelative(0.38f, -0.38f, 0.39f, -1.01f, 0.0f, -1.4f);
        pathBuilder4.curveToRelative(0.0f, 0.0f, -0.01f, -0.01f, -0.01f, -0.01f);
        pathBuilder4.curveToRelative(-0.39f, -0.39f, -1.01f, -0.38f, -1.4f, 0.0f);
        pathBuilder3.lineToRelative(-0.75f, 0.75f);
        pathBuilder4.curveTo(16.07f, 4.74f, 14.12f, 4.0f, 12.0f, 4.0f);
        pathBuilder4.curveToRelative(-1.48f, 0.0f, -2.89f, 0.38f, -4.13f, 1.04f);
        pathBuilder3.lineToRelative(3.36f, 3.36f);
        pathBuilder4.curveTo(11.41f, 8.16f, 11.68f, 8.0f, 12.0f, 8.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(2.1f, 3.51f);
        pathBuilder5.lineTo(2.1f, 3.51f);
        pathBuilder5.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder5.lineToRelative(2.72f, 2.72f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(3.73f, 9.09f, 3.05f, 10.86f, 3.0f, 12.76f);
        pathBuilder6.curveTo(2.87f, 17.84f, 6.94f, 22.0f, 12.0f, 22.0f);
        pathBuilder6.curveToRelative(2.02f, 0.0f, 3.88f, -0.67f, 5.38f, -1.79f);
        pathBuilder5.lineToRelative(1.69f, 1.69f);
        ...
        pathBuilder5.lineTo(3.51f, 3.51f);
