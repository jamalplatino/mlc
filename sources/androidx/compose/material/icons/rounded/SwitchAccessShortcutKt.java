...
public final class SwitchAccessShortcutKt {
    ...
    public static final ImageVector getSwitchAccessShortcut(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SwitchAccessShortcut", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, 0.78f, -0.84f, 1.25f, -1.51f, 0.86f);
        pathBuilder2.curveTo(14.21f, 19.36f, 12.0f, 15.79f, 12.0f, 12.0f);
        pathBuilder2.curveToRelative(0.0f, -2.73f, 1.08f, -5.27f, 2.75f, -7.25f);
        pathBuilder.lineToRelative(-1.9f, -1.9f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveTo(12.54f, 2.54f, 12.76f, 2.0f, 13.21f, 2.0f);
        pathBuilder.horizontalLineToRelative(5.29f);
        pathBuilder3.curveTo(18.78f, 2.0f, 19.0f, 2.22f, 19.0f, 2.5f);
        ...
        pathBuilder4.curveTo(14.84f, 7.82f, 14.0f, 9.88f, 14.0f, 12.0f);
        pathBuilder4.curveToRelative(0.0f, 3.13f, 1.86f, 6.01f, 4.51f, 7.55f);
        pathBuilder4.curveTo(18.81f, 19.73f, 19.0f, 20.06f, 19.0f, 20.41f);
        pathBuilder.close();
