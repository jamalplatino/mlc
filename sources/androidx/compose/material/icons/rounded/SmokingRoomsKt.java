...
public final class SmokingRoomsKt {
    ...
    public static final ImageVector getSmokingRooms(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SmokingRooms", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, -1.51f, -1.0f, -2.79f, -2.38f, -3.21f);
        pathBuilder2.curveToRelative(-0.48f, -0.14f, -0.97f, 0.22f, -0.97f, 0.72f);
        pathBuilder2.curveToRelative(0.0f, 0.33f, 0.21f, 0.62f, 0.52f, 0.71f);
        pathBuilder2.curveToRelative(0.77f, 0.23f, 1.33f, 0.94f, 1.33f, 1.78f);
        pathBuilder2.curveToRelative(0.0f, 0.82f, -0.53f, 1.51f, -1.27f, 1.76f);
        pathBuilder2.curveToRelative(-0.33f, 0.11f, -0.58f, 0.39f, -0.58f, 0.74f);
        ...
        pathBuilder4.curveToRelative(0.03f, 1.84f, 1.62f, 3.29f, 3.46f, 3.29f);
