...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_syncAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SyncAlt", "Landroidx/compose/material/icons/Icons$Rounded;", "getSyncAlt", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SyncAltKt {
    ...
    public static final ImageVector getSyncAlt(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.SyncAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(18.54f, 4.54f, 18.0f, 4.76f, 18.0f, 5.21f);
        ...
        pathBuilder.lineToRelative(2.79f, -2.79f);
        pathBuilder3.curveTo(21.84f, 8.16f, 21.84f, 7.84f, 21.65f, 7.65f);
        pathBuilder.close();
        ...
        pathBuilder5.curveToRelative(-0.2f, 0.19f, -0.2f, 0.51f, -0.01f, 0.7f);
        pathBuilder4.lineToRelative(2.79f, 2.79f);
        pathBuilder5.curveTo(5.46f, 19.46f, 6.0f, 19.24f, 6.0f, 18.79f);
        ...
        pathBuilder4.reflectiveCurveTo(20.55f, 15.0f, 20.0f, 15.0f);
        pathBuilder4.close();
