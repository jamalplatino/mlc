...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_balance", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Balance", "Landroidx/compose/material/icons/Icons$Rounded;", "getBalance", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BalanceKt {
    ...
    public static final ImageVector getBalance(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Balance", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.17f, 0.39f, -0.23f, 0.84f, -0.11f, 1.25f);
        pathBuilder2.curveToRelative(0.39f, 1.3f, 1.76f, 2.26f, 3.39f, 2.26f);
        pathBuilder.reflectiveCurveToRelative(3.01f, -0.96f, 3.39f, -2.26f);
        pathBuilder2.curveToRelative(0.12f, -0.41f, 0.06f, -0.86f, -0.11f, -1.25f);
        ...
        pathBuilder3.curveTo(3.45f, 4.0f, 3.0f, 4.45f, 3.0f, 5.0f);
        pathBuilder3.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder.horizontalLineToRelative(1.0f);
        pathBuilder.lineToRelative(-2.78f, 6.49f);
        pathBuilder3.curveToRelative(-0.17f, 0.39f, -0.23f, 0.84f, -0.11f, 1.25f);
        pathBuilder3.curveTo(2.49f, 15.04f, 3.87f, 16.0f, 5.5f, 16.0f);
        pathBuilder.reflectiveCurveToRelative(3.01f, -0.96f, 3.39f, -2.26f);
