...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_openInNewOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "OpenInNewOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getOpenInNewOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class OpenInNewOffKt {
    ...
    public static final ImageVector getOpenInNewOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.OpenInNewOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(14.54f, 3.54f, 14.76f, 3.0f, 15.21f, 3.0f);
        pathBuilder.horizontalLineToRelative(5.29f);
        pathBuilder2.curveTo(20.78f, 3.0f, 21.0f, 3.22f, 21.0f, 3.5f);
        ...
        pathBuilder.lineToRelative(0.0f, 0.0f);
        pathBuilder4.curveTo(20.09f, 22.29f, 19.46f, 22.29f, 19.07f, 21.9f);
        pathBuilder.close();
