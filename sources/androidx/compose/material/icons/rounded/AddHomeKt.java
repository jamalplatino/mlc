...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_addHome", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AddHome", "Landroidx/compose/material/icons/Icons$Rounded;", "getAddHome", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AddHomeKt {
    ...
    public static final ImageVector getAddHome(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.AddHome", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(16.53f, 11.16f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(1.23f, -0.26f, 2.4f, -0.18f, 3.47f, 0.14f);
        pathBuilder.verticalLineTo(10.0f);
        pathBuilder2.curveToRelative(0.0f, -0.63f, -0.3f, -1.22f, -0.8f, -1.6f);
        pathBuilder.lineToRelative(-6.0f, -4.5f);
        pathBuilder2.curveToRelative(-0.71f, -0.53f, -1.69f, -0.53f, -2.4f, 0.0f);
        pathBuilder.lineToRelative(-6.0f, 4.5f);
        pathBuilder2.curveTo(4.3f, 8.78f, 4.0f, 9.37f, 4.0f, 10.0f);
        pathBuilder.verticalLineToRelative(9.0f);
        pathBuilder2.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder.horizontalLineToRelative(5.68f);
        pathBuilder2.curveToRelative(-0.61f, -1.28f, -0.86f, -2.77f, -0.55f, -4.35f);
        pathBuilder2.curveTo(11.65f, 13.93f, 13.82f, 11.74f, 16.53f, 11.16f);
        pathBuilder.close();
