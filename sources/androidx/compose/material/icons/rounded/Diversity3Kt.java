...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_diversity3", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Diversity3", "Landroidx/compose/material/icons/Icons$Rounded;", "getDiversity3", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Diversity3Kt {
    ...
    public static final ImageVector getDiversity3(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Rounded.Diversity3", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(6.32f, 13.01f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(0.96f, 0.02f, 1.85f, 0.5f, 2.45f, 1.34f);
        pathBuilder2.curveTo(9.5f, 15.38f, 10.71f, 16.0f, 12.0f, 16.0f);
        pathBuilder2.curveToRelative(1.29f, 0.0f, 2.5f, -0.62f, 3.23f, -1.66f);
        pathBuilder2.curveToRelative(0.6f, -0.84f, 1.49f, -1.32f, 2.45f, -1.34f);
        pathBuilder2.curveTo(16.96f, 11.78f, 14.08f, 11.0f, 12.0f, 11.0f);
        pathBuilder2.curveTo(9.93f, 11.0f, 7.04f, 11.78f, 6.32f, 13.01f);
        pathBuilder.close();
        ...
        pathBuilder3.lineTo(4.0f, 13.0f);
        ...
        pathBuilder4.curveTo(1.0f, 11.66f, 2.34f, 13.0f, 4.0f, 13.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(20.0f, 13.0f);
        pathBuilder5.lineTo(20.0f, 13.0f);
        ...
        pathBuilder6.curveTo(17.0f, 11.66f, 18.34f, 13.0f, 20.0f, 13.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.reflectiveCurveTo(9.0f, 5.34f, 9.0f, 7.0f);
        pathBuilder7.curveTo(9.0f, 8.66f, 10.34f, 10.0f, 12.0f, 10.0f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(21.0f, 14.0f);
        pathBuilder9.horizontalLineToRelative(-3.27f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveToRelative(-0.77f, 0.0f, -1.35f, 0.45f, -1.68f, 0.92f);
        pathBuilder10.curveTo(16.01f, 14.98f, 14.69f, 17.0f, 12.0f, 17.0f);
        pathBuilder10.curveToRelative(-1.43f, 0.0f, -3.03f, -0.64f, -4.05f, -2.08f);
        pathBuilder10.curveTo(7.56f, 14.37f, 6.95f, 14.0f, 6.27f, 14.0f);
        pathBuilder9.lineTo(3.0f, 14.0f);
        ...
        pathBuilder9.verticalLineToRelative(-1.26f);
        pathBuilder10.curveToRelative(1.15f, 0.8f, 2.54f, 1.26f, 4.0f, 1.26f);
        pathBuilder9.reflectiveCurveToRelative(2.85f, -0.46f, 4.0f, -1.26f);
        ...
        pathBuilder9.verticalLineToRelative(-3.0f);
        pathBuilder11.curveTo(23.0f, 14.9f, 22.1f, 14.0f, 21.0f, 14.0f);
        pathBuilder9.close();
