...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_receiptLong", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ReceiptLong", "Landroidx/compose/material/icons/Icons$Rounded;", "getReceiptLong", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ReceiptLongKt {
    ...
    public static final ImageVector getReceiptLong(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Rounded.ReceiptLong", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder3.verticalLineToRelative(0.0f);
        pathBuilder4.curveTo(15.0f, 11.55f, 14.55f, 12.0f, 14.0f, 12.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(19.5f, 3.5f);
        pathBuilder5.lineTo(18.0f, 2.0f);
        pathBuilder5.lineToRelative(-1.5f, 1.5f);
        pathBuilder5.lineTo(15.0f, 2.0f);
        pathBuilder5.lineToRelative(-1.5f, 1.5f);
        pathBuilder5.lineTo(12.0f, 2.0f);
        pathBuilder5.lineToRelative(-1.5f, 1.5f);
        pathBuilder5.lineTo(9.0f, 2.0f);
        pathBuilder5.lineTo(7.5f, 3.5f);
        ...
        pathBuilder5.lineTo(19.5f, 3.5f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(17.0f, 8.0f);
        ...
        pathBuilder9.moveTo(17.0f, 11.0f);
