...
public final class EmojiPeopleKt {
    ...
    public static final ImageVector getEmojiPeople(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.EmojiPeople", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(8.53f, 6.99f, 6.48f, 5.2f, 6.07f, 2.85f);
        pathBuilder4.curveTo(5.99f, 2.36f, 5.58f, 2.0f, 5.09f, 2.0f);
        pathBuilder3.horizontalLineToRelative(0.0f);
        pathBuilder4.curveToRelative(-0.61f, 0.0f, -1.09f, 0.54f, -1.0f, 1.14f);
        pathBuilder4.curveTo(4.53f, 5.8f, 6.47f, 7.95f, 9.0f, 8.71f);
        ...
        pathBuilder3.lineToRelative(3.24f, 3.24f);
