...
public final class PlaylistAddCheckCircleKt {
    ...
    public static final ImageVector getPlaylistAddCheckCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.PlaylistAddCheckCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(7.45f, 9.0f, 7.0f, 8.55f, 7.0f, 8.0f);
        ...
        pathBuilder2.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder.horizontalLineTo(8.0f);
        pathBuilder2.curveTo(7.45f, 12.0f, 7.0f, 11.55f, 7.0f, 11.0f);
        ...
        pathBuilder4.curveTo(18.68f, 13.1f, 18.68f, 13.73f, 18.29f, 14.12f);
        pathBuilder.close();
