...
public final class SportsEsportsKt {
    ...
    public static final ImageVector getSportsEsports(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SportsEsports", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.48f, 0.48f, 1.13f, 0.75f, 1.8f, 0.75f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder3.curveTo(20.61f, 19.0f, 21.8f, 17.63f, 21.58f, 16.09f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(16.0f, 9.55f, 15.55f, 10.0f, 15.0f, 10.0f);
        pathBuilder.close();
        ...
        pathBuilder.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilder5.curveTo(18.0f, 12.55f, 17.55f, 13.0f, 17.0f, 13.0f);
        pathBuilder.close();
