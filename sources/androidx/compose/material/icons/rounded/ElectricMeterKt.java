...
public final class ElectricMeterKt {
    ...
    public static final ImageVector getElectricMeter(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.ElectricMeter", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(11.73f, 2.0f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveTo(7.05f, 2.14f, 3.15f, 6.03f, 3.0f, 10.71f);
        pathBuilder2.curveToRelative(-0.13f, 4.04f, 2.42f, 7.5f, 6.0f, 8.77f);
        ...
        pathBuilder4.curveToRelative(3.49f, -1.24f, 6.0f, -4.57f, 6.0f, -8.47f);
        pathBuilder4.curveTo(21.0f, 5.95f, 16.82f, 1.85f, 11.73f, 2.0f);
        pathBuilder.close();
        pathBuilder.moveTo(13.54f, 14.71f);
        pathBuilder.lineTo(12.0f, 16.25f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(-0.41f, 0.41f, -1.09f, 0.41f, -1.5f, 0.0f);
        pathBuilder.horizontalLineToRelative(0.0f);
        pathBuilder5.curveToRelative(-0.41f, -0.41f, -0.41f, -1.09f, 0.0f, -1.5f);
        ...
        pathBuilder6.curveToRelative(0.41f, -0.41f, 1.09f, -0.41f, 1.5f, 0.0f);
        pathBuilder.lineToRelative(0.0f, 0.0f);
        pathBuilder6.curveToRelative(0.41f, 0.41f, 0.41f, 1.09f, 0.0f, 1.5f);
        pathBuilder.lineToRelative(-0.5f, 0.5f);
        pathBuilder.lineToRelative(0.54f, 0.54f);
        ...
        pathBuilder7.curveTo(8.45f, 9.0f, 8.0f, 8.55f, 8.0f, 8.0f);
        ...
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder8.curveTo(16.0f, 8.55f, 15.55f, 9.0f, 15.0f, 9.0f);
        pathBuilder.close();
