...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__5k", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_5k", "Landroidx/compose/material/icons/Icons$Rounded;", "get_5k", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class _5kKt {
    ...
    public static final ImageVector get_5k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded._5k", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(6.5f, 9.34f, 6.84f, 9.0f, 7.25f, 9.0f);
        pathBuilder.horizontalLineToRelative(3.0f);
        pathBuilder4.curveTo(10.66f, 9.0f, 11.0f, 9.34f, 11.0f, 9.75f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder4.curveTo(11.0f, 10.16f, 10.66f, 10.5f, 10.25f, 10.5f);
        pathBuilder.close();
        ...
        pathBuilder5.curveTo(16.17f, 9.1f, 16.38f, 9.0f, 16.59f, 9.0f);
        pathBuilder.lineToRelative(0.0f, 0.0f);
        pathBuilder5.curveToRelative(0.58f, 0.0f, 0.91f, 0.66f, 0.56f, 1.12f);
