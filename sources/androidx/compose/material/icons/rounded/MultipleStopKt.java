...
public final class MultipleStopKt {
    ...
    public static final ImageVector getMultipleStop(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.MultipleStop", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.lineToRelative(-2.79f, 2.79f);
        pathBuilder2.curveTo(17.54f, 11.46f, 17.0f, 11.24f, 17.0f, 10.79f);
        ...
        pathBuilder3.curveTo(9.45f, 7.0f, 9.0f, 7.45f, 9.0f, 8.0f);
        ...
        pathBuilder.reflectiveCurveToRelative(-1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder4.curveTo(13.0f, 16.55f, 13.45f, 17.0f, 14.0f, 17.0f);
        pathBuilder.close();
        ...
        pathBuilder.reflectiveCurveToRelative(-1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder5.curveTo(17.0f, 16.55f, 17.45f, 17.0f, 18.0f, 17.0f);
        pathBuilder.close();
