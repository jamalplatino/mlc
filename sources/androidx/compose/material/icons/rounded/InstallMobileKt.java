...
public final class InstallMobileKt {
    ...
    public static final ImageVector getInstallMobile(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.InstallMobile", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.lineToRelative(3.59f, 3.59f);
        pathBuilder4.curveTo(17.69f, 13.68f, 18.32f, 13.68f, 18.71f, 13.29f);
        pathBuilder.close();
