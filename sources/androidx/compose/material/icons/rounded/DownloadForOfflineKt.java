...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.DownloadForOffline", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.lineToRelative(-2.79f, -2.79f);
        pathBuilder3.curveTo(8.54f, 10.54f, 8.76f, 10.0f, 9.21f, 10.0f);
