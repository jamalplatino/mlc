...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_unfoldLessDouble", "Landroidx/compose/ui/graphics/vector/ImageVector;", "UnfoldLessDouble", "Landroidx/compose/material/icons/Icons$Rounded;", "getUnfoldLessDouble", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class UnfoldLessDoubleKt {
    ...
    public static final ImageVector getUnfoldLessDouble(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.UnfoldLessDouble", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(9.54f, 23.3f);
        pathBuilder5.lineToRelative(2.47f, -2.46f);
        pathBuilder5.lineToRelative(2.46f, 2.46f);
        ...
        pathBuilder5.lineToRelative(-3.17f, -3.18f);
        pathBuilder6.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilder5.lineToRelative(-3.17f, 3.18f);
        pathBuilder6.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder6.curveTo(8.52f, 23.69f, 9.15f, 23.69f, 9.54f, 23.3f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(9.54f, 18.29f);
        pathBuilder7.lineToRelative(2.47f, -2.45f);
        pathBuilder7.lineToRelative(2.46f, 2.46f);
        ...
        pathBuilder7.lineToRelative(-3.17f, -3.18f);
        pathBuilder8.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilder7.lineToRelative(-3.17f, 3.17f);
        pathBuilder8.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilder7.reflectiveCurveTo(9.15f, 18.68f, 9.54f, 18.29f);
        pathBuilder7.close();
