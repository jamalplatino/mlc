...
public final class AssignmentLateKt {
    ...
    public static final ImageVector getAssignmentLate(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.AssignmentLate", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(11.25f, 3.09f, 11.59f, 2.75f, 12.0f, 2.75f);
        pathBuilder.close();
        ...
        pathBuilder5.curveTo(13.0f, 12.55f, 12.55f, 13.0f, 12.0f, 13.0f);
        pathBuilder.close();
