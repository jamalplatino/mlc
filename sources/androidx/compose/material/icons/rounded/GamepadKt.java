...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gamepad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Gamepad", "Landroidx/compose/material/icons/Icons$Rounded;", "getGamepad", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class GamepadKt {
    ...
    public static final ImageVector getGamepad(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Gamepad", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.lineToRelative(2.5f, -2.5f);
        pathBuilder2.curveToRelative(0.09f, -0.09f, 0.14f, -0.21f, 0.14f, -0.35f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(-2.5f, -2.5f);
        pathBuilder2.curveTo(7.55f, 9.05f, 7.43f, 9.0f, 7.29f, 9.0f);
        pathBuilder.close();
        ...
        pathBuilder.verticalLineToRelative(-4.29f);
        pathBuilder3.curveToRelative(0.0f, -0.13f, -0.05f, -0.26f, -0.15f, -0.35f);
        pathBuilder.lineToRelative(-2.5f, -2.5f);
        pathBuilder3.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilder.lineToRelative(-2.5f, 2.5f);
        pathBuilder3.curveToRelative(-0.09f, 0.09f, -0.14f, 0.21f, -0.14f, 0.35f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(2.5f, 2.5f);
        pathBuilder4.curveToRelative(0.09f, 0.09f, 0.22f, 0.15f, 0.35f, 0.15f);
        ...
        pathBuilder.horizontalLineToRelative(-4.29f);
        pathBuilder5.curveToRelative(-0.14f, -0.01f, -0.26f, 0.04f, -0.36f, 0.14f);
        pathBuilder.close();
