...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_assuredWorkload", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AssuredWorkload", "Landroidx/compose/material/icons/Icons$Rounded;", "getAssuredWorkload", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AssuredWorkloadKt {
    ...
    public static final ImageVector getAssuredWorkload(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("Rounded.AssuredWorkload", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder.verticalLineToRelative(5.0f);
        pathBuilder2.curveTo(5.0f, 16.55f, 5.45f, 17.0f, 6.0f, 17.0f);
        ...
        pathBuilder4.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder3.verticalLineToRelative(5.0f);
        pathBuilder4.curveTo(11.0f, 16.55f, 11.45f, 17.0f, 12.0f, 17.0f);
        ...
        pathBuilder5.moveTo(21.32f, 5.66f);
        pathBuilder5.lineToRelative(-8.42f, -4.21f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveToRelative(-0.56f, -0.28f, -1.23f, -0.28f, -1.79f, 0.0f);
        pathBuilder5.lineTo(2.68f, 5.66f);
        pathBuilder6.curveTo(2.26f, 5.87f, 2.0f, 6.3f, 2.0f, 6.76f);
        pathBuilder5.verticalLineToRelative(0.0f);
        pathBuilder6.curveTo(2.0f, 7.45f, 2.55f, 8.0f, 3.24f, 8.0f);
        pathBuilder5.horizontalLineToRelative(17.53f);
        pathBuilder6.curveTo(21.45f, 8.0f, 22.0f, 7.45f, 22.0f, 6.76f);
        pathBuilder5.verticalLineToRelative(0.0f);
        pathBuilder6.curveTo(22.0f, 6.3f, 21.74f, 5.87f, 21.32f, 5.66f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(2.0f, 20.0f);
        pathBuilder7.lineTo(2.0f, 20.0f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder7.horizontalLineToRelative(11.4f);
        pathBuilder8.curveToRelative(-0.21f, -0.64f, -0.32f, -1.31f, -0.36f, -2.0f);
        pathBuilder7.horizontalLineTo(3.0f);
        pathBuilder8.curveTo(2.45f, 19.0f, 2.0f, 19.45f, 2.0f, 20.0f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(19.0f, 12.26f);
        ...
        pathBuilder9.lineTo(19.0f, 12.26f);
        pathBuilder9.close();
        ...
        pathBuilder11.moveTo(19.55f, 14.22f);
        pathBuilder11.lineToRelative(-3.0f, 1.5f);
        pathBuilder11.curveTo(16.21f, 15.89f, 16.0f, 16.24f, 16.0f, 16.62f);
        pathBuilder11.verticalLineToRelative(1.93f);
        PathBuilder pathBuilder12 = pathBuilder11;
        pathBuilder12.curveToRelative(0.0f, 2.52f, 1.71f, 4.88f, 4.0f, 5.45f);
        pathBuilder12.curveToRelative(2.29f, -0.57f, 4.0f, -2.93f, 4.0f, -5.45f);
        pathBuilder11.verticalLineToRelative(-1.93f);
        pathBuilder11.curveToRelative(0.0f, -0.38f, -0.21f, -0.73f, -0.55f, -0.89f);
        pathBuilder11.lineToRelative(-3.0f, -1.5f);
        pathBuilder11.curveTo(20.17f, 14.08f, 19.83f, 14.08f, 19.55f, 14.22f);
        pathBuilder11.close();
        pathBuilder11.moveTo(18.58f, 20.3f);
        pathBuilder11.lineToRelative(-0.8f, -0.8f);
        ...
        pathBuilder11.lineToRelative(0.44f, 0.44f);
        pathBuilder11.lineToRelative(1.88f, -1.85f);
        PathBuilder pathBuilder14 = pathBuilder11;
        pathBuilder14.curveToRelative(0.29f, -0.29f, 0.77f, -0.29f, 1.06f, 0.0f);
        pathBuilder11.lineToRelative(0.0f, 0.0f);
        pathBuilder14.curveToRelative(0.29f, 0.29f, 0.29f, 0.77f, 0.0f, 1.06f);
        pathBuilder11.lineToRelative(-2.23f, 2.21f);
        pathBuilder11.curveTo(19.6f, 20.69f, 18.97f, 20.69f, 18.58f, 20.3f);
        pathBuilder11.close();
