...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_screenRotationAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ScreenRotationAlt", "Landroidx/compose/material/icons/Icons$Rounded;", "getScreenRotationAlt", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ScreenRotationAltKt {
    ...
    public static final ImageVector getScreenRotationAlt(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.ScreenRotationAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(18.53f, 9.29f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveTo(19.16f, 9.92f, 18.71f, 11.0f, 17.82f, 11.0f);
        ...
        pathBuilder3.moveTo(5.47f, 14.71f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveTo(4.84f, 14.08f, 5.29f, 13.0f, 6.18f, 13.0f);
        pathBuilder4.curveToRelative(0.27f, 0.0f, 0.52f, 0.11f, 0.71f, 0.29f);
        pathBuilder3.lineTo(13.6f, 20.0f);
        pathBuilder3.lineToRelative(4.99f, -5.0f);
        ...
        pathBuilder3.lineTo(5.47f, 14.71f);
        pathBuilder3.close();
