...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_garage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Garage", "Landroidx/compose/material/icons/Icons$Rounded;", "getGarage", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class GarageKt {
    ...
    public static final ImageVector getGarage(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.Garage", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.moveTo(8.33f, 7.5f);
        pathBuilder5.lineToRelative(-0.66f, 2.0f);
        pathBuilder5.lineToRelative(8.66f, 0.0f);
        pathBuilder5.lineToRelative(-0.66f, -2.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.close();
        pathBuilder6.moveTo(19.0f, 17.69f);
        pathBuilder7.curveToRelative(0.0f, 0.45f, -0.35f, 0.81f, -0.78f, 0.81f);
        pathBuilder6.horizontalLineToRelative(-0.44f);
        pathBuilder7.curveToRelative(-0.44f, 0.0f, -0.78f, -0.36f, -0.78f, -0.81f);
        pathBuilder6.verticalLineTo(16.5f);
        pathBuilder6.horizontalLineTo(7.0f);
        pathBuilder6.verticalLineToRelative(1.19f);
        pathBuilder7.curveToRelative(0.0f, 0.45f, -0.35f, 0.81f, -0.78f, 0.81f);
        pathBuilder6.horizontalLineTo(5.78f);
        pathBuilder7.curveTo(5.35f, 18.5f, 5.0f, 18.14f, 5.0f, 17.69f);
        pathBuilder6.verticalLineToRelative(-6.5f);
        pathBuilder7.curveTo(5.82f, 8.72f, 6.34f, 7.16f, 6.56f, 6.5f);
        pathBuilder7.curveToRelative(0.05f, -0.16f, 0.12f, -0.29f, 0.19f, -0.4f);
        pathBuilder7.curveTo(6.77f, 6.08f, 6.78f, 6.06f, 6.8f, 6.04f);
        pathBuilder7.curveTo(7.18f, 5.51f, 7.72f, 5.5f, 7.72f, 5.5f);
        pathBuilder6.horizontalLineToRelative(8.56f);
        pathBuilder7.curveToRelative(0.0f, 0.0f, 0.54f, 0.01f, 0.92f, 0.53f);
        pathBuilder7.curveToRelative(0.02f, 0.03f, 0.03f, 0.05f, 0.05f, 0.07f);
        pathBuilder7.curveToRelative(0.07f, 0.11f, 0.14f, 0.24f, 0.19f, 0.4f);
        pathBuilder7.curveToRelative(0.22f, 0.66f, 0.74f, 2.23f, 1.56f, 4.69f);
        pathBuilder6.verticalLineTo(17.69f);
        pathBuilder6.close();
