...
public final class SupportAgentKt {
    ...
    public static final ImageVector getSupportAgent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.SupportAgent", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, -3.83f, 2.95f, -7.18f, 6.78f, -7.29f);
        pathBuilder2.curveToRelative(3.96f, -0.12f, 7.22f, 3.06f, 7.22f, 7.0f);
        ...
        pathBuilder2.curveToRelative(0.59f, -0.31f, 1.0f, -0.92f, 1.0f, -1.64f);
        pathBuilder.verticalLineToRelative(-2.3f);
        pathBuilder2.curveTo(22.0f, 13.14f, 21.59f, 12.53f, 21.0f, 12.22f);
        pathBuilder.close();
        ...
        pathBuilder7.moveTo(18.0f, 11.03f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveTo(17.52f, 8.18f, 15.04f, 6.0f, 12.05f, 6.0f);
        pathBuilder8.curveToRelative(-3.03f, 0.0f, -6.29f, 2.51f, -6.03f, 6.45f);
        pathBuilder8.curveToRelative(2.47f, -1.01f, 4.33f, -3.21f, 4.86f, -5.89f);
        pathBuilder8.curveTo(12.19f, 9.19f, 14.88f, 11.0f, 18.0f, 11.03f);
        pathBuilder7.close();
