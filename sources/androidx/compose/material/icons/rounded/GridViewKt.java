...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gridView", "Landroidx/compose/ui/graphics/vector/ImageVector;", "GridView", "Landroidx/compose/material/icons/Icons$Rounded;", "getGridView", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class GridViewKt {
    ...
    public static final ImageVector getGridView(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.GridView", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilder3.verticalLineToRelative(4.0f);
        pathBuilder4.curveTo(3.0f, 20.1f, 3.9f, 21.0f, 5.0f, 21.0f);
        pathBuilder3.close();
        ...
        pathBuilder6.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilder5.horizontalLineToRelative(-4.0f);
        pathBuilder6.curveTo(13.9f, 3.0f, 13.0f, 3.9f, 13.0f, 5.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(15.0f, 21.0f);
        ...
        pathBuilder8.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilder7.verticalLineToRelative(4.0f);
        pathBuilder8.curveTo(13.0f, 20.1f, 13.9f, 21.0f, 15.0f, 21.0f);
        pathBuilder7.close();
