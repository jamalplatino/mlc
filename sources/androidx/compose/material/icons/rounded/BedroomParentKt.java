...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomParent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomParent", "Landroidx/compose/material/icons/Icons$Rounded;", "getBedroomParent", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class BedroomParentKt {
    ...
    public static final ImageVector getBedroomParent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.BedroomParent", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.verticalLineToRelative(-1.0f);
        pathBuilder2.curveTo(17.5f, 12.45f, 17.05f, 12.0f, 16.5f, 12.0f);
        pathBuilder.close();
        ...
        pathBuilder4.moveTo(12.75f, 8.5f);
        ...
        pathBuilder5.close();
        pathBuilder5.moveTo(18.25f, 17.0f);
        pathBuilder5.lineTo(18.25f, 17.0f);
        ...
        pathBuilder6.curveTo(6.5f, 16.66f, 6.16f, 17.0f, 5.75f, 17.0f);
        pathBuilder5.horizontalLineToRelative(0.0f);
        pathBuilder6.curveTo(5.34f, 17.0f, 5.0f, 16.66f, 5.0f, 16.25f);
        pathBuilder5.verticalLineToRelative(-3.08f);
        pathBuilder6.curveToRelative(0.0f, -0.66f, 0.25f, -1.26f, 0.65f, -1.72f);
        pathBuilder5.verticalLineTo(9.0f);
        pathBuilder6.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilder5.horizontalLineTo(11.0f);
        pathBuilder6.curveToRelative(0.37f, 0.0f, 0.72f, 0.12f, 1.0f, 0.32f);
        pathBuilder6.curveTo(12.28f, 7.12f, 12.63f, 7.0f, 13.0f, 7.0f);
        pathBuilder5.horizontalLineToRelative(3.35f);
        pathBuilder6.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilder5.verticalLineToRelative(2.45f);
        pathBuilder6.curveToRelative(0.4f, 0.46f, 0.65f, 1.06f, 0.65f, 1.72f);
        pathBuilder5.verticalLineToRelative(3.08f);
        pathBuilder6.curveTo(19.0f, 16.66f, 18.66f, 17.0f, 18.25f, 17.0f);
        pathBuilder5.close();
