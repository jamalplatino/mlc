...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_densitySmall", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DensitySmall", "Landroidx/compose/material/icons/Icons$Rounded;", "getDensitySmall", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class DensitySmallKt {
    ...
    public static final ImageVector getDensitySmall(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.DensitySmall", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(4.0f, 22.0f);
        ...
        pathBuilder4.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder3.verticalLineToRelative(0.0f);
        pathBuilder4.curveTo(3.0f, 21.55f, 3.45f, 22.0f, 4.0f, 22.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(4.0f, 16.0f);
        ...
        pathBuilder6.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder5.verticalLineToRelative(0.0f);
        pathBuilder6.curveTo(3.0f, 15.55f, 3.45f, 16.0f, 4.0f, 16.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(4.0f, 10.0f);
        ...
        pathBuilder8.curveTo(3.45f, 8.0f, 3.0f, 8.45f, 3.0f, 9.0f);
        pathBuilder7.verticalLineToRelative(0.0f);
        pathBuilder8.curveTo(3.0f, 9.55f, 3.45f, 10.0f, 4.0f, 10.0f);
        pathBuilder7.close();
