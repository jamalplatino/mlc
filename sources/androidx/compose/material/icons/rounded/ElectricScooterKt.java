...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_electricScooter", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElectricScooter", "Landroidx/compose/material/icons/Icons$Rounded;", "getElectricScooter", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ElectricScooterKt {
    ...
    public static final ImageVector getElectricScooter(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.ElectricScooter", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(-2.16f, 0.65f, -3.81f, 2.48f, -4.19f, 4.75f);
        ...
        pathBuilder3.curveTo(1.7f, 16.34f, 3.16f, 18.0f, 5.0f, 18.0f);
        pathBuilder3.curveTo(6.3f, 18.0f, 7.4f, 17.16f, 7.82f, 16.0f);
        pathBuilder.close();
        ...
        pathBuilder4.reflectiveCurveTo(20.66f, 12.0f, 19.0f, 12.0f);
        pathBuilder4.close();
        pathBuilder4.moveTo(19.0f, 16.0f);
        ...
        pathBuilder4.reflectiveCurveTo(19.55f, 16.0f, 19.0f, 16.0f);
        pathBuilder4.close();
        ...
        pathBuilder6.moveTo(11.0f, 20.0f);
        pathBuilder6.lineToRelative(-4.0f, 0.0f);
        pathBuilder6.lineToRelative(6.0f, 3.0f);
