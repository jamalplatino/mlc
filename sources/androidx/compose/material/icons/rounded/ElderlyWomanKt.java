...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_elderlyWoman", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElderlyWoman", "Landroidx/compose/material/icons/Icons$Rounded;", "getElderlyWoman", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ElderlyWomanKt {
    ...
    public static final ImageVector getElderlyWoman(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.ElderlyWoman", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(14.12f, 7.1f, 13.63f, 6.0f, 12.34f, 6.0f);
        pathBuilder.lineToRelative(0.0f, 0.0f);
        pathBuilder2.curveTo(8.72f, 6.0f, 6.0f, 16.69f, 6.0f, 19.0f);
        pathBuilder.horizontalLineToRelative(2.5f);
        pathBuilder.lineTo(7.0f, 21.0f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveToRelative(-0.33f, 0.44f, -0.24f, 1.07f, 0.2f, 1.4f);
        pathBuilder3.curveToRelative(0.44f, 0.33f, 1.07f, 0.24f, 1.4f, -0.2f);
        ...
        pathBuilder4.curveToRelative(0.0f, -0.22f, -0.04f, -0.43f, -0.1f, -0.64f);
        pathBuilder.lineTo(13.0f, 13.0f);
        pathBuilder.lineToRelative(0.49f, -2.71f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(0.81f, 1.23f, 2.05f, 2.14f, 3.51f, 2.52f);
        ...
        pathBuilder6.moveTo(11.6f, 2.91f);
        PathBuilder pathBuilder7 = pathBuilder6;
        pathBuilder7.curveToRelative(-0.06f, 0.19f, -0.1f, 0.38f, -0.1f, 0.59f);
        ...
        pathBuilder8.curveToRelative(-0.21f, 0.0f, -0.4f, 0.04f, -0.59f, 0.1f);
        pathBuilder8.curveTo(12.76f, 1.25f, 12.41f, 1.0f, 12.0f, 1.0f);
        pathBuilder8.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder8.curveTo(11.0f, 2.41f, 11.25f, 2.76f, 11.6f, 2.91f);
        pathBuilder6.close();
