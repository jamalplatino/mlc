...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_hdrPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "HdrPlus", "Landroidx/compose/material/icons/Icons$Rounded;", "getHdrPlus", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class HdrPlusKt {
    ...
    public static final ImageVector getHdrPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.HdrPlus", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.2f, 0.46f, -0.14f, 0.97f, -0.64f, 0.97f);
        pathBuilder3.horizontalLineToRelative(0.0f);
        pathBuilder4.curveToRelative(-0.27f, 0.0f, -0.52f, -0.16f, -0.63f, -0.41f);
        pathBuilder3.lineTo(9.6f, 17.0f);
        pathBuilder3.horizontalLineTo(8.5f);
        pathBuilder3.verticalLineToRelative(1.31f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(8.5f, 18.69f, 8.19f, 19.0f, 7.81f, 19.0f);
        pathBuilder3.horizontalLineTo(7.69f);
        pathBuilder5.curveTo(7.31f, 19.0f, 7.0f, 18.69f, 7.0f, 18.31f);
        ...
        pathBuilder5.curveToRelative(0.82f, 0.0f, 1.5f, 0.68f, 1.5f, 1.5f);
        ...
        pathBuilder5.curveTo(8.5f, 11.66f, 8.16f, 12.0f, 7.75f, 12.0f);
        pathBuilder3.horizontalLineToRelative(0.0f);
        pathBuilder5.curveTo(7.34f, 12.0f, 7.0f, 11.66f, 7.0f, 11.25f);
        pathBuilder3.verticalLineToRelative(-4.5f);
        pathBuilder5.curveTo(7.0f, 6.34f, 7.34f, 6.0f, 7.75f, 6.0f);
        pathBuilder3.horizontalLineToRelative(0.0f);
        pathBuilder5.curveTo(8.16f, 6.0f, 8.5f, 6.34f, 8.5f, 6.75f);
        pathBuilder3.verticalLineTo(8.0f);
        pathBuilder3.horizontalLineToRelative(2.0f);
        pathBuilder3.verticalLineTo(6.75f);
        pathBuilder5.curveTo(10.5f, 6.34f, 10.84f, 6.0f, 11.25f, 6.0f);
        pathBuilder3.horizontalLineToRelative(0.0f);
        pathBuilder5.curveTo(11.66f, 6.0f, 12.0f, 6.34f, 12.0f, 6.75f);
        pathBuilder3.verticalLineToRelative(4.5f);
        pathBuilder5.curveTo(12.0f, 11.66f, 11.66f, 12.0f, 11.25f, 12.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.curveTo(13.34f, 16.0f, 13.0f, 15.66f, 13.0f, 15.25f);
        ...
        pathBuilder5.curveTo(17.5f, 15.66f, 17.16f, 16.0f, 16.75f, 16.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.curveTo(13.0f, 6.22f, 13.22f, 6.0f, 13.5f, 6.0f);
        pathBuilder3.horizontalLineTo(16.0f);
        pathBuilder5.curveToRelative(0.83f, 0.0f, 1.5f, 0.68f, 1.5f, 1.5f);
