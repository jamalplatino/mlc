...
public final class LocalCarWashKt {
    ...
    public static final ImageVector getLocalCarWash(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.LocalCarWash", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, -0.66f, -0.66f, -1.64f, -1.11f, -2.22f);
        pathBuilder2.curveToRelative(-0.2f, -0.26f, -0.59f, -0.26f, -0.79f, 0.0f);
        pathBuilder2.curveToRelative(-0.44f, 0.58f, -1.1f, 1.56f, -1.1f, 2.22f);
        ...
        pathBuilder3.curveToRelative(0.0f, -0.66f, -0.66f, -1.64f, -1.11f, -2.22f);
        pathBuilder3.curveToRelative(-0.2f, -0.26f, -0.59f, -0.26f, -0.79f, 0.0f);
        pathBuilder3.curveToRelative(-0.44f, 0.58f, -1.1f, 1.56f, -1.1f, 2.22f);
        pathBuilder3.curveTo(5.5f, 4.33f, 6.17f, 5.0f, 7.0f, 5.0f);
        pathBuilder.close();
        pathBuilder.moveTo(18.92f, 8.01f);
        pathBuilder.curveTo(18.72f, 7.42f, 18.16f, 7.0f, 17.5f, 7.0f);
        pathBuilder.horizontalLineToRelative(-11.0f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveToRelative(-0.66f, 0.0f, -1.21f, 0.42f, -1.42f, 1.01f);
        pathBuilder.lineToRelative(-1.97f, 5.67f);
        pathBuilder4.curveToRelative(-0.07f, 0.21f, -0.11f, 0.43f, -0.11f, 0.66f);
        ...
        pathBuilder5.curveToRelative(0.0f, 0.82f, 0.67f, 1.5f, 1.5f, 1.5f);
        pathBuilder5.curveToRelative(0.82f, 0.0f, 1.5f, -0.67f, 1.5f, -1.5f);
        pathBuilder.verticalLineToRelative(-7.16f);
