...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_insertPageBreak", "Landroidx/compose/ui/graphics/vector/ImageVector;", "InsertPageBreak", "Landroidx/compose/material/icons/Icons$Rounded;", "getInsertPageBreak", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class InsertPageBreakKt {
    ...
    public static final ImageVector getInsertPageBreak(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Rounded.InsertPageBreak", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(4.9f, 2.0f, 4.01f, 2.89f, 4.01f, 3.99f);
        ...
        pathBuilder4.lineTo(15.0f, 14.0f);
        ...
        pathBuilder5.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder4.horizontalLineToRelative(4.0f);
        pathBuilder5.curveTo(14.55f, 15.0f, 15.0f, 14.55f, 15.0f, 14.0f);
        pathBuilder4.close();
        ...
        pathBuilder6.moveTo(17.0f, 14.0f);
        pathBuilder6.lineTo(17.0f, 14.0f);
        ...
        pathBuilder7.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilder6.horizontalLineToRelative(-4.0f);
        pathBuilder7.curveTo(17.45f, 13.0f, 17.0f, 13.45f, 17.0f, 14.0f);
        pathBuilder6.close();
        ...
        pathBuilder8.moveTo(6.0f, 13.0f);
        pathBuilder8.horizontalLineTo(2.0f);
        ...
        pathBuilder9.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder8.verticalLineToRelative(0.0f);
        pathBuilder9.curveTo(7.0f, 13.45f, 6.55f, 13.0f, 6.0f, 13.0f);
        pathBuilder8.close();
