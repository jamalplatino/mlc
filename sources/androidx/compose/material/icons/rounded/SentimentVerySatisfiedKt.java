...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentVerySatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentVerySatisfied", "Landroidx/compose/material/icons/Icons$Rounded;", "getSentimentVerySatisfied", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SentimentVerySatisfiedKt {
    ...
    public static final ImageVector getSentimentVerySatisfied(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SentimentVerySatisfied", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(2.03f, 0.0f, 3.8f, -1.11f, 4.75f, -2.75f);
        pathBuilder4.curveToRelative(0.19f, -0.33f, -0.05f, -0.75f, -0.44f, -0.75f);
        pathBuilder.lineTo(7.69f, 14.0f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(-0.38f, 0.0f, -0.63f, 0.42f, -0.44f, 0.75f);
        pathBuilder5.curveToRelative(0.95f, 1.64f, 2.72f, 2.75f, 4.75f, 2.75f);
        pathBuilder.close();
        ...
        pathBuilder.lineToRelative(-0.88f, 0.88f);
        pathBuilder6.curveToRelative(-0.3f, 0.29f, -0.3f, 0.77f, -0.01f, 1.06f);
        pathBuilder.close();
        pathBuilder.moveTo(11.99f, 2.0f);
        pathBuilder6.curveTo(6.47f, 2.0f, 2.0f, 6.47f, 2.0f, 12.0f);
