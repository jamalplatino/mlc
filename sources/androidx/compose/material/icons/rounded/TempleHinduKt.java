...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_templeHindu", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TempleHindu", "Landroidx/compose/material/icons/Icons$Rounded;", "getTempleHindu", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class TempleHinduKt {
    ...
    public static final ImageVector getTempleHindu(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.TempleHindu", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.horizontalLineToRelative(0.0f);
        pathBuilder5.curveTo(20.45f, 11.0f, 20.0f, 11.45f, 20.0f, 12.0f);
        pathBuilder2.close();
        ...
        pathBuilder6.moveTo(15.9f, 6.0f);
        pathBuilder6.lineTo(15.0f, 3.0f);
        ...
        pathBuilder6.horizontalLineToRelative(-2.03f);
        pathBuilder6.verticalLineTo(2.0f);
        pathBuilder7.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilder6.horizontalLineToRelative(0.0f);
        pathBuilder7.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder6.verticalLineToRelative(1.12f);
        pathBuilder6.lineTo(8.1f, 6.0f);
        pathBuilder6.horizontalLineTo(15.9f);
        pathBuilder6.close();
