...
public final class LabelImportantKt {
    ...
    public static final ImageVector getLabelImportant(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.LabelImportant", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(16.26f, 5.31f, 15.65f, 5.0f, 15.0f, 5.0f);
        pathBuilder.horizontalLineTo(5.94f);
        pathBuilder2.curveToRelative(-0.81f, 0.0f, -1.28f, 0.93f, -0.81f, 1.59f);
