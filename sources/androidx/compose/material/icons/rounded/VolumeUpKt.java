...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_volumeUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "VolumeUp", "Landroidx/compose/material/icons/Icons$Rounded;", "getVolumeUp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class VolumeUpKt {
    ...
    public static final ImageVector getVolumeUp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.VolumeUp", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, 0.38f, 0.25f, 0.71f, 0.6f, 0.85f);
        pathBuilder2.curveTo(17.18f, 6.53f, 19.0f, 9.06f, 19.0f, 12.0f);
        pathBuilder.reflectiveCurveToRelative(-1.82f, 5.47f, -4.4f, 6.5f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveToRelative(-0.36f, 0.14f, -0.6f, 0.47f, -0.6f, 0.85f);
        pathBuilder.verticalLineToRelative(0.2f);
        pathBuilder3.curveToRelative(0.0f, 0.63f, 0.63f, 1.07f, 1.21f, 0.85f);
        pathBuilder3.curveTo(18.6f, 19.11f, 21.0f, 15.84f, 21.0f, 12.0f);
