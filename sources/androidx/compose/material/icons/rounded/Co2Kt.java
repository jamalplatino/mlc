...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_co2", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Co2", "Landroidx/compose/material/icons/Icons$Rounded;", "getCo2", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Co2Kt {
    ...
    public static final ImageVector getCo2(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Co2", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder.verticalLineToRelative(-4.0f);
        pathBuilder2.curveTo(15.0f, 9.45f, 14.55f, 9.0f, 14.0f, 9.0f);
        pathBuilder.close();
        ...
        pathBuilder6.curveTo(8.0f, 10.66f, 7.66f, 11.0f, 7.25f, 11.0f);
        pathBuilder6.curveToRelative(-0.33f, 0.0f, -0.6f, -0.21f, -0.71f, -0.5f);
        pathBuilder6.curveToRelative(0.0f, 0.0f, -2.04f, 0.0f, -2.04f, 0.0f);
        pathBuilder.verticalLineToRelative(3.0f);
        ...
        pathBuilder7.curveTo(7.66f, 13.0f, 8.0f, 13.34f, 8.0f, 13.75f);
