...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_hvac", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Hvac", "Landroidx/compose/material/icons/Icons$Rounded;", "getHvac", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class HvacKt {
    ...
    public static final ImageVector getHvac(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Rounded.Hvac", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(8.56f, 14.0f);
        ...
        pathBuilder3.curveTo(8.12f, 13.04f, 8.29f, 13.55f, 8.56f, 14.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.curveToRelative(-1.01f, 0.0f, -1.91f, 0.39f, -2.62f, 1.0f);
        pathBuilder4.horizontalLineToRelative(5.24f);
        pathBuilder4.curveTo(13.91f, 8.39f, 13.01f, 8.0f, 12.0f, 8.0f);
        pathBuilder4.close();
        ...
        pathBuilder5.moveTo(8.56f, 10.0f);
        pathBuilder5.curveToRelative(-0.26f, 0.45f, -0.44f, 0.96f, -0.51f, 1.5f);
        pathBuilder5.horizontalLineToRelative(7.9f);
        ...
        pathBuilder6.reflectiveCurveTo(15.31f, 18.0f, 12.0f, 18.0f);
        pathBuilder6.close();
