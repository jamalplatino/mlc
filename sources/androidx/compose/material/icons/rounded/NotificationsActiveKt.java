...
public final class NotificationsActiveKt {
    ...
    public static final ImageVector getNotificationsActive(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.NotificationsActive", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.42f, -0.38f, 0.43f, -1.03f, 0.03f, -1.43f);
        pathBuilder2.curveToRelative(-0.38f, -0.38f, -1.0f, -0.39f, -1.39f, -0.02f);
        pathBuilder2.curveTo(3.7f, 4.84f, 2.52f, 6.96f, 2.14f, 9.34f);
        pathBuilder2.curveToRelative(-0.09f, 0.61f, 0.38f, 1.16f, 1.0f, 1.16f);
        pathBuilder2.curveToRelative(0.48f, 0.0f, 0.9f, -0.35f, 0.98f, -0.83f);
        pathBuilder2.curveToRelative(0.3f, -1.94f, 1.26f, -3.67f, 2.65f, -4.94f);
        pathBuilder.close();
        pathBuilder.moveTo(18.6f, 3.28f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveToRelative(-0.4f, -0.37f, -1.02f, -0.36f, -1.4f, 0.02f);
        pathBuilder3.curveToRelative(-0.4f, 0.4f, -0.38f, 1.04f, 0.03f, 1.42f);
        pathBuilder3.curveToRelative(1.38f, 1.27f, 2.35f, 3.0f, 2.65f, 4.94f);
        pathBuilder3.curveToRelative(0.07f, 0.48f, 0.49f, 0.83f, 0.98f, 0.83f);
        pathBuilder3.curveToRelative(0.61f, 0.0f, 1.09f, -0.55f, 0.99f, -1.16f);
        pathBuilder3.curveToRelative(-0.38f, -2.37f, -1.55f, -4.48f, -3.25f, -6.05f);
        pathBuilder.close();
