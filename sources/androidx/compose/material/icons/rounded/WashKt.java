...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Wash", "Landroidx/compose/material/icons/Icons$Rounded;", "getWash", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class WashKt {
    ...
    public static final ImageVector getWash(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Wash", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder7.curveTo(19.88f, 8.0f, 21.0f, 6.88f, 21.0f, 5.5f);
        pathBuilder7.curveToRelative(0.0f, -1.25f, -1.41f, -3.16f, -2.11f, -4.04f);
        pathBuilder7.curveToRelative(-0.2f, -0.25f, -0.57f, -0.25f, -0.77f, 0.0f);
        pathBuilder7.curveTo(17.41f, 2.34f, 16.0f, 4.25f, 16.0f, 5.5f);
        pathBuilder7.curveTo(16.0f, 6.88f, 17.12f, 8.0f, 18.5f, 8.0f);
        pathBuilder.close();
        pathBuilder.moveTo(13.5f, 9.0f);
        PathBuilder pathBuilder8 = pathBuilder;
        pathBuilder8.curveTo(14.33f, 9.0f, 15.0f, 8.33f, 15.0f, 7.5f);
        pathBuilder8.curveToRelative(0.0f, -0.56f, -0.67f, -1.49f, -1.11f, -2.04f);
        pathBuilder8.curveToRelative(-0.2f, -0.25f, -0.58f, -0.25f, -0.77f, 0.0f);
        pathBuilder8.curveTo(12.67f, 6.01f, 12.0f, 6.94f, 12.0f, 7.5f);
        pathBuilder8.curveTo(12.0f, 8.33f, 12.67f, 9.0f, 13.5f, 9.0f);
        pathBuilder.close();
