...
public final class LocalPrintshopKt {
    ...
    public static final ImageVector getLocalPrintshop(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.LocalPrintshop", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.verticalLineToRelative(-5.0f);
        pathBuilder6.curveTo(22.0f, 9.34f, 20.66f, 8.0f, 19.0f, 8.0f);
        pathBuilder3.close();
