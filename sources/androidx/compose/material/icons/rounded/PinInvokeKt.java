...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_pinInvoke", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PinInvoke", "Landroidx/compose/material/icons/Icons$Rounded;", "getPinInvoke", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PinInvokeKt {
    ...
    public static final ImageVector getPinInvoke(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.PinInvoke", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(14.46f, 15.12f, 15.0f, 14.9f, 15.0f, 14.45f);
        ...
        pathBuilder.lineToRelative(1.27f, 1.27f);
        pathBuilder.lineToRelative(-2.12f, 2.12f);
        pathBuilder5.curveTo(8.95f, 14.63f, 8.95f, 15.27f, 9.34f, 15.66f);
        pathBuilder.close();
