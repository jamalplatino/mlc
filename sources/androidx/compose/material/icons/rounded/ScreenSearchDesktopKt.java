...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_screenSearchDesktop", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ScreenSearchDesktop", "Landroidx/compose/material/icons/Icons$Rounded;", "getScreenSearchDesktop", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ScreenSearchDesktopKt {
    ...
    public static final ImageVector getScreenSearchDesktop(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.ScreenSearchDesktop", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder2.curveTo(23.0f, 19.45f, 22.55f, 19.0f, 22.0f, 19.0f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(2.0f, 17.1f, 2.9f, 18.0f, 4.0f, 18.0f);
        pathBuilder3.close();
        pathBuilder3.moveTo(8.59f, 8.05f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(9.87f, 6.18f, 12.45f, 6.0f, 13.97f, 7.53f);
        pathBuilder5.curveToRelative(1.18f, 1.18f, 1.34f, 3.0f, 0.47f, 4.36f);
        pathBuilder3.lineTo(16.0f, 13.44f);
        ...
        pathBuilder5.curveToRelative(-1.57f, 1.0f, -3.76f, 0.64f, -4.87f, -1.11f);
        pathBuilder5.curveTo(7.79f, 10.7f, 7.83f, 9.17f, 8.59f, 8.05f);
        pathBuilder3.close();
        ...
        pathBuilder6.moveTo(11.5f, 10.0f);
