...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_cardGiftcard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "CardGiftcard", "Landroidx/compose/material/icons/Icons$Rounded;", "getCardGiftcard", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class CardGiftcardKt {
    ...
    public static final ImageVector getCardGiftcard(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.CardGiftcard", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveToRelative(-0.33f, 0.45f, -0.23f, 1.08f, 0.22f, 1.4f);
        pathBuilder5.curveToRelative(0.44f, 0.32f, 1.07f, 0.22f, 1.39f, -0.22f);
        pathBuilder.lineTo(12.0f, 7.4f);
        pathBuilder.lineToRelative(2.79f, 3.8f);
        PathBuilder pathBuilder6 = pathBuilder;
        pathBuilder6.curveToRelative(0.32f, 0.44f, 0.95f, 0.54f, 1.39f, 0.22f);
        pathBuilder6.curveToRelative(0.45f, -0.32f, 0.55f, -0.95f, 0.22f, -1.4f);
