...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_readMore", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ReadMore", "Landroidx/compose/material/icons/Icons$Rounded;", "getReadMore", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ReadMoreKt {
    ...
    public static final ImageVector getReadMore(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Rounded.ReadMore", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder.horizontalLineToRelative(-7.0f);
        pathBuilder2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder2.curveTo(13.0f, 8.55f, 13.45f, 9.0f, 14.0f, 9.0f);
        pathBuilder.close();
        ...
        pathBuilder3.horizontalLineToRelative(7.0f);
        pathBuilder4.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder4.curveTo(22.0f, 15.45f, 21.55f, 15.0f, 21.0f, 15.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(21.0f, 11.0f);
        ...
        pathBuilder5.horizontalLineToRelative(4.0f);
        pathBuilder6.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder6.curveTo(22.0f, 11.45f, 21.55f, 11.0f, 21.0f, 11.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(8.85f, 7.85f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveTo(8.54f, 7.54f, 8.0f, 7.76f, 8.0f, 8.21f);
        ...
        pathBuilder8.curveToRelative(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.35f);
        pathBuilder7.lineToRelative(3.79f, -3.79f);
        pathBuilder7.curveToRelative(0.2f, -0.2f, 0.2f, -0.51f, 0.0f, -0.71f);
        pathBuilder7.lineTo(8.85f, 7.85f);
        pathBuilder7.close();
