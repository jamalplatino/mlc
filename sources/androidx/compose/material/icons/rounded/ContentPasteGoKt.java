...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_contentPasteGo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ContentPasteGo", "Landroidx/compose/material/icons/Icons$Rounded;", "getContentPasteGo", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ContentPasteGoKt {
    ...
    public static final ImageVector getContentPasteGo(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.ContentPasteGo", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(21.29f, 16.29f);
        pathBuilder4.lineToRelative(-2.58f, -2.58f);
        ...
        pathBuilder4.lineToRelative(0.87f, 0.88f);
        ...
        pathBuilder4.horizontalLineToRelative(5.17f);
        pathBuilder4.lineToRelative(-0.87f, 0.88f);
        ...
        pathBuilder4.lineToRelative(2.58f, -2.58f);
        pathBuilder4.curveTo(21.68f, 17.31f, 21.68f, 16.68f, 21.29f, 16.29f);
        pathBuilder4.close();
