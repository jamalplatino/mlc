...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulbCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LightbulbCircle", "Landroidx/compose/material/icons/Icons$Rounded;", "getLightbulbCircle", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LightbulbCircleKt {
    ...
    public static final ImageVector getLightbulbCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.LightbulbCircle", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(9.34f, 16.5f, 9.0f, 16.16f, 9.0f, 15.75f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder3.curveTo(9.0f, 15.34f, 9.34f, 15.0f, 9.75f, 15.0f);
        pathBuilder.horizontalLineToRelative(4.5f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilder.verticalLineToRelative(0.0f);
        pathBuilder4.curveTo(15.0f, 16.16f, 14.66f, 16.5f, 14.25f, 16.5f);
        pathBuilder.close();
        pathBuilder.moveTo(14.97f, 14.0f);
        pathBuilder.horizontalLineTo(9.03f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveTo(7.8f, 13.09f, 7.0f, 11.64f, 7.0f, 10.0f);
