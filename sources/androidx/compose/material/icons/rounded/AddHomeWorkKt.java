...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_addHomeWork", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AddHomeWork", "Landroidx/compose/material/icons/Icons$Rounded;", "getAddHomeWork", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AddHomeWorkKt {
    ...
    public static final ImageVector getAddHomeWork(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.AddHomeWork", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(14.96f, 11.7f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(-0.09f, -0.52f, -0.36f, -0.99f, -0.8f, -1.3f);
        pathBuilder.lineToRelative(-5.0f, -3.57f);
        pathBuilder2.curveToRelative(-0.7f, -0.5f, -1.63f, -0.5f, -2.32f, 0.0f);
        pathBuilder.lineToRelative(-5.0f, 3.57f);
        pathBuilder2.curveTo(1.31f, 10.78f, 1.0f, 11.38f, 1.0f, 12.03f);
        ...
        pathBuilder3.curveTo(11.25f, 20.09f, 11.0f, 19.08f, 11.0f, 18.0f);
        pathBuilder3.curveTo(11.0f, 15.22f, 12.62f, 12.83f, 14.96f, 11.7f);
        pathBuilder.close();
        ImageVector.Builder.m3530addPathoIyEayM$default(builder3, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, r22, r23, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        int r39 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r40 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder4 = new PathBuilder();
        pathBuilder4.moveTo(23.0f, 13.11f);
        pathBuilder4.verticalLineTo(4.97f);
        pathBuilder4.curveTo(23.0f, 3.88f, 22.12f, 3.0f, 21.03f, 3.0f);
        pathBuilder4.horizontalLineToRelative(-9.06f);
        pathBuilder4.curveTo(10.88f, 3.0f, 10.0f, 3.88f, 10.0f, 4.97f);
        pathBuilder4.lineToRelative(0.02f, 0.05f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveToRelative(0.1f, 0.06f, 0.21f, 0.11f, 0.3f, 0.18f);
        pathBuilder4.lineToRelative(5.0f, 3.57f);
        pathBuilder5.curveToRelative(0.79f, 0.56f, 1.34f, 1.4f, 1.56f, 2.32f);
        pathBuilder5.curveTo(17.25f, 11.04f, 17.62f, 11.0f, 18.0f, 11.0f);
        pathBuilder5.curveTo(19.96f, 11.0f, 21.73f, 11.81f, 23.0f, 13.11f);
        pathBuilder4.close();
        ...
        pathBuilder6.moveTo(23.0f, 18.0f);
        ...
        pathBuilder6.reflectiveCurveTo(23.0f, 20.76f, 23.0f, 18.0f);
        pathBuilder6.close();
        pathBuilder6.moveTo(17.5f, 21.0f);
        ...
        pathBuilder6.horizontalLineTo(17.5f);
        pathBuilder6.close();
