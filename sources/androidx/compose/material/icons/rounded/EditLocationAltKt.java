...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_editLocationAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EditLocationAlt", "Landroidx/compose/material/icons/Icons$Rounded;", "getEditLocationAlt", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class EditLocationAltKt {
    ...
    public static final ImageVector getEditLocationAlt(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Rounded.EditLocationAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(9.0f, 8.2f, 9.11f, 7.94f, 9.29f, 7.76f);
        ...
        pathBuilder2.curveToRelative(0.0f, 3.18f, 2.44f, 6.92f, 7.33f, 11.22f);
        pathBuilder2.curveToRelative(0.38f, 0.33f, 0.96f, 0.33f, 1.34f, 0.0f);
        pathBuilder2.curveTo(17.56f, 17.12f, 20.0f, 13.37f, 20.0f, 10.2f);
        pathBuilder2.curveToRelative(0.0f, -1.01f, -0.16f, -1.94f, -0.45f, -2.8f);
        pathBuilder.lineToRelative(-5.31f, 5.31f);
        pathBuilder2.curveTo(14.06f, 12.89f, 13.8f, 13.0f, 13.54f, 13.0f);
        pathBuilder.close();
        ...
        pathBuilder3.lineToRelative(6.16f, -6.16f);
        ...
        pathBuilder4.moveTo(20.71f, 2.0f);
        pathBuilder4.lineTo(20.0f, 1.29f);
        ...
        pathBuilder4.lineToRelative(0.72f, -0.72f);
        pathBuilder4.curveTo(21.1f, 3.02f, 21.1f, 2.39f, 20.71f, 2.0f);
        pathBuilder4.close();
