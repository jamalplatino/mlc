...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_synagogue", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Synagogue", "Landroidx/compose/material/icons/Icons$Rounded;", "getSynagogue", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SynagogueKt {
    ...
    public static final ImageVector getSynagogue(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Rounded.Synagogue", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(12.92f, 13.82f, 14.0f, 14.79f, 14.0f, 16.0f);
        pathBuilder.verticalLineToRelative(5.0f);
        pathBuilder.horizontalLineToRelative(4.0f);
        pathBuilder.verticalLineTo(8.94f);
        pathBuilder2.curveToRelative(0.0f, -0.59f, -0.26f, -1.16f, -0.72f, -1.54f);
        pathBuilder.lineToRelative(-4.0f, -3.33f);
        pathBuilder2.curveToRelative(-0.74f, -0.62f, -1.82f, -0.62f, -2.56f, 0.0f);
        pathBuilder.lineToRelative(-4.0f, 3.33f);
        pathBuilder2.curveTo(6.26f, 7.78f, 6.0f, 8.34f, 6.0f, 8.94f);
        pathBuilder.close();
        ...
        pathBuilder4.curveTo(1.9f, 5.0f, 1.0f, 5.9f, 1.0f, 7.0f);
        pathBuilder3.verticalLineToRelative(1.0f);
        pathBuilder3.horizontalLineToRelative(4.0f);
        pathBuilder3.verticalLineTo(7.0f);
        pathBuilder4.curveTo(5.0f, 5.9f, 4.1f, 5.0f, 3.0f, 5.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.curveTo(1.0f, 20.1f, 1.9f, 21.0f, 3.0f, 21.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(21.0f, 5.0f);
        ...
        pathBuilder7.curveTo(23.0f, 5.9f, 22.1f, 5.0f, 21.0f, 5.0f);
        pathBuilder6.close();
        ...
        pathBuilder8.moveTo(19.0f, 21.0f);
