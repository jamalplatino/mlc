...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_groups2", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Groups2", "Landroidx/compose/material/icons/Icons$Rounded;", "getGroups2", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class Groups2Kt {
    ...
    public static final ImageVector getGroups2(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("Rounded.Groups2", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(1.66f, 11.11f);
        ...
        pathBuilder5.lineTo(6.0f, 17.0f);
        ...
        pathBuilder7.moveTo(1.22f, 14.58f);
        PathBuilder pathBuilder8 = pathBuilder7;
        pathBuilder8.curveTo(0.48f, 14.9f, 0.0f, 15.62f, 0.0f, 16.43f);
        pathBuilder7.lineTo(0.0f, 17.0f);
        pathBuilder8.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilder7.lineToRelative(3.5f, 0.0f);
        pathBuilder7.verticalLineToRelative(-1.61f);
        pathBuilder8.curveToRelative(0.0f, -0.83f, 0.23f, -1.61f, 0.63f, -2.29f);
        pathBuilder8.curveTo(4.76f, 14.04f, 4.39f, 14.0f, 4.0f, 14.0f);
        pathBuilder8.curveTo(3.01f, 14.0f, 2.07f, 14.21f, 1.22f, 14.58f);
        pathBuilder7.close();
        ...
        pathBuilder9.moveTo(22.78f, 14.58f);
        PathBuilder pathBuilder10 = pathBuilder9;
        pathBuilder10.curveTo(21.93f, 14.21f, 20.99f, 14.0f, 20.0f, 14.0f);
        pathBuilder10.curveToRelative(-0.39f, 0.0f, -0.76f, 0.04f, -1.13f, 0.1f);
        pathBuilder10.curveToRelative(0.4f, 0.68f, 0.63f, 1.46f, 0.63f, 2.29f);
        pathBuilder9.verticalLineTo(18.0f);
        pathBuilder9.lineToRelative(3.5f, 0.0f);
        pathBuilder10.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilder9.lineToRelative(0.0f, -0.57f);
        ...
        pathBuilder11.moveTo(22.0f, 11.0f);
        pathBuilder11.verticalLineToRelative(-0.5f);
        pathBuilder11.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilder11.horizontalLineToRelative(-2.0f);
        pathBuilder11.curveToRelative(-0.42f, 0.0f, -0.65f, 0.48f, -0.39f, 0.81f);
        pathBuilder11.lineToRelative(0.7f, 0.63f);
        PathBuilder pathBuilder12 = pathBuilder11;
        pathBuilder12.curveTo(18.12f, 10.25f, 18.0f, 10.61f, 18.0f, 11.0f);
        pathBuilder12.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilder11.reflectiveCurveTo(22.0f, 12.1f, 22.0f, 11.0f);
        pathBuilder11.close();
