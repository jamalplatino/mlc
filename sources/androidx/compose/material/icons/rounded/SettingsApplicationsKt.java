...
public final class SettingsApplicationsKt {
    ...
    public static final ImageVector getSettingsApplications(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Rounded.SettingsApplications", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(21.0f, 3.9f, 20.11f, 3.0f, 19.0f, 3.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.curveToRelative(0.18f, 0.16f, 0.22f, 0.42f, 0.1f, 0.63f);
        pathBuilder3.lineToRelative(-0.59f, 1.02f);
        pathBuilder5.curveToRelative(-0.12f, 0.21f, -0.37f, 0.3f, -0.59f, 0.22f);
        ...
        pathBuilder5.curveToRelative(-0.05f, 0.23f, -0.25f, 0.4f, -0.49f, 0.4f);
        pathBuilder3.horizontalLineToRelative(-1.18f);
        PathBuilder pathBuilder6 = pathBuilder3;
        pathBuilder6.curveToRelative(-0.24f, 0.0f, -0.44f, -0.17f, -0.49f, -0.4f);
        pathBuilder3.lineToRelative(-0.22f, -1.09f);
        pathBuilder6.curveToRelative(-0.4f, -0.15f, -0.76f, -0.36f, -1.08f, -0.63f);
        pathBuilder3.lineToRelative(-1.06f, 0.36f);
        pathBuilder6.curveToRelative(-0.23f, 0.08f, -0.47f, -0.02f, -0.59f, -0.22f);
        pathBuilder3.lineToRelative(-0.59f, -1.02f);
        pathBuilder6.curveToRelative(-0.12f, -0.21f, -0.08f, -0.47f, 0.1f, -0.63f);
        pathBuilder3.lineToRelative(0.84f, -0.73f);
        pathBuilder6.curveTo(8.28f, 12.42f, 8.25f, 12.22f, 8.25f, 12.0f);
        pathBuilder3.reflectiveCurveToRelative(0.03f, -0.42f, 0.06f, -0.63f);
        pathBuilder3.lineToRelative(-0.84f, -0.73f);
        PathBuilder pathBuilder7 = pathBuilder3;
        pathBuilder7.curveToRelative(-0.18f, -0.16f, -0.22f, -0.42f, -0.1f, -0.63f);
        pathBuilder3.lineToRelative(0.59f, -1.02f);
        pathBuilder7.curveToRelative(0.12f, -0.21f, 0.37f, -0.3f, 0.59f, -0.22f);
        pathBuilder3.lineToRelative(1.06f, 0.36f);
        pathBuilder7.curveToRelative(0.32f, -0.27f, 0.68f, -0.48f, 1.08f, -0.63f);
        pathBuilder3.lineToRelative(0.22f, -1.09f);
        pathBuilder7.curveTo(10.97f, 7.17f, 11.17f, 7.0f, 11.41f, 7.0f);
        pathBuilder3.horizontalLineToRelative(1.18f);
        PathBuilder pathBuilder8 = pathBuilder3;
        pathBuilder8.curveToRelative(0.24f, 0.0f, 0.44f, 0.17f, 0.49f, 0.4f);
        pathBuilder3.lineToRelative(0.22f, 1.09f);
        pathBuilder8.curveToRelative(0.4f, 0.15f, 0.76f, 0.36f, 1.08f, 0.63f);
        pathBuilder3.lineToRelative(1.06f, -0.36f);
        pathBuilder8.curveToRelative(0.23f, -0.08f, 0.47f, 0.02f, 0.59f, 0.22f);
        pathBuilder3.lineToRelative(0.59f, 1.02f);
        pathBuilder8.curveToRelative(0.12f, 0.21f, 0.08f, 0.47f, -0.1f, 0.63f);
        pathBuilder3.lineToRelative(-0.84f, 0.73f);
        pathBuilder3.curveTo(15.72f, 11.58f, 15.75f, 11.78f, 15.75f, 12.0f);
        pathBuilder3.close();
