...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentVeryDissatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentVeryDissatisfied", "Landroidx/compose/material/icons/Icons$Rounded;", "getSentimentVeryDissatisfied", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SentimentVeryDissatisfiedKt {
    ...
    public static final ImageVector getSentimentVeryDissatisfied(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.SentimentVeryDissatisfied", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        int r22 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r23 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(12.0f, 13.5f);
        PathBuilder pathBuilder2 = pathBuilder;
        pathBuilder2.curveToRelative(-2.03f, 0.0f, -3.8f, 1.11f, -4.75f, 2.75f);
        pathBuilder2.curveToRelative(-0.19f, 0.33f, 0.06f, 0.75f, 0.44f, 0.75f);
        pathBuilder.horizontalLineToRelative(8.62f);
        PathBuilder pathBuilder3 = pathBuilder;
        pathBuilder3.curveToRelative(0.38f, 0.0f, 0.63f, -0.42f, 0.44f, -0.75f);
        pathBuilder3.curveToRelative(-0.95f, -1.64f, -2.72f, -2.75f, -4.75f, -2.75f);
        pathBuilder.close();
