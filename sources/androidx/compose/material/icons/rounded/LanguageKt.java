...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_language", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Language", "Landroidx/compose/material/icons/Icons$Rounded;", "getLanguage", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LanguageKt {
    ...
    public static final ImageVector getLanguage(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.Language", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.32f, 1.25f, 0.78f, 2.45f, 1.38f, 3.56f);
        pathBuilder4.curveToRelative(-1.84f, -0.63f, -3.37f, -1.9f, -4.33f, -3.56f);
        pathBuilder.close();
        pathBuilder.moveTo(8.03f, 8.0f);
        pathBuilder.lineTo(5.08f, 8.0f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(0.96f, -1.66f, 2.49f, -2.93f, 4.33f, -3.56f);
        pathBuilder5.curveTo(8.81f, 5.55f, 8.35f, 6.75f, 8.03f, 8.0f);
        pathBuilder.close();
