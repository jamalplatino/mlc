...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_removeRoad", "Landroidx/compose/ui/graphics/vector/ImageVector;", "RemoveRoad", "Landroidx/compose/material/icons/Icons$Rounded;", "getRemoveRoad", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class RemoveRoadKt {
    ...
    public static final ImageVector getRemoveRoad(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder7 = new ImageVector.Builder("Rounded.RemoveRoad", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.curveTo(11.0f, 7.55f, 11.45f, 8.0f, 12.0f, 8.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.lineTo(12.0f, 14.0f);
        ...
        pathBuilder8.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder7.verticalLineToRelative(2.0f);
        pathBuilder8.curveTo(11.0f, 13.55f, 11.45f, 14.0f, 12.0f, 14.0f);
        pathBuilder7.close();
        ...
        pathBuilder9.lineTo(12.0f, 20.0f);
        ...
        pathBuilder10.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder9.verticalLineToRelative(2.0f);
        pathBuilder10.curveTo(11.0f, 19.55f, 11.45f, 20.0f, 12.0f, 20.0f);
        pathBuilder9.close();
        ...
        pathBuilder11.moveTo(21.79f, 15.71f);
        pathBuilder11.lineTo(21.79f, 15.71f);
        pathBuilder11.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilder11.lineTo(19.0f, 17.09f);
        pathBuilder11.lineToRelative(-1.38f, -1.38f);
        ...
        pathBuilder12.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilder11.lineTo(19.0f, 19.91f);
        pathBuilder11.lineToRelative(1.38f, 1.38f);
        ...
        pathBuilder11.lineToRelative(-1.38f, -1.38f);
        pathBuilder11.lineToRelative(1.38f, -1.38f);
        pathBuilder13.curveTo(22.18f, 16.73f, 22.18f, 16.1f, 21.79f, 15.71f);
        pathBuilder11.close();
