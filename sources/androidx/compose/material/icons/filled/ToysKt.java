...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_toys", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Toys", "Landroidx/compose/material/icons/Icons$Filled;", "getToys", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ToysKt {
    ...
    public static final ImageVector getToys(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.Toys", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveToRelative(0.0f, 1.5f, 0.83f, 2.79f, 2.05f, 3.48f);
        pathBuilder4.curveTo(4.28f, 18.9f, 5.51f, 20.0f, 7.0f, 20.0f);
        ...
        pathBuilder5.curveToRelative(1.49f, 0.0f, 2.72f, -1.1f, 2.95f, -2.52f);
        pathBuilder5.curveTo(21.17f, 16.79f, 22.0f, 15.5f, 22.0f, 14.0f);
        pathBuilder.close();
