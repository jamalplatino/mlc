...
public final class LanguageKt {
    ...
    public static final ImageVector getLanguage(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.Language", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.43f, -1.43f, 1.08f, -2.76f, 1.91f, -3.96f);
        pathBuilder.close();
        pathBuilder.moveTo(4.26f, 14.0f);
        pathBuilder3.curveTo(4.1f, 13.36f, 4.0f, 12.69f, 4.0f, 12.0f);
        pathBuilder.reflectiveCurveToRelative(0.1f, -1.36f, 0.26f, -2.0f);
        pathBuilder.horizontalLineToRelative(3.38f);
        PathBuilder pathBuilder4 = pathBuilder;
        pathBuilder4.curveToRelative(-0.08f, 0.66f, -0.14f, 1.32f, -0.14f, 2.0f);
        pathBuilder4.curveToRelative(0.0f, 0.68f, 0.06f, 1.34f, 0.14f, 2.0f);
        pathBuilder.lineTo(4.26f, 14.0f);
        pathBuilder.close();
        pathBuilder.moveTo(5.08f, 16.0f);
        pathBuilder.horizontalLineToRelative(2.95f);
        PathBuilder pathBuilder5 = pathBuilder;
        pathBuilder5.curveToRelative(0.32f, 1.25f, 0.78f, 2.45f, 1.38f, 3.56f);
        pathBuilder5.curveToRelative(-1.84f, -0.63f, -3.37f, -1.9f, -4.33f, -3.56f);
        pathBuilder.close();
        pathBuilder.moveTo(8.03f, 8.0f);
        pathBuilder.lineTo(5.08f, 8.0f);
        PathBuilder pathBuilder6 = pathBuilder;
        pathBuilder6.curveToRelative(0.96f, -1.66f, 2.49f, -2.93f, 4.33f, -3.56f);
        pathBuilder6.curveTo(8.81f, 5.55f, 8.35f, 6.75f, 8.03f, 8.0f);
        pathBuilder.close();
        ...
        pathBuilder7.curveToRelative(-0.09f, -0.66f, -0.16f, -1.32f, -0.16f, -2.0f);
        pathBuilder7.curveToRelative(0.0f, -0.68f, 0.07f, -1.35f, 0.16f, -2.0f);
        pathBuilder.horizontalLineToRelative(4.68f);
        PathBuilder pathBuilder8 = pathBuilder;
        pathBuilder8.curveToRelative(0.09f, 0.65f, 0.16f, 1.32f, 0.16f, 2.0f);
        pathBuilder8.curveToRelative(0.0f, 0.68f, -0.07f, 1.34f, -0.16f, 2.0f);
        pathBuilder.close();
        pathBuilder.moveTo(14.59f, 19.56f);
        PathBuilder pathBuilder9 = pathBuilder;
        pathBuilder9.curveToRelative(0.6f, -1.11f, 1.06f, -2.31f, 1.38f, -3.56f);
        pathBuilder.horizontalLineToRelative(2.95f);
        pathBuilder9.curveToRelative(-0.96f, 1.65f, -2.49f, 2.93f, -4.33f, 3.56f);
        pathBuilder.close();
        pathBuilder.moveTo(16.36f, 14.0f);
        PathBuilder pathBuilder10 = pathBuilder;
        pathBuilder10.curveToRelative(0.08f, -0.66f, 0.14f, -1.32f, 0.14f, -2.0f);
        pathBuilder10.curveToRelative(0.0f, -0.68f, -0.06f, -1.34f, -0.14f, -2.0f);
        pathBuilder.horizontalLineToRelative(3.38f);
        pathBuilder10.curveToRelative(0.16f, 0.64f, 0.26f, 1.31f, 0.26f, 2.0f);
        pathBuilder.reflectiveCurveToRelative(-0.1f, 1.36f, -0.26f, 2.0f);
        pathBuilder.horizontalLineToRelative(-3.38f);
        pathBuilder.close();
