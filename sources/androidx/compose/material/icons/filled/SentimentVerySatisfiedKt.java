...
public final class SentimentVerySatisfiedKt {
    ...
    public static final ImageVector getSentimentVerySatisfied(Icons.Filled filled) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Filled.SentimentVerySatisfied", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveToRelative(0.78f, 2.34f, 2.72f, 4.0f, 5.0f, 4.0f);
        pathBuilder5.reflectiveCurveToRelative(4.22f, -1.66f, 5.0f, -4.0f);
        pathBuilder5.lineTo(7.0f, 14.0f);
        pathBuilder5.close();
