...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_liquor", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Liquor", "Landroidx/compose/material/icons/Icons$Filled;", "getLiquor", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LiquorKt {
    ...
    public static final ImageVector getLiquor(Icons.Filled filled) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Filled.Liquor", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(19.28f, 8.09f, 19.0f, 7.71f, 19.0f, 7.28f);
        pathBuilder2.verticalLineTo(3.0f);
        pathBuilder3.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        pathBuilder2.horizontalLineToRelative(-3.0f);
        pathBuilder3.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilder2.verticalLineToRelative(4.28f);
        pathBuilder3.curveToRelative(0.0f, 0.43f, -0.28f, 0.81f, -0.68f, 0.95f);
        pathBuilder2.lineToRelative(-0.95f, 0.32f);
        pathBuilder3.curveTo(11.55f, 8.82f, 11.0f, 9.58f, 11.0f, 10.44f);
