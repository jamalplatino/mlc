...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stroller", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stroller", "Landroidx/compose/material/icons/Icons$Filled;", "getStroller", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class StrollerKt {
    ...
    public static final ImageVector getStroller(Icons.Filled filled) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Filled.Stroller", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.verticalLineTo(6.48f);
        PathBuilder pathBuilder6 = pathBuilder5;
        pathBuilder6.curveTo(22.0f, 4.56f, 20.52f, 3.0f, 18.65f, 3.0f);
        pathBuilder6.curveToRelative(-1.66f, 0.0f, -2.54f, 1.27f, -3.18f, 2.03f);
        pathBuilder5.lineToRelative(-8.8f, 10.32f);
        pathBuilder5.curveTo(6.12f, 16.0f, 6.58f, 17.0f, 7.43f, 17.0f);
        pathBuilder5.lineTo(15.0f, 17.0f);
        ...
        pathBuilder7.curveTo(17.58f, 5.59f, 17.97f, 5.0f, 18.65f, 5.0f);
        pathBuilder7.curveTo(19.42f, 5.0f, 20.0f, 5.66f, 20.0f, 6.48f);
        ...
        pathBuilder8.moveTo(14.3f, 4.1f);
        PathBuilder pathBuilder9 = pathBuilder8;
        pathBuilder9.curveTo(13.03f, 3.4f, 11.56f, 3.0f, 10.0f, 3.0f);
        pathBuilder9.curveTo(8.03f, 3.0f, 6.21f, 3.64f, 4.72f, 4.72f);
        pathBuilder8.lineToRelative(4.89f, 4.89f);
        pathBuilder8.lineTo(14.3f, 4.1f);
        pathBuilder8.close();
