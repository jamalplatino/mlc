...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_mediation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Mediation", "Landroidx/compose/material/icons/Icons$Filled;", "getMediation", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MediationKt {
    ...
    public static final ImageVector getMediation(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.Mediation", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(7.96f, 21.69f, 6.64f, 23.0f, 5.0f, 23.0f);
        ...
        pathBuilder3.curveTo(7.4f, 14.16f, 6.3f, 15.0f, 5.0f, 15.0f);
        ...
        pathBuilder4.curveToRelative(-0.32f, -2.23f, -1.69f, -4.1f, -3.59f, -5.14f);
        pathBuilder4.curveTo(6.78f, 6.55f, 5.95f, 7.0f, 5.0f, 7.0f);
        pathBuilder4.curveTo(3.34f, 7.0f, 2.0f, 5.66f, 2.0f, 4.0f);
        pathBuilder.reflectiveCurveToRelative(1.34f, -3.0f, 3.0f, -3.0f);
