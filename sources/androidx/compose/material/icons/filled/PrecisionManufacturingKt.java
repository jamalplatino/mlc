...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_precisionManufacturing", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PrecisionManufacturing", "Landroidx/compose/material/icons/Icons$Filled;", "getPrecisionManufacturing", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PrecisionManufacturingKt {
    ...
    public static final ImageVector getPrecisionManufacturing(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.PrecisionManufacturing", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.curveTo(8.34f, 4.65f, 6.98f, 3.73f, 5.4f, 4.07f);
        pathBuilder4.curveTo(4.24f, 4.32f, 3.25f, 5.32f, 3.04f, 6.5f);
        pathBuilder4.curveTo(2.82f, 7.82f, 3.5f, 8.97f, 4.52f, 9.58f);
        ...
        pathBuilder6.curveTo(20.75f, 8.2f, 20.31f, 8.03f, 19.93f, 8.21f);
        pathBuilder.close();
        pathBuilder.moveTo(6.0f, 8.0f);
        pathBuilder6.curveTo(5.45f, 8.0f, 5.0f, 7.55f, 5.0f, 7.0f);
