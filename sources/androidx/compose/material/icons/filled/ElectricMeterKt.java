...
public final class ElectricMeterKt {
    ...
    public static final ImageVector getElectricMeter(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.ElectricMeter", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(0.0f, 3.91f, 2.51f, 7.24f, 6.0f, 8.47f);
        ...
        pathBuilder3.curveToRelative(3.49f, -1.24f, 6.0f, -4.57f, 6.0f, -8.47f);
        pathBuilder3.curveTo(21.0f, 6.04f, 16.96f, 2.0f, 12.0f, 2.0f);
        pathBuilder.close();
