...
public final class NotListedLocationKt {
    ...
    public static final ImageVector getNotListedLocation(Icons.Filled filled) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Filled.NotListedLocation", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.0f, -2.84f, 2.62f, -2.62f, 2.62f, -4.38f);
        pathBuilder3.curveToRelative(0.0f, -0.96f, -0.79f, -1.75f, -1.75f, -1.75f);
