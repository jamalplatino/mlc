...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stream", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stream", "Landroidx/compose/material/icons/Icons$Filled;", "getStream", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class StreamKt {
    ...
    public static final ImageVector getStream(Icons.Filled filled) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Filled.Stream", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder7.moveTo(10.05f, 8.59f);
        pathBuilder7.lineTo(6.03f, 4.55f);
        pathBuilder7.horizontalLineToRelative(-0.01f);
        pathBuilder7.lineToRelative(-0.31f, -0.32f);
        pathBuilder7.lineToRelative(-1.42f, 1.41f);
        pathBuilder7.lineToRelative(4.02f, 4.05f);
        pathBuilder7.lineToRelative(0.01f, -0.01f);
        pathBuilder7.lineToRelative(0.31f, 0.32f);
        pathBuilder7.close();
        pathBuilder7.moveTo(13.943f, 8.617f);
        pathBuilder7.lineToRelative(4.405f, -4.392f);
        pathBuilder7.lineTo(19.76f, 5.64f);
        pathBuilder7.lineToRelative(-4.405f, 4.393f);
        pathBuilder7.close();
        pathBuilder7.moveTo(10.01f, 15.36f);
        pathBuilder7.lineToRelative(-1.42f, -1.41f);
        ...
        pathBuilder7.close();
        pathBuilder7.moveTo(19.76f, 18.3f);
        pathBuilder7.lineToRelative(-3.99f, -4.01f);
        pathBuilder7.lineToRelative(-0.36f, -0.35f);
        pathBuilder7.lineTo(14.0f, 15.35f);
        pathBuilder7.lineToRelative(3.99f, 4.01f);
        ...
        pathBuilder9.arcToRelative(2.0f, 2.0f, 0.0f, true, true, 4.0f, 0.0f);
        pathBuilder9.arcToRelative(2.0f, 2.0f, 0.0f, true, true, -4.0f, 0.0f);
