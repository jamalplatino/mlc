...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_linkedCamera", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LinkedCamera", "Landroidx/compose/material/icons/Icons$Filled;", "getLinkedCamera", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LinkedCameraKt {
    ...
    public static final ImageVector getLinkedCamera(Icons.Filled filled) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Filled.LinkedCamera", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(16.0f, 3.33f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveToRelative(2.58f, 0.0f, 4.67f, 2.09f, 4.67f, 4.67f);
        pathBuilder3.horizontalLineTo(22.0f);
        pathBuilder4.curveToRelative(0.0f, -3.31f, -2.69f, -6.0f, -6.0f, -6.0f);
        pathBuilder3.verticalLineToRelative(1.33f);
        pathBuilder3.moveTo(16.0f, 6.0f);
        pathBuilder4.curveToRelative(1.11f, 0.0f, 2.0f, 0.89f, 2.0f, 2.0f);
        pathBuilder3.horizontalLineToRelative(1.33f);
        pathBuilder4.curveToRelative(0.0f, -1.84f, -1.49f, -3.33f, -3.33f, -3.33f);
        ...
        pathBuilder5.moveTo(17.0f, 9.0f);
        pathBuilder5.curveToRelative(0.0f, -1.11f, -0.89f, -2.0f, -2.0f, -2.0f);
        pathBuilder5.lineTo(15.0f, 4.0f);
        pathBuilder5.lineTo(9.0f, 4.0f);
        pathBuilder5.lineTo(7.17f, 6.0f);
        pathBuilder5.lineTo(4.0f, 6.0f);
