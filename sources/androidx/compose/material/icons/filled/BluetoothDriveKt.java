...
public final class BluetoothDriveKt {
    ...
    public static final ImageVector getBluetoothDrive(Icons.Filled filled) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Filled.BluetoothDrive", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(15.9f, 12.0f, 15.0f, 11.1f, 15.0f, 10.0f);
        pathBuilder.close();
        pathBuilder.moveTo(6.5f, 16.0f);
        pathBuilder3.curveTo(5.67f, 16.0f, 5.0f, 15.33f, 5.0f, 14.5f);
