...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_psychology", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Psychology", "Landroidx/compose/material/icons/Icons$Filled;", "getPsychology", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PsychologyKt {
    ...
    public static final ImageVector getPsychology(Icons.Filled filled) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Filled.Psychology", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(3.85f, 12.53f, 4.09f, 13.0f, 4.5f, 13.0f);
        ...
        pathBuilder4.curveToRelative(2.36f, -1.12f, 4.0f, -3.53f, 4.0f, -6.32f);
        pathBuilder4.curveTo(20.0f, 6.13f, 16.87f, 3.0f, 13.0f, 3.0f);
        pathBuilder2.close();
        ...
        pathBuilder5.curveToRelative(-0.05f, 0.09f, -0.16f, 0.12f, -0.24f, 0.09f);
        pathBuilder2.lineToRelative(-0.99f, -0.4f);
        pathBuilder5.curveToRelative(-0.21f, 0.16f, -0.43f, 0.29f, -0.67f, 0.39f);
        ...
        pathBuilder6.curveToRelative(-0.25f, -0.1f, -0.47f, -0.23f, -0.68f, -0.39f);
        pathBuilder2.lineToRelative(-0.99f, 0.4f);
        pathBuilder6.curveToRelative(-0.09f, 0.03f, -0.2f, 0.0f, -0.25f, -0.09f);
        pathBuilder2.lineToRelative(-0.8f, -1.39f);
        ...
        pathBuilder7.curveTo(10.01f, 10.26f, 10.0f, 10.13f, 10.0f, 10.0f);
        pathBuilder7.curveToRelative(0.0f, -0.13f, 0.02f, -0.27f, 0.04f, -0.39f);
        ...
        pathBuilder8.curveToRelative(0.05f, -0.09f, 0.15f, -0.12f, 0.24f, -0.09f);
        pathBuilder2.lineToRelative(1.0f, 0.4f);
        pathBuilder8.curveToRelative(0.2f, -0.15f, 0.43f, -0.29f, 0.67f, -0.39f);
        pathBuilder2.lineToRelative(0.15f, -1.06f);
        pathBuilder8.curveTo(12.02f, 6.07f, 12.1f, 6.0f, 12.2f, 6.0f);
        pathBuilder2.horizontalLineToRelative(1.6f);
        pathBuilder2.curveToRelative(0.1f, 0.0f, 0.18f, 0.07f, 0.2f, 0.17f);
        pathBuilder2.lineToRelative(0.15f, 1.06f);
        PathBuilder pathBuilder9 = pathBuilder2;
        pathBuilder9.curveToRelative(0.24f, 0.1f, 0.46f, 0.23f, 0.67f, 0.39f);
        pathBuilder2.lineToRelative(1.0f, -0.4f);
        pathBuilder9.curveToRelative(0.09f, -0.03f, 0.2f, 0.0f, 0.24f, 0.09f);
        pathBuilder2.lineToRelative(0.8f, 1.38f);
        pathBuilder9.curveToRelative(0.05f, 0.09f, 0.03f, 0.2f, -0.05f, 0.26f);
        pathBuilder2.lineToRelative(-0.85f, 0.66f);
        pathBuilder9.curveTo(15.99f, 9.73f, 16.0f, 9.86f, 16.0f, 10.0f);
        pathBuilder2.close();
