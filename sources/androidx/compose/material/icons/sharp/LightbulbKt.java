...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulb", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lightbulb", "Landroidx/compose/material/icons/Icons$Sharp;", "getLightbulb", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class LightbulbKt {
    ...
    public static final ImageVector getLightbulb(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Sharp.Lightbulb", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder5.curveTo(7.86f, 2.0f, 4.5f, 5.36f, 4.5f, 9.5f);
        pathBuilder5.curveToRelative(0.0f, 3.82f, 2.66f, 5.86f, 3.77f, 6.5f);
        pathBuilder4.horizontalLineToRelative(7.46f);
        pathBuilder5.curveToRelative(1.11f, -0.64f, 3.77f, -2.68f, 3.77f, -6.5f);
        pathBuilder5.curveTo(19.5f, 5.36f, 16.14f, 2.0f, 12.0f, 2.0f);
        pathBuilder4.close();
