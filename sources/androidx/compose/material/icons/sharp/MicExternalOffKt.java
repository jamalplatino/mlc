...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_micExternalOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "MicExternalOff", "Landroidx/compose/material/icons/Icons$Sharp;", "getMicExternalOff", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MicExternalOffKt {
    ...
    public static final ImageVector getMicExternalOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Sharp.MicExternalOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(14.0f, 4.0f);
        pathBuilder3.lineToRelative(4.0f, 0.0f);
        pathBuilder3.lineToRelative(0.0f, 11.17f);
        pathBuilder3.lineToRelative(2.0f, 2.0f);
        pathBuilder3.lineToRelative(0.0f, -15.17f);
        pathBuilder3.lineToRelative(-8.0f, 0.0f);
        pathBuilder3.lineToRelative(0.0f, 7.17f);
        pathBuilder3.lineToRelative(2.0f, 2.0f);
        pathBuilder3.close();
        ...
        pathBuilder4.curveToRelative(0.0f, 2.21f, 0.0f, 4.0f, 0.0f, 4.0f);
        pathBuilder4.horizontalLineToRelative(8.0f);
        pathBuilder4.verticalLineToRelative(-5.17f);
