...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_spatialAudioOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SpatialAudioOff", "Landroidx/compose/material/icons/Icons$Sharp;", "getSpatialAudioOff", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SpatialAudioOffKt {
    ...
    public static final ImageVector getSpatialAudioOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Sharp.SpatialAudioOff", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.curveToRelative(2.73f, 2.73f, 2.73f, 7.17f, 0.0f, 9.9f);
        pathBuilder5.lineToRelative(1.41f, 1.41f);
        pathBuilder6.curveTo(23.88f, 10.21f, 23.88f, 4.51f, 20.36f, 1.0f);
        pathBuilder5.close();
        ...
        pathBuilder7.moveTo(17.54f, 10.9f);
        ...
        pathBuilder8.curveToRelative(1.17f, 1.17f, 1.17f, 3.07f, 0.0f, 4.24f);
        pathBuilder7.lineTo(17.54f, 10.9f);
        pathBuilder7.close();
