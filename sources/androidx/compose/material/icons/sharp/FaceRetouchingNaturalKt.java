...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_faceRetouchingNatural", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FaceRetouchingNatural", "Landroidx/compose/material/icons/Icons$Sharp;", "getFaceRetouchingNatural", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class FaceRetouchingNaturalKt {
    ...
    public static final ImageVector getFaceRetouchingNatural(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Sharp.FaceRetouchingNatural", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.moveTo(19.85f, 10.59f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveTo(20.79f, 15.4f, 17.01f, 20.0f, 12.0f, 20.0f);
        pathBuilder4.curveToRelative(-4.41f, 0.0f, -8.0f, -3.59f, -8.0f, -8.0f);
        pathBuilder4.curveToRelative(0.0f, -0.39f, 3.87f, -1.12f, 5.74f, -5.69f);
        pathBuilder4.curveToRelative(3.42f, 4.19f, 8.07f, 3.73f, 9.09f, 3.59f);
        pathBuilder3.lineToRelative(-1.48f, -3.25f);
        pathBuilder3.lineTo(12.63f, 4.5f);
        pathBuilder3.lineToRelative(3.5f, -1.59f);
        PathBuilder pathBuilder5 = pathBuilder3;
        pathBuilder5.curveTo(9.51f, -0.14f, 2.0f, 4.77f, 2.0f, 12.0f);
        pathBuilder5.curveToRelative(0.0f, 5.52f, 4.48f, 10.0f, 10.0f, 10.0f);
        pathBuilder5.curveToRelative(7.21f, 0.0f, 12.12f, -7.45f, 9.1f, -14.13f);
        pathBuilder3.lineTo(19.85f, 10.59f);
        pathBuilder3.close();
        ...
        pathBuilder8.moveTo(20.6f, 5.6f);
        pathBuilder8.lineTo(19.5f, 8.0f);
        pathBuilder8.lineToRelative(-1.1f, -2.4f);
        pathBuilder8.lineTo(16.0f, 4.5f);
        pathBuilder8.lineToRelative(2.4f, -1.1f);
        pathBuilder8.lineTo(19.5f, 1.0f);
        pathBuilder8.lineToRelative(1.1f, 2.4f);
        pathBuilder8.lineTo(23.0f, 4.5f);
        pathBuilder8.lineTo(20.6f, 5.6f);
        pathBuilder8.close();
