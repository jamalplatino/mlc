...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_signalWifi4BarLock", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SignalWifi4BarLock", "Landroidx/compose/material/icons/Icons$Sharp;", "getSignalWifi4BarLock", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class SignalWifi4BarLockKt {
    ...
    public static final ImageVector getSignalWifi4BarLock(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Sharp.SignalWifi4BarLock", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(22.0f, 15.11f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveToRelative(0.0f, -1.0f, -0.68f, -1.92f, -1.66f, -2.08f);
        pathBuilder5.curveToRelative(-0.12f, -0.02f, -0.24f, -0.02f, -0.36f, -0.02f);
        pathBuilder4.lineToRelative(0.0f, 0.0f);
        pathBuilder5.curveToRelative(0.0f, 0.0f, -0.01f, 0.0f, -0.01f, 0.0f);
        pathBuilder5.curveTo(18.88f, 13.03f, 18.0f, 13.91f, 18.0f, 15.0f);
        pathBuilder4.verticalLineToRelative(1.0f);
        pathBuilder5.curveToRelative(-0.55f, 0.0f, -1.0f, 0.0f, -1.0f, 0.0f);
        pathBuilder4.verticalLineToRelative(5.0f);
        pathBuilder4.horizontalLineToRelative(6.0f);
        pathBuilder4.verticalLineToRelative(-5.0f);
        PathBuilder pathBuilder6 = pathBuilder4;
        pathBuilder6.curveToRelative(0.0f, 0.0f, -0.45f, 0.0f, -1.0f, 0.0f);
        pathBuilder4.verticalLineTo(15.11f);
        pathBuilder4.close();
