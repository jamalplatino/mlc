...
public final class RemoveShoppingCartKt {
    ...
    public static final ImageVector getRemoveShoppingCart(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Sharp.RemoveShoppingCart", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.5f, 0.36f, -0.83f, 0.95f, -0.83f, 1.62f);
        pathBuilder2.curveToRelative(0.0f, 1.1f, 0.89f, 2.0f, 1.99f, 2.0f);
        pathBuilder2.curveToRelative(0.67f, 0.0f, 1.26f, -0.33f, 1.62f, -0.84f);
