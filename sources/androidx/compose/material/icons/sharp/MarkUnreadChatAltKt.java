...
public final class MarkUnreadChatAltKt {
    ...
    public static final ImageVector getMarkUnreadChatAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Sharp.MarkUnreadChatAlt", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.horizontalLineToRelative(9.03f);
        pathBuilder3.curveToRelative(-1.21f, -1.6f, -1.08f, -3.21f, -0.92f, -4.0f);
        pathBuilder3.horizontalLineTo(2.01f);
