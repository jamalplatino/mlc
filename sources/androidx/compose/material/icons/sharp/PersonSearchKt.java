...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_personSearch", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PersonSearch", "Landroidx/compose/material/icons/Icons$Sharp;", "getPersonSearch", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class PersonSearchKt {
    ...
    public static final ImageVector getPersonSearch(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("Sharp.PersonSearch", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(7.62f, 13.91f, 2.0f, 15.27f, 2.0f, 18.0f);
        pathBuilder3.verticalLineToRelative(2.0f);
        pathBuilder3.horizontalLineToRelative(9.54f);
        pathBuilder3.curveTo(9.07f, 17.24f, 10.31f, 14.11f, 10.35f, 14.01f);
        pathBuilder3.close();
        ...
        pathBuilder5.curveTo(19.79f, 17.43f, 20.0f, 16.74f, 20.0f, 16.0f);
        ...
        pathBuilder6.curveToRelative(0.74f, 0.0f, 1.43f, -0.22f, 2.02f, -0.57f);
        pathBuilder4.lineTo(20.59f, 22.0f);
        pathBuilder4.lineTo(22.0f, 20.59f);
        pathBuilder4.lineTo(19.43f, 18.02f);
        pathBuilder4.close();
