...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_onDeviceTraining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "OnDeviceTraining", "Landroidx/compose/material/icons/Icons$Sharp;", "getOnDeviceTraining", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class OnDeviceTrainingKt {
    ...
    public static final ImageVector getOnDeviceTraining(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder6 = new ImageVector.Builder("Sharp.OnDeviceTraining", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.moveTo(20.0f, 1.01f);
        pathBuilder4.lineTo(4.0f, 1.0f);
        pathBuilder4.verticalLineToRelative(22.0f);
        pathBuilder4.horizontalLineToRelative(16.0f);
        pathBuilder4.verticalLineTo(1.01f);
        pathBuilder4.close();
        ...
        pathBuilder5.moveTo(16.01f, 15.95f);
        pathBuilder5.curveTo(16.63f, 15.12f, 17.0f, 14.11f, 17.0f, 13.0f);
        pathBuilder5.reflectiveCurveToRelative(-0.37f, -2.12f, -0.99f, -2.95f);
        pathBuilder5.lineToRelative(-1.07f, 1.07f);
        pathBuilder5.curveToRelative(0.35f, 0.54f, 0.56f, 1.19f, 0.56f, 1.88f);
        pathBuilder5.reflectiveCurveToRelative(-0.21f, 1.34f, -0.56f, 1.88f);
        pathBuilder5.lineTo(16.01f, 15.95f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(9.06f, 14.88f);
        ...
        pathBuilder6.verticalLineToRelative(1.25f);
        pathBuilder6.lineToRelative(2.25f, -2.0f);
        pathBuilder6.lineToRelative(-2.25f, -2.0f);
        ...
        pathBuilder6.lineTo(9.06f, 14.88f);
        pathBuilder6.close();
