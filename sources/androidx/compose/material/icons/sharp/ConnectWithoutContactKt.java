...
public final class ConnectWithoutContactKt {
    ...
    public static final ImageVector getConnectWithoutContact(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Sharp.ConnectWithoutContact", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(9.86f, 8.15f, 11.25f, 6.51f, 11.45f, 4.5f);
        pathBuilder.close();
        ...
        pathBuilder4.curveToRelative(-1.49f, 0.0f, -2.71f, -1.08f, -2.95f, -2.5f);
        pathBuilder.horizontalLineToRelative(-2.0f);
        pathBuilder4.curveToRelative(0.2f, 2.01f, 1.59f, 3.65f, 3.45f, 4.24f);
