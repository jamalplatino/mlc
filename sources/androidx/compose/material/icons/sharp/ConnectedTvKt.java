...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_connectedTv", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ConnectedTv", "Landroidx/compose/material/icons/Icons$Sharp;", "getConnectedTv", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ConnectedTvKt {
    ...
    public static final ImageVector getConnectedTv(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("Sharp.ConnectedTv", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(6.97f, 12.43f, 8.57f, 14.03f, 8.57f, 16.0f);
        pathBuilder.close();
        ...
        pathBuilder3.moveTo(11.55f, 16.0f);
        pathBuilder3.horizontalLineTo(13.0f);
        PathBuilder pathBuilder4 = pathBuilder3;
        pathBuilder4.curveToRelative(0.0f, -4.42f, -3.59f, -8.0f, -8.0f, -8.0f);
        pathBuilder3.verticalLineToRelative(1.45f);
        pathBuilder4.curveTo(8.61f, 9.45f, 11.55f, 12.38f, 11.55f, 16.0f);
        pathBuilder3.close();
        ...
        pathBuilder5.moveTo(5.0f, 14.0f);
        pathBuilder5.verticalLineToRelative(2.0f);
        pathBuilder5.horizontalLineToRelative(2.0f);
        pathBuilder5.curveTo(7.0f, 14.89f, 6.11f, 14.0f, 5.0f, 14.0f);
        pathBuilder5.close();
        ...
        pathBuilder6.moveTo(22.0f, 3.0f);
        ...
        pathBuilder6.close();
        pathBuilder6.moveTo(20.0f, 17.0f);
