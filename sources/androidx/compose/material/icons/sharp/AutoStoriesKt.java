...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_autoStories", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AutoStories", "Landroidx/compose/material/icons/Icons$Sharp;", "getAutoStories", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AutoStoriesKt {
    ...
    public static final ImageVector getAutoStories(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Sharp.AutoStories", Dp.m5626constructorimpl(24.0f), Dp.m5626constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, false, 224, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveTo(10.38f, 4.55f, 8.51f, 4.0f, 6.5f, 4.0f);
        ...
        pathBuilder.reflectiveCurveToRelative(3.98f, 0.82f, 5.5f, 2.0f);
        pathBuilder.verticalLineTo(5.48f);
        pathBuilder3.curveTo(22.37f, 5.12f, 21.7f, 4.84f, 21.0f, 4.6f);
        pathBuilder.close();
        ImageVector.Builder.m3530addPathoIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", new SolidColor(Color.Companion.m2847getBlack0d7_KjU(), (DefaultConstructorMarker) null), 1.0f, (Brush) null, 1.0f, 1.0f, r22, r23, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        int r39 = StrokeCap.Companion.m3204getButtKaPHkGw();
        int r40 = StrokeJoin.Companion.m3214getBevelLxFBmk8();
        PathBuilder pathBuilder4 = new PathBuilder();
        pathBuilder4.moveTo(19.0f, 0.5f);
        pathBuilder4.lineToRelative(-5.0f, 5.0f);
        pathBuilder4.lineToRelative(0.0f, 9.5f);
        pathBuilder4.lineToRelative(5.0f, -4.5f);
        pathBuilder4.close();
