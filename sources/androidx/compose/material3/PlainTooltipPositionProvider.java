...
final class PlainTooltipPositionProvider implements PopupPositionProvider {
    ...
    public long m1487calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        Intrinsics.checkNotNullParameter(intRect, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int left = intRect.getLeft() + ((intRect.getWidth() - IntSize.m5786getWidthimpl(j2)) / 2);
