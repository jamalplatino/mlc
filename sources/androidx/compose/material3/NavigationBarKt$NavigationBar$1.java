...
final class NavigationBarKt$NavigationBar$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m549height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), NavigationBarKt.NavigationBarHeight));
            ...
            int i3 = i2 >> 3;
            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m410spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding()), Alignment.Companion.getTop(), composer, (i3 & 112) | (i3 & 14));
