...
public final class MappedInteractionSource implements InteractionSource {
    ...
    private MappedInteractionSource(InteractionSource interactionSource, long j) {
        Intrinsics.checkNotNullParameter(interactionSource, "underlyingInteractionSource");
        this.delta = j;
    ...
    public final PressInteraction.Press mapPress(PressInteraction.Press press) {
        return new PressInteraction.Press(Offset.m2576minusMKHz9U(press.m383getPressPositionF1C5BW0(), this.delta), (DefaultConstructorMarker) null);
    }
}
