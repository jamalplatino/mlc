...
final class ListItemKt$ListItem$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        if ((i & 91) != 18 || !composer.getSkipping()) {
            ...
            Modifier align = rowScope.align(PaddingKt.padding(RowScope.weight$default(rowScope, Modifier.Companion, 1.0f, false, 2, (Object) null), this.$contentPaddingValues), this.$boxAlignment);
            ...
            if (function32 != null) {
                function32.invoke(rowScope, composer, Integer.valueOf(i & 14));
            }
            if (ComposerKt.isTraceInProgress()) {
