...
final class TextFieldKt$drawIndicatorLine$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope contentDrawScope) {
        ...
        if (!Dp.m5631equalsimpl0(this.$strokeWidthDp, Dp.Companion.m5644getHairlineD9Ej5fM())) {
            float density = this.$strokeWidthDp * contentDrawScope.getDensity();
            float r2 = Size.m2638getHeightimpl(contentDrawScope.m3429getSizeNHjbRc()) - (density / ((float) 2));
            DrawScope.m3396drawLine1RTmtNc$default(contentDrawScope2, this.$indicatorBorder.getBrush(), OffsetKt.Offset(0.0f, r2), OffsetKt.Offset(Size.m2641getWidthimpl(contentDrawScope.m3429getSizeNHjbRc()), r2), density, 0, (PathEffect) null, 0.0f, (ColorFilter) null, 0, 496, (Object) null);
        }
    }
}
