...
final class TimePickerKt$TimeSelector$2 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        if (!Selection.m1536equalsimpl0(this.$selection, this.$state.m1770getSelectionJiIwxys$material3_release())) {
            this.$state.m1773setSelectioniHAOin8$material3_release(this.$selection);
