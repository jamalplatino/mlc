...
public final class ProgressIndicatorDefaults {
    ...
    private static final int CircularDeterminateStrokeCap = StrokeCap.Companion.m3204getButtKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.Companion.m3206getSquareKaPHkGw();
    private static final float CircularStrokeWidth = CircularProgressIndicatorTokens.INSTANCE.m1897getActiveIndicatorWidthD9Ej5fM();
    public static final ProgressIndicatorDefaults INSTANCE = new ProgressIndicatorDefaults();
    private static final int LinearStrokeCap = StrokeCap.Companion.m3204getButtKaPHkGw();
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        long r0 = Color.Companion.m2856getTransparent0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
