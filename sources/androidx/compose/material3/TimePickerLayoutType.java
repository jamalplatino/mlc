...
public final class TimePickerLayoutType {
    ...
    public static final int Horizontal = m1761constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Vertical = m1761constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1760boximpl(int i) {
    ...
    public static boolean m1762equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m1766unboximpl();
    }
    ...
    public static String m1765toStringimpl(int i) {
        if (m1763equalsimpl0(i, Horizontal)) {
            return "Horizontal";
        }
        return m1763equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
