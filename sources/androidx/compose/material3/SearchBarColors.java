...
public final class SearchBarColors {
    ...
    public final long m1521getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getDividerColor-0d7_KjU  reason: not valid java name */
    public final long m1522getDividerColor0d7_KjU() {
    ...
    private SearchBarColors(long j, long j2, TextFieldColors textFieldColors) {
        Intrinsics.checkNotNullParameter(textFieldColors, "inputFieldColors");
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m2822equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual((Object) this.inputFieldColors, (Object) searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m2828hashCodeimpl(this.containerColor) * 31) + Color.m2828hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
