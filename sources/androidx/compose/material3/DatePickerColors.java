...
public final class DatePickerColors {
    ...
    public final long m1280getContainerColor0d7_KjU$material3_release() {
        return this.containerColor;
    }

    /* renamed from: getDayInSelectionRangeContainerColor-0d7_KjU$material3_release  reason: not valid java name */
    public final long m1281getDayInSelectionRangeContainerColor0d7_KjU$material3_release() {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        ...
        long j = (!z2 || !z4) ? (!z2 || z4) ? (!z3 || !z4) ? (!z3 || z4) ? z ? this.todayContentColor : z4 ? this.dayContentColor : this.disabledDayContentColor : this.disabledDayContentColor : this.dayInSelectionRangeContentColor : this.disabledSelectedDayContentColor : this.selectedDayContentColor;
        if (z3) {
            ...
            state = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            ...
            j = Color.Companion.m2856getTransparent0d7_KjU();
        }
        long j2 = j;
        if (z3) {
            composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation(composer, "622@27316L134");
            state = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> r9 = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(z2 ? this.selectedYearContentColor : z ? this.currentYearContentColor : this.yearContentColor, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        if (z) {
            j = this.selectedYearContainerColor;
        } else {
            j = Color.Companion.m2856getTransparent0d7_KjU();
        }
        State<Color> r11 = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2822equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m2822equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m2822equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m2822equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m2822equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m2822equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m2822equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m2822equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m2822equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m2822equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m2822equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m2822equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m2822equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m2822equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m2822equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m2822equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m2822equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m2822equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m2822equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Color.m2828hashCodeimpl(this.containerColor) * 31) + Color.m2828hashCodeimpl(this.titleContentColor)) * 31) + Color.m2828hashCodeimpl(this.headlineContentColor)) * 31) + Color.m2828hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m2828hashCodeimpl(this.subheadContentColor)) * 31) + Color.m2828hashCodeimpl(this.yearContentColor)) * 31) + Color.m2828hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m2828hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m2828hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m2828hashCodeimpl(this.dayContentColor)) * 31) + Color.m2828hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m2828hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m2828hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m2828hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m2828hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m2828hashCodeimpl(this.todayContentColor)) * 31) + Color.m2828hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m2828hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m2828hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
