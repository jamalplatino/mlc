...
final class NavigationBarKt$NavigationBarItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1451measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Object obj;
        Placeable placeable;
        ...
        for (Measurable measurable : iterable) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                ...
                float f = (float) 2;
                int width = r3.getWidth() + measureScope2.m5601roundToPx0680j_4(Dp.m5626constructorimpl(NavigationBarKt.IndicatorHorizontalPadding * f));
                int roundToInt = MathKt.roundToInt(((float) width) * this.$animationProgress);
                int height = r3.getHeight() + measureScope2.m5601roundToPx0680j_4(Dp.m5626constructorimpl(NavigationBarKt.IndicatorVerticalPadding * f));
                for (Measurable measurable2 : iterable) {
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), (Object) "indicatorRipple")) {
                        ...
                        placeable2 = null;
                        if (this.$label == null) {
                            return NavigationBarKt.m1448placeIconX9ElhV4(measureScope, r3, r4, placeable, j);
                        }
                        Intrinsics.checkNotNull(placeable2);
                        return NavigationBarKt.m1449placeLabelAndIconzUg2_y0(measureScope, placeable2, r3, r4, placeable, j, this.$alwaysShowLabel, this.$animationProgress);
                    }
                    long j3 = j;
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
