...
public final class RichTooltipColors {
    ...
    public final long m1512getActionContentColor0d7_KjU() {
        return this.actionContentColor;
    }

    /* renamed from: getContainerColor-0d7_KjU  reason: not valid java name */
    public final long m1513getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m1514getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m1515getTitleContentColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m2822equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m2822equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m2822equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m2828hashCodeimpl(this.containerColor) * 31) + Color.m2828hashCodeimpl(this.contentColor)) * 31) + Color.m2828hashCodeimpl(this.titleContentColor)) * 31) + Color.m2828hashCodeimpl(this.actionContentColor);
    }
}
