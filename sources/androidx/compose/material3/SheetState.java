...
public final class SheetState {
    ...
    public SheetState(boolean z, SheetValue sheetValue, Function1<? super SheetValue, Boolean> function1, boolean z2) {
        ...
        if (z && sheetValue == SheetValue.PartiallyExpanded) {
            ...
            this.swipeableState = new SwipeableV2State(sheetValue, SwipeableV2Defaults.INSTANCE.getAnimationSpec(), function1, (Function2) null, 0.0f, 24, (DefaultConstructorMarker) null);
        } else {
    ...
    public final Object expand(Continuation<? super Unit> continuation) {
        Object animateTo$default = SwipeableV2State.animateTo$default(this.swipeableState, SheetValue.Expanded, 0.0f, continuation, 2, (Object) null);
