    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1164547968, i2, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:327)");
            }
            Modifier r1 = SelectableKt.m813selectableO2vRcR0$default(SurfaceKt.m1647surface8ww4TTg(InteractiveComponentSizeKt.minimumInteractiveComponentSize(this.$modifier), this.$shape, SurfaceKt.m1648surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer2, (this.$$changed >> 15) & 14), this.$border, this.$shadowElevation), this.$selected, this.$interactionSource, RippleKt.m1106rememberRipple9IZ8Weo(false, 0.0f, 0, composer, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
