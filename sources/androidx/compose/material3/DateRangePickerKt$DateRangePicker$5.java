...
final class DateRangePickerKt$DateRangePicker$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            int r0 = this.$state.m1302getDisplayModejFl4v0();
            DateRangePickerState dateRangePickerState = this.$state;
            composer.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean changed = composer.changed((Object) dateRangePickerState);
            ...
            DatePickerKt.m1292DisplayModeToggleButtontER2X8s(padding, r0, (Function1) rememberedValue, composer, 6);
            if (ComposerKt.isTraceInProgress()) {
