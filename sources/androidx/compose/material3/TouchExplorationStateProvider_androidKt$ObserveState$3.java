...
final class TouchExplorationStateProvider_androidKt$ObserveState$3 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        ...
        LifecycleEventObserver touchExplorationStateProvider_androidKt$ObserveState$3$observer$1 = new TouchExplorationStateProvider_androidKt$ObserveState$3$observer$1(this.$handleEvent);
        this.$this_ObserveState.addObserver(touchExplorationStateProvider_androidKt$ObserveState$3$observer$1);
        return new TouchExplorationStateProvider_androidKt$ObserveState$3$invoke$$inlined$onDispose$1(this.$onDispose, this.$this_ObserveState, touchExplorationStateProvider_androidKt$ObserveState$3$observer$1);
    }
}
