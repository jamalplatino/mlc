...
public final class ElevationKt {
    ...
    public static final TweenSpec<Dp> DefaultIncomingSpec = new TweenSpec(MenuKt.InTransitionDuration, 0, EasingKt.getFastOutSlowInEasing(), 2, (DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    ...
    public static /* synthetic */ Object m1337animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m1336animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ  reason: not valid java name */
    public static final Object m1336animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float f, Interaction interaction, Interaction interaction2, Continuation<? super Unit> continuation) {
        ...
        if (animationSpec != null) {
            Object animateTo$default = Animatable.animateTo$default(animatable, Dp.m5624boximpl(f), animationSpec, (Object) null, (Function1) null, continuation, 12, (Object) null);
            return animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$default : Unit.INSTANCE;
        }
        Object snapTo = animatable.snapTo(Dp.m5624boximpl(f), continuation);
    ...
    static {
        ...
        HoveredOutgoingSpec = new TweenSpec(MenuKt.InTransitionDuration, 0, easing, 2, (DefaultConstructorMarker) null);
    }
}
