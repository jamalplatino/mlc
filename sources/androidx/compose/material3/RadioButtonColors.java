...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        long j = (!z || !z2) ? (!z || z2) ? (z || !z2) ? this.disabledUnselectedColor : this.disabledSelectedColor : this.unselectedColor : this.selectedColor;
        if (z) {
            composer.startReplaceableGroup(-1943770131);
            ComposerKt.sourceInformation(composer, "193@8119L75");
            state = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 48, 12);
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m2822equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m2822equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m2822equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m2828hashCodeimpl(this.selectedColor) * 31) + Color.m2828hashCodeimpl(this.unselectedColor)) * 31) + Color.m2828hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2828hashCodeimpl(this.disabledUnselectedColor);
    }
}
