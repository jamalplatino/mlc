                        ...
                        TextKt.ProvideTextStyle(labelLarge, ComposableLambdaKt.composableLambda(composer, -2136309793, true, new Function2<Composer, Integer, Unit>() {
                            ...
                            public final void invoke(Composer composer, int i) {
                                ...
                                if ((i & 11) != 2 || !composer.getSkipping()) {
                                    ...
                                    Modifier padding = PaddingKt.padding(SizeKt.m547defaultMinSizeVpY3zN4(Modifier.Companion, ButtonDefaults.INSTANCE.m1159getMinWidthD9Ej5fM(), ButtonDefaults.INSTANCE.m1158getMinHeightD9Ej5fM()), paddingValues);
