...
public final class DrawerDefaults {
    ...
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m2154getStandardContainerElevationD9Ej5fM();
    public static final DrawerDefaults INSTANCE = new DrawerDefaults();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m2151getContainerWidthD9Ej5fM();
    private static final float ModalDrawerElevation = NavigationDrawerTokens.INSTANCE.m2153getModalContainerElevationD9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m2154getStandardContainerElevationD9Ej5fM();

    /* renamed from: getDismissibleDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1327getDismissibleDrawerElevationD9Ej5fM() {
        return DismissibleDrawerElevation;
    }

    /* renamed from: getMaximumDrawerWidth-D9Ej5fM  reason: not valid java name */
    public final float m1328getMaximumDrawerWidthD9Ej5fM() {
        return MaximumDrawerWidth;
    }

    /* renamed from: getModalDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1329getModalDrawerElevationD9Ej5fM() {
        return ModalDrawerElevation;
    }

    /* renamed from: getPermanentDrawerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1330getPermanentDrawerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets r5 = WindowInsetsKt.m583onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.m597plusgK_yJZ4(WindowInsetsSides.Companion.m612getVerticalJoeWqyM(), WindowInsetsSides.Companion.m610getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
