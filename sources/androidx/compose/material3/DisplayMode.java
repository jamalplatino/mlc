...
public final class DisplayMode {
    ...
    public static final int Input = m1313constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Picker = m1313constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1312boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1313constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1314equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).m1318unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1315equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1316hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m1314equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1316hashCodeimpl(this.value);
    }
    ...
    public static String m1317toStringimpl(int i) {
        if (m1315equalsimpl0(i, Picker)) {
            return "Picker";
        }
        return m1315equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
