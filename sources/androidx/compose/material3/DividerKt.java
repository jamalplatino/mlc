...
public final class DividerKt {
    ...
    public static final void m1322Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, int i, int i2) {
        int i3;
        float f2;
        ...
        if ((i & 896) == 0) {
            i3 |= ((i2 & 4) != 0 || !startRestartGroup.changed(j)) ? 128 : 256;
        }
        if ((i3 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = DividerDefaults.INSTANCE.m1321getThicknessD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
            ...
            if (Dp.m5631equalsimpl0(f, Dp.Companion.m5644getHairlineD9Ej5fM())) {
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = startRestartGroup.consume(CompositionLocalsKt.getLocalDensity());
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                f2 = Dp.m5626constructorimpl(1.0f / ((Density) consume).getDensity());
            } else {
                f2 = f;
            }
            startRestartGroup.endReplaceableGroup();
            BoxKt.Box(BackgroundKt.m182backgroundbw27NRU$default(SizeKt.m549height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, (Object) null), f2), j, (Shape) null, 2, (Object) null), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
