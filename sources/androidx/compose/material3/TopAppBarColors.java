...
public final class TopAppBarColors {
    ...
    public final long m1847getActionIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1848getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1849getTitleContentColor0d7_KjU$material3_release() {
    ...
    public final long m1846containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long r0 = ColorKt.m2872lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2822equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2822equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2822equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2822equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2828hashCodeimpl(this.containerColor) * 31) + Color.m2828hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2828hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2828hashCodeimpl(this.titleContentColor)) * 31) + Color.m2828hashCodeimpl(this.actionIconContentColor);
    }
}
