...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5626constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5626constructorimpl((float) 48.0d);
    ...
    public final float m1897getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1898getSizeD9Ej5fM() {
        return Size;
    }
