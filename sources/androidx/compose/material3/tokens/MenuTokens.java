...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m5626constructorimpl((float) 48.0d);
    ...
    public final float m2141getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2142getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2143getListItemTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5626constructorimpl(f);
        ListItemTrailingIconSize = Dp.m5626constructorimpl(f);
    }
}
