...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5626constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5626constructorimpl((float) 24.0d);
    ...
    public final float m2183getContainerSizeD9Ej5fM() {
    ...
    public final float m2184getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2185getUnselectedOutlineWidthD9Ej5fM() {
