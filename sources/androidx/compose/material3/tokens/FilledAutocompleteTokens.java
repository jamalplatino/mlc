...
public final class FilledAutocompleteTokens {
    ...
    private static final float MenuContainerElevation = ElevationTokens.INSTANCE.m1998getLevel2D9Ej5fM();
    ...
    private static final float MenuListItemContainerHeight = Dp.m5626constructorimpl((float) 48.0d);
    ...
    private static final float TextFieldContainerHeight = Dp.m5626constructorimpl((float) 56.0d);
    ...
    private static final float TextFieldFocusActiveIndicatorHeight = Dp.m5626constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m5626constructorimpl((float) 20.0d);
    private static final ColorSchemeKeyTokens TextFieldTrailingIconColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float TextFieldTrailingIconSize = Dp.m5626constructorimpl((float) 24.0d);
    ...
    public final float m2056getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m2057getMenuDividerHeightD9Ej5fM() {
        return MenuDividerHeight;
    }

    /* renamed from: getMenuListItemContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2058getMenuListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2059getTextFieldActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2060getTextFieldContainerHeightD9Ej5fM() {
    ...
    public final float m2061getTextFieldDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2062getTextFieldFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2063getTextFieldHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2064getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2065getTextFieldTrailingIconSizeD9Ej5fM() {
    ...
    static {
        float f = (float) 1.0d;
        MenuDividerHeight = Dp.m5626constructorimpl(f);
        TextFieldActiveIndicatorHeight = Dp.m5626constructorimpl(f);
        TextFieldDisabledActiveIndicatorHeight = Dp.m5626constructorimpl(f);
        TextFieldHoverActiveIndicatorHeight = Dp.m5626constructorimpl(f);
    }
}
