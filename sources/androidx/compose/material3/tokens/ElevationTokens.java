...
public final class ElevationTokens {
    ...
    private static final float Level0 = Dp.m5626constructorimpl((float) 0.0d);
    private static final float Level1 = Dp.m5626constructorimpl((float) 1.0d);
    private static final float Level2 = Dp.m5626constructorimpl((float) 3.0d);
    private static final float Level3 = Dp.m5626constructorimpl((float) 6.0d);
    private static final float Level4 = Dp.m5626constructorimpl((float) 8.0d);
    private static final float Level5 = Dp.m5626constructorimpl((float) 12.0d);

    /* renamed from: getLevel0-D9Ej5fM  reason: not valid java name */
    public final float m1996getLevel0D9Ej5fM() {
        return Level0;
    }

    /* renamed from: getLevel1-D9Ej5fM  reason: not valid java name */
    public final float m1997getLevel1D9Ej5fM() {
        return Level1;
    }

    /* renamed from: getLevel2-D9Ej5fM  reason: not valid java name */
    public final float m1998getLevel2D9Ej5fM() {
        return Level2;
    }

    /* renamed from: getLevel3-D9Ej5fM  reason: not valid java name */
    public final float m1999getLevel3D9Ej5fM() {
        return Level3;
    }

    /* renamed from: getLevel4-D9Ej5fM  reason: not valid java name */
    public final float m2000getLevel4D9Ej5fM() {
        return Level4;
    }

    /* renamed from: getLevel5-D9Ej5fM  reason: not valid java name */
    public final float m2001getLevel5D9Ej5fM() {
        return Level5;
    }
