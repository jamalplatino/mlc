...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m5626constructorimpl((float) 2.0d);
    ...
    public final float m2187getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m2188getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m2189getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m2191getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m5626constructorimpl(f);
        HoverOutlineWidth = Dp.m5626constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m5626constructorimpl(f2);
        OutlineWidth = Dp.m5626constructorimpl(f);
        TrailingIconSize = Dp.m5626constructorimpl(f2);
    }
}
