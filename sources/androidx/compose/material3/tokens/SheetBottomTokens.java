...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5626constructorimpl((float) 4.0d);
    public static final float DockedDragHandleOpacity = 0.4f;
    private static final float DockedDragHandleWidth = Dp.m5626constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m1997getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m1997getLevel1D9Ej5fM();
    ...
    public final float m2288getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM  reason: not valid java name */
    public final float m2289getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2290getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2291getDockedStandardContainerElevationD9Ej5fM() {
