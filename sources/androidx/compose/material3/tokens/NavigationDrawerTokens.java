...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5626constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5626constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m5626constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1997getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1996getLevel0D9Ej5fM();
    ...
    public final float m2149getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2150getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2153getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m2154getStandardContainerElevationD9Ej5fM() {
