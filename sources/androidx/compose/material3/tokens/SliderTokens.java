...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m1996getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m1997getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m1996getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5626constructorimpl((float) 28.0d);
    ...
    private static final float OverlapHandleOutlineWidth = Dp.m5626constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5626constructorimpl((float) 2.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m1996getLevel0D9Ej5fM();
    ...
    public final float m2292getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2293getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2294getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM  reason: not valid java name */
    public final float m2295getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2296getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2297getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2298getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m2299getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2300getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2301getStateLayerSizeD9Ej5fM() {
    ...
    public final float m2302getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2303getTrackElevationD9Ej5fM() {
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5626constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5626constructorimpl(f2);
        HandleWidth = Dp.m5626constructorimpl(f2);
        InactiveTrackHeight = Dp.m5626constructorimpl(f);
    }
}
