...
final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        if ((i & 91) != 18 || !composer.getSkipping()) {
            ...
            ListItemKt.m1413TrailingContent3IgeMak(rowScope, this.$colors.trailingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m2831unboximpl(), ListItemType.m1422equalsimpl0(this.$listItemType, ListItemType.Companion.m1429getThreeLineAlXitO8()), this.$it, composer, i & 14);
            if (ComposerKt.isTraceInProgress()) {
