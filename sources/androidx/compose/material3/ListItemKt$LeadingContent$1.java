...
final class ListItemKt$LeadingContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Modifier then = PaddingKt.m497paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, ListItemKt.LeadingContentEndPadding, 0.0f, 11, (Object) null).then(!this.$topAlign ? this.$this_LeadingContent.align(Modifier.Companion, Alignment.Companion.getCenterVertically()) : Modifier.Companion);
