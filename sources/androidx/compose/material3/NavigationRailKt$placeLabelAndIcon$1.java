...
final class NavigationRailKt$placeLabelAndIcon$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        if (placeable != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, (i - placeable.getWidth()) / 2, this.$offset + (i2 - measureScope.m5601roundToPx0680j_4(NavigationRailKt.IndicatorVerticalPaddingWithLabel)), 0.0f, 4, (Object) null);
        }
