...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(kotlin.jvm.functions.Function0<kotlin.Unit> r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            float r10 = r11.m5607toPx0680j_4(r12)
            r7.setElevation(r10)
            ...
            kotlin.jvm.functions.Function2 r10 = r10.m1856getLambda1$material3_release()
    ...
    public final IntSize m1860getPopupContentSizebOM6tXw() {
    ...
    public final void updatePosition() {
        ...
        if (parentBounds != null && (r0 = m1860getPopupContentSizebOM6tXw()) != null) {
            long r5 = r0.m5790unboximpl();
            Rect rect = this.previousWindowVisibleFrame;
            this.composeView.getWindowVisibleDisplayFrame(rect);
            IntRect intBounds = toIntBounds(rect);
            long r02 = this.positionProvider.m5878calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, r5);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x007f, code lost:
        if (r2.invoke(r1, r0).booleanValue() != false) goto L_0x0081;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public final void m1861setPopupContentSizefhxjrPA(IntSize intSize) {
