...
final class TextFieldMeasurePolicy$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        if (placeable != null) {
            ...
            TextFieldKt.placeWithLabel(placementScope, i, i2, placeable2, placeable, placeable3, placeable4, placeable5, placeable6, placeable7, placeable8, placeable9, access$getSingleLine$p, i3, i3 + this.$labelPlaceable.getHeight(), this.this$0.animationProgress, this.$this_measure.getDensity());
            return;
        }
