...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(T t, Function1<? super T, Unit> function1, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        int i3 = i & 8;
        EffectsKt.LaunchedEffect(t, mutableState.getValue(), new SwipeableKt$rememberSwipeableStateFor$1(t, swipeableState, (Continuation<? super SwipeableKt$rememberSwipeableStateFor$1>) null), composer, (i & 14) | i3 | 512);
    ...
    public static /* synthetic */ Modifier m1656swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2 function2, ResistanceConfig resistanceConfig, float f, int i, Object obj) {
        int i2 = i;
        return m1655swipeablepPrIpRY(modifier, swipeableState, map, orientation, (i2 & 8) != 0 ? true : z, (i2 & 16) != 0 ? false : z2, (i2 & 32) != 0 ? null : mutableInteractionSource, (i2 & 64) != 0 ? SwipeableKt$swipeable$1.INSTANCE : function2, (i2 & 128) != 0 ? SwipeableDefaults.resistanceConfig$material3_release$default(SwipeableDefaults.INSTANCE, map.keySet(), 0.0f, 0.0f, 6, (Object) null) : resistanceConfig, (i2 & 256) != 0 ? SwipeableDefaults.INSTANCE.m1654getVelocityThresholdD9Ej5fM$material3_release() : f);
    }
    ...
    public static final <T> Modifier m1655swipeablepPrIpRY(Modifier modifier, SwipeableState<T> swipeableState, Map<Float, ? extends T> map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2<? super T, ? super T, ? extends ThresholdConfig> function2, ResistanceConfig resistanceConfig, float f) {
