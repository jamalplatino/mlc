...
final class BottomSheetScaffoldKt$StandardBottomSheet$anchorChangeHandler$1$1 extends Lambda implements Function2<SheetValue, Float, Unit> {
    ...
    public final void invoke(final SheetValue sheetValue, final float f) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(sheetState, sheetValue, f, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (sheetState.getSwipeableState$material3_release().animateTo(sheetValue, f, this) == coroutine_suspended) {
