...
public final class TouchExplorationStateProvider_androidKt {
    ...
    public static final void ObserveState(Lifecycle lifecycle, Function1<? super Lifecycle.Event, Unit> function1, Function0<Unit> function0, Composer composer, int i, int i2) {
        ...
        EffectsKt.DisposableEffect((Object) lifecycle, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) new TouchExplorationStateProvider_androidKt$ObserveState$3(lifecycle, function12, function02), startRestartGroup, 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
