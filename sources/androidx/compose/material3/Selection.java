...
public final class Selection {
    ...
    public static final int Hour = m1534constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Minute = m1534constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Selection m1533boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1534constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1535equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m1539unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1536equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1537hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1538toStringimpl(int i) {
    ...
    public final /* synthetic */ int m1539unboximpl() {
        return this.value;
    }
