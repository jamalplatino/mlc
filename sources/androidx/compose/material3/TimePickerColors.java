...
public final class TimePickerColors {
    ...
    public final long m1730clockDialContentColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1736periodSelectorContentColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1737timeSelectorContainerColorvNxB06k$material3_release(boolean z) {
    ...
    public final long m1738timeSelectorContentColorvNxB06k$material3_release(boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m2822equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m2822equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m2822equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m2822equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m2822equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m2822equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m2822equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m2822equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m2822equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m2822equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m2822equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m2828hashCodeimpl(this.clockDialColor) * 31) + Color.m2828hashCodeimpl(this.selectorColor)) * 31) + Color.m2828hashCodeimpl(this.containerColor)) * 31) + Color.m2828hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2828hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2828hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2828hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2828hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
