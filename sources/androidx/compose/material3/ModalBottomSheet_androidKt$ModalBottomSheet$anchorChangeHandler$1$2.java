...
final class ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$2 extends Lambda implements Function1<SheetValue, Unit> {
    ...
    ModalBottomSheet_androidKt$ModalBottomSheet$anchorChangeHandler$1$2(CoroutineScope coroutineScope, SheetState sheetState) {
        super(1);
    ...
    public final void invoke(final SheetValue sheetValue) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(sheetState, sheetValue, continuation);
        }
