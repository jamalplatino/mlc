...
final class DatePickerKt$DatePickerContent$1$4$2$2$1 extends Lambda implements Function1<Integer, Unit> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(stateData, lazyListState, i, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (LazyListState.scrollToItem$default(lazyListState, (((i - stateData.getYearRange().getFirst()) * 12) + stateData.getDisplayedMonth().getMonth()) - 1, 0, this, 2, (Object) null) == coroutine_suspended) {
