...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1875getContainerElevationD9Ej5fM();
    private static final PaddingValues ContentPadding = PaddingKt.m490PaddingValuesa9UjIt4$default(AppBarKt.BottomAppBarHorizontalPadding, AppBarKt.getBottomAppBarVerticalPadding(), AppBarKt.BottomAppBarHorizontalPadding, 0.0f, 8, (Object) null);
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets r5 = WindowInsetsKt.m583onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.m597plusgK_yJZ4(WindowInsetsSides.Companion.m607getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m605getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
