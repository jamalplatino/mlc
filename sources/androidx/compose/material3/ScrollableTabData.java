...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int r6 = density.m5601roundToPx0680j_4(((TabPosition) CollectionsKt.last(list)).m1679getRightD9Ej5fM()) + i;
        int maxValue = r6 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.m5601roundToPx0680j_4(tabPosition.m1678getLeftD9Ej5fM()) - ((maxValue / 2) - (density.m5601roundToPx0680j_4(tabPosition.m1680getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(r6 - maxValue, 0));
    }
}
