...
final class ChipKt$SelectableChip$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C1384@68695L29,1386@68811L42,1387@68900L43,1379@68510L527:Chip.kt#uh7d8r");
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-577614814, i2, -1, "androidx.compose.material3.SelectableChip.<anonymous> (Chip.kt:1378)");
            }
            SelectableChipColors selectableChipColors = this.$colors;
            boolean z = this.$enabled;
            boolean z2 = this.$selected;
            int i3 = this.$$dirty;
            long r3 = selectableChipColors.labelColor$material3_release(z, z2, composer2, ((i3 << 3) & 112) | ((i3 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m2831unboximpl();
            SelectableChipColors selectableChipColors2 = this.$colors;
            boolean z3 = this.$enabled;
            boolean z4 = this.$selected;
            int i4 = this.$$dirty;
            long r8 = selectableChipColors2.leadingIconContentColor$material3_release(z3, z4, composer2, ((i4 << 3) & 112) | ((i4 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m2831unboximpl();
            SelectableChipColors selectableChipColors3 = this.$colors;
            boolean z5 = this.$enabled;
            boolean z6 = this.$selected;
            int i5 = this.$$dirty;
            long r10 = selectableChipColors3.trailingIconContentColor$material3_release(z5, z6, composer2, ((i5 << 3) & 112) | ((i5 >> 9) & 14) | ((this.$$dirty1 << 6) & 896)).getValue().m2831unboximpl();
            ...
            int i8 = this.$$dirty1;
            ChipKt.m1174ChipContentfe0OD_I(function2, textStyle, r3, function22, function23, function24, r8, r10, f, paddingValues, composer, ((i8 << 15) & 1879048192) | i7 | ((i8 << 15) & 234881024));
            if (ComposerKt.isTraceInProgress()) {
