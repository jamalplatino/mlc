...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public AnimatedPaddingValues(State<Float> state, State<Dp> state2) {
        Intrinsics.checkNotNullParameter(state, "animationProgress");
        Intrinsics.checkNotNullParameter(state2, "topPadding");
        this.animationProgress = state;
        this.topPadding = state2;
    }

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    public float m1122calculateTopPaddingD9Ej5fM() {
        return Dp.m5626constructorimpl(this.topPadding.getValue().m5640unboximpl() * this.animationProgress.getValue().floatValue());
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    public float m1119calculateBottomPaddingD9Ej5fM() {
        return Dp.m5626constructorimpl(SearchBarKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    public float m1120calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return Dp.m5626constructorimpl((float) 0);
    }

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    public float m1121calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return Dp.m5626constructorimpl((float) 0);
    }
}
