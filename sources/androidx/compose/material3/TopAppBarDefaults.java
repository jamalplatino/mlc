...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1854topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        composer2.startReplaceableGroup(2142919275);
        ComposerKt.sourceInformation(composer2, "C(topAppBarColors)P(1:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.Color,4:c#ui.graphics.Color,0:c#ui.graphics.Color)546@26259L9,547@26324L11,551@26568L9,552@26649L9,553@26739L9:AppBar.kt#uh7d8r");
        long color = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getContainerColor(), composer2, 6) : j;
        long r9 = (i2 & 2) != 0 ? ColorSchemeKt.m1240applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer2, 6), color, TopAppBarSmallTokens.INSTANCE.m2371getOnScrollContainerElevationD9Ej5fM()) : j2;
        long color2 = (i2 & 4) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getLeadingIconColor(), composer2, 6) : j3;
        long color3 = (i2 & 8) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getHeadlineColor(), composer2, 6) : j4;
        long color4 = (i2 & 16) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getTrailingIconColor(), composer2, 6) : j5;
        ...
        TopAppBarColors topAppBarColors = new TopAppBarColors(color, r9, color2, color3, color4, (DefaultConstructorMarker) null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1853smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        composer2.startReplaceableGroup(-1717201472);
        ComposerKt.sourceInformation(composer2, "C(smallTopAppBarColors)P(1:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.Color,4:c#ui.graphics.Color,0:c#ui.graphics.Color)585@28109L9,586@28174L11,590@28418L9,591@28499L9,592@28589L9,594@28633L196:AppBar.kt#uh7d8r");
        long color = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getContainerColor(), composer2, 6) : j;
        long r6 = (i2 & 2) != 0 ? ColorSchemeKt.m1240applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer2, 6), color, TopAppBarSmallTokens.INSTANCE.m2371getOnScrollContainerElevationD9Ej5fM()) : j2;
        long color2 = (i2 & 4) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getLeadingIconColor(), composer2, 6) : j3;
        long color3 = (i2 & 8) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getHeadlineColor(), composer2, 6) : j4;
        long color4 = (i2 & 16) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallTokens.INSTANCE.getTrailingIconColor(), composer2, 6) : j5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1717201472, i3, -1, "androidx.compose.material3.TopAppBarDefaults.smallTopAppBarColors (AppBar.kt:584)");
        }
        TopAppBarColors topAppBarColors = m1854topAppBarColorszjMxDiM(color, r6, color2, color3, color4, composer, (i3 & 14) | (i3 & 112) | (i3 & 896) | (i3 & 7168) | (57344 & i3) | (i3 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets r5 = WindowInsetsKt.m583onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 8), WindowInsetsSides.m597plusgK_yJZ4(WindowInsetsSides.Companion.m607getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m611getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m1850centerAlignedTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        composer2.startReplaceableGroup(1896017784);
        ComposerKt.sourceInformation(composer2, "C(centerAlignedTopAppBarColors)P(1:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.Color,4:c#ui.graphics.Color,0:c#ui.graphics.Color)623@29880L9,624@29945L11,628@30197L9,629@30286L9,630@30384L9:AppBar.kt#uh7d8r");
        long color = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallCenteredTokens.INSTANCE.getContainerColor(), composer2, 6) : j;
        long r9 = (i2 & 2) != 0 ? ColorSchemeKt.m1240applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer2, 6), color, TopAppBarSmallTokens.INSTANCE.m2371getOnScrollContainerElevationD9Ej5fM()) : j2;
        long color2 = (i2 & 4) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallCenteredTokens.INSTANCE.getLeadingIconColor(), composer2, 6) : j3;
        long color3 = (i2 & 8) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallCenteredTokens.INSTANCE.getHeadlineColor(), composer2, 6) : j4;
        long color4 = (i2 & 16) != 0 ? ColorSchemeKt.toColor(TopAppBarSmallCenteredTokens.INSTANCE.getTrailingIconColor(), composer2, 6) : j5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1852mediumTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        composer2.startReplaceableGroup(-582474442);
        ComposerKt.sourceInformation(composer2, "C(mediumTopAppBarColors)P(1:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.Color,4:c#ui.graphics.Color,0:c#ui.graphics.Color)654@31423L9,655@31488L11,659@31733L9,660@31815L9,661@31906L9:AppBar.kt#uh7d8r");
        long color = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TopAppBarMediumTokens.INSTANCE.getContainerColor(), composer2, 6) : j;
        long r9 = (i2 & 2) != 0 ? ColorSchemeKt.m1240applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer2, 6), color, TopAppBarSmallTokens.INSTANCE.m2371getOnScrollContainerElevationD9Ej5fM()) : j2;
        long color2 = (i2 & 4) != 0 ? ColorSchemeKt.toColor(TopAppBarMediumTokens.INSTANCE.getLeadingIconColor(), composer2, 6) : j3;
        long color3 = (i2 & 8) != 0 ? ColorSchemeKt.toColor(TopAppBarMediumTokens.INSTANCE.getHeadlineColor(), composer2, 6) : j4;
        long color4 = (i2 & 16) != 0 ? ColorSchemeKt.toColor(TopAppBarMediumTokens.INSTANCE.getTrailingIconColor(), composer2, 6) : j5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1851largeTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        composer2.startReplaceableGroup(-1471507700);
        ComposerKt.sourceInformation(composer2, "C(largeTopAppBarColors)P(1:c#ui.graphics.Color,3:c#ui.graphics.Color,2:c#ui.graphics.Color,4:c#ui.graphics.Color,0:c#ui.graphics.Color)685@32942L9,686@33007L11,690@33251L9,691@33332L9,692@33422L9:AppBar.kt#uh7d8r");
        long color = (i2 & 1) != 0 ? ColorSchemeKt.toColor(TopAppBarLargeTokens.INSTANCE.getContainerColor(), composer2, 6) : j;
        long r9 = (i2 & 2) != 0 ? ColorSchemeKt.m1240applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer2, 6), color, TopAppBarSmallTokens.INSTANCE.m2371getOnScrollContainerElevationD9Ej5fM()) : j2;
        long color2 = (i2 & 4) != 0 ? ColorSchemeKt.toColor(TopAppBarLargeTokens.INSTANCE.getLeadingIconColor(), composer2, 6) : j3;
        long color3 = (i2 & 8) != 0 ? ColorSchemeKt.toColor(TopAppBarLargeTokens.INSTANCE.getHeadlineColor(), composer2, 6) : j4;
        long color4 = (i2 & 16) != 0 ? ColorSchemeKt.toColor(TopAppBarLargeTokens.INSTANCE.getTrailingIconColor(), composer2, 6) : j5;
        if (ComposerKt.isTraceInProgress()) {
