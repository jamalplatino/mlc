...
public final class InputIdentifier {
    ...
    public static final int EndDateInput = m1398constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int SingleDateInput = m1398constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int StartDateInput = m1398constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m1397boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1398constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1399equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).m1403unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1400equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1401hashCodeimpl(int i) {
    ...
    public final /* synthetic */ int m1403unboximpl() {
        return this.value;
    }
    ...
    public static String m1402toStringimpl(int i) {
        if (m1400equalsimpl0(i, SingleDateInput)) {
            return "SingleDateInput";
        }
        if (m1400equalsimpl0(i, StartDateInput)) {
            return "StartDateInput";
        }
        return m1400equalsimpl0(i, EndDateInput) ? "EndDateInput" : "Unknown";
    }
}
