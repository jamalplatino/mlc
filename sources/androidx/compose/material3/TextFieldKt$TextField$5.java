...
final class TextFieldKt$TextField$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C353@18747L20,342@18309L1731:TextField.kt#uh7d8r");
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1163788208, i2, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:341)");
            }
            Modifier r3 = SizeKt.m547defaultMinSizeVpY3zN4(this.$modifier, TextFieldDefaults.INSTANCE.m1702getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m1701getMinHeightD9Ej5fM());
            ...
            BasicTextFieldKt.BasicTextField(textFieldValue4, (Function1<? super TextFieldValue, Unit>) function12, modifier2, this.$enabled, this.$readOnly, this.$mergedTextStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$visualTransformation, (Function1<? super TextLayoutResult, Unit>) null, this.$interactionSource, (Brush) solidColor, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer2, 1751957978, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
                    ...
                    ComposerKt.sourceInformation(composer2, "C363@19268L748:TextField.kt#uh7d8r");
                    if ((i & 14) == 0) {
                    ...
                    if ((i2 & 91) != 18 || !composer.getSkipping()) {
                        ...
                        boolean z3 = z;
                        int i6 = i5;
                        int i7 = ((i4 >> 3) & 896) | ((i3 << 3) & 112) | ((i5 >> 12) & 7168) | (i5 & 57344) | ((i6 << 15) & 458752) | ((i5 << 9) & 3670016) | ((i4 << 3) & 29360128) | ((i4 << 3) & 234881024) | ((i4 << 3) & 1879048192);
                        int i8 = ((i4 >> 27) & 14) | 100663296 | ((i5 << 3) & 112) | ((i5 << 3) & 896) | ((i5 << 3) & 7168) | ((i6 << 9) & 57344) | ((i6 << 9) & 458752);
                        textFieldDefaults2.DecorationBox(text, function2, z3, z2, visualTransformation, mutableInteractionSource, z2, function23, function24, function25, function26, function27, function28, function29, shape, textFieldColors, (PaddingValues) null, (Function2<? super Composer, ? super Integer, Unit>) null, composer, i7, i8, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE);
                        if (ComposerKt.isTraceInProgress()) {
