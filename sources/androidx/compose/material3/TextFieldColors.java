...
public final class TextFieldColors {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledLeadingIconColor : z2 ? this.errorLeadingIconColor : leadingIconColor$lambda$0(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedLeadingIconColor : this.unfocusedLeadingIconColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> indicatorColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (z) {
            ...
            state = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(715788969);
            ComposerKt.sourceInformation(composer, "1816@99679L33");
            state = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> containerColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> r10 = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(!z ? this.disabledContainerColor : z2 ? this.errorContainerColor : containerColor$lambda$3(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedContainerColor : this.unfocusedContainerColor, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> placeholderColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledPlaceholderColor : z2 ? this.errorPlaceholderColor : placeholderColor$lambda$4(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedPlaceholderColor : this.unfocusedPlaceholderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> labelColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledLabelColor : z2 ? this.errorLabelColor : labelColor$lambda$5(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedLabelColor : this.unfocusedLabelColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledTextColor : z2 ? this.errorTextColor : textColor$lambda$6(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedTextColor : this.unfocusedTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> supportingTextColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledSupportingTextColor : z2 ? this.errorSupportingTextColor : supportingTextColor$lambda$7(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedSupportingTextColor : this.unfocusedSupportingTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> prefixColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledPrefixColor : z2 ? this.errorPrefixColor : prefixColor$lambda$8(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedPrefixColor : this.unfocusedPrefixColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> suffixColor$material3_release(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(!z ? this.disabledSuffixColor : z2 ? this.errorSuffixColor : suffixColor$lambda$9(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i >> 6) & 14)) ? this.focusedSuffixColor : this.unfocusedSuffixColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> cursorColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2811boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.focusedTextColor, textFieldColors.focusedTextColor) && Color.m2822equalsimpl0(this.unfocusedTextColor, textFieldColors.unfocusedTextColor) && Color.m2822equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m2822equalsimpl0(this.errorTextColor, textFieldColors.errorTextColor) && Color.m2822equalsimpl0(this.focusedContainerColor, textFieldColors.focusedContainerColor) && Color.m2822equalsimpl0(this.unfocusedContainerColor, textFieldColors.unfocusedContainerColor) && Color.m2822equalsimpl0(this.disabledContainerColor, textFieldColors.disabledContainerColor) && Color.m2822equalsimpl0(this.errorContainerColor, textFieldColors.errorContainerColor) && Color.m2822equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m2822equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && Intrinsics.areEqual((Object) this.textSelectionColors, (Object) textFieldColors.textSelectionColors) && Color.m2822equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m2822equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m2822equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m2822equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m2822equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m2822equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m2822equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m2822equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m2822equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m2822equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m2822equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m2822equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m2822equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m2822equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m2822equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m2822equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m2822equalsimpl0(this.focusedPlaceholderColor, textFieldColors.focusedPlaceholderColor) && Color.m2822equalsimpl0(this.unfocusedPlaceholderColor, textFieldColors.unfocusedPlaceholderColor) && Color.m2822equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m2822equalsimpl0(this.errorPlaceholderColor, textFieldColors.errorPlaceholderColor) && Color.m2822equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m2822equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m2822equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m2822equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor) && Color.m2822equalsimpl0(this.focusedPrefixColor, textFieldColors.focusedPrefixColor) && Color.m2822equalsimpl0(this.unfocusedPrefixColor, textFieldColors.unfocusedPrefixColor) && Color.m2822equalsimpl0(this.disabledPrefixColor, textFieldColors.disabledPrefixColor) && Color.m2822equalsimpl0(this.errorPrefixColor, textFieldColors.errorPrefixColor) && Color.m2822equalsimpl0(this.focusedSuffixColor, textFieldColors.focusedSuffixColor) && Color.m2822equalsimpl0(this.unfocusedSuffixColor, textFieldColors.unfocusedSuffixColor) && Color.m2822equalsimpl0(this.disabledSuffixColor, textFieldColors.disabledSuffixColor) && Color.m2822equalsimpl0(this.errorSuffixColor, textFieldColors.errorSuffixColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m2828hashCodeimpl(this.focusedTextColor) * 31) + Color.m2828hashCodeimpl(this.unfocusedTextColor)) * 31) + Color.m2828hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2828hashCodeimpl(this.errorTextColor)) * 31) + Color.m2828hashCodeimpl(this.focusedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedContainerColor)) * 31) + Color.m2828hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2828hashCodeimpl(this.errorContainerColor)) * 31) + Color.m2828hashCodeimpl(this.cursorColor)) * 31) + Color.m2828hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m2828hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2828hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2828hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2828hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m2828hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2828hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2828hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m2828hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2828hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2828hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2828hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2828hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2828hashCodeimpl(this.focusedPlaceholderColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedPlaceholderColor)) * 31) + Color.m2828hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m2828hashCodeimpl(this.errorPlaceholderColor)) * 31) + Color.m2828hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m2828hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m2828hashCodeimpl(this.errorSupportingTextColor)) * 31) + Color.m2828hashCodeimpl(this.focusedPrefixColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedPrefixColor)) * 31) + Color.m2828hashCodeimpl(this.disabledPrefixColor)) * 31) + Color.m2828hashCodeimpl(this.errorPrefixColor)) * 31) + Color.m2828hashCodeimpl(this.focusedSuffixColor)) * 31) + Color.m2828hashCodeimpl(this.unfocusedSuffixColor)) * 31) + Color.m2828hashCodeimpl(this.disabledSuffixColor)) * 31) + Color.m2828hashCodeimpl(this.errorSuffixColor);
    }
