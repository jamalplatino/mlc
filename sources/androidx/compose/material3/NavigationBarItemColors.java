...
public final class NavigationBarItemColors {
    ...
    public final long m1442getIndicatorColor0d7_KjU$material3_release() {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> r9 = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(!z2 ? this.disabledIconColor : z ? this.selectedIconColor : this.unselectedIconColor, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> r9 = SingleValueAnimationKt.m96animateColorAsStateeuL9pac(!z2 ? this.disabledTextColor : z ? this.selectedTextColor : this.unselectedTextColor, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m2822equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m2822equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m2822equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m2822equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m2822equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m2822equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m2828hashCodeimpl(this.selectedIconColor) * 31) + Color.m2828hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2828hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2828hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2828hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m2828hashCodeimpl(this.disabledIconColor)) * 31) + Color.m2828hashCodeimpl(this.disabledTextColor);
    }
}
