...
final class OutlinedTextFieldKt$OutlinedTextField$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C190@10308L20,171@9477L2337:OutlinedTextField.kt#uh7d8r");
        if ((i2 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1886965181, i2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous> (OutlinedTextField.kt:170)");
            }
            ...
            BasicTextFieldKt.BasicTextField(this.$value, (Function1<? super String, Unit>) function12, modifier, this.$enabled, this.$readOnly, this.$mergedTextStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$minLines, this.$visualTransformation, (Function1<? super TextLayoutResult, Unit>) null, this.$interactionSource, (Brush) solidColor, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composer2, 1474611661, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
                    ...
                    ComposerKt.sourceInformation(composer2, "C199@10744L1046:OutlinedTextField.kt#uh7d8r");
                    if ((i & 14) == 0) {
                    ...
                    if ((i2 & 91) != 18 || !composer.getSkipping()) {
                        ...
                        int i7 = i4;
                        int i8 = i5;
                        int i9 = (i6 & 14) | ((i2 << 3) & 112) | ((i6 >> 3) & 896) | ((i7 >> 12) & 7168) | (i7 & 57344) | ((i8 << 15) & 458752) | ((i7 << 9) & 3670016) | ((i6 << 3) & 29360128) | ((i6 << 3) & 234881024) | ((i6 << 3) & 1879048192);
                        ...
                        String str3 = str2;
                        outlinedTextFieldDefaults2.DecorationBox(str3, function2, z5, z7, visualTransformation2, interactionSource, z8, function23, function24, function23, function24, function25, function26, function27, textFieldColors, (PaddingValues) null, ComposableLambdaKt.composableLambda(composer2, 2108828640, true, new Function2<Composer, Integer, Unit>() {
                            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                                invoke((Composer) obj, ((Number) obj2).intValue());
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Composer composer, int i) {
                                ...
                                if ((i2 & 11) != 2 || !composer.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(2108828640, i2, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous>.<anonymous> (OutlinedTextField.kt:215)");
                                    }
