...
final class AnimatedContentKt$AnimatedContent$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AnimatedContentKt$AnimatedContent$4(S s, Modifier modifier, Function1<? super AnimatedContentScope<S>, ContentTransform> function1, Alignment alignment, Function4<? super AnimatedVisibilityScope, ? super S, ? super Composer, ? super Integer, Unit> function4, int i, int i2) {
        super(2);
        this.$targetState = s;
