...
final class AnimatedContentScope$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m5744getXimpl(this.this$0.m40calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.this$0.m41getCurrentSizeYbymL2g()))) - i));
    }
}
