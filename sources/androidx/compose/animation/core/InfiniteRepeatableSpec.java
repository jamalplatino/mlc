...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode2, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(durationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode2, (i & 4) != 0 ? StartOffset.m142constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode2) {
        this(durationBasedAnimationSpec, repeatMode2, StartOffset.m142constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null), (DefaultConstructorMarker) null);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) infiniteRepeatableSpec.animation, (Object) this.animation) || infiniteRepeatableSpec.repeatMode != this.repeatMode || !StartOffset.m144equalsimpl0(infiniteRepeatableSpec.initialStartOffset, this.initialStartOffset)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m147hashCodeimpl(this.initialStartOffset);
    }
}
