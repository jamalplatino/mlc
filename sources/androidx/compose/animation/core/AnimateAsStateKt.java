...
public final class AnimateAsStateKt {
    ...
    private static final SpringSpec<Dp> dpDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Dp.m5624boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Dp.Companion)), 3, (Object) null);
    ...
    private static final SpringSpec<IntOffset> intOffsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5735boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, (Object) null);
    private static final SpringSpec<IntSize> intSizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m5778boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.Companion)), 3, (Object) null);
    private static final SpringSpec<Offset> offsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Offset.m2561boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Offset.Companion)), 3, (Object) null);
    ...
    private static final SpringSpec<Size> sizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Size.m2629boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Size.Companion)), 3, (Object) null);
    ...
    public static final State<Float> animateFloatAsState(float f, AnimationSpec<Float> animationSpec, float f2, String str, Function1<? super Float, Unit> function1, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(668842840, i3, -1, "androidx.compose.animation.core.animateFloatAsState (AnimateAsState.kt:62)");
        }
    ...
    public static final State<Dp> m111animateDpAsStateAjpBEmI(float f, AnimationSpec<Dp> animationSpec, String str, Function1<? super Dp, Unit> function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        int i4 = i3 << 6;
        State<Dp> animateValueAsState = animateValueAsState(Dp.m5624boximpl(f), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec2, (Dp) null, str2, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | (57344 & i4) | (i4 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Size> m120animateSizeAsStateYLp_XPw(long j, AnimationSpec<Size> animationSpec, String str, Function1<? super Size, Unit> function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1374633148, i3, -1, "androidx.compose.animation.core.animateSizeAsState (AnimateAsState.kt:149)");
        }
        int i4 = i3 << 6;
        State<Size> animateValueAsState = animateValueAsState(Size.m2629boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, (Size) null, str2, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | (57344 & i4) | (i4 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Offset> m117animateOffsetAsState7362WCg(long j, AnimationSpec<Offset> animationSpec, String str, Function1<? super Offset, Unit> function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(357896800, i3, -1, "androidx.compose.animation.core.animateOffsetAsState (AnimateAsState.kt:189)");
        }
        int i4 = i3 << 6;
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2561boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, (Offset) null, str2, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | (57344 & i4) | (i4 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntOffset> m114animateIntOffsetAsStateHyPO7BM(long j, AnimationSpec<IntOffset> animationSpec, String str, Function1<? super IntOffset, Unit> function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-696782904, i3, -1, "androidx.compose.animation.core.animateIntOffsetAsState (AnimateAsState.kt:308)");
        }
        int i4 = i3 << 6;
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5735boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, (IntOffset) null, str2, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | (57344 & i4) | (i4 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntSize> m115animateIntSizeAsState4goxYXU(long j, AnimationSpec<IntSize> animationSpec, String str, Function1<? super IntSize, Unit> function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(582576328, i3, -1, "androidx.compose.animation.core.animateIntSizeAsState (AnimateAsState.kt:346)");
        }
        int i4 = i3 << 6;
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5778boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, (IntSize) null, str2, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | (57344 & i4) | (i4 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final <T, V extends AnimationVector> State<T> animateValueAsState(T t, TwoWayConverter<T, V> twoWayConverter, AnimationSpec<T> animationSpec, T t2, String str, Function1<? super T, Unit> function1, Composer composer, int i, int i2) {
        ...
        Composer composer2 = composer;
        int i3 = i;
        Intrinsics.checkNotNullParameter(twoWayConverter2, "typeConverter");
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1994373980, i3, -1, "androidx.compose.animation.core.animateValueAsState (AnimateAsState.kt:390)");
        }
        composer2.startReplaceableGroup(-492369756);
        ComposerKt.sourceInformation(composer2, "C(remember):Composables.kt#9igjgp");
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = new Animatable(t, twoWayConverter2, t4, str2);
    ...
    public static final /* synthetic */ State animateFloatAsState(float f, AnimationSpec animationSpec, float f2, Function1 function1, Composer composer, int i, int i2) {
        ...
        State<Float> animateFloatAsState = animateFloatAsState(f, animationSpec2, f3, (String) null, function12, composer, (i & 14) | (i & 112) | (i & 896) | ((i << 3) & 57344), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m112animateDpAsStateKz89ssw(float f, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        ...
        State<Dp> animateValueAsState = animateValueAsState(Dp.m5624boximpl(f), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec2, (Dp) null, (String) null, function12, composer, (i & 14) | ((i << 3) & 896) | ((i << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m119animateSizeAsStateLjSzlW0(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        State<Size> animateValueAsState = animateValueAsState(Size.m2629boximpl(j), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, (Size) null, (String) null, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | ((i3 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m118animateOffsetAsStateN6fFfp4(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2561boximpl(j), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, (Offset) null, (String) null, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | ((i3 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m113animateIntOffsetAsState8f6pmRE(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5735boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, (IntOffset) null, (String) null, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | ((i3 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m116animateIntSizeAsStatezTRF_AQ(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        int i3 = i;
        ...
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5778boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, (IntSize) null, (String) null, function12, composer, (i3 & 14) | ((i3 << 3) & 896) | ((i3 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State animateValueAsState(Object obj, TwoWayConverter twoWayConverter, AnimationSpec animationSpec, Object obj2, Function1 function1, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-846382129, i3, -1, "androidx.compose.animation.core.animateValueAsState (AnimateAsState.kt:569)");
        }
        int i4 = i3 & 8;
        State animateValueAsState = animateValueAsState(obj, twoWayConverter, animationSpec2, obj3, "ValueAnimation", function12, composer, (i4 << 9) | i4 | 24576 | (i3 & 14) | (i3 & 112) | (i3 & 896) | (i3 & 7168) | ((i3 << 3) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
