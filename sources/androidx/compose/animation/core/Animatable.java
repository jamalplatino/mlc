...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public Animatable(T t, TwoWayConverter<T, V> twoWayConverter, T t2, String str) {
        ...
        this.typeConverter = twoWayConverter2;
        this.visibilityThreshold = t2;
        this.label = str2;
        this.internalState = new AnimationState(twoWayConverter2, t, (AnimationVector) null, 0, 0, false, 60, (DefaultConstructorMarker) null);
        ...
        V createVector = createVector(t3, Float.NEGATIVE_INFINITY);
        this.negativeInfinityBounds = createVector;
        V createVector2 = createVector(t3, Float.POSITIVE_INFINITY);
    ...
    public final Object runAnimation(Animation<T, V> animation, T t, Function1<? super Animatable<T, V>, Unit> function1, Continuation<? super AnimationResult<T, V>> continuation) {
        return MutatorMutex.mutate$default(this.mutatorMutex, (MutatePriority) null, new Animatable$runAnimation$2(this, t, animation, this.internalState.getLastFrameTimeNanos(), function1, (Continuation<? super Animatable$runAnimation$2>) null), continuation, 1, (Object) null);
    }
