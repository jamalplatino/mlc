...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public final long m137getInitialStartOffsetRmkjzm4() {
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode2, long j, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, durationBasedAnimationSpec, (i2 & 4) != 0 ? RepeatMode.Restart : repeatMode2, (i2 & 8) != 0 ? StartOffset.m142constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ RepeatableSpec(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode2) {
        this(i, durationBasedAnimationSpec, repeatMode2, StartOffset.m142constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null), (DefaultConstructorMarker) null);
    ...
    public boolean equals(Object obj) {
        ...
        if (repeatableSpec.iterations != this.iterations || !Intrinsics.areEqual((Object) repeatableSpec.animation, (Object) this.animation) || repeatableSpec.repeatMode != this.repeatMode || !StartOffset.m144equalsimpl0(repeatableSpec.initialStartOffset, this.initialStartOffset)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m147hashCodeimpl(this.initialStartOffset);
    }
}
