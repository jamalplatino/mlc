...
public final class AnimatedContentScope<S> implements Transition.Segment<S> {
    ...
    private final MutableState measuredSize$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5778boximpl(IntSize.Companion.m5791getZeroYbymL2g()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public static final class SlideDirection {
        ...
        public static final int Down = m53constructorimpl(3);
        /* access modifiers changed from: private */
        public static final int End = m53constructorimpl(5);
        /* access modifiers changed from: private */
        public static final int Left = m53constructorimpl(0);
        /* access modifiers changed from: private */
        public static final int Right = m53constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int Start = m53constructorimpl(4);
        /* access modifiers changed from: private */
        public static final int Up = m53constructorimpl(2);
        ...
        public static boolean m54equalsimpl(int i, Object obj) {
            return (obj instanceof SlideDirection) && i == ((SlideDirection) obj).m58unboximpl();
        }
        ...
        public static String m57toStringimpl(int i) {
            if (m55equalsimpl0(i, Left)) {
                return "Left";
            }
            if (m55equalsimpl0(i, Right)) {
                return "Right";
            }
            if (m55equalsimpl0(i, Up)) {
                return "Up";
            }
            if (m55equalsimpl0(i, Down)) {
                return "Down";
            }
            if (m55equalsimpl0(i, Start)) {
                return "Start";
            }
            return m55equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }

    /* renamed from: slideIntoContainer-HTTW7Ok$default  reason: not valid java name */
    public static /* synthetic */ EnterTransition m44slideIntoContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5735boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, (Object) null);
        }
        if ((i2 & 4) != 0) {
            function1 = AnimatedContentScope$slideIntoContainer$1.INSTANCE;
        }
        return animatedContentScope.m48slideIntoContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* renamed from: slideIntoContainer-HTTW7Ok  reason: not valid java name */
    public final EnterTransition m48slideIntoContainerHTTW7Ok(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1) {
        ...
        if (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m64getUpaUPqQNE())) {
        ...
        if (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m59getDownaUPqQNE())) {
    ...
    private final boolean m42isLeft9jb1Dl8(int i) {
        return SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m61getLeftaUPqQNE()) || (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m63getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr) || (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m60getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-9jb1Dl8  reason: not valid java name */
    private final boolean m43isRight9jb1Dl8(int i) {
        return SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m62getRightaUPqQNE()) || (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m63getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl) || (SlideDirection.m55equalsimpl0(i, SlideDirection.Companion.m60getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE  reason: not valid java name */
    public final long m40calculateOffsetemnUabE(long j, long j2) {
        return this.contentAlignment.m2462alignKFBX0sM(j, j2, LayoutDirection.Ltr);
    }

    /* renamed from: slideOutOfContainer-HTTW7Ok$default  reason: not valid java name */
    public static /* synthetic */ ExitTransition m45slideOutOfContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5735boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, (Object) null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentScope.m49slideOutOfContainerHTTW7Ok(i, finiteAnimationSpec, function1);
    }

    /* renamed from: slideOutOfContainer-HTTW7Ok  reason: not valid java name */
    public final ExitTransition m49slideOutOfContainerHTTW7Ok(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1) {
        Intrinsics.checkNotNullParameter(finiteAnimationSpec, "animationSpec");
    ...
    public final long m46getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize$delegate.getValue()).m5790unboximpl();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release  reason: not valid java name */
    public final void m47setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize$delegate.setValue(IntSize.m5778boximpl(j));
    }

    /* access modifiers changed from: private */
    /* renamed from: getCurrentSize-YbymL2g  reason: not valid java name */
    public final long m41getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().m5790unboximpl() : m46getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    private final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult m50measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            Placeable r13 = measurable.m4520measureBRTryo0(j);
            ...
            return MeasureScope.layout$default(measureScope, IntSize.m5786getWidthimpl(animate.getValue().m5790unboximpl()), IntSize.m5785getHeightimpl(animate.getValue().m5790unboximpl()), (Map) null, new AnimatedContentScope$SizeModifier$measure$1(r13, this.this$0.getContentAlignment$animation_release().m2462alignKFBX0sM(IntSizeKt.IntSize(r13.getWidth(), r13.getHeight()), animate.getValue().m5790unboximpl(), LayoutDirection.Ltr)), 4, (Object) null);
        }
    }
}
