...
final class AnimatedContentScope$slideOutOfContainer$5 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m5745getYimpl(this.this$0.m40calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), r0))) + IntSize.m5785getHeightimpl(r0)));
    }
}
