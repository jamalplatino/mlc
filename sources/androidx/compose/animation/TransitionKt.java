...
public final class TransitionKt {
    ...
    public static final <S> androidx.compose.runtime.State<androidx.compose.ui.graphics.Color> animateColor(androidx.compose.animation.core.Transition<S> r8, kotlin.jvm.functions.Function3<? super androidx.compose.animation.core.Transition.Segment<S>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, ? extends androidx.compose.animation.core.FiniteAnimationSpec<androidx.compose.ui.graphics.Color>> r9, java.lang.String r10, kotlin.jvm.functions.Function3<? super S, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, androidx.compose.ui.graphics.Color> r11, androidx.compose.runtime.Composer r12, int r13, int r14) {
        ...
        L_0x0024:
            ...
            long r0 = r10.m2831unboximpl()
            androidx.compose.ui.graphics.colorspace.ColorSpace r10 = androidx.compose.ui.graphics.Color.m2825getColorSpaceimpl(r0)
    ...
    public static final State<Color> m109animateColorDTcfvLk(InfiniteTransition infiniteTransition, long j, long j2, InfiniteRepeatableSpec<Color> infiniteRepeatableSpec, String str, Composer composer, int i, int i2) {
        ...
        InfiniteRepeatableSpec<Color> infiniteRepeatableSpec2 = infiniteRepeatableSpec;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1901963533, i3, -1, "androidx.compose.animation.animateColor (Transition.kt:96)");
        }
        composer2.startReplaceableGroup(-492369756);
        ComposerKt.sourceInformation(composer2, "C(remember):Composables.kt#9igjgp");
        Object rememberedValue = composer.rememberedValue();
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m2825getColorSpaceimpl(j2));
            composer2.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        int i4 = i3 << 3;
        State<Color> animateValue = InfiniteTransitionKt.animateValue(infiniteTransition, Color.m2811boximpl(j), Color.m2811boximpl(j2), (TwoWayConverter) rememberedValue, infiniteRepeatableSpec, str2, composer, InfiniteTransition.$stable | 4096 | (i3 & 14) | (i3 & 112) | (i3 & 896) | (InfiniteRepeatableSpec.$stable << 12) | (57344 & i4) | (i4 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m110animateColorRIQooxk(InfiniteTransition infiniteTransition, long j, long j2, InfiniteRepeatableSpec infiniteRepeatableSpec, Composer composer, int i) {
        Composer composer2 = composer;
        int i2 = i;
        InfiniteTransition infiniteTransition2 = infiniteTransition;
        Intrinsics.checkNotNullParameter(infiniteTransition, "$this$animateColor");
        ...
        State<Color> r0 = m109animateColorDTcfvLk(infiniteTransition, j, j2, infiniteRepeatableSpec, "ColorAnimation", composer, InfiniteTransition.$stable | 24576 | (i2 & 14) | (i2 & 112) | (i2 & 896) | (InfiniteRepeatableSpec.$stable << 9) | (i2 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
