...
final class SizeAnimationModifier$animateTo$data$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = Animatable.animateTo$default(this.$this_apply.getAnim(), IntSize.m5778boximpl(this.$targetSize), this.this$0.getAnimSpec(), (Object) null, (Function1) null, this, 12, (Object) null);
        ...
        if (animationResult.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != null) {
            listener.invoke(IntSize.m5778boximpl(this.$this_apply.m102getStartSizeYbymL2g()), animationResult.getEndState().getValue());
        }
