    ...
    public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
        ...
        return VectorConvertersKt.TwoWayConverter(AnonymousClass1.INSTANCE, new Function1<AnimationVector4D, Color>() {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                return Color.m2811boximpl(m68invokevNxB06k((AnimationVector4D) obj));
            }
            ...
            public final long m68invokevNxB06k(AnimationVector4D animationVector4D) {
                ...
                return Color.m2818convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(access$multiplyColumn, -2.0f, 2.0f), RangesKt.coerceIn(access$multiplyColumn2, -2.0f, 2.0f), RangesKt.coerceIn(access$multiplyColumn3, -2.0f, 2.0f), RangesKt.coerceIn(animationVector4D.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getCieXyz()), colorSpace);
            }
        });
    }
}
