...
final class EnterExitTransitionKt$createModifier$1$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        ...
        graphicsLayerScope.setScaleX(EnterExitTransitionKt.createModifier$lambda$11(this.$scale$delegate));
        graphicsLayerScope.setScaleY(EnterExitTransitionKt.createModifier$lambda$11(this.$scale$delegate));
        graphicsLayerScope.m3009setTransformOrigin__ExYCQ(EnterExitTransitionKt.createModifier$lambda$13(this.$transformOrigin$delegate));
    }
}
