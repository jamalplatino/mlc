...
final class AnimatedContentScope$SizeModifier$measure$size$2 extends Lambda implements Function1<S, IntSize> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return IntSize.m5778boximpl(m51invokeYEO4UFw(obj));
    }

    /* renamed from: invoke-YEO4UFw  reason: not valid java name */
    public final long m51invokeYEO4UFw(S s) {
        State state = this.this$0.getTargetSizeMap$animation_release().get(s);
        return state != null ? ((IntSize) state.getValue()).m5790unboximpl() : IntSize.Companion.m5791getZeroYbymL2g();
    }
}
