...
public final class BorderKt$borderziNgDLE$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m5624boximpl(this.$width$inlined));
        if (this.$brush$inlined instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m2811boximpl(((SolidColor) this.$brush$inlined).m3186getValue0d7_KjU()));
            inspectorInfo.setValue(Color.m2811boximpl(((SolidColor) this.$brush$inlined).m3186getValue0d7_KjU()));
        } else {
