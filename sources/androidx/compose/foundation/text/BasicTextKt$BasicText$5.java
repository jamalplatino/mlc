...
final class BasicTextKt$BasicText$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        BasicTextKt.m858BasicTextVhcvRP8(this.$text, this.$modifier, this.$style, this.$onTextLayout, this.$overflow, this.$softWrap, this.$maxLines, this.$minLines, this.$inlineContent, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
