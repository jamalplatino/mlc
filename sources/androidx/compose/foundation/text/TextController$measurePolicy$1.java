...
public final class TextController$measurePolicy$1 implements MeasurePolicy {
    ...
    public MeasureResult m923measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        int i;
        Pair pair;
        ...
        TextLayoutResult r4 = this.this$0.getState().getTextDelegate().m934layoutNN6EwU(j, measureScope.getLayoutDirection(), layoutResult);
        ...
        if (list.size() >= r4.getPlaceholderRects().size()) {
            ...
            while (i2 < size) {
                ...
                if (rect != null) {
                    i = i2;
                    pair = new Pair(((Measurable) list2.get(i2)).m4520measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) ((float) Math.floor((double) rect.getWidth())), 0, (int) ((float) Math.floor((double) rect.getHeight())), 5, (Object) null)), IntOffset.m5735boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(rect.getLeft()), MathKt.roundToInt(rect.getTop()))));
                } else {
                    i = i2;
                    pair = null;
                }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
        Intrinsics.checkNotNullParameter(list, "measurables");
        return IntSize.m5785getHeightimpl(TextDelegate.m931layoutNN6EwU$default(this.this$0.getState().getTextDelegate(), ConstraintsKt.Constraints(0, i, 0, Integer.MAX_VALUE), intrinsicMeasureScope.getLayoutDirection(), (TextLayoutResult) null, 4, (Object) null).m5104getSizeYbymL2g());
    }
