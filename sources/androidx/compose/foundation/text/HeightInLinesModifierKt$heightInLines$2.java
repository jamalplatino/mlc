...
final class HeightInLinesModifierKt$heightInLines$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        boolean changed = composer.changed((Object) textStyle) | composer.changed((Object) layoutDirection);
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            ...
            FontStyle r5 = textStyle2.m5153getFontStyle4Lr2A7w();
            int r52 = r5 != null ? r5.m5223unboximpl() : FontStyle.Companion.m5225getNormal_LCdwA();
            FontSynthesis r6 = textStyle2.m5154getFontSynthesisZQGJjVo();
            rememberedValue2 = resolver.m5194resolveDPcqOEQ(fontFamily, fontWeight, r52, r6 != null ? r6.m5234unboximpl() : FontSynthesis.Companion.m5235getAllGVVA2EU());
        ...
        if (z || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = Integer.valueOf(IntSize.m5785getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
        ...
        if (z2 || rememberedValue4 == Composer.Companion.getEmpty()) {
            rememberedValue4 = Integer.valueOf(IntSize.m5785getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + 10 + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
        ...
        Modifier r13 = SizeKt.m550heightInVpY3zN4(Modifier.Companion, valueOf != null ? density.m5604toDpu2uoSUM(valueOf.intValue()) : Dp.Companion.m5646getUnspecifiedD9Ej5fM(), num != null ? density.m5604toDpu2uoSUM(num.intValue()) : Dp.Companion.m5646getUnspecifiedD9Ej5fM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
