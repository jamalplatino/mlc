...
final class CoreTextFieldKt$previewKeyEventToDeselectOnBack$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m873invokeZmokQxo(((KeyEvent) obj).m4170unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m873invokeZmokQxo(android.view.KeyEvent keyEvent) {
        boolean z;
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        if (this.$state.getHandleState() != HandleState.Selection || !KeyEventHelpers_androidKt.m881cancelsTextSelectionZmokQxo(keyEvent)) {
            z = false;
        } else {
            z = true;
