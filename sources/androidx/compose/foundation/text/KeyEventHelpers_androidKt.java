...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m881cancelsTextSelectionZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$cancelsTextSelection");
        return keyEvent.getKeyCode() == 4 && KeyEventType.m4174equalsimpl0(KeyEvent_androidKt.m4182getTypeZmokQxo(keyEvent), KeyEventType.Companion.m4179getKeyUpCS__XNY());
    }
}
