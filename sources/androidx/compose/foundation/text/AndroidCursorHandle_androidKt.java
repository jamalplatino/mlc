...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m854CursorHandleULxng0E(long j, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m974HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(startRestartGroup, -1458480226, true, new AndroidCursorHandle_androidKt$CursorHandle$1(function2, modifier, i2)), startRestartGroup, (i2 & 14) | 432);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void DefaultCursorHandle(Modifier modifier, Composer composer, int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m565sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    static {
        float r0 = Dp.m5626constructorimpl((float) 25);
        CursorHandleHeight = r0;
        CursorHandleWidth = Dp.m5626constructorimpl(Dp.m5626constructorimpl(r0 * 2.0f) / 2.4142137f);
    }
}
