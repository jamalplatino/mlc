...
final class TextController$measurePolicy$1$measure$2 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Placeable.PlacementScope.m4560place70tqf50$default(placementScope, (Placeable) pair.component1(), ((IntOffset) pair.component2()).m5753unboximpl(), 0.0f, 2, (Object) null);
        }
    }
}
