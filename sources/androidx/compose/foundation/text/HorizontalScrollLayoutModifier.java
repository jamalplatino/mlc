...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m880measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        if (measurable.maxIntrinsicWidth(Constraints.m5569getMaxHeightimpl(j)) < Constraints.m5570getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = Constraints.m5561copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable r12 = measurable.m4520measureBRTryo0(j2);
        int min = Math.min(r12.getWidth(), Constraints.m5570getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, min, r12.getHeight(), (Map) null, new HorizontalScrollLayoutModifier$measure$1(measureScope, this, r12, min), 4, (Object) null);
    }
}
