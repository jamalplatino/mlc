...
public final class KeyboardOptions {
    ...
    public final int m890getCapitalizationIUNYP9k() {
        return this.capitalization;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m891getImeActioneUduSuo() {
        return this.imeAction;
    }

    /* renamed from: getKeyboardType-PjHm6EE  reason: not valid java name */
    public final int m892getKeyboardTypePjHm6EE() {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.Companion.m5319getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.Companion.m5345getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.Companion.m5291getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m888copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m889copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m889copy3m2b7yw(int i, boolean z, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        return KeyboardCapitalization.m5310equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m5325equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m5279equalsimpl0(this.imeAction, keyboardOptions.imeAction);
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m5311hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m5326hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m5280hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + KeyboardCapitalization.m5312toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m5327toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m5281toStringimpl(this.imeAction) + ')';
    }
}
