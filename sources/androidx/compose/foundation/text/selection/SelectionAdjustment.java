...
public interface SelectionAdjustment {
    ...
    long m997adjustZXO7KMw(TextLayoutResult textLayoutResult, long j, int i, boolean z, TextRange textRange);
    ...
    public static final class Companion {
        ...
        public final long m999adjustByBoundaryDvylE(TextLayoutResult textLayoutResult, long j, Function1<? super Integer, TextRange> function1) {
            ...
            long r2 = function1.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m5131getStartimpl(j), 0, lastIndex))).m5135unboximpl();
            long r0 = function1.invoke(Integer.valueOf(RangesKt.coerceIn(TextRange.m5126getEndimpl(j), 0, lastIndex))).m5135unboximpl();
            return TextRangeKt.TextRange(TextRange.m5130getReversedimpl(j) ? TextRange.m5126getEndimpl(r2) : TextRange.m5131getStartimpl(r2), TextRange.m5130getReversedimpl(j) ? TextRange.m5131getStartimpl(r0) : TextRange.m5126getEndimpl(r0));
        }
    }
}
