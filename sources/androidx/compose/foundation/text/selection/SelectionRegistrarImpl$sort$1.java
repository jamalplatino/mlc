...
final class SelectionRegistrarImpl$sort$1 extends Lambda implements Function2<Selectable, Selectable, Integer> {
    ...
    public final Integer invoke(Selectable selectable, Selectable selectable2) {
        ...
        if (layoutCoordinates != null) {
            j = this.$containerLayoutCoordinates.m4497localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m2588getZeroF1C5BW0());
        } else {
            j = Offset.Companion.m2588getZeroF1C5BW0();
        }
        if (layoutCoordinates2 != null) {
            j2 = this.$containerLayoutCoordinates.m4497localPositionOfR5De75A(layoutCoordinates2, Offset.Companion.m2588getZeroF1C5BW0());
        } else {
            j2 = Offset.Companion.m2588getZeroF1C5BW0();
        }
        if (Offset.m2573getYimpl(j) == Offset.m2573getYimpl(j2)) {
            i = ComparisonsKt.compareValues(Float.valueOf(Offset.m2572getXimpl(j)), Float.valueOf(Offset.m2572getXimpl(j2)));
        } else {
            i = ComparisonsKt.compareValues(Float.valueOf(Offset.m2573getYimpl(j)), Float.valueOf(Offset.m2573getYimpl(j2)));
        }
