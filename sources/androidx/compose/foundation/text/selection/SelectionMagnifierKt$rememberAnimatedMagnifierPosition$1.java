        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() {
                public /* bridge */ /* synthetic */ Object invoke() {
                    return Offset.m2561boximpl(m1015invokeF1C5BW0());
                }
            ...
            if (snapshotFlow.collect(new FlowCollector<Offset>() {
                public /* bridge */ /* synthetic */ Object emit(Object obj, Continuation continuation) {
                    return m1016emit3MmeM6k(((Offset) obj).m2582unboximpl(), continuation);
                }

                /* renamed from: emit-3MmeM6k  reason: not valid java name */
                public final Object m1016emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (!OffsetKt.m2591isSpecifiedk4lQ0M(animatable.getValue().m2582unboximpl()) || !OffsetKt.m2591isSpecifiedk4lQ0M(j) || Offset.m2573getYimpl(animatable.getValue().m2582unboximpl()) == Offset.m2573getYimpl(j)) {
                        Object snapTo = animatable.snapTo(Offset.m2561boximpl(j), continuation);
