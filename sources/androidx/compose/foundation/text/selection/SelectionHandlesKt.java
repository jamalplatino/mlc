...
public final class SelectionHandlesKt {
    ...
    public static final long m1011getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j) - 1.0f);
    }

    static {
        float f = (float) 25;
        HandleWidth = Dp.m5626constructorimpl(f);
        HandleHeight = Dp.m5626constructorimpl(f);
    }
}
