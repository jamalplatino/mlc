...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m1007copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle2, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m1009copyUv8p0NA(handle2, j);
    }
    ...
    public final long m1008component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA  reason: not valid java name */
    public final SelectionHandleInfo m1009copyUv8p0NA(Handle handle2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m2569equalsimpl0(this.position, selectionHandleInfo.position);
    }
    ...
    public final long m1010getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m2574hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + Offset.m2580toStringimpl(this.position) + ')';
    }
