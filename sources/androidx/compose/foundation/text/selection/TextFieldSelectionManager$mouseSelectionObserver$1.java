...
public final class TextFieldSelectionManager$mouseSelectionObserver$1 implements MouseSelectionObserver {
    ...
    public boolean m1080onExtendk4lQ0M(long j) {
    ...
    public boolean m1082onStart3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
        ...
        textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m963getOffsetForPosition3MmeM6k$default(textLayoutResultProxy, j, false, 2, (Object) null));
        int r4 = TextLayoutResultProxy.m963getOffsetForPosition3MmeM6k$default(textLayoutResultProxy, textFieldSelectionManager.dragBeginPosition, false, 2, (Object) null);
    ...
    public boolean m1079onDrag3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
        TextFieldState state$foundation_release;
        TextLayoutResultProxy layoutResult;
        Intrinsics.checkNotNullParameter(selectionAdjustment, "adjustment");
        if (this.this$0.getValue$foundation_release().getText().length() == 0 || (state$foundation_release = this.this$0.getState$foundation_release()) == null || (layoutResult = state$foundation_release.getLayoutResult()) == null) {
        ...
        TextFieldSelectionManager textFieldSelectionManager = this.this$0;
        int r5 = layoutResult.m965getOffsetForPosition3MmeM6k(j, false);
        ...
        textFieldSelectionManager.updateSelection(value$foundation_release, access$getDragBeginOffsetInText$p.intValue(), r5, false, selectionAdjustment);
        return true;
    }
}
