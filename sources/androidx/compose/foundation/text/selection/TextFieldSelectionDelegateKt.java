...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m1062getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int i, int i2, TextRange textRange, boolean z, SelectionAdjustment selectionAdjustment) {
        ...
        if (textRange != null || !Intrinsics.areEqual((Object) selectionAdjustment, (Object) SelectionAdjustment.Companion.getCharacter())) {
            return selectionAdjustment.m997adjustZXO7KMw(textLayoutResult, TextRange, -1, z, textRange);
        }
        return TextRange;
    }
}
