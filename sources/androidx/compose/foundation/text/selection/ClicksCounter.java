...
final class ClicksCounter {
    ...
    public final boolean positionIsTolerable(PointerInputChange pointerInputChange, PointerInputChange pointerInputChange2) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "prevClick");
        Intrinsics.checkNotNullParameter(pointerInputChange2, "newClick");
        return ((double) Offset.m2570getDistanceimpl(Offset.m2576minusMKHz9U(pointerInputChange2.m4324getPositionF1C5BW0(), pointerInputChange.m4324getPositionF1C5BW0()))) < 100.0d;
    }
}
