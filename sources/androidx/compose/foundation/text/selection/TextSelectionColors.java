...
public final class TextSelectionColors {
    ...
    public final long m1090getBackgroundColor0d7_KjU() {
        return this.backgroundColor;
    }

    /* renamed from: getHandleColor-0d7_KjU  reason: not valid java name */
    public final long m1091getHandleColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m2822equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m2822equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m2828hashCodeimpl(this.handleColor) * 31) + Color.m2828hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m2829toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m2829toStringimpl(this.backgroundColor) + ')';
    }
}
