...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m976getOriginalSelectiond9O1mEE() {
    ...
    public final long m977getSelectiond9O1mEE() {
    ...
    public final void m978setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m5126getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m5126getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            long r0 = textLayoutResult.m5105getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5126getEndimpl(r0) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m5126getEndimpl(r0));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long r0 = textLayoutResult.m5105getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5131getStartimpl(r0) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m5131getStartimpl(r0));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m5103getOffsetForPositionk4lQ0M(OffsetKt.Offset(number.floatValue(), lineBottom)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5126getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5129getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m5128getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m5129getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m5128getMaximpl(this.selection));
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            setCursor(TextRange.m5126getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        BaseTextPreparedSelection baseTextPreparedSelection2 = this;
        return this;
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> function1) {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            if (TextRange.m5125getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m5129getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m5128getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        BaseTextPreparedSelection baseTextPreparedSelection2 = this;
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            this.selection = TextRangeKt.TextRange(TextRange.m5131getStartimpl(this.originalSelection), TextRange.m5126getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        BaseTextPreparedSelection baseTextPreparedSelection2 = this;
        return this;
