...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static /* synthetic */ Pair m991getTextSelectionInfoyM0VcXU$default(TextLayoutResult textLayoutResult, long j, long j2, Offset offset, long j3, SelectionAdjustment selectionAdjustment, Selection selection, boolean z, int i, Object obj) {
        int i2 = i;
        return m990getTextSelectionInfoyM0VcXU(textLayoutResult, j, j2, offset, j3, selectionAdjustment, (i2 & 64) != 0 ? null : selection, (i2 & 128) != 0 ? true : z);
    }
    ...
    public static final kotlin.Pair<androidx.compose.foundation.text.selection.Selection, java.lang.Boolean> m990getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult r15, long r16, long r18, androidx.compose.ui.geometry.Offset r20, long r21, androidx.compose.foundation.text.selection.SelectionAdjustment r23, androidx.compose.foundation.text.selection.Selection r24, boolean r25) {
        /*
            ...
            long r2 = r15.m5104getSizeYbymL2g()
            int r2 = androidx.compose.ui.unit.IntSize.m5786getWidthimpl(r2)
            float r2 = (float) r2
            long r3 = r15.m5104getSizeYbymL2g()
            int r3 = androidx.compose.ui.unit.IntSize.m5785getHeightimpl(r3)
            float r3 = (float) r3
            r4 = 0
            r0.<init>(r4, r4, r2, r3)
            ...
            r11 = r16
            r13 = r18
            boolean r2 = r9.m1053isSelected2x9bVx0$foundation_release(r10, r11, r13)
            r9 = 0
            r3 = 0
        ...
        L_0x0042:
            r4 = r16
            int r10 = m989getOffsetForPosition0AR0LA0(r15, r0, r4)
            r4 = r18
            int r11 = m989getOffsetForPosition0AR0LA0(r15, r0, r4)
            if (r20 == 0) goto L_0x0059
            long r4 = r20.m2582unboximpl()
            int r0 = m989getOffsetForPosition0AR0LA0(r15, r0, r4)
            goto L_0x005a
        L_0x0059:
            r0 = -1
        L_0x005a:
            ...
            long r2 = r24.m996toTextRanged9O1mEE()
            androidx.compose.ui.text.TextRange r0 = androidx.compose.ui.text.TextRange.m5119boximpl(r2)
            r6 = r0
            goto L_0x006c
        L_0x006b:
            r6 = r3
        L_0x006c:
            ...
            r4 = r12
            r5 = r25
            long r0 = r0.m997adjustZXO7KMw(r1, r2, r4, r5, r6)
            boolean r2 = androidx.compose.ui.text.TextRange.m5130getReversedimpl(r0)
            r3 = r21
            r5 = r15
            androidx.compose.foundation.text.selection.Selection r0 = m988getAssembledSelectionInfovJH6DeI(r0, r2, r3, r5)
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r0, (java.lang.Object) r8)
            r2 = 1
            r1 = r1 ^ r2
        ...
        L_0x0093:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.MultiWidgetSelectionDelegateKt.m990getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult, long, long, androidx.compose.ui.geometry.Offset, long, androidx.compose.foundation.text.selection.SelectionAdjustment, androidx.compose.foundation.text.selection.Selection, boolean):kotlin.Pair");
    }

    /* renamed from: getOffsetForPosition-0AR0LA0  reason: not valid java name */
    public static final int m989getOffsetForPosition0AR0LA0(TextLayoutResult textLayoutResult, Rect rect, long j) {
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        Intrinsics.checkNotNullParameter(rect, "bounds");
        int length = textLayoutResult.getLayoutInput().getText().length();
        if (rect.m2598containsk4lQ0M(j)) {
            return RangesKt.coerceIn(textLayoutResult.m5103getOffsetForPositionk4lQ0M(j), 0, length);
        }
        if (SelectionMode.Vertical.m1052compare3MmeM6k$foundation_release(j, rect) < 0) {
            return 0;
        }
        return length;
    }
    ...
    public static final Selection m988getAssembledSelectionInfovJH6DeI(long j, boolean z, long j2, TextLayoutResult textLayoutResult) {
        return new Selection(new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(TextRange.m5131getStartimpl(j)), TextRange.m5131getStartimpl(j), j2), new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(Math.max(TextRange.m5126getEndimpl(j) - 1, 0)), TextRange.m5126getEndimpl(j), j2), z);
    }
}
