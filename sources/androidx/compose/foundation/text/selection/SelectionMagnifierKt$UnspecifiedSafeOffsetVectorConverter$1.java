...
final class SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1 extends Lambda implements Function1<Offset, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m1012invokek4lQ0M(((Offset) obj).m2582unboximpl());
    }

    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
    public final AnimationVector2D m1012invokek4lQ0M(long j) {
        if (OffsetKt.m2591isSpecifiedk4lQ0M(j)) {
            return new AnimationVector2D(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j));
        }
