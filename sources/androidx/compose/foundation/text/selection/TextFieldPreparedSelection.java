...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public TextFieldPreparedSelection(TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResultProxy, TextPreparedSelectionState textPreparedSelectionState) {
        super(textFieldValue.getAnnotatedString(), textFieldValue.m5352getSelectiond9O1mEE(), textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, offsetMapping, textPreparedSelectionState, (DefaultConstructorMarker) null);
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m5347copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m977getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> function1) {
        ...
        if (TextRange.m5125getCollapsedimpl(m977getSelectiond9O1mEE())) {
        ...
        return CollectionsKt.listOf(new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m5129getMinimpl(m977getSelectiond9O1mEE()), TextRange.m5129getMinimpl(m977getSelectiond9O1mEE())));
    }
    ...
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L_0x001b:
            ...
            long r3 = r1.m5352getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m5126getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m2605getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m2638getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m5103getOffsetForPositionk4lQ0M(r0)
