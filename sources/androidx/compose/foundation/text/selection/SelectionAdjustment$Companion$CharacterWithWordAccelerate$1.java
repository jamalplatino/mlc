...
public final class SelectionAdjustment$Companion$CharacterWithWordAccelerate$1 implements SelectionAdjustment {
    ...
    public long m1001adjustZXO7KMw(TextLayoutResult textLayoutResult, long j, int i, boolean z, TextRange textRange) {
        int i2;
        int i3;
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        if (textRange == null) {
            return SelectionAdjustment.Companion.$$INSTANCE.getWord().m997adjustZXO7KMw(textLayoutResult, j, i, z, textRange);
        }
        if (TextRange.m5125getCollapsedimpl(j)) {
            return SelectionAdjustmentKt.ensureAtLeastOneChar(textLayoutResult.getLayoutInput().getText().getText(), TextRange.m5131getStartimpl(j), StringsKt.getLastIndex(textLayoutResult.getLayoutInput().getText()), z, TextRange.m5130getReversedimpl(textRange.m5135unboximpl()));
        }
        if (z) {
            i3 = updateSelectionBoundary(textLayoutResult, TextRange.m5131getStartimpl(j), i, TextRange.m5131getStartimpl(textRange.m5135unboximpl()), TextRange.m5126getEndimpl(j), true, TextRange.m5130getReversedimpl(j));
            i2 = TextRange.m5126getEndimpl(j);
        } else {
            int r13 = TextRange.m5131getStartimpl(j);
            i2 = updateSelectionBoundary(textLayoutResult, TextRange.m5126getEndimpl(j), i, TextRange.m5126getEndimpl(textRange.m5135unboximpl()), TextRange.m5131getStartimpl(j), false, TextRange.m5130getReversedimpl(j));
            i3 = r13;
        }
    ...
    private final int snapToWordBoundary(TextLayoutResult textLayoutResult, int i, int i2, int i3, boolean z, boolean z2) {
        int i4;
        int i5;
        long r0 = textLayoutResult.m5105getWordBoundaryjx7JFs(i);
        if (textLayoutResult.getLineForOffset(TextRange.m5131getStartimpl(r0)) == i2) {
            i4 = TextRange.m5131getStartimpl(r0);
        } else {
            i4 = textLayoutResult.getLineStart(i2);
        }
        if (textLayoutResult.getLineForOffset(TextRange.m5126getEndimpl(r0)) == i2) {
            i5 = TextRange.m5126getEndimpl(r0);
        } else {
    ...
    private final boolean isAtWordBoundary(TextLayoutResult textLayoutResult, int i) {
        long r0 = textLayoutResult.m5105getWordBoundaryjx7JFs(i);
        return i == TextRange.m5131getStartimpl(r0) || i == TextRange.m5126getEndimpl(r0);
    }
}
