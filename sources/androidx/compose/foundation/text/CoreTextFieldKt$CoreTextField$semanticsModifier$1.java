...
final class CoreTextFieldKt$CoreTextField$semanticsModifier$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public final void invoke(final SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m4982setImeAction4L7nppU(semanticsPropertyReceiver, this.$imeOptions.m5302getImeActioneUduSuo());
        SemanticsPropertiesKt.setEditableText(semanticsPropertyReceiver, this.$transformedText.getText());
        SemanticsPropertiesKt.m4985setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, this.$value.m5352getSelectiond9O1mEE());
        if (!this.$enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, (String) null, new Function3<Integer, Integer, Boolean, Boolean>() {
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                boolean z2 = false;
                if (z && !(i == TextRange.m5131getStartimpl(textFieldValue.m5352getSelectiond9O1mEE()) && i2 == TextRange.m5126getEndimpl(textFieldValue.m5352getSelectiond9O1mEE()))) {
        ...
        if (!TextRange.m5125getCollapsedimpl(this.$value.m5352getSelectiond9O1mEE()) && !this.$isPassword) {
