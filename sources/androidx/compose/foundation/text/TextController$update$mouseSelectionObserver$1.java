...
public final class TextController$update$mouseSelectionObserver$1 implements MouseSelectionObserver {
    ...
    public boolean m928onExtendk4lQ0M(long j) {
        ...
        if (selectionRegistrar.m1056notifySelectionUpdate5iVPX68(layoutCoordinates, j, this.lastPosition, false, SelectionAdjustment.Companion.getNone())) {
            this.lastPosition = j;
        }
    ...
    public boolean m929onExtendDragk4lQ0M(long j) {
        LayoutCoordinates layoutCoordinates = this.this$0.getState().getLayoutCoordinates();
        if (layoutCoordinates == null) {
            return true;
        }
    ...
    public boolean m930onStart3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
        ...
        selectionRegistrar.m1057notifySelectionUpdateStartd4ec7I(layoutCoordinates, j, selectionAdjustment);
        this.lastPosition = j;
        return SelectionRegistrarKt.hasSelection(selectionRegistrar, textController.getState().getSelectableId());
    }

    /* renamed from: onDrag-3MmeM6k  reason: not valid java name */
    public boolean m927onDrag3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
        Intrinsics.checkNotNullParameter(selectionAdjustment, "adjustment");
        LayoutCoordinates layoutCoordinates = this.this$0.getState().getLayoutCoordinates();
        if (layoutCoordinates != null) {
            SelectionRegistrar selectionRegistrar = this.$selectionRegistrar;
            ...
            if (selectionRegistrar.m1056notifySelectionUpdate5iVPX68(layoutCoordinates, j, this.lastPosition, false, selectionAdjustment)) {
                this.lastPosition = j;
            }
        }
        return true;
