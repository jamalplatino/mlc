...
public final class BorderStroke {
    ...
    public final float m200getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m5631equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual((Object) this.brush, (Object) borderStroke.brush);
    }

    public int hashCode() {
        return (Dp.m5632hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + Dp.m5637toStringimpl(this.width) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default  reason: not valid java name */
    public static /* synthetic */ BorderStroke m198copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m199copyD5KLDUw(f, brush2);
    }

    /* renamed from: copy-D5KLDUw  reason: not valid java name */
    public final BorderStroke m199copyD5KLDUw(float f, Brush brush2) {
