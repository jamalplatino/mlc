...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m842component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m843copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
    ...
    public final DpCornerSize m844copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m5631equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    public int hashCode() {
        return Dp.m5632hashCodeimpl(this.size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m5624boximpl(m845getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m846toPxTmRCtEA(long j, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5607toPx0680j_4(this.size);
    }
