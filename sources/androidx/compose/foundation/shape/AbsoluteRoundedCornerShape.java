...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline m829createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        float f5 = f;
        float f6 = f2;
        float f7 = f3;
        float f8 = f4;
        ...
        if (f5 + f6 + f7 + f8 == 0.0f) {
            return new Outline.Rectangle(SizeKt.m2662toRectuvyYCjk(j));
        }
        Rect r6 = SizeKt.m2662toRectuvyYCjk(j);
        long CornerRadius$default = CornerRadiusKt.CornerRadius$default(f5, 0.0f, 2, (Object) null);
        return new Outline.Rounded(RoundRectKt.m2624RoundRectZAM2FJo(r6, CornerRadius$default, CornerRadiusKt.CornerRadius$default(f6, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(f7, 0.0f, 2, (Object) null), CornerRadiusKt.CornerRadius$default(f8, 0.0f, 2, (Object) null)));
    }
    ...
    private final long m828toRadiusBz7bX_o(float f) {
