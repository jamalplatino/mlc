...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline m833createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline m834createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        float r3 = this.topStart.m835toPxTmRCtEA(j, density);
        float r4 = this.topEnd.m835toPxTmRCtEA(j, density);
        float r5 = this.bottomEnd.m835toPxTmRCtEA(j, density);
        float r0 = this.bottomStart.m835toPxTmRCtEA(j, density);
        float r6 = Size.m2640getMinDimensionimpl(j);
        float f = r3 + r0;
        if (f > r6) {
            float f2 = r6 / f;
            r3 *= f2;
        ...
        if (r3 >= 0.0f && r4 >= 0.0f && r5 >= 0.0f && f3 >= 0.0f) {
            return m833createOutlineLjSzlW0(j, r3, r4, r5, f3, layoutDirection);
        }
