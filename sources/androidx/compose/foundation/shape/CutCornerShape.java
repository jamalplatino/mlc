...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline m838createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2641getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m2641getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m2641getWidthimpl(j), Size.m2638getHeightimpl(j) - f6);
        Path.lineTo(Size.m2641getWidthimpl(j) - f6, Size.m2638getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m2638getHeightimpl(j));
        Path.lineTo(0.0f, Size.m2638getHeightimpl(j) - f3);
        Path.close();
