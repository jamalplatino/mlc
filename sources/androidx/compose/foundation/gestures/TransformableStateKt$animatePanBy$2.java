...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.Companion), Offset.m2561boximpl(this.$previous.element), (AnimationVector) null, 0, 0, false, 60, (DefaultConstructorMarker) null);
            Offset r4 = Offset.m2561boximpl(this.$offset);
            ...
            if (SuspendAnimationKt.animateTo$default(animationState, r4, animationSpec, false, new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() {
                ...
                public final void invoke(AnimationScope<Offset, AnimationVector2D> animationScope) {
                    ...
                    TransformScope.m376transformByd4ec7I$default(transformScope, 0.0f, Offset.m2576minusMKHz9U(animationScope.getValue().m2582unboximpl(), longRef.element), 0.0f, 5, (Object) null);
                    longRef.element = animationScope.getValue().m2582unboximpl();
                }
