...
public final class TransformableStateKt {
    ...
    public static final Object animateZoomBy(TransformableState transformableState, float f, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        if (f > 0.0f) {
            ...
            Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$animateZoomBy$3(floatRef, f, animationSpec, (Continuation<? super TransformableStateKt$animateZoomBy$3>) null), continuation, 1, (Object) null);
    ...
    public static final Object animateRotateBy(TransformableState transformableState, float f, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$animateRotateBy$2(new Ref.FloatRef(), f, animationSpec, (Continuation<? super TransformableStateKt$animateRotateBy$2>) null), continuation, 1, (Object) null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    /* renamed from: animatePanBy-ubNVwUQ$default  reason: not valid java name */
    public static /* synthetic */ Object m380animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, (Object) null, 5, (DefaultConstructorMarker) null);
        }
        return m379animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }

    /* renamed from: animatePanBy-ubNVwUQ  reason: not valid java name */
    public static final Object m379animatePanByubNVwUQ(TransformableState transformableState, long j, AnimationSpec<Offset> animationSpec, Continuation<? super Unit> continuation) {
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = Offset.Companion.m2588getZeroF1C5BW0();
        Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$animatePanBy$2(longRef, j, animationSpec, (Continuation<? super TransformableStateKt$animatePanBy$2>) null), continuation, 1, (Object) null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    public static final Object zoomBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$zoomBy$2(f, (Continuation<? super TransformableStateKt$zoomBy$2>) null), continuation, 1, (Object) null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    public static final Object rotateBy(TransformableState transformableState, float f, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$rotateBy$2(f, (Continuation<? super TransformableStateKt$rotateBy$2>) null), continuation, 1, (Object) null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }

    /* renamed from: panBy-d-4ec7I  reason: not valid java name */
    public static final Object m381panByd4ec7I(TransformableState transformableState, long j, Continuation<? super Unit> continuation) {
        Object transform$default = TransformableState.transform$default(transformableState, (MutatePriority) null, new TransformableStateKt$panBy$2(j, (Continuation<? super TransformableStateKt$panBy$2>) null), continuation, 1, (Object) null);
        return transform$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? transform$default : Unit.INSTANCE;
    }
