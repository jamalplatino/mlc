    ...
    public final void invoke(PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            if (this.$reverseDirection) {
                positionChange = Offset.m2579timestuRUvjQ(positionChange, -1.0f);
            }
            sendChannel.m7552trySendJP2dKIU(new DragEvent.DragDelta(positionChange, (DefaultConstructorMarker) null));
        }
    }
}
