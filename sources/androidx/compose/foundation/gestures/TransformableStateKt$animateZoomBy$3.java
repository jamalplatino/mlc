        ...
        if (i == 0) {
            ...
            if (SuspendAnimationKt.animateTo$default(AnimationState$default, boxFloat, animationSpec, false, new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() {
                ...
                public final void invoke(AnimationScope<Float, AnimationVector1D> animationScope) {
                    ...
                    TransformScope.m376transformByd4ec7I$default(transformScope, floatRef.element == 0.0f ? 1.0f : animationScope.getValue().floatValue() / floatRef.element, 0, 0.0f, 6, (Object) null);
