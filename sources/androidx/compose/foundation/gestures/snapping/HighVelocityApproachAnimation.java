...
final class HighVelocityApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(ScrollScope scrollScope, float f, float f2, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        Object access$animateDecay = SnapFlingBehaviorKt.animateDecay(scrollScope, f, AnimationStateKt.AnimationState$default(0.0f, f2, 0, 0, false, 28, (Object) null), this.decayAnimationSpec, function1, continuation);
