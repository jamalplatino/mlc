...
public final class DefaultTransformableState$transformScope$1 implements TransformScope {
    ...
    public void m267transformByd4ec7I(float f, long j, float f2) {
        this.this$0.getOnTransformation().invoke(Float.valueOf(f), Offset.m2561boximpl(j), Float.valueOf(f2));
    }
}
