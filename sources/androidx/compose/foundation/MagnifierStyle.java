...
public final class MagnifierStyle {
    ...
    public final float m231getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m232getElevationD9Ej5fM$foundation_release() {
    ...
    public final long m233getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }
    ...
    public /* synthetic */ MagnifierStyle(long r8, float r10, float r11, boolean r12, boolean r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            ...
            long r0 = r0.m5733getUnspecifiedMYxV2XQ()
            goto L_0x000c
        L_0x000b:
            r0 = r8
        L_0x000c:
            ...
            float r2 = r2.m5646getUnspecifiedD9Ej5fM()
            goto L_0x0018
        L_0x0017:
            r2 = r10
        L_0x0018:
            ...
            float r3 = r3.m5646getUnspecifiedD9Ej5fM()
            goto L_0x0024
        L_0x0023:
            r3 = r11
        L_0x0024:
    ...
    public boolean equals(Object obj) {
        ...
        return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5721equalsimpl0(this.size, magnifierStyle.size) && Dp.m5631equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5631equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
    }

    public int hashCode() {
        return (((((((((Boolean.hashCode(this.useTextDefault) * 31) + DpSize.m5726hashCodeimpl(this.size)) * 31) + Dp.m5632hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5632hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }

    public String toString() {
        return this.useTextDefault ? "MagnifierStyle.TextDefault" : "MagnifierStyle(size=" + DpSize.m5731toStringimpl(this.size) + ", cornerRadius=" + Dp.m5637toStringimpl(this.cornerRadius) + ", elevation=" + Dp.m5637toStringimpl(this.elevation) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
    ...
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(MagnifierStyle magnifierStyle, int i) {
            ...
            if (magnifierStyle.getUseTextDefault$foundation_release() || Intrinsics.areEqual((Object) magnifierStyle, (Object) getDefault()) || i >= 29) {
                return true;
            }
            return false;
        }
