...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap imageBitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m226Image5hnEew(imageBitmap, str, modifier2, center, fit, f2, colorFilter2, FilterQuality.Companion.m2916getLowfv9h1I(), composer, (i3 & 112) | 8 | (i3 & 896) | (i3 & 7168) | (57344 & i3) | (458752 & i3) | (i3 & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m226Image5hnEew(ImageBitmap imageBitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        ...
        int r5 = (i5 & 128) != 0 ? DrawScope.Companion.m3431getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m3518BitmapPainterQZhYCtY$default(imageBitmap, 0, 0, r5, 6, (Object) null);
    ...
    public static final void Image(Painter painter, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        Updater.m2451setimpl(r7, measurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
