...
final class BorderKt$drawRectBorder$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    ...
    public final void invoke(ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m3404drawRectAsUm42w$default(contentDrawScope, this.$brush, this.$rectTopLeft, this.$size, 0.0f, this.$style, (ColorFilter) null, 0, LocationRequestCompat.QUALITY_LOW_POWER, (Object) null);
    }
}
