...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle magnifierStyle, View view, Density density, float f) {
        ...
        long r0 = density.m5608toSizeXkaWNTQ(magnifierStyle.m233getSizeMYxV2XQ$foundation_release());
        float r2 = density.m5607toPx0680j_4(magnifierStyle.m231getCornerRadiusD9Ej5fM$foundation_release());
        float r9 = density.m5607toPx0680j_4(magnifierStyle.m232getElevationD9Ej5fM$foundation_release());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (r0 != Size.Companion.m2649getUnspecifiedNHjbRc()) {
            builder.setSize(MathKt.roundToInt(Size.m2641getWidthimpl(r0)), MathKt.roundToInt(Size.m2638getHeightimpl(r0)));
        }
        if (!Float.isNaN(r2)) {
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void m257updateWko1d7g(long j, long j2, float f) {
            if (!Float.isNaN(f)) {
                getMagnifier().setZoom(f);
            }
            if (OffsetKt.m2591isSpecifiedk4lQ0M(j2)) {
                getMagnifier().show(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j), Offset.m2572getXimpl(j2), Offset.m2573getYimpl(j2));
            } else {
                getMagnifier().show(Offset.m2572getXimpl(j), Offset.m2573getYimpl(j));
            }
        }
    }
}
