...
final class Background extends InspectorValueInfo implements DrawModifier {
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        ...
        if (color2 != null) {
            DrawScope.m3405drawRectnJ9OG0$default(contentDrawScope, color2.m2831unboximpl(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 126, (Object) null);
        }
        Brush brush2 = this.brush;
        if (brush2 != null) {
            DrawScope.m3404drawRectAsUm42w$default(contentDrawScope, brush2, 0, 0, this.alpha, (DrawStyle) null, (ColorFilter) null, 0, 118, (Object) null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline outline;
        if (!Size.m2636equalsimpl(contentDrawScope.m3429getSizeNHjbRc(), this.lastSize) || contentDrawScope.getLayoutDirection() != this.lastLayoutDirection) {
            outline = this.shape.m3175createOutlinePq9zytI(contentDrawScope.m3429getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        } else {
        ...
        Color color2 = this.color;
        if (color2 != null) {
            color2.m2831unboximpl();
            OutlineKt.m3076drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color.m2831unboximpl(), 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 60, (Object) null);
        }
        Brush brush2 = this.brush;
        if (brush2 != null) {
            OutlineKt.m3074drawOutlinehn5TExg$default(contentDrawScope, outline, brush2, this.alpha, (DrawStyle) null, (ColorFilter) null, 0, 56, (Object) null);
        }
        this.lastOutline = outline;
        this.lastSize = Size.m2629boximpl(contentDrawScope.m3429getSizeNHjbRc());
    ...
    public int hashCode() {
        Color color2 = this.color;
        int i = 0;
        int r0 = (color2 != null ? Color.m2828hashCodeimpl(color2.m2831unboximpl()) : 0) * 31;
        Brush brush2 = this.brush;
        if (brush2 != null) {
            i = brush2.hashCode();
        }
        return ((((r0 + i) * 31) + Float.hashCode(this.alpha)) * 31) + this.shape.hashCode();
    }

    public boolean equals(Object obj) {
        Background background = obj instanceof Background ? (Background) obj : null;
        if (background != null && Intrinsics.areEqual((Object) this.color, (Object) background.color) && Intrinsics.areEqual((Object) this.brush, (Object) background.brush) && this.alpha == background.alpha && Intrinsics.areEqual((Object) this.shape, (Object) background.shape)) {
            return true;
        }
        return false;
    }
