...
final class WrapContentModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        Placeable.PlacementScope.m4560place70tqf50$default(placementScope2, this.$placeable, ((IntOffset) this.this$0.alignmentCallback.invoke(IntSize.m5778boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection())).m5753unboximpl(), 0.0f, 2, (Object) null);
    }
}
