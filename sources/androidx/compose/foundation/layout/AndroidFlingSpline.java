...
final class AndroidFlingSpline {
    ...
    public final long m400flingPositionLfoxSSI(float f) {
        float f2;
        float f3;
        float f4 = (float) 100;
        int i = (int) (f4 * f);
        ...
        return FlingResult.m402constructorimpl((((long) Float.floatToIntBits(f3)) & 4294967295L) | (floatToIntBits << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m401boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static long m402constructorimpl(long j) {
            return j;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m403equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m409unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m403equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m407hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m408toStringimpl(this.packedValue);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ long m409unboximpl() {
        ...
        public static final float m405getDistanceCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m406getVelocityCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
