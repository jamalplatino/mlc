...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.m5601roundToPx0680j_4(this.leftDp);
    }

    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5601roundToPx0680j_4(this.topDp);
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.m5601roundToPx0680j_4(this.rightDp);
    }

    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5601roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + Dp.m5637toStringimpl(this.leftDp) + ", top=" + Dp.m5637toStringimpl(this.topDp) + ", right=" + Dp.m5637toStringimpl(this.rightDp) + ", bottom=" + Dp.m5637toStringimpl(this.bottomDp) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Dp.m5631equalsimpl0(this.leftDp, fixedDpInsets.leftDp) || !Dp.m5631equalsimpl0(this.topDp, fixedDpInsets.topDp) || !Dp.m5631equalsimpl0(this.rightDp, fixedDpInsets.rightDp) || !Dp.m5631equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Dp.m5632hashCodeimpl(this.leftDp) * 31) + Dp.m5632hashCodeimpl(this.topDp)) * 31) + Dp.m5632hashCodeimpl(this.rightDp)) * 31) + Dp.m5632hashCodeimpl(this.bottomDp);
    }
}
