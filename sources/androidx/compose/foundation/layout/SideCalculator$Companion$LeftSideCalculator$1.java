...
public final class SideCalculator$Companion$LeftSideCalculator$1 implements SideCalculator {
    ...
    public long m541consumedOffsetsMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2572getXimpl(j), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m542consumedVelocityQWom1Mo(long j, float f) {
        return VelocityKt.Velocity(Velocity.m5851getXimpl(j) - f, 0.0f);
    }
}
