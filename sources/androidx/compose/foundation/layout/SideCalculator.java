...
interface SideCalculator {
    ...
    long m536consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long m537consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        public final SideCalculator m538chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m608getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m611getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m609getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m605getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m610getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (!WindowInsetsSides.m594equalsimpl0(i, WindowInsetsSides.Companion.m606getEndJoeWqyM())) {
