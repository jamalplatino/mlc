...
final class LimitInsets implements WindowInsets {
    ...
    public final int m472getSidesJoeWqyM() {
        return this.sides;
    }
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m601getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m602getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m595hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m595hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m611getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m603getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m604getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m595hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m595hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m605getBottomJoeWqyM())) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.insets, (Object) limitInsets.insets) || !WindowInsetsSides.m594equalsimpl0(this.sides, limitInsets.sides)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (this.insets.hashCode() * 31) + WindowInsetsSides.m596hashCodeimpl(this.sides);
    }

    public String toString() {
        return "(" + this.insets + " only " + WindowInsetsSides.m598toStringimpl(this.sides) + ')';
    }
}
