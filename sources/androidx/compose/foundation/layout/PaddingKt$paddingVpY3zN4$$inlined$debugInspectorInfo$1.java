...
public final class PaddingKt$paddingVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("horizontal", Dp.m5624boximpl(this.$horizontal$inlined));
        inspectorInfo.getProperties().set("vertical", Dp.m5624boximpl(this.$vertical$inlined));
    }
}
