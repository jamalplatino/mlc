...
final class PaddingModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public final float m498getBottomD9Ej5fM() {
        return this.bottom;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m499getEndD9Ej5fM() {
        return this.end;
    }
    ...
    public final float m500getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m501getTopD9Ej5fM() {
        return this.top;
    }
    ...
    private PaddingModifier(float f, float f2, float f3, float f4, boolean z, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.bottom = f4;
        this.rtlAware = z;
        if ((f < 0.0f && !Dp.m5631equalsimpl0(f, Dp.Companion.m5646getUnspecifiedD9Ej5fM())) || ((f2 < 0.0f && !Dp.m5631equalsimpl0(f2, Dp.Companion.m5646getUnspecifiedD9Ej5fM())) || ((f3 < 0.0f && !Dp.m5631equalsimpl0(f3, Dp.Companion.m5646getUnspecifiedD9Ej5fM())) || (f4 < 0.0f && !Dp.m5631equalsimpl0(f4, Dp.Companion.m5646getUnspecifiedD9Ej5fM()))))) {
            throw new IllegalArgumentException("Padding must be non-negative".toString());
        }
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m502measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        int r0 = measureScope.m5601roundToPx0680j_4(this.start) + measureScope.m5601roundToPx0680j_4(this.end);
        int r1 = measureScope.m5601roundToPx0680j_4(this.top) + measureScope.m5601roundToPx0680j_4(this.bottom);
        Placeable r12 = measurable.m4520measureBRTryo0(ConstraintsKt.m5586offsetNN6EwU(j, -r0, -r1));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m5584constrainWidthK40F9xA(j, r12.getWidth() + r0), ConstraintsKt.m5583constrainHeightK40F9xA(j, r12.getHeight() + r1), (Map) null, new PaddingModifier$measure$1(this, r12, measureScope), 4, (Object) null);
    }

    public int hashCode() {
        return (((((((Dp.m5632hashCodeimpl(this.start) * 31) + Dp.m5632hashCodeimpl(this.top)) * 31) + Dp.m5632hashCodeimpl(this.end)) * 31) + Dp.m5632hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public boolean equals(Object obj) {
        PaddingModifier paddingModifier = obj instanceof PaddingModifier ? (PaddingModifier) obj : null;
        if (paddingModifier != null && Dp.m5631equalsimpl0(this.start, paddingModifier.start) && Dp.m5631equalsimpl0(this.top, paddingModifier.top) && Dp.m5631equalsimpl0(this.end, paddingModifier.end) && Dp.m5631equalsimpl0(this.bottom, paddingModifier.bottom) && this.rtlAware == paddingModifier.rtlAware) {
            return true;
        }
        return false;
    }
