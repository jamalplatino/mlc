...
final class MinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m476calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5580fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m5569getMaxHeightimpl(j)));
    }
