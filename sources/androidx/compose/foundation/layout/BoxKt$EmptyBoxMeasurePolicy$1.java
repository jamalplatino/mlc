...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult m444measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$MeasurePolicy");
        Intrinsics.checkNotNullParameter(list, "<anonymous parameter 0>");
        return MeasureScope.layout$default(measureScope, Constraints.m5572getMinWidthimpl(j), Constraints.m5571getMinHeightimpl(j), (Map) null, BoxKt$EmptyBoxMeasurePolicy$1$measure$1.INSTANCE, 4, (Object) null);
    }
}
