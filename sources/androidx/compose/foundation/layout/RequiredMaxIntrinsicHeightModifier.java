...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long m528calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5579fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m5570getMaxWidthimpl(j)));
    }
