...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.m5601roundToPx0680j_4(this.paddingValues.m504calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5601roundToPx0680j_4(this.paddingValues.m506calculateTopPaddingD9Ej5fM());
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.m5601roundToPx0680j_4(this.paddingValues.m505calculateRightPaddingu2uoSUM(layoutDirection));
    }

    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m5601roundToPx0680j_4(this.paddingValues.m503calculateBottomPaddingD9Ej5fM());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return "PaddingValues(" + Dp.m5637toStringimpl(this.paddingValues.m504calculateLeftPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m5637toStringimpl(this.paddingValues.m506calculateTopPaddingD9Ej5fM()) + ", " + Dp.m5637toStringimpl(this.paddingValues.m505calculateRightPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m5637toStringimpl(this.paddingValues.m503calculateBottomPaddingD9Ej5fM()) + ')';
    }
