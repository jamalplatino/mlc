...
public final class RowColumnImplKt {
    ...
    public static final MeasurePolicy m532rowColumnMeasurePolicyTDGSqEk(LayoutOrientation layoutOrientation, Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, float f, SizeMode sizeMode, CrossAxisAlignment crossAxisAlignment) {
        ...
        return new RowColumnImplKt$rowColumnMeasurePolicy$1(layoutOrientation, function5, f, sizeMode, crossAxisAlignment);
    }
