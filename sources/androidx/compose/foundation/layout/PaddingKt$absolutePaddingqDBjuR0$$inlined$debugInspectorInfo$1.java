...
public final class PaddingKt$absolutePaddingqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("left", Dp.m5624boximpl(this.$left$inlined));
        inspectorInfo.getProperties().set("top", Dp.m5624boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set("right", Dp.m5624boximpl(this.$right$inlined));
        inspectorInfo.getProperties().set("bottom", Dp.m5624boximpl(this.$bottom$inlined));
    }
}
