...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", TextUnit.m5797boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", TextUnit.m5797boximpl(this.$after$inlined));
    }
}
