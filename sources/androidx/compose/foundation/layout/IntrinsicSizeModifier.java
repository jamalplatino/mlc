...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long m470calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    MeasureResult m471measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long r0 = m470calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            r0 = ConstraintsKt.m5582constrainN9IONVI(j, r0);
        }
        Placeable r9 = measurable.m4520measureBRTryo0(r0);
