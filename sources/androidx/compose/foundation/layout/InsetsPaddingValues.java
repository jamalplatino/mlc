...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float m467calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density2 = this.density;
        return density2.m5604toDpu2uoSUM(this.insets.getLeft(density2, layoutDirection));
    }

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    public float m469calculateTopPaddingD9Ej5fM() {
        Density density2 = this.density;
        return density2.m5604toDpu2uoSUM(this.insets.getTop(density2));
    }

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    public float m468calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density2 = this.density;
        return density2.m5604toDpu2uoSUM(this.insets.getRight(density2, layoutDirection));
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    public float m466calculateBottomPaddingD9Ej5fM() {
        Density density2 = this.density;
        return density2.m5604toDpu2uoSUM(this.insets.getBottom(density2));
    }
