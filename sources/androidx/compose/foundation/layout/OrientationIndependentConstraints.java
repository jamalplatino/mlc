...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5572getMinWidthimpl(j) : Constraints.m5571getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5570getMaxWidthimpl(j) : Constraints.m5569getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5571getMinHeightimpl(j) : Constraints.m5572getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m5569getMaxHeightimpl(j) : Constraints.m5570getMaxWidthimpl(j));
    }
    ...
    public final long m485toBoxConstraintsOenEA2s(LayoutOrientation layoutOrientation) {
