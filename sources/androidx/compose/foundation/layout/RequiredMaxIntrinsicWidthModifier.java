...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m529calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5580fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m5569getMaxHeightimpl(j)));
    }
