...
public interface PaddingValues {
    ...
    float m503calculateBottomPaddingD9Ej5fM();

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    float m504calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    float m505calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    float m506calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m507getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m508getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m509getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m510getTopD9Ej5fM$annotations() {
        }

        /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
        public float m511calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }

        /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
        public float m512calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.left;
        }

        /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
        public float m513calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }

        /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
        public float m514calculateTopPaddingD9Ej5fM() {
            return this.top;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!Dp.m5631equalsimpl0(this.left, absolute.left) || !Dp.m5631equalsimpl0(this.top, absolute.top) || !Dp.m5631equalsimpl0(this.right, absolute.right) || !Dp.m5631equalsimpl0(this.bottom, absolute.bottom)) {
                return false;
            }
            return true;
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + Dp.m5637toStringimpl(this.left) + ", top=" + Dp.m5637toStringimpl(this.top) + ", right=" + Dp.m5637toStringimpl(this.right) + ", bottom=" + Dp.m5637toStringimpl(this.bottom) + ')';
        }
