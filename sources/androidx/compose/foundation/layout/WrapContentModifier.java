...
final class WrapContentModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult m613measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        int i;
        ...
        int i2 = 0;
        int r1 = this.direction != Direction.Vertical ? 0 : Constraints.m5572getMinWidthimpl(j);
        ...
        Placeable r3 = measurable2.m4520measureBRTryo0(ConstraintsKt.Constraints(r1, i, i2, i3));
        int coerceIn = RangesKt.coerceIn(r3.getWidth(), Constraints.m5572getMinWidthimpl(j), Constraints.m5570getMaxWidthimpl(j));
        int coerceIn2 = RangesKt.coerceIn(r3.getHeight(), Constraints.m5571getMinHeightimpl(j), Constraints.m5569getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, coerceIn, coerceIn2, (Map) null, new WrapContentModifier$measure$1(this, coerceIn, r3, coerceIn2, measureScope), 4, (Object) null);
    }
