...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int i) {
        ...
        return Integer.valueOf(this.state.isVertical$foundation_release() ? IntOffset.m5745getYimpl(r0) : IntOffset.m5744getXimpl(r0));
    }
    ...
    public float expectedDistanceTo(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            i3 += this.state.isVertical$foundation_release() ? IntSize.m5785getHeightimpl(lazyStaggeredGridItemInfo.m774getSizeYbymL2g()) : IntSize.m5786getWidthimpl(lazyStaggeredGridItemInfo.m774getSizeYbymL2g());
        }
