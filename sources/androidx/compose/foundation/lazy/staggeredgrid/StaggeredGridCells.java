...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.m5601roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }

        public int hashCode() {
            return Dp.m5632hashCodeimpl(this.minSize);
        }

        public boolean equals(Object obj) {
            return (obj instanceof Adaptive) && Dp.m5631equalsimpl0(this.minSize, ((Adaptive) obj).minSize);
        }
    }
}
