...
public final class LineIndex {
    ...
    public static final /* synthetic */ LineIndex m719boximpl(int i) {
        return new LineIndex(i);
    }

    /* renamed from: compareTo-bKFJvoY  reason: not valid java name */
    public static final int m720compareTobKFJvoY(int i, int i2) {
        return i - i2;
    }
    ...
    public static boolean m723equalsimpl(int i, Object obj) {
        return (obj instanceof LineIndex) && i == ((LineIndex) obj).m731unboximpl();
    }
    ...
    public static final int m726inchA7yfN8(int i) {
        return m721constructorimpl(i + 1);
    }

    /* renamed from: dec-hA7yfN8  reason: not valid java name */
    public static final int m722dechA7yfN8(int i) {
        return m721constructorimpl(i - 1);
    }

    /* renamed from: plus--_Ze7BM  reason: not valid java name */
    public static final int m729plus_Ze7BM(int i, int i2) {
        return m721constructorimpl(i + i2);
    }

    /* renamed from: minus--_Ze7BM  reason: not valid java name */
    public static final int m727minus_Ze7BM(int i, int i2) {
        return m721constructorimpl(i - i2);
    }

    /* renamed from: minus-fVkYB0M  reason: not valid java name */
    public static final int m728minusfVkYB0M(int i, int i2) {
        return m721constructorimpl(i - i2);
    }
}
