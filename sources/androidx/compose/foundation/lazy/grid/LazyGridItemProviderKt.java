...
public final class LazyGridItemProviderKt {
    ...
    public static final LazyGridItemProvider rememberLazyGridItemProvider(LazyGridState lazyGridState, Function1<? super LazyGridScope, Unit> function1, Composer composer, int i) {
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new LazyGridItemProviderKt$rememberLazyGridItemProvider$1$1(SnapshotStateKt.derivedStateOf(new LazyGridItemProviderKt$rememberLazyGridItemProvider$1$itemProviderState$1(rememberUpdatedState, lazyGridState, rememberLazyNearestItemsRangeState)));
