...
public final class LazyAnimateScrollKt {
    ...
    public static final float BoundDistance = Dp.m5626constructorimpl((float) 1500);
    private static final boolean DEBUG = false;
    /* access modifiers changed from: private */
    public static final float MinimumDistance = Dp.m5626constructorimpl((float) 50);
    /* access modifiers changed from: private */
    public static final float TargetDistance = Dp.m5626constructorimpl((float) 2500);
