...
public final class LazyMeasuredItemProvider {
    ...
    public final long m651getChildConstraintsmsEJaDk() {
    ...
    private LazyMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory2) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m5570getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m5569getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, (Object) null);
    }

    /* renamed from: getAndMeasure-ZjPyQlc  reason: not valid java name */
    public final LazyMeasuredItem m650getAndMeasureZjPyQlc(int i) {
        return this.measuredItemFactory.m652createItemHK0c1C0(i, this.itemProvider.getKey(i), this.measureScope.m742measure0kLqBqw(i, this.childConstraints));
    }
