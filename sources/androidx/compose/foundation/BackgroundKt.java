...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m182backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    public static final Modifier m181backgroundbw27NRU(Modifier modifier, long j, Shape shape) {
        Intrinsics.checkNotNullParameter(modifier, "$this$background");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return modifier.then(new Background(Color.m2811boximpl(j), (Brush) null, 0.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1(j, shape) : InspectableValueKt.getNoInspectorInfo(), 6, (DefaultConstructorMarker) null));
    }
