...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5626constructorimpl((float) 30);
    ...
    public static /* synthetic */ Modifier m186basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m243getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m237equalsimpl0(i6, MarqueeAnimationMode.Companion.m243getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        return m185basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* access modifiers changed from: private */
    /* renamed from: createMarqueeAnimationSpec-Z4HSEVQ  reason: not valid java name */
    public static final AnimationSpec<Float> m187createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.m5607toPx0680j_4(f2)), f, i3);
        long r3 = StartOffset.m142constructorimpl$default((-i3) + i2, 0, 2, (DefaultConstructorMarker) null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m122infiniteRepeatable9IiC70o$default(velocityBasedTween, (RepeatMode) null, r3, 2, (Object) null);
        }
        return AnimationSpecKt.m124repeatable91I0pcU$default(i, velocityBasedTween, (RepeatMode) null, r3, 4, (Object) null);
    }
    ...
    public static final MarqueeSpacing m183MarqueeSpacing0680j_4(float f) {
        return new BasicMarqueeKt$MarqueeSpacing$1(f);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m185basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
        Intrinsics.checkNotNullParameter(modifier, "$this$basicMarquee");
        Intrinsics.checkNotNullParameter(marqueeSpacing, "spacing");
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new BasicMarqueeKt$basicMarquee1Mj1MLw$$inlined$debugInspectorInfo$1(i, i2, i3, i4, marqueeSpacing, f) : InspectableValueKt.getNoInspectorInfo(), new BasicMarqueeKt$basicMarquee$2(i, i3, i4, f, marqueeSpacing, i2));
    }
}
