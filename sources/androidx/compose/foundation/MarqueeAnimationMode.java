...
public final class MarqueeAnimationMode {
    ...
    public static final int Immediately = m235constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int WhileFocused = m235constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m234boximpl(int i) {
    ...
    public static boolean m236equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m240unboximpl();
    }
    ...
    public static String m239toStringimpl(int i) {
        if (m237equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m237equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m241getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m242getWhileFocusedZbEOnfQ$annotations() {
        }
