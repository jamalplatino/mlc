...
public final class BasicMarqueeKt$basicMarquee1Mj1MLw$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("animationMode", MarqueeAnimationMode.m234boximpl(this.$animationMode$inlined));
        ...
        inspectorInfo.getProperties().set("velocity", Dp.m5624boximpl(this.$velocity$inlined));
    }
}
