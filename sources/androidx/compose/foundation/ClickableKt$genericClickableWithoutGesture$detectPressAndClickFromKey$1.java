...
final class ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m220invokeZmokQxo(((KeyEvent) obj).m4170unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m220invokeZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        boolean z = true;
        if (!this.$enabled || !Clickable_androidKt.m223isPressZmokQxo(keyEvent)) {
            if (this.$enabled && Clickable_androidKt.m221isClickZmokQxo(keyEvent)) {
                PressInteraction.Press remove = this.$currentKeyPressInteractions.remove(Key.m3583boximpl(KeyEvent_androidKt.m4181getKeyZmokQxo(keyEvent)));
                if (remove != null) {
        ...
        } else if (!this.$currentKeyPressInteractions.containsKey(Key.m3583boximpl(KeyEvent_androidKt.m4181getKeyZmokQxo(keyEvent)))) {
            final PressInteraction.Press press = new PressInteraction.Press(this.$keyClickOffset.getValue().m2582unboximpl(), (DefaultConstructorMarker) null);
            this.$currentKeyPressInteractions.put(Key.m3583boximpl(KeyEvent_androidKt.m4181getKeyZmokQxo(keyEvent)), press);
