...
final class ToggleableKt$triStateToggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier r8 = ToggleableKt.m820triStateToggleableO2vRcR0(modifier2, toggleableState, (MutableInteractionSource) rememberedValue, (Indication) consume, this.$enabled, this.$role, this.$onClick);
        if (ComposerKt.isTraceInProgress()) {
