...
final class ToggleableKt$toggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier modifier3 = ToggleableKt.m816toggleableO2vRcR0(modifier2, z, (MutableInteractionSource) rememberedValue, (Indication) consume, this.$enabled, this.$role, this.$onValueChange);
        if (ComposerKt.isTraceInProgress()) {
