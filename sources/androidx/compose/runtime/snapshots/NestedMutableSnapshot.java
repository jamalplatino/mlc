...
public final class NestedMutableSnapshot extends MutableSnapshot {
    ...
    public androidx.compose.runtime.snapshots.SnapshotApplyResult apply() {
        ...
        L_0x002b:
            ...
            monitor-enter(r3)
            r4 = r6
            androidx.compose.runtime.snapshots.Snapshot r4 = (androidx.compose.runtime.snapshots.Snapshot) r4     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotKt.validateOpen(r4)     // Catch:{ all -> 0x00ca }
            if (r0 == 0) goto L_0x0076
            int r4 = r0.size()     // Catch:{ all -> 0x00ca }
            if (r4 != 0) goto L_0x003f
            goto L_0x0076
        L_0x003f:
            androidx.compose.runtime.snapshots.MutableSnapshot r4 = r6.parent     // Catch:{ all -> 0x00ca }
            int r4 = r4.getId()     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r5 = r6.parent     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r5 = r5.getInvalid$runtime_release()     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotApplyResult r2 = r6.innerApplyLocked$runtime_release(r4, r2, r5)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotApplyResult$Success r4 = androidx.compose.runtime.snapshots.SnapshotApplyResult.Success.INSTANCE     // Catch:{ all -> 0x00ca }
            boolean r4 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r2, (java.lang.Object) r4)     // Catch:{ all -> 0x00ca }
            if (r4 != 0) goto L_0x0059
            monitor-exit(r3)
            return r2
        L_0x0059:
            androidx.compose.runtime.snapshots.MutableSnapshot r2 = r6.parent     // Catch:{ all -> 0x00ca }
            java.util.Set r2 = r2.getModified$runtime_release()     // Catch:{ all -> 0x00ca }
            if (r2 != 0) goto L_0x0070
            java.util.HashSet r2 = new java.util.HashSet     // Catch:{ all -> 0x00ca }
            r2.<init>()     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r4 = r6.parent     // Catch:{ all -> 0x00ca }
            r5 = r2
            java.util.Set r5 = (java.util.Set) r5     // Catch:{ all -> 0x00ca }
            r4.setModified(r5)     // Catch:{ all -> 0x00ca }
            java.util.Set r2 = (java.util.Set) r2     // Catch:{ all -> 0x00ca }
        L_0x0070:
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x00ca }
            r2.addAll(r0)     // Catch:{ all -> 0x00ca }
            goto L_0x0079
        L_0x0076:
            r6.closeAndReleasePinning$runtime_release()     // Catch:{ all -> 0x00ca }
        L_0x0079:
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            int r0 = r0.getId()     // Catch:{ all -> 0x00ca }
            if (r0 >= r1) goto L_0x0086
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            r0.advance$runtime_release()     // Catch:{ all -> 0x00ca }
        L_0x0086:
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r2 = r0.getInvalid$runtime_release()     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r2 = r2.clear(r1)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r4 = r6.getPreviousIds$runtime_release()     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r2 = r2.andNot(r4)     // Catch:{ all -> 0x00ca }
            r0.setInvalid$runtime_release(r2)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            r0.recordPrevious$runtime_release(r1)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            int r1 = r6.takeoverPinnedSnapshot$runtime_release()     // Catch:{ all -> 0x00ca }
            r0.recordPreviousPinnedSnapshot$runtime_release(r1)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.SnapshotIdSet r1 = r6.getPreviousIds$runtime_release()     // Catch:{ all -> 0x00ca }
            r0.recordPreviousList$runtime_release(r1)     // Catch:{ all -> 0x00ca }
            androidx.compose.runtime.snapshots.MutableSnapshot r0 = r6.parent     // Catch:{ all -> 0x00ca }
            int[] r1 = r6.getPreviousPinnedSnapshots$runtime_release()     // Catch:{ all -> 0x00ca }
            r0.recordPreviousPinnedSnapshots$runtime_release(r1)     // Catch:{ all -> 0x00ca }
