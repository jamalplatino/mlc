...
public final class GlobalSnapshot extends MutableSnapshot {
    ...
    public GlobalSnapshot(int r5, androidx.compose.runtime.snapshots.SnapshotIdSet r6) {
        /*
            ...
            monitor-enter(r0)
            java.util.List r1 = androidx.compose.runtime.snapshots.SnapshotKt.globalWriteObservers     // Catch:{ all -> 0x003e }
            java.util.Collection r1 = (java.util.Collection) r1     // Catch:{ all -> 0x003e }
            ...
            java.util.List r1 = androidx.compose.runtime.snapshots.SnapshotKt.globalWriteObservers     // Catch:{ all -> 0x003e }
            java.util.Collection r1 = (java.util.Collection) r1     // Catch:{ all -> 0x003e }
            java.util.List r1 = kotlin.collections.CollectionsKt.toMutableList(r1)     // Catch:{ all -> 0x003e }
            goto L_0x0026
        L_0x0025:
            r1 = r2
        L_0x0026:
            if (r1 == 0) goto L_0x0038
            java.lang.Object r3 = kotlin.collections.CollectionsKt.singleOrNull(r1)     // Catch:{ all -> 0x003e }
            kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3     // Catch:{ all -> 0x003e }
            if (r3 != 0) goto L_0x0039
            androidx.compose.runtime.snapshots.GlobalSnapshot$1$1$1 r3 = new androidx.compose.runtime.snapshots.GlobalSnapshot$1$1$1     // Catch:{ all -> 0x003e }
