...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2443boximpl(Composer composer2) {
        return new Updater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2444constructorimpl(Composer composer2) {
        Intrinsics.checkNotNullParameter(composer2, "composer");
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2445equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual((Object) composer2, (Object) ((Updater) obj).m2455unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2446equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m2447hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2452toStringimpl(Composer composer2) {
        return "Updater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m2445equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2447hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2452toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2455unboximpl() {
    ...
    public static final void m2450setimpl(Composer composer2, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl  reason: not valid java name */
    public static final <V> void m2451setimpl(Composer composer2, V v, Function2<? super T, ? super V, Unit> function2) {
        Intrinsics.checkNotNullParameter(function2, "block");
    ...
    public static final void m2453updateimpl(Composer composer2, int i, Function2<? super T, ? super Integer, Unit> function2) {
        Intrinsics.checkNotNullParameter(function2, "block");
    ...
    /* renamed from: update-impl  reason: not valid java name */
    public static final <V> void m2454updateimpl(Composer composer2, V v, Function2<? super T, ? super V, Unit> function2) {
        Intrinsics.checkNotNullParameter(function2, "block");
        boolean inserting = composer2.getInserting();
    ...
    public static final void m2448initimpl(Composer composer2, Function1<? super T, Unit> function1) {
    ...
    public static final void m2449reconcileimpl(Composer composer2, Function1<? super T, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
