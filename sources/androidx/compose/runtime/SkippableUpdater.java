...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m2435boximpl(Composer composer2) {
        return new SkippableUpdater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2436constructorimpl(Composer composer2) {
        Intrinsics.checkNotNullParameter(composer2, "composer");
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2437equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual((Object) composer2, (Object) ((SkippableUpdater) obj).m2442unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2438equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m2439hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2440toStringimpl(Composer composer2) {
        return "SkippableUpdater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m2437equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2439hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2440toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2442unboximpl() {
    ...
    public static final void m2441updateimpl(Composer composer2, Function1<? super Updater<T>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
        composer2.startReplaceableGroup(509942095);
        function1.invoke(Updater.m2443boximpl(Updater.m2444constructorimpl(composer2)));
