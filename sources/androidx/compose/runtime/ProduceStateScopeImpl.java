...
final class ProduceStateScopeImpl<T> implements ProduceStateScope<T>, MutableState<T> {
    ...
    public java.lang.Object awaitDispose(kotlin.jvm.functions.Function0<kotlin.Unit> r5, kotlin.coroutines.Continuation<?> r6) {
        ...
        L_0x002f:
            ...
            kotlin.ResultKt.throwOnFailure(r6)     // Catch:{ all -> 0x0063 }
            goto L_0x005d
        L_0x0037:
            kotlin.ResultKt.throwOnFailure(r6)
            r0.L$0 = r5     // Catch:{ all -> 0x0063 }
            r0.label = r3     // Catch:{ all -> 0x0063 }
            kotlinx.coroutines.CancellableContinuationImpl r6 = new kotlinx.coroutines.CancellableContinuationImpl     // Catch:{ all -> 0x0063 }
            kotlin.coroutines.Continuation r2 = kotlin.coroutines.intrinsics.IntrinsicsKt.intercepted(r0)     // Catch:{ all -> 0x0063 }
            r6.<init>(r2, r3)     // Catch:{ all -> 0x0063 }
            r6.initCancellability()     // Catch:{ all -> 0x0063 }
            r2 = r6
            kotlinx.coroutines.CancellableContinuation r2 = (kotlinx.coroutines.CancellableContinuation) r2     // Catch:{ all -> 0x0063 }
            java.lang.Object r6 = r6.getResult()     // Catch:{ all -> 0x0063 }
            java.lang.Object r2 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ all -> 0x0063 }
            if (r6 != r2) goto L_0x005a
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch:{ all -> 0x0063 }
        L_0x005a:
            if (r6 != r1) goto L_0x005d
            return r1
        L_0x005d:
            kotlin.KotlinNothingValueException r6 = new kotlin.KotlinNothingValueException     // Catch:{ all -> 0x0063 }
