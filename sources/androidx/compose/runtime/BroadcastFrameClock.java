    ...
    private static final class FrameAwaiter<R> {
        ...
        public final void resume(long j) {
            ...
            try {
                ...
                obj = Result.m6005constructorimpl(this.onFrame.invoke(Long.valueOf(j)));
            } catch (Throwable th) {
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (access$getFailureCause$p != null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m6005constructorimpl(ResultKt.createFailure(access$getFailureCause$p)));
            } else {
