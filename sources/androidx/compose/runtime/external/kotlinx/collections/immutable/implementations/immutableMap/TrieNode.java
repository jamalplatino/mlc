...
public final class TrieNode<K, V> {
    ...
    public static final class ModificationResult<K, V> {
        ...
        public final ModificationResult<K, V> replaceNode(Function1<? super TrieNode<K, V>, TrieNode<K, V>> function1) {
            ...
            ModificationResult modificationResult = this;
    ...
    private final TrieNode<K, V> makeNode(int i, K k, V v, int i2, K k2, V v2, int i3, MutabilityOwnership mutabilityOwnership) {
        ...
        if (i4 > 30) {
            return new TrieNode<>(0, 0, new Object[]{k, v3, k4, v4}, mutabilityOwnership2);
        }
        int i5 = i;
        ...
        if (indexSegment != indexSegment2) {
            if (indexSegment < indexSegment2) {
                objArr = new Object[]{k, v3, k4, v4};
            } else {
                objArr = new Object[]{k4, v4, k, v3};
            }
            return new TrieNode<>((1 << indexSegment) | (1 << indexSegment2), 0, objArr, mutabilityOwnership2);
        }
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        CommonFunctionsKt.m2459assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m2459assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasNodeAt(i3)) {
            ...
            if (keyAtIndex != null) {
                i4 = keyAtIndex.hashCode();
            }
            TrieNode<K, V> mutablePut = nodeAtIndex$runtime_release.mutablePut(i4, keyAtIndex, valueAtKeyIndex, i2 + 5, persistentHashMapBuilder);
        ...
        if (trieNode.hasNodeAt(i)) {
            ...
            if (hasEntryAt$runtime_release(i3)) {
                ...
                if (nodeAtIndex$runtime_release2.containsKey(keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, i5)) {
                    ...
                    return nodeAtIndex$runtime_release2.mutablePut(i4, keyAtIndex2, valueAtKeyIndex2, i5, persistentHashMapBuilder);
                }
            }
        ...
        return makeNode(hashCode, keyAtIndex3, valueAtKeyIndex3, i4, keyAtIndex4, valueAtKeyIndex4, i2 + 5, persistentHashMapBuilder.getOwnership$runtime_release());
    }
