...
public class StateSet {
    ...
    private void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        ...
        L_0x0022:
            ...
            goto L_0x0010
        L_0x0025:
            int r0 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            r1 = 0
        L_0x002a:
            r3 = 1
            ...
            goto L_0x00b3
        L_0x0039:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            boolean r0 = r4.equals(r0)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            if (r0 == 0) goto L_0x00b3
            return
        L_0x0044:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            int r7 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            switch(r7) {
        ...
        L_0x0050:
            ...
            boolean r4 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
        ...
        L_0x0077:
            ...
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            java.lang.String r5 = "unknown tag "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            java.lang.StringBuilder r0 = r4.append(r0)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            java.lang.String r0 = r0.toString()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            android.util.Log.v(r3, r0)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            goto L_0x00b3
        L_0x0098:
            androidx.constraintlayout.widget.StateSet$Variant r0 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            r0.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            if (r1 == 0) goto L_0x00b3
            r1.add(r0)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            goto L_0x00b3
        L_0x00a3:
            androidx.constraintlayout.widget.StateSet$State r1 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            r1.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r0 = r8.mStateList     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            int r3 = r1.mId     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            r0.put(r3, r1)     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            goto L_0x00b3
        L_0x00b0:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
        L_0x00b3:
            int r0 = r10.next()     // Catch:{ XmlPullParserException -> 0x00be, IOException -> 0x00b9 }
            goto L_0x002a
        L_0x00b9:
            r9 = move-exception
            r9.printStackTrace()
