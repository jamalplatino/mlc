...
public final class ResourceManagerInternal {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0076 A[Catch:{ Exception -> 0x00a5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x009d A[Catch:{ Exception -> 0x00a5 }] */
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(android.content.Context r11, int r12) {
        ...
        L_0x0050:
            ...
            if (r7 == 0) goto L_0x00ad
            android.content.res.XmlResourceParser r1 = r1.getXml(r12)     // Catch:{ Exception -> 0x00a5 }
            android.util.AttributeSet r7 = android.util.Xml.asAttributeSet(r1)     // Catch:{ Exception -> 0x00a5 }
        L_0x006a:
            int r8 = r1.next()     // Catch:{ Exception -> 0x00a5 }
            r9 = 2
        ...
        L_0x0074:
            ...
            java.lang.String r3 = r1.getName()     // Catch:{ Exception -> 0x00a5 }
            androidx.collection.SparseArrayCompat<java.lang.String> r8 = r10.mKnownDrawableIdTags     // Catch:{ Exception -> 0x00a5 }
            r8.append(r12, r3)     // Catch:{ Exception -> 0x00a5 }
            androidx.collection.SimpleArrayMap<java.lang.String, androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate> r8 = r10.mDelegates     // Catch:{ Exception -> 0x00a5 }
            java.lang.Object r3 = r8.get(r3)     // Catch:{ Exception -> 0x00a5 }
            androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate r3 = (androidx.appcompat.widget.ResourceManagerInternal.InflateDelegate) r3     // Catch:{ Exception -> 0x00a5 }
            if (r3 == 0) goto L_0x0092
            android.content.res.Resources$Theme r8 = r11.getTheme()     // Catch:{ Exception -> 0x00a5 }
            android.graphics.drawable.Drawable r1 = r3.createFromXmlInner(r11, r1, r7, r8)     // Catch:{ Exception -> 0x00a5 }
            r6 = r1
        L_0x0092:
            if (r6 == 0) goto L_0x00ad
            int r0 = r0.changingConfigurations     // Catch:{ Exception -> 0x00a5 }
            r6.setChangingConfigurations(r0)     // Catch:{ Exception -> 0x00a5 }
            r10.addDrawableToCache(r11, r4, r6)     // Catch:{ Exception -> 0x00a5 }
            goto L_0x00ad
        L_0x009d:
            org.xmlpull.v1.XmlPullParserException r11 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ Exception -> 0x00a5 }
            java.lang.String r0 = "No start tag found"
            r11.<init>(r0)     // Catch:{ Exception -> 0x00a5 }
            throw r11     // Catch:{ Exception -> 0x00a5 }
        L_0x00a5:
            r11 = move-exception
