...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r8) {
        /*
            ...
            r4 = 0
            java.lang.String r5 = r8.getScheme()     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.String r6 = "android.resource"
            boolean r5 = r6.equals(r5)     // Catch:{ FileNotFoundException -> 0x007e }
            if (r5 == 0) goto L_0x002e
            android.graphics.drawable.Drawable r8 = r7.getDrawableFromResourceUri(r8)     // Catch:{ NotFoundException -> 0x001b }
            return r8
        L_0x001b:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x007e }
            r2.<init>(r3)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.StringBuilder r2 = r2.append(r8)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x007e }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x007e }
            throw r1     // Catch:{ FileNotFoundException -> 0x007e }
        L_0x002e:
            android.content.Context r3 = r7.mProviderContext     // Catch:{ FileNotFoundException -> 0x007e }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ FileNotFoundException -> 0x007e }
            java.io.InputStream r3 = r3.openInputStream(r8)     // Catch:{ FileNotFoundException -> 0x007e }
            if (r3 == 0) goto L_0x006b
            android.graphics.drawable.Drawable r2 = android.graphics.drawable.Drawable.createFromStream(r3, r4)     // Catch:{ all -> 0x0054 }
            r3.close()     // Catch:{ IOException -> 0x0042 }
            goto L_0x0053
        L_0x0042:
            r3 = move-exception
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x007e }
            r5.<init>(r1)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.StringBuilder r1 = r5.append(r8)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.String r1 = r1.toString()     // Catch:{ FileNotFoundException -> 0x007e }
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x007e }
        L_0x0053:
            return r2
        L_0x0054:
            r2 = move-exception
        ...
        L_0x0059:
            ...
            android.util.Log.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x007e }
        L_0x006a:
            throw r2     // Catch:{ FileNotFoundException -> 0x007e }
        L_0x006b:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x007e }
            r3.<init>(r2)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.StringBuilder r2 = r3.append(r8)     // Catch:{ FileNotFoundException -> 0x007e }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x007e }
            r1.<init>(r2)     // Catch:{ FileNotFoundException -> 0x007e }
            throw r1     // Catch:{ FileNotFoundException -> 0x007e }
        L_0x007e:
