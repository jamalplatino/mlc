    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                r6 = 0
                androidx.appcompat.widget.ActivityChooserModel r7 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00eb }
                android.content.Context r7 = r7.mContext     // Catch:{ FileNotFoundException -> 0x00eb }
                java.io.FileOutputStream r15 = r7.openFileOutput(r15, r3)     // Catch:{ FileNotFoundException -> 0x00eb }
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer()
                r7.setOutput(r15, r6)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r8 = "UTF-8"
                java.lang.Boolean r9 = java.lang.Boolean.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.startDocument(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.startTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                int r8 = r4.size()     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r9 = r3
            L_0x0033:
                if (r9 >= r8) goto L_0x0068
                java.lang.Object r10 = r4.remove(r3)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r10 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r10     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.startTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r11 = "activity"
                android.content.ComponentName r12 = r10.activity     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r12 = r12.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r11 = "time"
                long r12 = r10.time     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r12 = java.lang.String.valueOf(r12)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r11 = "weight"
                float r10 = r10.weight     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.attribute(r6, r11, r10)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.endTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                int r9 = r9 + 1
                goto L_0x0033
            L_0x0068:
                r7.endTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
                r7.endDocument()     // Catch:{ IllegalArgumentException -> 0x00be, IllegalStateException -> 0x009c, IOException -> 0x007a }
            ...
            L_0x007a:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0078 }
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x0078 }
                r3.<init>()     // Catch:{ all -> 0x0078 }
                java.lang.StringBuilder r2 = r3.append(r2)     // Catch:{ all -> 0x0078 }
                androidx.appcompat.widget.ActivityChooserModel r3 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0078 }
                java.lang.String r3 = r3.mHistoryFileName     // Catch:{ all -> 0x0078 }
            ...
            L_0x00e1:
                ...
                r15.close()     // Catch:{ IOException -> 0x00ea }
            L_0x00ea:
                throw r0
            L_0x00eb:
                r0 = move-exception
