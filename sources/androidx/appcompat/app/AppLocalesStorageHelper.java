...
class AppLocalesStorageHelper {
    ...
    static java.lang.String readLocales(android.content.Context r9) {
        ...
        L_0x004b:
            ...
            android.util.Log.w(r1, r4)     // Catch:{ all -> 0x0049 }
            if (r3 == 0) goto L_0x0053
            goto L_0x0045
        L_0x0053:
    ...
    static class SerialExecutor implements Executor {
        ...
        public /* synthetic */ void m33lambda$execute$0$androidxappcompatappAppLocalesStorageHelper$SerialExecutor(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
