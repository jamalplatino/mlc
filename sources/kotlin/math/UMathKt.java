...
public final class UMathKt {
    ...
    private static final int m7225minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m7207minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m7226mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m7215minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m7223maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m7195maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m7224maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m7203maxOfeb3DHEI(j, j2);
    }
}
