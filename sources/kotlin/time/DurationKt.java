...
public final class DurationKt {
    ...
    private static final long m7463timesmvk6XK0(int i, long j) {
        return Duration.m7375timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m7462timeskIfJnKk(double d, long j) {
        return Duration.m7374timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r82 = Duration.Companion.m7439getZEROUwyO8pc();
            ...
            if (length > i3) {
                ...
                if (str2.charAt(i3) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            r82 = Duration.m7373plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                                            long r83 = Duration.m7373plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                                            r82 = Duration.m7373plusLRDsOJo(r83, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                    ...
                    if (!z) {
                        ...
                        if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(i6 - i3, 8), true)) {
                            r82 = Duration.Companion.m7437getINFINITEUwyO8pc();
                        } else {
                            boolean z8 = !z5;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r84 = Duration.m7373plusLRDsOJo(r82, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, str4);
                                            String substring7 = substring4.substring(indexOf$default2);
                                            String str8 = str5;
                                            Intrinsics.checkNotNullExpressionValue(substring7, str8);
                                            r8 = Duration.m7373plusLRDsOJo(r84, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i3 >= i) {
                                                str5 = str8;
                                            } else {
                                            ...
                                            String str9 = str5;
                                            r8 = Duration.m7373plusLRDsOJo(r82, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                ...
                if (z2) {
                    return Duration.m7389unaryMinusUwyO8pc(r82);
                }
                return r82;
            }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m7337constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m7337constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m7337constructorimpl((j << 1) + ((long) i));
    }
