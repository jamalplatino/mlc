...
public final class LongSaturatedMathKt {
    ...
    public static final long m7465saturatingAddpTJri5U(long j, long j2) {
        long r4 = Duration.m7357getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m7464checkInfiniteSumDefinedPjuGub4(j, j2, r4);
        }
        if ((1 | (r4 - 1)) == Long.MAX_VALUE) {
            return m7466saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + r4;
        if (((j ^ j3) & (r4 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m7464checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m7369isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m7466saturatingAddInHalvespTJri5U(long j, long j2) {
        long r0 = Duration.m7340divUwyO8pc(j2, 2);
        if (((Duration.m7357getInWholeNanosecondsimpl(r0) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (((double) j) + Duration.m7380toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m7465saturatingAddpTJri5U(m7465saturatingAddpTJri5U(j, r0), Duration.m7372minusLRDsOJo(j2, r0));
    }

    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m7389unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m7373plusLRDsOJo(duration, DurationKt.toDuration(j5, DurationUnit.NANOSECONDS));
        }
