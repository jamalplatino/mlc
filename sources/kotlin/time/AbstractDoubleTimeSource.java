...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m7314minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m7332minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m7312elapsedNowUwyO8pc() {
            return Duration.m7372minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m7317plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m7373plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m7315minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m7342equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m7369isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m7439getZEROUwyO8pc();
                    }
                    long r2 = Duration.m7372minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m7342equalsimpl0(m7315minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m7439getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m7365hashCodeimpl(Duration.m7373plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m7386toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m7439getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
