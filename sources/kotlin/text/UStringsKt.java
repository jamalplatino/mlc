...
public final class UStringsKt {
    ...
    public static final String m7309toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m7311toStringolVBNx4(short s, int i) {
    ...
    public static final String m7310toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m7308toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m6073unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m6336unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m6152unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m6231unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m6152unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m6100constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m6017boximpl(UByte.m6023constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m6152unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m6100constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m6280boximpl(UShort.m6286constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m6100constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m6100constructorimpl(i3 * r3);
            int r7 = UInt.m6100constructorimpl(UInt.m6100constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m6179constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m6179constructorimpl(j * r5);
            long r13 = ULong.m6179constructorimpl(ULong.m6179constructorimpl(((long) UInt.m6100constructorimpl(digitOf)) & 4294967295L) + r9);
