...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m7245getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m7246getLastsVKNKU() {
        return this.last;
    }
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m7221getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m6179constructorimpl(j ^ ULong.m6179constructorimpl(j >>> 32))) * 31) + ((int) ULong.m6179constructorimpl(j2 ^ ULong.m6179constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m6225toStringimpl(this.first)).append("..").append(ULong.m6225toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m6225toStringimpl(this.first)).append(" downTo ").append(ULong.m6225toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m7247fromClosedRange7ftBX0g(long j, long j2, long j3) {
