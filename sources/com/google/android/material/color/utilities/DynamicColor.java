...
public final class DynamicColor {
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function == null) {
            ...
            dynamicColor = function.apply(dynamicScheme2);
        }
        double d2 = 1.0d;
        if (dynamicColor != null) {
            ...
            double ratioOfTones = Contrast.ratioOfTones(this.tone.apply(dynamicScheme2).doubleValue(), dynamicColor.tone.apply(dynamicScheme2).doubleValue());
            if (z2) {
                double ratioOfTones2 = Contrast.ratioOfTones(this.toneMinContrast.apply(dynamicScheme2).doubleValue(), dynamicColor.toneMinContrast.apply(dynamicScheme2).doubleValue());
                if (z) {
                    d2 = ratioOfTones2;
                }
                d = ratioOfTones;
            } else {
                double ratioOfTones3 = Contrast.ratioOfTones(this.toneMaxContrast.apply(dynamicScheme2).doubleValue(), dynamicColor.toneMaxContrast.apply(dynamicScheme2).doubleValue());
                if (z) {
            ...
            return calculateDynamicTone(dynamicScheme, this.tone, new DynamicColor$$ExternalSyntheticLambda18(dynamicScheme2), new DynamicColor$$ExternalSyntheticLambda1(doubleValue), new DynamicColor$$ExternalSyntheticLambda2(dynamicColor), this.toneDeltaConstraint, new DynamicColor$$ExternalSyntheticLambda3(d2), new DynamicColor$$ExternalSyntheticLambda4(d));
        }
        d = 21.0d;
        return calculateDynamicTone(dynamicScheme, this.tone, new DynamicColor$$ExternalSyntheticLambda18(dynamicScheme2), new DynamicColor$$ExternalSyntheticLambda1(doubleValue), new DynamicColor$$ExternalSyntheticLambda2(dynamicColor), this.toneDeltaConstraint, new DynamicColor$$ExternalSyntheticLambda3(d2), new DynamicColor$$ExternalSyntheticLambda4(d));
    }
