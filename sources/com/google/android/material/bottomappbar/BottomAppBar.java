...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public float getFabTranslationX(int i) {
        ...
        View findDependentView = findDependentView();
        int measuredWidth = (getMeasuredWidth() / 2) - ((isLayoutRtl ? this.leftInset : this.rightInset) + ((this.fabAlignmentModeEndMargin == -1 || findDependentView == null) ? this.fabOffsetEndMode : (findDependentView.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin));
        if (isLayoutRtl) {
            i2 = -1;
        }
