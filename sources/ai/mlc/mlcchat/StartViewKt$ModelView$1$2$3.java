...
final class StartViewKt$ModelView$1$2$3 extends Lambda implements Function0<Unit> {
    ...
    StartViewKt$ModelView$1$2$3(AppViewModel.ModelState modelState, MutableState<Boolean> mutableState) {
        super(0);
