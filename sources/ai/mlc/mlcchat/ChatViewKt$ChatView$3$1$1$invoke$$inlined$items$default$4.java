...
public final class ChatViewKt$ChatView$3$1$1$invoke$$inlined$items$default$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ List $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChatViewKt$ChatView$3$1$1$invoke$$inlined$items$default$4(List list) {
        super(4);
        this.$items = list;
    }
    ...
    public final void invoke(LazyItemScope lazyItemScope, int i, Composer composer, int i2) {
        ...
        if ((i3 & 731) != 146 || !composer.getSkipping()) {
            ...
            ChatViewKt.MessageView((MessageData) this.$items.get(i), composer, 8);
            if (ComposerKt.isTraceInProgress()) {
